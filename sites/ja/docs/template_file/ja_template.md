...
1. Seeed Studio で使用するすべての製品をリストアップし、テキスト付きの横並びの表と、「今すぐ入手」製品リンクを記載します。サンプルコードは以下のとおりです。
...
2. ソフトウェアを開き、必要な依存関係やライブラリをインストールする
...
### テーブルコード
ここにはハイパーリンク、画像リンク、テーブルタイトルが含まれます
...
:::note
`syntax` を使った _Markdown_ の **コンテンツ** です。[this `api`](#) を確認してください。
:::
