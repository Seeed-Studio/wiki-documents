...
url: https://wiki.seeedstudio.com/ja/Seeed_Elderly/Navigation/Sensor_Network_4.7/
---


このトピックでは、物理世界からデジタルデータを取得する最初のステップ、つまり動的なセンシングフレームワークにおける情報インフラの展開について、Seeed Studio 製品ドキュメントを紹介します。これにより、社会が物理的および自然環境を監視し理解するための基盤を築きます。

このページは、2つの大きなセクションで構成されています。
...
<strong><font color={'8DC215'} size={"4"}>私たちは、長距離接続とインテリジェンスを備えた産業用グレードのセンサーを展開し、物理世界から計測レベルの精度でデジタルデータを生成します。このセクションでは以下を見つけることができます：</font></strong>

- さまざまな産業用環境データセンシング用のセンサーとプローブ
- インテリジェントなシナリオに即時展開可能な AI ベースのセンサー
- リモート環境データ監視用のデータロガー
- 長距離、高セキュリティ、屋内外データ伝送用のゲートウェイ
- ルーターなどのその他のデータ伝送ネットワークインフラ

### 産業用センサーとプローブ

<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>SenseCAP センサーとプローブ</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP センサーとプローブは、産業用ハードウェア設計で複数の環境データをセンシングします。</font></div>
    </a>
</div>

<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>SenseCAP S210X シリーズセンサー</font></div>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S210X シリーズユーザーガイドの PDF ダウンロード</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2101 - 温度と湿度</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2102 - ワイヤレス光強度</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2103 - 温度、湿度、CO2</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2104 - 土壌水分と温度</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2105 - 土壌水分、温度、EC</font></span></a>
            <br/>
    </a>
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="Sensor/SenseCAP/SenseCAP_Probe/Industrial-ph-Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 土壌条件と水質のための pH メーター</font></span></a>
            <br/>
            <a href="Sensor/SenseCAP/SenseCAP_Probe/Soil-Moisture-Temperature-EC-Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 土壌水分と温度プローブ</font></span></a>
            <br/>
            <a href="Sensor/SenseCAP/SenseCAP_Probe/Soil-Moisture-Temperature-Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 土壌水分、温度、EC プローブ</font></span></a>
    </a>
</div>
...
<div class="intro_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="https://files.seeedstudio.com/products/101990784/SenseCAP%20ONE%20Compact%20Weather%20Sensor%20User%20Guide-v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE 気象センサーシリーズユーザーガイドの PDF ダウンロード</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S500 - 温度、湿度、気圧、風速、風向</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S700 - 温度、湿度、風速/風向、気圧、光強度、降水強度</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S900 - PM2.5 と PM10 を検知可能な 9-in-1 センサー</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S1000 - CO2、PM2.5、PM10 を検知可能な 10-in-1 センサー</font></span></a>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC21F'} size={"6"}>SenseCAP AI ベースセンサー</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>即時展開可能なインテリジェントシナリオ向けに構築された <strong>SenseCAP A1101</strong> は、インテリジェントビジョンを備えています。</font></div>
            <a href="/ja/Train-Deploy-AI-Model-A1101" target="_blank"><span><font color={'FFFFFF'} size={"3"}> 詳細はこちらをクリック</font></span></a>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>SenseCAP データロガー</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP データロガーは、MODBUS-RTU RS485/アナログ/GPIOセンサーに接続し、センサーからのデータをLoRaWAN / 4Gネットワークに送信することができます</font></div>
    </a>
</div>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="Sensor/SenseCAP/SenseCAP_Data_Logger/tutorial/How_to_Configure_the_12V_RS485_Sensor_for_S2100_Data_Logger" target="_blank"><span><font color={'FFFFFF'} size={"2"}>S2100 データロガー用12V RS485センサーの設定方法</font></span></a>
            <br/>
            ...
            <br/>
            <a href="Sensor/SenseCAP/SenseCAP_Data_Logger/tutorial/How_to_Configure_the_Counter&GPIO_Sensor_for_S2100_Data_Logger" target="_blank"><span><font color={'FFFFFF'} size={"2"}>S2100 データロガー用カウンター＆GPIOセンサーの設定方法</font></span></a>
            <br/>
            <a href="/ja/Build-LoRaWAN-Sensors-SenseCAP-XIAO-Controller-Data-Logger" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP S2110 センサービルダーとSenseCAP データロガーを使用したLoRaWANセンサーの構築</font></span></a>
            <br/>
    </a>
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="https://files.seeedstudio.com/products/114992170/Sensor%20Hub%204G%20Data%20Logger%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP センサーハブ 4G ユーザーガイドのPDFダウンロード</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/114992170/Developer%20Guide%20for%20Private%20MQTT%20Messaging%20of%20SenseCAP%20SensorHub%20v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP センサーハブのプライベートMQTTメッセージング開発者ガイドのPDFダウンロード</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>SenseCAP ゲートウェイ</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP ゲートウェイは、長距離/LoRaWANデバイス向けに広範囲の無線ネットワークカバレッジとデータ送信能力を提供します</font></div>
    </a>
</div>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <a href="Network/SenseCAP_Network/SenseCAP_M1-Helium_gateway/SenseCAP_M1_Overview" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP M1 概要</font></span></a>
            <br/>
            ...
            <br/>
            <a href="Network/SenseCAP_Network/SenseCAP_M2_Data_Only-Helium_gateway/SenseCAP_M2_Data_Only_Overview" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP M2 データ専用概要</font></span></a>
            <br/>
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="Network/SenseCAP_Network/SenseCAP_M2_Multi_Platform/Tutorial/Connect-M2-Multi-Platform-Gateway-to-AWS-IoT" target="_blank"><span><font color={'FFFFFF'} size={"2"}>AWSプラットフォームへの接続</font></span></a>
            <br/>
            <a href="Network/SenseCAP_Network/SenseCAP_M2_Multi_Platform/Tutorial/Connect-M2-Multi-Platform-Gateway-to-The-Things-Network" target="_blank"><span><font color={'FFFFFF'} size={"2"}>TTNプラットフォームへの接続</font></span></a>
            <br/>
            <a href="Network/SenseCAP_Network/SenseCAP_M2_Multi_Platform/Tutorial/Connect-M2-Multi-Platform-Gateway-to-ChirpStack" target="_blank"><span><font color={'FFFFFF'} size={"2"}>ChirpStackプラットフォームへの接続</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'left'}}>
            ...
            <a href="Network/SenseCAP_Network/SenseCAP_M4_Square-Flux_gateway/SenseCAP_M4_Overview" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP M4 Square 概要</font></span></a>
            <br/>
            <a href="Network/SenseCAP_Network/SenseCAP_M4_Square-Flux_gateway/SenseCAP_M4_Quick_Start" target="_blank"><span><font color={'FFFFFF'} size={"2"}>SenseCAP M4 Square クイックスタート</font></span></a>
            <br/>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>ルーター</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>ルーターはローカルネットワークをインターネットに接続し、デバイス同士の通信を可能にします。</font></div>
    </a>
</div>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/ja/OpenWrt-Getting-Started" target="_blank"><span><font color={'FFFFFF'} size={"2"}> アプリケーション: OpenWRTのインストール</font></span></a>
            <br/>
            <a href="/ja/OpenWrt-Plex-Media-Server-on-Docker" target="_blank"><span><font color={'FFFFFF'} size={"2"}> アプリケーション: Plex Media Serverのインストール</font></span></a>
            <br/>
            <a href="/ja/Mender-Client-dual-GbE-CM4" target="_blank"><span><font color={'FFFFFF'} size={"2"}> アプリケーション: reRouter向けMenderの使用</font></span></a>
    </a>
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/ja/h68k-ha-esphome" target="_blank"><span><font color={'FFFFFF'} size={"2"}> アプリケーション: Home Assistantを中心としたスマートホーム制御センターの構築</font></span></a>
    </a>
</div>

## 簡単な IoT - 自分で構築しよう

<strong><font color={'8DC215'} size={"4"}>複雑な機器を使わずに、マイクロコントローラーと簡単な機能的な電気部品を使用することで物理的な世界を感知し、監視することができます。このセクションでは以下の内容を見つけることができます:</font></strong>

- Grove センサーやその他の機能的な電気部品
- マイクロコントローラーと接続された拡張ボード、アクセサリーなど
- IoT または組み込み ML メソッドの応用知識
- 無料のコースやより興味深いチュートリアルを含むキット
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Grove センサー</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これは Grove センサーの紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Grove-I2C_High_Accuracy_Temp-Humi_Sensor-SHT35" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SHT35 </font></span></a>,
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/ja/Grove-1-Wire_Thermocouple_Amplifier-MAX31850K" target="_blank"><span><font color={'FFFFFF'} size={"2"}>ワイヤー1本 - MAX31850K</font></span></a>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"} >複数機能</font></div>
            <a href="/ja/Grove-Temperature_Humidity_Pressure_Gas_Sensor_BME680" target="_blank"><span><font color={'FFFFFF'} size={"2"}>温度/湿度/圧力/ガス</font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Grove-Capacitive_Moisture_Sensor-Corrosion-Resistant" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 1プローブタイプ</font></span></a>
            <br/>
            <a href="/ja/Grove-Moisture_Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 2プローブタイプ</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>空気品質</font></div>
            <a href="/ja/Grove-Air_Quality_Sensor_v1.3" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 空気品質</font></span></a>
            <br/>
            <a href="/ja/Grove-Laser_PM2.5_Sensor-HM3301" target="_blank"><span><font color={'FFFFFF'} size={"2"}> レーザー PM2.5 センサー</font></span></a>
            <br/>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>動き</font></div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これは Grove センサーネットワークの紹介であり、センサーに提供される通信方法について説明します。</font></div>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Grove_NFC" target="_blank"><span><font color={'FFFFFF'} size={"2"}> NFC モジュール </font></span></a>
            <br/>
            <a href="/ja/Grove_NFC_Tag" target="_blank"><span><font color={'FFFFFF'} size={"2"}> NFC タグ </font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Grove-Serial_RF_Pro" target="_blank"><span><font color={'FFFFFF'} size={"2"}> シリアル RF Pro </font></span></a>
            <br/>
            <a href="/ja/Grove-125KHz_RFID_Reader" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 125KHz RFID リーダー </font></span></a>
            <br/>
            <a href="/ja/Grove_LoRa_Radio" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 868MHz 長距離通信 </font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/ja/Grove-RJ45_Adapter" target="_blank"><span><font color={'FFFFFF'} size={"2"}> RJ45 アダプター </font></span></a>
            <br/>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>センシングノード</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これはセンシングノードの紹介であり、Grove エコシステム以外のセンサーについて説明します。</font></div>
    </a>
</div>

<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>mmWave レーダーセンサー</font></div>
            ...
            <br/>
            <a href="/ja/Microwave-Sensor-24GHz-Doppler-Radar-Motion-Sensor-MW2401TR11" target="_blank"><span><font color={'FFFFFF'} size={"2"}> マイクロ波センサー - 24GHz ドップラーレーダー動作センサー - MW2401TR11</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Beyond Grove / 廃止製品</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}> これは Seeed Studio の長年にわたるセンサーおよび通信モジュールの紹介です。</font></div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Gear_Stepper_Motor_Driver_Pack" target="_blank"><span><font color={'FFFFFF'} size={"2"}> ギアステッピングモータードライバーパック</font></span></a>
            <br/>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}> これはオープンソースのマイクロコントローラーの紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="Wio-Terminal-Light" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 光センサー</font></span></a>,
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/ja/Wio_Tracker" target="_blank"><span><font color={'FFFFFF'} size={"2"}>Wioトラッカーボード</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="Arch_GPRS" target="_blank"><span><font color={'FFFFFF'} size={"2"}>Arch GPRS ボード</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>独自プラットフォームを使用するマイクロコントローラーの紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="Azure_Sphere_MT3620_Development_Kit" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Azure Sphere用MT3620開発キット</font></span></a>
            <br/>
            <a href="MT3620_Mini_Dev_Board" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Azure Sphere用MT3620ミニ開発ボード</font></span></a>
            <br/>
            <a href="https://seeedjp.github.io/ReButton/" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Azure IoT Hub/IoT Central用reButton</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>廃止製品</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これは Seeed Studio の長年にわたるマイクロコントローラーの紹介です。</font></div>
            <a href="/ja/UartSB_Frame" target="_blank"><span><font color={'FFFFFF'} size={"3"}> こちらをクリック </font></span></a>して全体像をご覧ください。
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="//Air602_WiFi_Development_Board" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Air602 WiFi開発ボード</font></span></a>,
            <br/>
            <a href="//Air602_Firmware_Programming_Manual" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Air602ファームウェアマニュアル</font></span></a>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="//Skeleton_Box" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 紹介</font></span></a>
            <br/>
            <a href="//Skeleton_Bot-4WD_hercules_mobile_robotic_platform" target="_blank"><span><font color={'FFFFFF'} size={"2"}> モバイルロボットプラットフォーム</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <span><font color={'FFFFFF'} size={"2"}> 統合</font></span><a href="/ja/K1100_SenseCAP_to_Azure_IoT_Central" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Azure IoT</font></span></a>,
            ...
            <br/>
            <span><font color={'FFFFFF'} size={"2"}> 統合</font></span><a href="/ja/Integrate-into-Azure-IoT-Hub" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Azure IoT</font></span></a>,
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>簡単に適用およびトレーニング可能な組み込み機械学習（TinyML）の使用法の紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO SAMD21</font></div>
            <a href="/ja/Contributor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > 近日公開予定</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO RP2040</font></div>
            <a href="/ja/XIAO-RP2040-EI" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > Edge Impulseを使用したモーション認識</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO nRF52840</font></div>
            <a href="/ja/XIAO-BLE-Sense-TFLite-Getting-Started" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > TensorFlow Liteでの入門</font></span></a>
            <br/>
            <a href="/ja/XIAO-BLE-Sense-TFLite-Mic" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > TensorFlow Liteを使用した音声認識</font></span></a>
            <br/>
            <a href="/ja/XIAOEI" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > Edge Impulseを使用したモーション認識</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO ESP32C3</font></div>
            <a href="/ja/xiaoesp32c3-chatgpt" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > XIAO ESP32C3でWiFiClientとHTTPClientを使用 - XIAO ESP32C3とChatGPTの連携</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Arduino / Arduino互換 - 拡張機能</font></div>
            <a href="/ja/Bluetooth_Shield_V2" target="_blank"><span><font color={'FFFFFF'} size={"3"}> Bluetoothシールド</font></span></a>,
            <a href="/ja/Solar_Charger_Shield_V2.2" target="_blank"><span><font color={'FFFFFF'} size={"3"}> ソーラーチャージャーシールド</font></span></a>,
            <a href="/ja/Base_Shield_V2" target="_blank"><span><font color={'FFFFFF'} size={"3"}> Groveベースシールド</font></span></a>,
            <a href="/ja/CAN-BUS_Shield_V2.0" target="_blank"><span><font color={'FFFFFF'} size={"3"}> CAN-BUSシールド</font></span></a>,
            <a href="/ja/RS232_Shield" target="_blank"><span><font color={'FFFFFF'} size={"3"}> RS232シールド</font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Wio_Terminal_LoRaWan_Chassis_with_Antenna-built-in_LoRa-E5_and_GNSS_EU868_US915" target="_blank"><span><font color={'FFFFFF'} size={"2"}> LoRaWAN対応バッテリーチャーシス</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO - 拡張機能</font></div>
            <a href="/ja/Seeeduino-XIAO-Expansion-Board" target="_blank"><span><font color={'FFFFFF'} size={"2"}> ボード1: 4つのGroveポート / OLED / RTC / SDカードスロット</font></span></a>
            <br/>
            <a href="/ja/Grove-Shield-for-Seeeduino-XIAO-embedded-battery-management-chip" target="_blank"><span><font color={'FFFFFF'} size={"2"}> ボード2: 8つのGroveポート / バッテリーマネジメント</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/ja/Grove-Starter-Kit-for-Raspberry-Pi-Pico" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Raspberry Pi Pico用Grove拡張ボード</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Wioシリーズ - 拡張機能</font></div>
            <a href="/ja/Grove-Shield-for-Wio-Lite" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Lite用Groveシールド</font></span></a>
            <br/>
            <a href="/ja/Wio-Extension-RTC" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Tracker用RTC</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Groveアクセサリ</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これはGroveアクセサリの紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a><span><font color={'FFFFFF'} size={"2"}> アルファ-LED</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>アクチュエータ</font></div>
            <a href="/ja/Grove-I2C_Motor_Driver_V1.3" target="_blank"><span><font color={'FFFFFF'} size={"2"}> モータードライバ </font></span></a>
            <br/>
            ...
            <br/>
            <a href="/ja/Grove-16-Channel_PWM_Driver-PCA9685" target="_blank"><span><font color={'FFFFFF'} size={"2"}>PWM ドライバ </font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/ja/Grove-Qwiic-Hub" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Grove to Qwiic ハブ </font></span></a>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Beyond Grove / 廃止製品</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これはSeeed Studioの長年のアクセサリーの紹介です。</font></div>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>電流</font></div>
            <a href="/ja/Adjustable_DC_DC_Power_Converter_1V-12V-1.5A" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 1Vから12VのDC電源コンバータ</font></span></a>
            <br/>
...
<a href="/ja/13.56Mhz_RFID_module-IOS-IEC_14443_type_a" target="_blank"><span><font color={'FFFFFF'} size={"2"}> RFIDモジュール</font></span></a>
            <br/>
<a href="/ja/AVR_USB_Programmer" target="_blank"><span><font color={'FFFFFF'} size={"2"}> AVR USBプログラマー</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>ケース</font></div>
            ...
            <br/>
            <a href="/ja/Shield-MaTrix-V0.9b" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Shield MaTrix V0.9</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Arduino用キット</font></div>
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Wio Terminal用キット</font></div>
            <a href="/ja/Wio-Terminal-TinyML" target="_blank"><span><font color={'FFFFFF'} size={"2"}> TinyMLとは何か </font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO用キット</font></div>
            <a href="/ja/XIAO-Kit-Courses" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Seeed Studio XIAO コース付きキット </font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Micro:bit用キット</font></div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Arduino ボード チュートリアル</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これは Arduino ボード チュートリアルの紹介です。</font></div>
    </a>
</div>

<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><a href="/ja/Download-Arduino-and-install-Arduino_Driver" target="_blank"><span><font color={'8DC215'} size={"5"}>📖 Arduino 基本操作</font></span></a></div>
            <a href="/ja/Download-Arduino-and-install-Arduino_Driver" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Arduino をダウンロードしてドライバーをインストールする</font></span></a>
            <br/>
            <a href="/ja/Seeed_Arduino_Boards" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Arduino IDE に Seeed Studio ボードを追加する方法</font></span></a>
            <br/>
            <a href="/ja/Guide_to_use_demos_downloaded_from_Seeed-s_Github" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Seeed Studio の Github からダウンロードしたデモを使用する方法</font></span></a>
            <br/>
            <a href="/ja/How_to_use_and_write_a_library" target="_blank"><span><font color={'FFFFFF'} size={"2"}> ライブラリを使用および作成する方法</font></span></a>
            <br/>
            <a href="/ja/Upload_Code" target="_blank"><span><font color={'FFFFFF'} size={"2"}> コードをアップロードする方法</font></span></a>
            <br/>
            <a href="/ja/Use_External_Editor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 外部エディタを使用する</font></span></a>
            <br/>
    </a>
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><a href="/ja/Arduino-AWS-IOT-Bridge" target="_blank"><span><font color={'8DC215'} size={"5"}>📖 Arduino 応用操作</font></span></a></div>
            ...
            <br/>
            <a href="/ja/I2C_And_I2C_Address_of_Seeed_Product" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Seeed 製品の I2C と I2C アドレス</font></span></a>
            <br/>
            <a href="/ja/ODYSSEY-X86J4105-Firmata" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Firmata チュートリアル - Arduino 互換で Firmata を使用する方法</font></span></a>
            <br/>
            <a href="/ja/Software-FreeRTOS" target="_blank"><span><font color={'FFFFFF'} size={"2"}> FreeRTOS チュートリアル - マルチタスクを適用する方法</font></span></a>
            <br/>
            <a href="/ja/Software-SWD" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SWD インターフェースを使用して Arduino ボードをデバッグする方法</font></span></a>
            <br/>
            <a href="/ja/Flashing-Arduino-Bootloader-DAPLink" target="_blank"><span><font color={'FFFFFF'} size={"2"}> DAP Link を使用して Arduino ブートローダーをフラッシュする</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Arduino のコンパイルプラットフォーム</font></div>
            <a href="/ja/Software-PlatformIO" target="_blank"><span><font color={'FFFFFF'} size={"2"}> PlatformIO </font></span></a>
            <br/>
            <a href="/ja/Compiling_MicroPython_for_embedded_devices" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 組み込みデバイス用 MicroPython のコンパイル </font></span></a>
            <br/>
            <a href="/ja/Guide_for_Codecraft_using_Arduino" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Arduino 用 Codecraft プラットフォーム </font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}> Arduino ボードの楽しいプロジェクト</font></div>
            <a href="/ja/IR_Remote" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 赤外線リモコン</font></span></a>
            <br/>
            <a href="/ja/Joystick_Control_RGB_Led" target="_blank"><span><font color={'FFFFFF'} size={"2"}> ジョイスティックで RGB LED を制御</font></span></a>
            <br/>
            <a href="/ja/Light_Sensor_and_LED_Bar" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 光センサーと LED バー</font></span></a>
            <br/>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>これは Wio Terminal チュートリアルの紹介です。</font></div>
    </a>
</div>

<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><a><span><font color={'8DC215'} size={"5"}>Wio Terminal の基本操作</font></span></a></div>
            <a href="/ja/Wio-Terminal-Firmware" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Terminal でレトロゲームをプレイする方法</font></span></a>
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}>USB ホストとしての</font></span></a>
            ...
            <br/>
            <a><span><font color={'FFFFFF'} size={"2"}>USB クライアントとしての</font></span></a>
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Wio Terminal の楽しいプロジェクト</font></div>
            ...
            <br/>
            <a href="/ja/Barometric-Pressure-sensor-using-the-Wio-terminal" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Terminal を使用した圧力センサー</font></span></a>
            <br/>
            <a href="/ja/Wio-Terminal-Reading-COVID19" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Terminal を使用してコロナウイルスのライブデータを読み取る</font></span></a>
            <br/>
            <a href="/ja/Wio-Terminal-Sound-Meter" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wio Terminal を使用して騒音レベルを測定する方法</font></span></a>
            <br/>
