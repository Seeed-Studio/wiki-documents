...
Ethernet ケーブルを Ethernet ポートに接続すると、ゲートウェイがインターネットに正常に接続された場合、上部のインジケーターが緑色で点灯します。
...
:::note PC とデバイスは同じルーター/ネットワークに接続されている必要があります。
:::
...
- ステップ 1: デバイスの AP ホットスポットをオンにします。

ボタンを 5 秒間押し続け、青色インジケーターがゆっくり点滅し始めたら、設定モードに入ります。
...
<tr><td colspan="1" rowspan="2" valign="top"><p></p><p></p><p>緑</p></td><td colspan="1" valign="top">点灯</td><td colspan="1" valign="top">ゲートウェイは正常で、インターネットに良好に接続されています。</td></tr>
...
<tr><td colspan="1" valign="top"><p></p><p>高速点滅</p></td><td colspan="1" valign="top">ボタンを 30 秒間押し続け、インジケーターが高速点滅を示すと、ファクトリーリセットが実行されます。</td></tr>
...
<tr><td colspan="1" rowspan="2" valign="top"><p></p><p>赤</p></td><td colspan="1" valign="top">点灯</td><td colspan="1" valign="top">ハードウェアの問題、またはインターネット接続の失敗です。</td></tr>
...
デバイス名と設置場所を設定し、設定内容を確認します。
バインドに成功すると、Device ディレクトリにゲートウェイが表示されます。
...
:::tip
SenseCAP M2 Multi-Platform Gateway は Helium ネットワークに接続できません。
:::
...
SenseCAP ポータルと SenseCAP Mate アプリでゲートウェイ情報を確認します
...
SenseCAP ポータルと SenseCAP Mate アプリでセンサーデータを確認します
