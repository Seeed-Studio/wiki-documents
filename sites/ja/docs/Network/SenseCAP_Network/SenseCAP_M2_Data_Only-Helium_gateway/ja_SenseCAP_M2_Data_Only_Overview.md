...
url: https://wiki.seeedstudio.com/ja/Network/SenseCAP_Network/SenseCAP_M2_Data_Only-Helium_gateway/SenseCAP_M2_Data_Only_Overview/
---
...
ユーザーは SenseCAP Hotspot App を使用して、いくつかの簡単なステップでホットスポットを簡単にセットアップできます。SenseCAP Hotspot Dashboard と SenseCAP Local Console も、効率的で簡単な方法でホットスポットを監視・管理するためにユーザー向けに開発されています。
...
SenseCAP デバイス自体の強力な機能に加えて、SenseCAP はユーザーがホットスポットの最大性能を得るための豊富なアクセサリ選択肢を提供しています。高性能 IoT アンテナ、アンテナケーブル、マウンティングパッド、避雷器などのベストセラー商品があります。
...
**オンボーディング料金は製品に含まれていないことにご注意ください。オンボーディングには \$0.50 のオンボーディング料金と \$0.50 の位置アサート料金がユーザーのウォレットから差し引かれます**。オンボーディングプロセスを進める際は、十分な Helium Data Credit とウォレットに少なくとも \$1 の SOL があることを確認してください。
...
- Type-C インターフェースは上級開発者管理用に予約されています。デバイスの電源供給には使用しないでください。
