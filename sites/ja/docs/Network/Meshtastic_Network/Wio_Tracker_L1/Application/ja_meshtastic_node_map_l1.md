...
Meshtastic デバイスは、MQTT を介して定期的に Meshtastic サーバーへ位置情報を報告します。Node Map はこれらのレポートを取得し、各ノードの位置、ルート、および電波到達範囲を表示します。デバイスは次の方法で位置情報を報告できます：
...
|----------|----------|-----------|-------|
| [MeshMap](https://meshmap.net/) | リアルタイムノード追跡、メッシュルート表示、電波到達範囲表示 | 一般ユーザー、初心者 | シンプルなインターフェース、デフォルトの Meshtastic サーバーを使用 |
...
任意のノードをクリックすると、詳細情報（デバイス ID、バッテリーレベルなど）、メッシュルート、電波カバレッジを確認できます。
