...
url: https://wiki.seeedstudio.com/ja/meshcore_node_map_meshtracker_x1/
---
...
リピーターまたは Room Server を MeshCore Node Map 上に表示するには、デバイスが位置情報を報告するよう正しく設定されている必要があります。 

まずリピーターにログインします。リピーターのデフォルトの管理者パスワードは `password` です。 
