...
url: https://wiki.seeedstudio.com/ja/meshtastic_node_map_x1/
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

このガイドでは、[MeshTracker X1](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) を使用して、[Meshtastic](https://meshtastic.org/docs/introduction/) デバイスの位置情報を Meshtastic Node Map 上に表示する方法を説明します。ここでは、デバイスにはすでに Meshtastic ファームウェアが書き込まれているものとします。
