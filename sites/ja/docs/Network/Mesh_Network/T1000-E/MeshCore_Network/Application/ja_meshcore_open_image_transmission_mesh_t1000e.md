---
description: このガイドでは、Card Tracker T1000-E をベースにした超低ビットレート画像圧縮を用いて、MeshCore 上で AI によって再構成された画像を送信する方法を説明します。
title: 画像伝送
keywords:
  - MeshCore
  - MeshCore Open
...
# SenseCAP Card Tracker T1000-E を用いた MeshCore 上での AI 画像伝送
...
- **アウトドア探検者**：ハイカー、クライマー、遠征チームが、登山道の状況を共有したり、遠隔地の風景画像を送信したり、テキストだけでは不十分な場合に視覚情報を提供できます。
...
出力画像は元の画像をピクセル単位で完全にコピーしたものではありません。デコーダーは、送信されていない追加のディテールを生成する場合があります。そのため、この機能はシーン認識、アウトドアでの通信、遠隔監視、視覚情報の共有には適していますが、証拠収集、本人確認、科学的な画像解析、正確な画像再現を必要とする用途には適していません。
