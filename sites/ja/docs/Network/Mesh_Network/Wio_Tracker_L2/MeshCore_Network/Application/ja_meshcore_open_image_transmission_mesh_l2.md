...
# Wio Tracker L2 向け MeshCore AI 画像伝送
...
出力画像は、元の画像をピクセル単位で完全にコピーしたものではありません。デコーダーは、送信されていない追加のディテールを生成する場合があります。そのため、この機能はシーン認識、アウトドアでの通信、遠隔監視、視覚情報の共有には適していますが、証拠収集、本人確認、科学的な画像解析、厳密な画像再現を必要とする用途には適していません。
