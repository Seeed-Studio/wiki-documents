...
<div className="robotics-page">
  ...
  <section className="hero-panel">
    ...
    <div className="hero-tips">
      ...
      <div><strong>AI ロボティクス</strong><span>シミュレーション、データ収集、GR00T、VLA、強化学習を探求</span></div>
    </div>
  </section>
  ...
  <section className="kit-index-panel" aria-label="Quick robot kit selection">
    <div className="section-title-row compact-title">
      ...
      <p>カードはデフォルトで折りたたまれています。お持ちのキットを開いて、その学習パスを確認してください。</p>
    </div>
    <div className="kit-index-grid">
      <a href="#rebot-rs"><span>🦾</span><strong>B601-RS</strong><small>RobStride ロボットアーム学習パス</small></a>
      <a href="#rebot-dm"><span>🦾</span><strong>B601-DM</strong><small>Damiao ロボットアーム学習パス</small></a>
  ...
  <section id="robot-kits" className="section-block">
    <div className="section-title-row">
      ...
      <p>各学習パスはハードウェアのセットアップから始まり、その後 SDK、ROS、シミュレーション、AI アプリケーションへと進みます。</p>
    </div>
...
<details id="rebot-rs" className="product-card rebot">
  ...
  <div className="product-body">
    <div className="product-meta-grid">
      <div><strong>おすすめ対象</strong><span>初めて reBot アームを使うユーザー</span></div>
...
<summary>
  <div className="product-head">
    ...
    <div>
      ...
      <span>LeRobot、シミュレーション、強化学習、GR00T/VLA 向けの低コストパス</span>
    </div>
  </div>
  <span className="summary-action">学習プランを展開</span>
</summary>
<div className="product-body">
  <div className="product-meta-grid">
    ...
    <div><strong>学習目標</strong><span>サーボ、シミュレーション、強化学習、GR00T、デュアルアームを学習</span></div>
  ...
  <div className="learning-steps">
    ...
    <a className="step-card" href="/ja/simulate_soarm101_by_leisaac/"><span className="step-index">6</span><div><b>LeIsaac シミュレーション</b><small>シミュレートされたモデルとタスクで Sim2Real に備えます。</small></div><em>シミュレーションの基礎</em></a>
    ...
    <a className="step-card optional" href="/ja/control_robotic_arm_via_phospho/"><span className="step-index">+</span><div><b>Phospho LeRobot</b><small>サードパーティのデータ収集およびトレーニングプラットフォームを試してみましょう。</small></div><em>任意の拡張</em></a>
  </div>
</div>
</details>
...
<div className="product-body">
  ...
  <div className="learning-steps">
    ...
    <a className="step-card" href="/ja/sound_follow_robot/"><span className="step-index">2</span><div><b>サウンドフォローデモ</b><small>音声入力を使用して、インタラクティブなモバイルデモを動かします。</small></div><em>アプリケーションデモ</em></a>
  </div>
</div>
</details>
...
<div className="reachy-path-grid">
  ...
  <section id="software" className="section-block compact-section">
    <div className="section-title-row">
      ...
      <p>セットアップ後は、ROS、Isaac、PX4、または VLA に進みます。</p>
    </div>
    <div className="resource-columns">
      ...
      <div><h4>NVIDIA Isaac</h4><a href="/ja/install_isaaclab/">Isaac Lab のインストール</a><a href="/ja/training_soarm101_policy_with_isaacLab/">SO Arm 強化学習</a><a href="/ja/simulate_soarm101_by_leisaac/">IsaacSim を用いた SO100 ロボットアーム</a></div>
