---
description: このトピックでは、Seeed Studioのロボティクス製品ドキュメントと学習コースを紹介します。
title: ロボティクス
keywords:
  - robotics
  - nvidia
...
<div className="robotic-tab-container">
    ...
    <div className="nav-grid">
        ...
        <div className="category-card robot-kits">
          ...
          <div className="card-container">
              ...
              <a href="/ja/simulate_soarm101_by_leisaac/" className="content-card">
                <span className="text">LeIsaac を使用した SO10x アーム</span>
              </a>
              ...
              <a href="/ja/fine_tune_gr00t_n1.5_for_lerobot_so_arm_and_deploy_on_jetson_thor/" className="content-card">
                  <span className="text">NVIDIA GR00T を使用した SO101</span>
                  <span className="tag recommended">New</span>
              </a>
          </div>
          ...
          <div className="card-container">
              ...
              <a href="/ja/control_robotic_arm_via_gr00t" className="content-card">
                <span className="text">NVIDIA GR00T を使用した StarAI</span>
              </a>
          </div>
          ...
          <div className="card-container">
              <a href="/ja/StackForce_Mini_Wheeled_Legged_Robot" className="content-card">
                <span className="text">ミニ脚付きホイールロボット</span>
                <span className="tag recommended">New</span>
              </a>
          </div>
      ...
      <div className="card-container">
          ...
          <a href="/ja/orbbec_gemini_335lg" className="content-card">
            <span className="text">Gemini 335Lg 深度カメラ</span>
            <span className="tag recommended">New</span>
          </a>
          <a href="/ja/orbbec_gemini336" className="content-card">
            <span className="text">Gemini 336 深度カメラ</span>
            <span className="tag recommended">New</span>
          </a>
          ...
          <a href="/ja/orbbec_depth_camera_on_ros/" className="content-card">
            <span className="text">ROS を使用した Orbbec</span>
          </a>
      ...
      <a href="/ja/install_isaaclab/" className="content-card">
        <span className="theory">Isaac Lab インストール</span>
      </a>
      <a href="/ja/training_soarm101_policy_with_isaacLab/" className="content-card">
        <span className="theory">SO Arm RL トレーニング</span>
        <span className="tag recommended">New</span>
      </a>
      <a href="/ja/simulate_soarm101_by_leisaac/" className="content-card">
        <span className="theory">SO100 Arm Isaac Sim</span>
        <span className="tag recommended">New</span>
      </a>
      </div>
      ...
      <div className="card-container">
      <a href="/ja/control_robotic_arm_via_gr00t" className="content-card">
        <span className="theory">StarAI with NVIDIA GR00T</span>
      </a>
      </div>
  ...
  [LINE84]  <!-- ==================== Tab 2: 学習センター (Learning) ==================== -->
  [LINE85]  <div className="tab-content content-learning">

    [LINE87]    <div className="learning-intro">
        [LINE88]        <h2>🎓 Robotics Academy</h2>
        [LINE89]        <p>ROS、シミュレーション、強化学習、高度なロボット制御を網羅した総合的なカリキュラム。</p>
    [LINE90]    </div>

    [LINE92]    <!-- Section 1: Core Software -->
    [LINE93]    <h3 className="course-section-title">💻 コアソフトウェアとシミュレーション</h3>
    [LINE94]    <div className="course-grid">

      [LINE96]      <!-- ROS Basics: 8 Lectures -->
      [LINE97]      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/1.%20ROS%20Basics%208%20lectures/README.md" className="course-card">
        [LINE98]        <div className="course-cover c-ros1">ROS 1</div>
        [LINE99]        <div className="course-info">
          [LINE100]          <div className="course-meta"><span className="level beg">Beginner</span> <span>⏱️ 8h</span></div>
          [LINE101]          <h3>ROS 1 Basics: 8 Lectures</h3>
          [LINE102]          <p>ノード、トピック、サービス、基本学習について学びます</p>
          [LINE103]          <span className="btn-start">Learning</span>
        [LINE104]        </div>
      [LINE105]      </a>

      [LINE107]      <!-- ROS Robot Simulation: 7 Lectures -->
      [LINE108]      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/2.%20ROS%20Robot%20Simulation%207%20Lectures/README.MD" className="course-card">
        [LINE109]        <div className="course-cover c-ros1">ROS 1</div>
        [LINE110]        <div className="course-info">
          [LINE111]          <div className="course-meta"><span className="level beg">Beginner</span> <span>⏱️ 8h</span></div>
          [LINE112]          <h3>ROS 1 Robot Simulation: 7 Lectures.</h3>
          [LINE113]          <p>モデリングから自律走行まで。</p>
          [LINE114]          <span className="btn-start">Learning</span>
        [LINE115]        </div>
      [LINE116]      </a>

      [LINE118]      <!-- ROS 2 -->
      [LINE119]      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS2_Tutorial/2.English/1.%20ROS%20Basics%208%20lectures/README.MD" className="course-card">
        [LINE120]        <div className="course-cover c-ros2">ROS 2</div>
        [LINE121]        <div className="course-info">
          [LINE122]          <div className="course-meta"><span className="level int">Intermediate</span> <span>⏱️ 8h</span></div>
          [LINE123]          <h3>ROS 2 Humble Basics: 8 Lectures</h3>
          [LINE124]          <p>ノード、トピック、サービス、基本学習について学びます</p>
          [LINE125]          <span className="btn-start">Learning</span>
        [LINE126]        </div>
      [LINE127]      </a>
      ...
      [LINE131]      <!-- Moveit2 -->
      [LINE132]      <a href="" className="course-card">
        [LINE133]        <div className="course-cover c-moveit">MoveIt 1/2</div>
        [LINE134]        <div className="course-info">
          [LINE135]          <div className="course-meta"><span className="level beg">Arm Beginner</span> <span>⏱️ 6h</span></div>
          [LINE136]          <h3>MoveIt 1/2</h3>
          [LINE137]          <p>カスタムマニピュレーターを MoveIt 1/2 にインポートし、順運動学と逆運動学を実装する</p>
          [LINE138]          <span className="btn-plan">Planning</span>
        [LINE139]        </div>
      [LINE140]      </a>

      [LINE142]      <!-- Pinocchio -->
      [LINE143]      <a href="" className="course-card">
        [LINE144]        <div className="course-cover c-pinocchio">Pinocchio</div>
        [LINE145]        <div className="course-info">
          [LINE146]          <div className="course-meta"><span className="level int">Arm Intermediate</span> <span>⏱️ 6h</span></div>
          [LINE147]          <h3>Pinocchio</h3>
          [LINE148]          <p>Pinocchio ロボティクスフレームワークを学び、自身のマニピュレーター用の運動学および動力学タスクを開発する</p>
          [LINE149]          <span className="btn-plan">Planning</span>
        [LINE150]        </div>
      [LINE151]      </a>


      [LINE154]      <!-- Isaac Sim -->
      [LINE155]      <a href="" className="course-card">
        [LINE156]        <div className="course-cover c-isaac">ISAAC</div>
        [LINE157]        <div className="course-info">
          [LINE158]          <div className="course-meta"><span className="level adv">Advanced</span> <span>⏱️ 12h</span></div>
          [LINE159]          <h3>NVIDIA Isaac Sim & Lab</h3>
          [LINE160]          <p>Sim2Real ワークフロー、USD パイプライン、環境作成。</p>
          [LINE161]          <span className="btn-plan">Planning</span>
        [LINE162]        </div>
      [LINE163]      </a>

      [LINE165]      <!-- MuJoCo -->
      [LINE166]      <a href="" className="course-card">
        [LINE167]        <div className="course-cover c-mujoco">MuJoCo</div>
        [LINE168]        <div className="course-info">
          [LINE169]          <div className="course-meta"><span className="level adv">Advanced</span> <span>⏱️ 10h</span></div>
          [LINE170]          <h3>MuJoCo Physics Engine</h3>
          [LINE171]          <p>敏捷なロボット制御に向けたモデルダイナミクスとシミュレーション。</p>
          [LINE172]          <span className="btn-plan">Planning</span>
        [LINE173]        </div>
      [LINE174]      </a>

      [LINE176]      <!-- Reinforcement Learning -->
      [LINE177]      <a href="" className="course-card">
        [LINE178]        <div className="course-cover c-rl">RL</div>
        [LINE179]        <div className="course-info">
          [LINE180]          <div className="course-meta"><span className="level adv">Hard</span> <span>⏱️ 20h</span></div>
          [LINE181]          <h3>Reinforcement Learning</h3>
          [LINE182]          <p>PPO、DRL トレーニングパイプライン、および Jetson へのデプロイ。</p>
          [LINE183]          <span className="btn-plan">Planning</span>
        [LINE184]        </div>
      [LINE185]      </a>

    [LINE187]    </div>

    [LINE189]    <!-- Section 2: Robot Applications -->
    [LINE190]    <h3 className="course-section-title" style={{marginTop: '3rem'}}>🤖 ロボットアプリケーション</h3>
    [LINE191]    <div className="course-grid">

      [LINE193]      <!-- Humanoid -->
      [LINE194]      <a href="" className="course-card">
        [LINE195]        <div className="course-cover c-human">Humanoid</div>
        [LINE196]        <div className="course-info">
          [LINE197]          <div className="course-meta"><span className="level beg">Beginner</span> <span>⏱️ 5h</span></div>
          [LINE198]          <h3>小型サーボヒューマノイドロボットコース </h3>
          [LINE199]          <p>小型ヒューマノイドロボットのハードウェア駆動、モーション・ダンスの振付、二次開発。</p>
          [LINE200]          <span className="btn-plan">Planning</span>
        [LINE201]        </div>
      [LINE202]      </a>


      [LINE205]      <!-- Lekiwi -->
      [LINE206]      <a href="" className="course-card">
        [LINE207]        <div className="course-cover c-lekiwi">Mobile Robot</div>
        [LINE208]        <div className="course-info">
          [LINE209]          <div className="course-meta"><span className="level beg">Beginner</span> <span>⏱️ 6h</span></div>
          [LINE210]          <h3>モバイルロボティクス (Lekiwi)</h3>
          [LINE211]          <p>SLAM、Navigation 2、自律パトロール。</p>
          [LINE212]          <span className="btn-plan">Planning</span>
        [LINE213]        </div>
      [LINE214]      </a>

      [LINE216]      <!-- Robotic Arm -->
      [LINE217]      <a href="" className="course-card">
        [LINE218]        <div className="course-cover c-arm">Robot Arm</div>
        [LINE219]        <div className="course-info">
          [LINE220]          <div className="course-meta"><span className="level int">Intermediate</span> <span>⏱️ 15h</span></div>
          [LINE221]          <h3>StarAI Arm System Course</h3>
          [LINE222]          <p>StarAI 6+1 DOF マニピュレーター: 運動学、動力学、模倣学習、および高度な VLAベースの強化学習</p>
          [LINE223]          <span className="btn-plan">Planning</span>
        [LINE224]        </div>
      [LINE225]      </a>

      [LINE227]      <!-- Wheeled-Legged -->
      [LINE228]      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_Mini_Wheeled_Legged_Robot/English/README.md" className="course-card">
        [LINE229]        <div className="course-cover c-legged">Wheel-Legged Robot</div>
        [LINE230]        <div className="course-info">
          [LINE231]          <div className="course-meta"><span className="level int">Intermediate</span> <span>⏱️ 8h</span></div>
          [LINE232]          <h3>Stackforce Wheeled-Legged Robots Course</h3>
          [LINE233]          <p>ハイブリッドロボットのバランス制御と LQR モーションプランニング。</p>
          [LINE234]          <span className="btn-start">Learning</span>
        [LINE235]        </div>
      [LINE236]      </a>

      [LINE238]      <!-- ReachyMini -->
      [LINE239]      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ReachyMini_Tutorial/2.English/README.md" className="course-card">
        [LINE240]        <div className="course-cover c-reachy">Desktop Robot</div>
        [LINE241]        <div className="course-info">
          [LINE242]          <div className="course-meta"><span className="level adv">Advanced</span> <span>⏱️ 8h</span></div>
          [LINE243]          <h3>ReachyMini Tutorial 13 Lectures</h3>
          [LINE244]          <p>ReachyMiniの基本操作、インターフェースチュートリアル、二次開発に関する体系的なコース</p>
          [LINE245]          <span className="btn-start">Learning</span>
        [LINE246]        </div>
      [LINE247]      </a>
...
.btn-plan {
  ...
  /* 差別化デザイン */
  background: #fff7ed; /* 極めて薄いオレンジ背景 */
  color: #ea580c;      /* 濃いオレンジ文字 */
  cursor: default;
}

/* Hover 効果：暖色系を保ち、Start ボタンのような色反転はせず、視点を奪わない */
