...
<div className="robotic-tab-container">
    ...
    <div className="nav-grid">
      ...
      <div className="card-container">
          ...
          <a href="/ja/orbbec_depth_camera_on_ros/" className="content-card">
            <span className="text">Orbbec と ROS</span>
          </a>
      ...
      <a href="/ja/simulate_soarm101_by_leisaac/" className="content-card">
        <span className="text">SO100 アーム Isaac Sim</span>
        <span className="tag recommended">New</span>
      </a>
      </div>
  ...
  <div className="tab-content content-learning">
    ...
    <div className="learning-intro">
        <h2>🎓 ロボティクスアカデミー</h2>
        <p>ROS、シミュレーション、強化学習、高度なロボット制御を網羅した総合カリキュラム。</p>
    </div>
    ...
    <div className="course-grid">
      ...
      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/1.%20ROS%20Basics%208%20lectures/README.md" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level beg">初心者</span> <span>⏱️ 8h</span></div>
          <h3>ROS 1 基礎：全 8 講義</h3>
          <p>ノード、トピック、サービスなどの基礎を学習します。</p>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level beg">アーム初心者</span> <span>⏱️ 6h</span></div>
          <h3>MoveIt 1/2</h3>
    ...
    <div className="course-grid">
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level beg">初心者</span> <span>⏱️ 5h</span></div>
...
.btn-plan {
  ...
  /* 差別化デザイン */
  background: #fff7ed; /* 非常に薄いオレンジ色の背景 */
  color: #ea580c;      /* やや濃いオレンジ色の文字 */
  cursor: default;
}

/* Hover 効果：暖色トーンを維持し、Start ボタンのように色を反転させず、視線を奪わないようにする */
