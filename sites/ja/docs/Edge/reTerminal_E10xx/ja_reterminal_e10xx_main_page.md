...
- [reTerminal Eシリーズ ePaperディスプレイをHome Assistant用ESPHomeで使用](https://wiki.seeedstudio.com/ja/reterminal_e10xx_with_esphome)

  reTerminal Eシリーズ ePaperディスプレイをHome Assistantに接続し、ESPHomeでYAMLを使用して簡単なグラフを描画する簡単なプログラムの書き方を説明します。

- [Home AssistantでのreTerminal Eシリーズ ePaperディスプレイの高度なESPHome使用法](https://wiki.seeedstudio.com/ja/reterminal_e10xx_with_esphome_advanced)

  Home AssistantでreTerminalのハードウェアとディープスリープなどの高度な機能、包括的な使用例の使用方法を説明します。

- [reTerminal Eシリーズ ePaperディスプレイをTRMNLで使用](https://wiki.seeedstudio.com/ja/reterminal_e10xx_trmnl)

  簡素化された開発と迅速な展開のための専用TRMNLフレームワークを活用します。

<!-- - [LVGL + SquareLine Studio](https://wiki.seeedstudio.com/ja/reTerminal_LVGL_SquareLine)
LVGLとビジュアルSquareLine Studioデザイナーを使用してリッチなグラフィカルインターフェースを作成します。 -->

## リソース

- [SenseCraft HMIドキュメント](https://wiki.seeedstudio.com/ja/sensecraft_hmi_overview/)
- [ESP32-S3データシート](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/esp32-s3_datasheet.pdf)
- [reTerminal MIC無線認証](https://files.seeedstudio.com/wiki/reterminal_e10xx/res/reTerminal_MIC_Radio_Certificate.pdf)
