...
reComputer Rugged J4012 は、NVIDIA Jetson Orin NX 16GB を搭載した IP66 等級のエッジ AI コンピュータです。密閉された M12 コネクタにより、USB、PSE 対応 Ethernet、CAN、RS-232/422/485、DI/DO インターフェースを提供し、さらに M.2 Key B スロットで 5G 拡張をサポートすることで、AMR、ロボティクス、農業、産業オートメーション、海洋用途などに最適です。
