...
[repository](https://github.com/hunter5299/Node-Red-project/tree/main/rtsp_to_webrtc) から RTSP から WebRTC への Python プロジェクトコードを取得します。プロジェクトコードを PC にダウンロードしたら、プロジェクトディレクトリに移動し、Python の依存関係をインストールします。
