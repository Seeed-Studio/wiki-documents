...
reBot Arm プロジェクトは [GitHub](https://github.com/Seeed-Projects/reBot-DevArm) 上でオープンソース公開されています。本ガイドでは、B601-RS の組み立てから操作まで、クイックスタート手順を説明します。
...
- スムーズに組み立てを行うため、以下の注意事項をよくお読みください。
  ...
  2. 動画は 4 月上旬に撮影されたものです。細かな更新がある場合がありますが、組み立て方法は同じです。最終的には、同梱されている部品を基準としてください。
  ...
  4. 組み立て作業中の安全を確保してください。指を挟んだりケガをしないよう注意してください。子どもが作業する場合は必ず保護者が付き添ってください。
...
- 過負荷／過速度での動作は避けてください。起動前に配線や固定部を確認し、湿気の多い／高温／粉じんの多い環境は避けてください。
