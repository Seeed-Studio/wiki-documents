...
| トピック | 型 | 説明 |
| --- | --- | --- |
| `/rebotarm/joint_states` | `sensor_msgs/msg/JointState` | 6 軸とグリッパーの統合ステータス |
...
| `/rebotarm/disable` | `std_srvs/srv/Trigger` | 安全に無効化；必要に応じて先にホーミング |
| `/rebotarm/safe_home` | `std_srvs/srv/Trigger` | 検証付き安全ホーミング |
