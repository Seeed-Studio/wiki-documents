...
url: https://wiki.seeedstudio.com/ja/RS485_750cm_Ultrasonic_Sensor-1/
---
...
RS485 750cm 超音波レベルセンサーは、超音波センシング技術を利用して28-750cmの測定範囲で距離を測定します。ベルマウスを装備し、1mmの分解能で最大750cmまでの物体を検出できます。IP67防水超音波トランスデューサーにより、下水道や水位監視、インテリジェントゴミ箱管理システム、ロボット回避、自動制御など、様々な用途で使用できます。
...
このページでは、S2100 LoRaWANデータロガーと750cm超音波レベルセンサーを接続するプロセスをガイドし、わずか5分で商用利用可能な堅牢で産業グレードのLoRaWANワイヤレスセンサーを作成できるようにします。
...
## 1. データロガー、RS485 750cm超音波レベルセンサー、ゲートウェイ、ツールの準備

1. **データロガー**: MODBUS RS485/アナログ/GPIOセンサーをLoRa対応センサーに変換し、LoRaWANプロトコルを通じてデータを転送するLoRaWANコンバーターです。

2. **RS485 750cm超音波レベルセンサー**: 距離測定に超音波センシング技術を使用します。測定範囲は28cmから750cmで、分解能は1mmに達することができます。IP67防水超音波トランスデューサーを備え、作業環境への強い適応性を持っています。
...
### 3. RS485 750cm超音波レベルセンサーをSenseCAP データロガーに接続
...
### 4. データロガーとRS485 750cm超音波レベルセンサー通信の設定
...
- **ステップ1:** アプリのホームページに戻ると、データロガーの赤色LEDが数秒間点滅し、続いて緑色LEDが短時間点滅してLoRaWAN接続が成功し、データが送信されたことを示します。または、データロガーのボタンを一度クリックして、このデータ送信を強制的に実行することもできます。
...
- **[PDF]** [RS485 750cm超音波レベルセンサー](https://files.seeedstudio.com/wiki/RS485-Ultrasonic-Level-Sensor/RS485-750cm-Ultrasonic-Level-Sensor.pdf)
