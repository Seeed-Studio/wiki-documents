...
url: https://wiki.seeedstudio.com/ja/XIAO-Kit-Courses/
---
# XIAO: 大きなパワー、小さなボード
...
<!-- <table align="center">
	...
	<tr>
	    ...
	    <td align="left"><strong> 序文</strong>: このコースはArduinoプログラミングや電子工学の知識を必要としません。コースでは、これらの必要な知識を段階的に理解し学習し、各プロジェクトで迅速に実践できるよう導きます。       <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/XIAO-Kit-Preface.pdf">序文 ></a></td>
	</tr>
	<tr>
	    <td ><img src="https://files.seeedstudio.com/wiki/XIAO-Kit/xiaokitss.png" alt="pir" width="250" height="auto"/></td>
	    <td align="left"><strong>ユニット1 ハードウェアとプログラミングの入門 </strong>: 学習過程において、各タスクのプログラムコードを可能な限り自分で書くよう努め、良い習慣を身につけ、記号エラーや不慣れなルールによるプログラムアップロードの失敗を避けます。 <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/Unit-1.zip">  入門 ></a></td>
	</tr>
	<tr>
	    ...
	    <td align="left"><strong>ユニット2 プロジェクト実践</strong>:このユニットでは、いくつかの古典的なプロジェクトを例に取り、プロジェクト実践を行い、アイデアから迅速に検証可能なプロトタイプを作成する方法を学びます。このユニットでは、コードを一行ずつ分析するのではなく、重要なステップのみを説明します。  <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/Unit-2.zip">プロジェクト実践 ></a></td>
	</tr>
	<tr>
	    <td><img src="https://files.seeedstudio.com/wiki/XIAO-Kit/xiaokit2.png" alt="pir" width="500" height="auto"/></td>
	    <td align="left"><strong>ユニット3 上級プロジェクト</strong>: このユニットでは、より複雑で完全なプロジェクトを実践します。プログラム実装の効果と設計構造は、より完成品に向けられています。 <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/Unit-3.zip">上級プロジェクト ></a></td>
	</tr>
	<tr>
	    <td><img src="https://files.seeedstudio.com/wiki/XIAO-Kit/xiaokit3.png" alt="pir" width="500" height="auto"/></td>
	    <td align="left"><strong>ユニット4 自主開発プロジェクト</strong>: このユニットでは、学んだことを実践し、作品の変換から始めて、0からプロトタイプ作品を共同で完成させ、発表会で発表します。    <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/Unit-4.zip">自主開発プロジェクト ></a></td>
	</tr>
    	<tr>
	    <td><img src="https://files.seeedstudio.com/wiki/XIAO-Kit/xiaokit4.png" alt="pir" width="500" height="auto"/></td>
	    <td align="left"><strong>あとがき</strong>: このレッスンに関連するリソース、ダウンロード、リンク、説明。 <a href="https://files.seeedstudio.com/wiki/XIAO-Kit/XIAO-Kit-Aferword.pdf">あとがき ></a></td>
	</tr>
</table>
