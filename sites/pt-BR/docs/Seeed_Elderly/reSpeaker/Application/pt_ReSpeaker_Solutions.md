...
## **Integre rapidamente com nossos SDKs e HDKs**

Com pressa para fornecer uma prova de conceito? Seu time-to-market é sensível? Nossos kits de desenvolvimento de software e hardware incluem muitas ferramentas para acelerar seu desenvolvimento e ajudá-lo a entregar dentro do prazo.

### **SDK**

- Guias de configuração
- Algoritmos profissionais de terceiros
- Bibliotecas wrapper
...
- Dimensões detalhadas e arquivos de esquemáticos
- Componentes-chave garantidos em estoque para fabricação
- Arquivos de case e suporte

### **Documentação**

- [Documentação detalhada na Wiki](https://wiki.seeedstudio.com/pt-br/ReSpeaker/)
- [Repositório GitHub](https://github.com/respeaker)
- [Fóruns da comunidade](https://forum.seeedstudio.com/)

## **Personalize sua solução de voz**

Nossa solução de voz está faltando algum recurso ou componente? Transforme-a na sua própria solução usando nosso serviço de personalização. Nós o ajudaremos a adicionar, remover ou reorganizar muitos dos componentes para atender às necessidades do seu projeto. Cada projeto é único e estamos preparados para ajudar a transformar nossa solução na sua solução. Abaixo estão alguns exemplos do que pode ser personalizado:
...
Se você tiver dúvidas, entre em contato conosco em iot@seeed.cc.
