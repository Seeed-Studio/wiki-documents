---
description: Kit Básico de Fixadores
title: Kit Básico de Fixadores
keywords:
  - Seeed_Elderly
...
url: https://wiki.seeedstudio.com/pt-br/Basic_Fastener_Kit/
---

![](https://files.seeedstudio.com/wiki/Basic_Fastener_Kit/img/Fastener_Kit_01.jpg)

O Kit Básico de Fixadores contém muitos componentes padrão, incluindo parafusos, porcas, rebites, abraçadeiras de cabo etc. As peças podem ser usadas para fixar diferentes partes em projetos mecânicos (como construção de robôs), isolar ou prender placas de circuito impresso (PCB), conectar carcaças etc. Esta caixa ajuda os makers a se livrar do incômodo de procurar por peças padrão. É compacta, leve e portátil, proporcionando conveniência aos makers.
...
<tr>
<th rowspan="4" scope="row">Rebite</th>
<td>R2056</td>
<td>Náilon branco</td>
...
<tr>
<th rowspan="5" scope="row">Parafuso</th>
<td>M2X8</td>
<td rowspan="5">Metal &amp; cabeça Philips</td>
...
<tr>
<th rowspan="2" scope="row">Porca</th>
<td>M2X1.7</td>
...
<tr>
<th rowspan="3" scope="row">Coluna Oca</th>
<td>ø3X3</td>
<td rowspan="3">ABS</td>
...
<tr>
<th rowspan="2" scope="row">Coluna Plástica</th>
<td>M3X12+6</td>
<td rowspan="2">Náilon (cabeça simples)</td>
...
<tr>
<th scope="row">Abraçadeira de Cabo</th>
<td>3X60mm</td>
<td>Náilon</td>
...
<tr>
<th scope="row">Almofada de Borracha</th>
<td>ø8X2.5</td>
<td>Silicone transparente</td>
...
Aqui está um exemplo que utiliza algumas peças deste Kit Básico de Fixadores. Se você tiver projetos semelhantes, o Kit Básico de Fixadores é indispensável.
