---
description: Dispositivos da Plataforma Raspberry Pi
title: Guia de Dispositivos da Plataforma Raspberry Pi
keywords:
  - Raspberry pi
...
url: https://wiki.seeedstudio.com/pt-br/Raspberry_Pi/
---
...
## Por que escolher Raspberry Pi?
<FamilyValueSection />

## Placas oficiais Raspberry Pi
...
## Compare os modelos de Raspberry Pi
|               | 3B+           |   Zero      |   Zero 2 W/WH     |   4B          |   CM4     | Pico | Pico WH |   5          |
|   :---:       | :---:         |   :---:     |   :---:         |   :---:       |   :---:   | :---: | :---: |:---: |
|   RAM         |1GB          |512MB          |512MB          |2/4/8 GB       |2/4/8 GB   | 264 KB |264 KB |4/8 GB |
|   Storage     |Micro SD          |Micro SD          |Micro SD          |Micro SD      |Até 32GB eMMC   | 2 MB |2 MB |Micro SD |
...
| Form Factor   | Padrão [a]    |pHat |pHat |Padrão [a] | Ultracompacto [c] |SOM com furos passantes |SOM com furos passantes |Padrão [a]|
|Ethernet   |✅|❌|❌|✅|✅|❌|❌|✅|
|Wifi       |❌|❌|✅|✅|❌|❌|✅|✅|
|Bluetooth  |❌|❌|✅|✅|❌|❌|✅|✅|
...
- [Primeiros Passos com Raspberry Pi 3 Model B](https://wiki.seeedstudio.com/pt-br/Getting_Started_with_Arduino/)
- [Conecte-se remotamente ao Raspberry Pi](https://wiki.seeedstudio.com/pt-br/remote_connect/)
- [Atualizar EEPROM para o Compute Module 4](https://wiki.seeedstudio.com/pt-br/Raspberry_pi_CM4_update_eeprom/)

## Hats (placas de extensão)
<HatSection />
...
- Agradecemos [aos esforços de Corey](https://github.com/orgs/Seeed-Studio/projects/6/views/1?pane=issue&itemId=33963820) e o seu trabalho será [exibido](https://wiki.seeedstudio.com/pt-br/Honorary-Contributors/).

Atualizações para esta página estão <a href="https://github.com/orgs/Seeed-Studio/projects/6?pane=issue&itemId=30495963">em andamento</a>. Fique ligado!