---
description: Este wiki fornece uma introdução abrangente aos recursos de hardware e ao uso das interfaces da placa carrier reComputer Jetson Robotics J401. Ele abrange especificações detalhadas, módulos suportados, instruções de configuração e guias práticos para usar várias interfaces, como expansão de câmera M.2, Ethernet, USB, CAN, UART, I2C e GMSL2, ajudando os usuários a iniciar rapidamente o desenvolvimento em robótica na plataforma J401.
title: Hardware e Uso de Interfaces da reComputer Robotics
tags:
...
Este wiki apresenta os diversos hardwares e interfaces da série reComputer Robotics e como usá-los para expandir suas ideias de projeto.
</div>
...
:::info
O uso das interfaces da reComputer Robotics é o mesmo da placa carrier Robotics J401. Consulte [este wiki](https://wiki.seeedstudio.com/pt-br/recomputer_jetson_robotics_j401_getting_started/#Uso-das-interfaces) para exemplos detalhados de uso das interfaces.
:::
...
- [Arquivo 3D da reComputer Robotics](https://files.seeedstudio.com/products/NVIDIA-Jetson/recomputer_robotics_j401.stp)
