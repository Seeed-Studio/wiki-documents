---
description: Este wiki explica como ajustar finamente o NVIDIA Isaac GR00T N1.7 para o reBot Arm B601 DM e implantá-lo no Jetson Thor com aceleração TensorRT.
title: Ajustar finamente o GR00T N1.7 para reBot Arm e implantar no Jetson Thor
keywords:
  - Jetson Thor
  - Robotics J601
  - reBot Arm
...
url: https://wiki.seeedstudio.com/pt-br/fine_tune_gr00t_n1.7_for_rebot_arm_and_deploy_on_robotics_j601/
---

# Ajustar finamente o GR00T N1.7 para reBot Arm e implantar no Jetson Thor
...
- reComputer Robotics J601 com NVIDIA Jetson Thor (JetPack 7.x instalado)
...
Se você quiser implantar seu próprio modelo VLA, antes de tudo, precisamos coletar um conjunto de dados adequado para nossa tarefa para ajustar finamente o modelo, de modo que ele possa ser adaptado à nossa tarefa de agarrar. Você pode consultar [este wiki](https://wiki.seeedstudio.com/pt-br/rebot_arm_b601_dm_lerobot/) para configuração do ambiente e coleta de dados.
...
<details>
<summary>modality.json (clique para expandir)</summary>
...
Visite o seguinte link para obter permissão de download para o modelo necessário:
...
<details>
<summary>convert_v3_to_v2.py (clique para expandir)</summary>
...
<details>
<summary>run_gr00t_server.py (clique para expandir)</summary>
