...
url: https://wiki.seeedstudio.com/pt-br/local_chatbot_recomputer/
---
...
Começaremos instalando o [Jetson Containers](https://github.com/dusty-nv/jetson-containers) para gerenciar e implantar facilmente nossos serviços dentro do Docker.
...
Certifique-se de estar executando o **JetPack 6.0** (ou verifique a compatibilidade na [Matriz de Suporte](https://docs.nvidia.com/deeplearning/riva/user-guide/docs/support-matrix.html)).
...
2. [Local Voice Chatbot: Implantar Riva e Llama2 no reComputer](https://wiki.seeedstudio.com/pt-br/Local_Voice_Chatbot/)
