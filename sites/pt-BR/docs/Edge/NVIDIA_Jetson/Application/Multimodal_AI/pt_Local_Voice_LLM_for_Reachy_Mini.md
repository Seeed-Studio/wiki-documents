---
description: Este wiki detalha como implantar e operar um assistente robótico totalmente local, interativo por voz, usando a combinação de hardware reComputer Mini J501 e Reachy Mini Lite. O guia explica a instalação do servidor Ollama, a configuração de modelos de fala locais e de aplicativos de conversação, alcançando, em última instância, um sistema de conversação por voz offline e de baixa latência que não requer conexão com a internet. Ele apresenta um projeto completo de ponta a ponta, cobrindo configuração de hardware, implantação de software e uma demonstração final do sistema em funcionamento.
title: Implemente um LLM de voz local no reComputer Mini para o Reachy Mini!
...
url: https://wiki.seeedstudio.com/pt-br/local_voice_llm_on_recomputer_jetson_for_reachy_mini/
---
...
:::info
Certifique-se de que o seu dispositivo Jetson inclua a [carrier board](https://www.seeedstudio.com/reComputer-Robotics-J4012-p-6505.html), o módulo Jetson e o [sistema de resfriamento](https://www.seeedstudio.com/reComputer-Mini-J501-heatsink-with-fan-p-6605.html), e que o sistema operacional JP6.2 esteja instalado.
:::
...
:::info
Consulte [aqui](https://github.com/Seeed-Projects/reachy-mini-loacl-conversation/tree/master) para obter mais informações de instalação.
:::
