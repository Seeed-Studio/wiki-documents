...
| spidev           | Interface de espaço de usuário SPI do Linux           |
...
### Exemplo de fiação do display SPI: ST7789
...
| RES         | Pino 31                            | GPIO / PQ.06 | Sinal de reset por hardware                |
...
Antes de executar o demo do display, a interface SPI no conector de 40 pinos deve ser habilitada.
...
Esta etapa garante que o driver SPI de espaço de usuário do Linux esteja disponível antes de verificar ou acessar `/dev/spidev*`.
...
Antes de executar o demo do display, exporte os pinos GPIO usados por `DC` e `RES`. O demo controla esses dois pinos através da interface sysfs GPIO.
...
1. Aumente gradualmente a velocidade de clock SPI.
