---
description: Esta FAQ explica as principais mudanças do JetPack 7.2 para o Jetson AGX Orin, resume a comparação de inferência entre JetPack 7.2 e JetPack 6.2 feita pela Seeed e mostra como atualizar com o Seeed Jetson DevelopTool.
...
url: https://wiki.seeedstudio.com/pt-br/jetpack72_deep_dive/
---

# Análise Detalhada do JetPack 7.2: O que muda para a inferência no Jetson AGX Orin?

Esta FAQ resume por que o JetPack 7.2 é importante para usuários de Jetson AGX Orin, o que a Seeed mediu ao comparar o JetPack 7.2 com o JetPack 6.2 e como avaliar um caminho de atualização com o Seeed Jetson DevelopTool.
...
| Sistema em produção com placa carrier personalizada | Não atualize apenas executando `apt upgrade`. Use uma imagem completa validada ou um caminho OTA oficialmente suportado pela Seeed. |
...
Para uma migração de versão principal, como de JetPack 6.x para JetPack 7.x, é recomendada uma gravação completa, a menos que a Seeed forneça explicitamente um caminho OTA validado para o seu produto exato e imagem de origem.

Para o fluxo completo de decisão entre gravação e OTA do JetPack 7.2, vídeo do DevelopTool, comandos de verificação e checklist de migração, consulte [Flash e Atualização OTA para JetPack 7.2](/pt-br/flash_and_ota_jetpack_7.2/).
...
#### P7: O que devo verificar após a atualização?

Após gravar ou atualizar, verifique os seguintes itens antes de executar cargas de trabalho em produção:
