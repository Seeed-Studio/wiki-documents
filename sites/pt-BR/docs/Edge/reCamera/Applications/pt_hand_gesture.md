...
:::note
Antes de compilar esta solução, certifique-se de que você configurou o ambiente **ReCamera-OS** (versão 0.2.1 ou superior) de acordo com a [documentação principal do projeto](https://wiki.seeedstudio.com/pt-br/recamera_develop_with_c_cpp/), incluindo o caminho do SDK e a ferramenta de cross-compilação.
:::
...
Obrigado por escolher nossos produtos! Estamos aqui para oferecer diferentes tipos de suporte para garantir que sua experiência com nossos produtos seja a mais tranquila possível. Oferecemos uma variedade de canais de comunicação para atender a diferentes preferências e necessidades.
