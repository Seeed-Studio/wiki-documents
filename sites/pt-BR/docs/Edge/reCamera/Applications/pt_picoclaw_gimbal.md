...
### 3.2 Controlar o Hardware Onboard por Linguagem Natural - Controlar Luz LED
...
Como o ***openclaw*** requer uma grande quantidade de memória (>=2GB) para rodar, escolhemos implantar uma versão leve do Claw, chamada ***picoclaw***, que precisa de apenas 10MB de memória para rodar e, portanto, é muito adequada para este projeto.
...
### 4.5 Iniciar a Web UI do picoclaw
Insira o seguinte comando na reCamera para iniciar a web UI do picoclaw.
...
Após definir a senha na web UI, configure o modelo grande do picoclaw seguindo os passos abaixo.

### 5.1  Encontre a opção ***Model*** na barra lateral esquerda e clique para entrar.

### 5.2 Role para baixo para encontrar o modelo ***deepseek-chat*** e clique no botão ***Edit***, como mostrado na figura abaixo.
...
Após definir a senha na web UI, conecte‑se ao robô do QQ seguindo os passos abaixo.
...
### 6.3 Após criar o robô, configure‑o de acordo com o tutorial e obtenha o respectivo Robot ID e Secret Key. Em seguida, volte para a web UI, encontre a opção ***Channel*** à esquerda, role para baixo até encontrar ***QQ***, clique para conectar, preencha o ID e a Secret Key e clique em Save.
...
Criamos várias skills simples especificamente adaptadas para a reCamera--->[Skill Link](https://drive.google.com/drive/folders/1bh-GXnF8QEMQW8UpO1aNcdOcblAF6B5H)
...
Lê os recursos de hardware da reCamera, semelhante a uma base de conhecimento para a reCamera—basta colocá‑la na pasta ***skill***.
