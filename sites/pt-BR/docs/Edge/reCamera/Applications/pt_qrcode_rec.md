...
**Principais recursos**:
- Captura de câmera e reconhecimento de código QR em tempo real
...
O diretório do repositório após o clone ficará assim:
```text
