...
Você pode clonar a demonstração a partir do seguinte repositório GitHub:
...
Se um movimento for detectado na imagem, uma mensagem de alerta aparecerá no canto inferior esquerdo e uma caixa de movimento será desenhada na imagem.
