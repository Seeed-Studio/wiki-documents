...
url: https://wiki.seeedstudio.com/pt-br/reCamera/reCamera_Basic/hardware_and_specs/recamera_2002_series_hardware_and_specs
---
...
<table style={{width: '72.2022%'}}>
    <tbody>
        ...
        <tr>
            ...
            <td style={{width: '64.4424%'}} colspan="2" rowspan="1" width="379">
                <p><span data-font-family="Montserrat">Luz branca de 0,3w</span></p>
            </td>
        </tr>
        <tr>
            <td style={{width: '18.8653%'}} colspan="1" rowspan="1" width="111">
            ...
            <td style={{width: '64.4424%'}} colspan="2" rowspan="1" width="379">
                <p><span data-font-family="Montserrat">1 indicador de energia, 2 E/S programáveis</span></p>
            </td>
        </tr>
        <tr>
            <td style={{width: '16.528%'}} colspan="1" rowspan="2" width="97">
            ...
            <td style={{width: '64.4424%'}} colspan="2" rowspan="1" width="379">
                <p><span data-font-family="Montserrat">Mic onboard</span></p>
            </td>
        </tr>
        <tr>
            <td style={{width: '18.8653%'}} colspan="1" rowspan="1" width="111">
...
<tr >
    ...
    <td >&lt;1%</td>
    <td >Imagem</td>
    <td >2592 x 1944(imagem estática)</td>
</tr>
<tr >
    <td >IMAGEM</td>
    <td  colspan="3">Resolução de imagem estática de 2592 x 1944</td>
</tr>
<tr >
    <td >VÍDEO</td>
...
Exemplo 1: Use o comando do Linux para alterar o brilho do **LED vermelho** para zero
...
O arquivo de configuração STA da reCamera está em **/etc/wpa_supplicant.conf**, onde você configura a conta e a senha do Wi-Fi a ser conectado.
...
O dispositivo possui uma porta serial com taxa de transmissão de 115200 e pode fazer login no sistema da reCamera.
