...
url: https://wiki.seeedstudio.com/pt-br/reCamera/reCamera_Basic/application/using_stream_deck_to_control_recamera_gimbal_bak/
---

## Introdução

Este wiki demonstra como controlar o reCamera Gimbal usando um Stream Deck. Ao enviar comandos via protocolo HTTP a partir do Stream Deck, você pode controlar o reCamera Gimbal para girar para ângulos específicos, ligar/desligar a luz de preenchimento, reproduzir áudio e executar outras operações.
...
### 1. Tratamento de Eventos do Dial (Webhook do reCamera)
...
> **⚠️ Pré-requisito**: Certifique-se de que o seu computador consiga dar ping com sucesso no endereço IP do dispositivo: `192.168.31.198` (lembre-se de substituir este pelo endereço IP real do seu dispositivo).
...
#### Dial 1: Controlar o Eixo de Guinada (Yaw)
...
#### Dial 2: Controlar o Eixo de Pitch (Pitch)
