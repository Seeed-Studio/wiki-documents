---
description: Este artigo descreve como exportar, configurar e usar pinos GPIO na reCamera Pro via interface sysfs, e fornece a fórmula de cálculo do número do pino e um código de referência em Python.
title: Usar pinos GPIO
keywords:
  - reCamera
  - reCamera Pro
  - GPIO
...
# Guia de uso dos pinos GPIO da reCamera Pro

## Introdução

Este artigo descreve como usar pinos GPIO na reCamera Pro. Você aprenderá como determinar o pino GPIO alvo usando a fórmula de cálculo do número do pino, exportar e configurar a direção e o nível do pino via interface sysfs e usar scripts Python para controlar saídas GPIO ou ler níveis de entrada.

:::note
Na reCamera Pro, há apenas dois GPIOs de uso geral expostos, e sua tensão de saída varia de 12 V a 21 V (dependendo da entrada DC-IN), o que não é adequado para a maioria dos dispositivos. No entanto, você pode reconfigurar os pinos UART ou CAN na interface de expansão como GPIOs de uso geral. Esses pinos fornecem um nível padrão de 3,3 V.
:::

## Localizando pinos GPIO
...
2. Usar o recurso de terminal na WebUI
...
- [Documentação oficial da reCamera Pro](/pt-br/recamera_pro_getting_started/)
