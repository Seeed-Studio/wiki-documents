---
description: Início rápido em três etapas para chamar sua primeira API da reCamera Pro — faça login, obtenha um token e faça uma chamada de API.
title: "Sua Primeira Chamada de API"
keywords:
  - reCamera
  - reCamera Pro
  - API
...
Se a solicitação não carregar um Token ou se o Token tiver expirado, o dispositivo retornará:
