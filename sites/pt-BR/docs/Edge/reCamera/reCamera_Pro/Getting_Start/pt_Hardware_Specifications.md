...
updatedAt: '2026-07-9'
url: https://wiki.seeedstudio.com/pt-br/recamera_pro_hardware_specifications/
---
...
| --- | --- |
| Processador | RV1126B |
| CPU | Cortex-A53 Quad-Core de 1,2 GHz |
| NPU | 3 TOPS, suporta computação mista INT8/INT16 |
| Memória | LPDDR4 2GB / 4GB |
| Armazenamento | 16GB eMMC, slot para cartão SD (máx. 512GB) |
| Câmera | SC850SL (4K@30FPS) |
| IMU | Sensor IMU de 6 eixos (ICM-42670-P) (acelerômetro de 3 eixos + giroscópio de 3 eixos) |
| Saída de Áudio | Alto-falante de 8 ohms com potência nominal de 1W |
