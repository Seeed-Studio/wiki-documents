...
title: Uso do Alto-falante do reCamera Pro
keywords:
  - reCamera
  - reCamera Pro
  - Speaker
...
```
Se o seu arquivo de áudio estiver no formato MP3, converta-o primeiro para o formato WAV usando o comando abaixo e, em seguida, reproduza-o conforme descrito acima:
```bash
