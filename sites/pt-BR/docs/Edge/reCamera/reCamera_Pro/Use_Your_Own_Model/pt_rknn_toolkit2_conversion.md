---
description: Converter modelos ONNX para o formato RKNN para a reCamera Pro e criar um modelo quantizado em INT8 com um conjunto de dados de calibração representativo.
...
| A compilação INT8 falha | Verifique todos os caminhos de dataset, contagem de entradas, dtype/shape e legibilidade das imagens. |
| A acurácia em INT8 é ruim | Verifique RGB/BGR, política de redimensionamento, mean/std, cobertura de calibração e pós-processamento. |
...
| A inferência no dispositivo é lenta | Meça após o aquecimento; verifique o pré-processamento e o pós-processamento, bem como a execução na NPU. |
