...
1. **Espectrograma de áudio em tempo real**: Exibe o espectro do sinal de áudio atualmente capturado em tempo real, ajudando os usuários a entender as características do som.
...
5. **Precisão de exibição do ranking de confiança**: Personalize a precisão numérica do ranking.
...
4. Após concluir a coleta, clique no botão **Stop**. Em seguida, clique no botão **Slice** para dividir a amostra de ruído de fundo em segmentos de 1 segundo.
   ...
   - (4) Área para as amostras segmentadas
...
- Ajuste o limite de confiança nos hiperparâmetros.
...
- [Introdução ao reCamera Pro](https://wiki.seeedstudio.com/pt-br/recamera_pro_getting_started/)
