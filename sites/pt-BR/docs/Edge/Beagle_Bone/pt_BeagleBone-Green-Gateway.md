...
url: https://wiki.seeedstudio.com/pt-br/BeagleBone-Green-Gateway/
---


![BeagleBoneGreenGateway](https://files.seeedstudio.com/wiki/BeagleBone-Green-Gateway/img/102110381-wiki.png)

**Seeed Studio BeagleBone® Green Gateway** é uma plataforma de desenvolvimento de baixo custo, open-source e suportada pela comunidade, para desenvolvedores e hobbistas. É um esforço conjunto da [BeagleBoard.org](https://beagleboard.org/) e da Seeed Studio. Ele é baseado no design clássico de hardware open-source do [BeagleBone® Black](https://beagleboard.org/black) e foi desenvolvido nesta versão diferenciada. O Seeed Studio BeagleBone® Green Gateway inclui dois conectores Grove, facilitando a conexão com a grande família de sensores Grove. O HDMI e o Ethernet on-board foram removidos para abrir espaço para esses recursos sem fio e conectores Grove.
...
|Item|Valor|
|----|------|
|Processador| AM3358 1GHz ARMR Cortex-A8|
|RAM| 512MB DDR3|
|Armazenamento Flash on-board |4GB eMMC|
|CPU Suporta |acelerador NEON de ponto flutuante e gráficos 3D|
|Micro USB Suporta |Alimentação e Comunicação|
|USB | USB 2.0 Host x2|
|GPIO |2 x cabeçalhos de 46 pinos|
|Ethernet |1|
|Conectividade Sem Fio|Wi-Fi 802.11b/g/n 2.4GHz e Bluetooth 4.1 LE|
|Conectores Grove| Grove I2C x 1 e Grove UART x 1|
...
|---------------------|---------|------------|
|Windows (64-bit) | [instalador 64-bit](https://beagleboard.org/static/Drivers/Windows/BONE_D64.exe)  | |
|Windows (32-bit) | [instalador 32-bit](https://beagleboard.org/static/Drivers/Windows/BONE_DRV.exe)||
...
- Para verificar se você está executando o Windows 32 ou 64 bits, consulte [este](https://support.microsoft.com/kb/827218).
...
Baixe o gravador Flash Open Source [balenaEtcher](https://www.balena.io/etcher/). Baixe a versão de acordo com o seu sistema operacional (Windows/macOS/Linux).
...
|101020082 |Grove - Sensor de Frequência Cardíaca de Presilha de Dedo com Carcaça |I2C|[link](https://www.seeedstudio.com/Grove-Finger-clip-Heart-Rate-Sensor-with-shell-p-2420.html)|
...
- [Primeiros passos com o BeagleBoard](https://beagleboard.org/getting-started)
...
- **[PDF]** [Esquemático do Seeed Studio BeagleBone® Green Gateway](https://files.seeedstudio.com/wiki/BeagleBone-Green-Gateway/SeeedStudio-BeagleBoneGreemGateway-SCH.pdf)

- **[ZIP]** [Esquemático do Seeed Studio BeagleBone® Green Gateway](https://files.seeedstudio.com/wiki/BeagleBone-Green-Gateway/SeeedStudio-BeagleBoneGreemGateway-SCH.zip)
