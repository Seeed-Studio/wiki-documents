---
description: Aprenda como integrar N3uron com MQTT e Modbus para aquisição de dados contínua e publicação na nuvem AWS. Este guia aborda instalação, configuração e pré-processamento de dados para otimizar seus projetos de automação industrial
title: Publicando Dados Industriais na Nuvem AWS Usando N3uron, MQTT e Modbus
keywords:
  - reComputer R1000
  - MQTT
  - IIoT
...
url: https://wiki.seeedstudio.com/pt-br/recomputer_r1000_n3uron_modbus_mqtt_aws/
---
## Introdução
...
Recomendamos fortemente estudar o guia [Getting Started with N3uron](https://wiki.seeedstudio.com/pt-br/recomputer_r1000_n3uron/). Ele oferece informações essenciais sobre como navegar na interface web do N3uron, compreender conceitos como o módulo Web UI e Web Vision, entender o conceito de tags e criar dashboards básicos. Se você ainda não explorou esses fundamentos, é recomendável fazê-lo antes de seguir adiante. Você pode acessar o guia através do link fornecido.
...
:::note
 Se você estiver usando Modbus RTU, há várias configurações a serem consideradas. Para isso, você precisa fornecer detalhes como porta COM, taxa de transmissão (baud rate) etc. Para mais informações sobre como configurar os protocolos Modbus RTU e TCP no N3uron, consulte o [guia](https://docs.n3uron.com/docs/modbus-client-configuration) fornecido.
:::
...
:::note
Para testes e experiência prática, fornecemos um [código Arduino](https://files.seeedstudio.com/wiki/Edge_Box/N3uron-mqtt-modbus/MQTT_N3uron.ino) que pode ser executado no XIAO. Além disso, você precisará inserir suas próprias credenciais nesse código antes de fazer o upload.
:::
...
Uma vez conectado ao sistema, você poderá visualizar o status em tempo real da saída do MQTT Broker.
...
:::note
 Fornecemos instruções passo a passo sobre como conectar a [nuvem AWS ao seu dispositivo reComputer R1000](https://wiki.seeedstudio.com/pt-br/recomputer_r1000_n3uron_aws/). Se você é novo neste wiki, consulte este link.
