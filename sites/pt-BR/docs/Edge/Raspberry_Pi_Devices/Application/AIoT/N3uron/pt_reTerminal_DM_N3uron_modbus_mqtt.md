---
description: Conecte o N3uron a dispositivos com suporte a MQTT e Modbus
title: Conecte o N3uron a dispositivos com suporte a MQTT e Modbus
keywords:
  - reTerminal DM
  - MQTT
  - IIoT
...
url: https://wiki.seeedstudio.com/pt-br/reTerminalDM_N3uron_modbus_mqtt/
---
## Introdução
...
Recomendamos fortemente estudar o guia [Getting Started with N3uron](https://wiki.seeedstudio.com/pt-br/reTerminalDM_N3uron_Get_Start/). Ele fornece informações essenciais para navegar na interface web do N3uron, compreender conceitos como o módulo Web UI e Web Vision, entender o conceito de tags e criar dashboards básicos. Se você ainda não explorou esses fundamentos, é aconselhável fazê-lo antes de prosseguir. Você pode acessar o guia através do link fornecido.
...
:::note
Para testes e experiência prática, fornecemos um [código Arduino](https://files.seeedstudio.com/wiki/reTerminalDM/N3uron-mqtt-modbus/MQTT_N3uron.ino) que pode ser executado no XIAO. Além disso, você precisará inserir suas próprias credenciais neste código antes de fazer o upload.
:::
...
Depois de conectado ao sistema, você pode visualizar o status em tempo real da saída do MQTT Broker.
...
:::note
 Fornecemos instruções passo a passo sobre como conectar uma [nuvem AWS ao seu dispositivo reTerminal DM](https://wiki.seeedstudio.com/pt-br/reTerminal-DM_AWS_first/). Se você é novo nesta wiki, consulte este link.
:::
