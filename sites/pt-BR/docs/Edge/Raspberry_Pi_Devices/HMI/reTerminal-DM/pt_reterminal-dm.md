---
description: Introdução ao reTerminal DM
title: Introdução ao reTerminal DM
keywords:
  - Edge
  - reTerminal-DM
...
<table >
  <tbody>
    ...
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}>Memória</td>
      <td data-style="height: 18px; width: 63.1933%;" style={{height: 18, width: '63.1933%'}}>8GB</td>
    </tr>
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}>Armazenamento</td>
      <td data-style="height: 18px; width: 63.1933%;" style={{height: 18, width: '63.1933%'}}>32GB eMMC</td>
    </tr>
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}> </td>
      <td data-style="height: 18px; width: 63.1933%;" style={{height: 18, width: '63.1933%'}}>Slot M.2 SATA SSD 2280-B Key (opcional)</td>
    </tr>
    <tr data-style="height: 36px;" style={{height: 36}}>
      <td data-style="height: 36px; width: 35.4622%;" style={{height: 36, width: '35.4622%'}}>Suporte a SO</td>
    ...
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}>Luminância</td>
    ...
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}>Áudio</td>
      <td data-style="height: 18px; width: 63.1933%;" style={{height: 18, width: '63.1933%'}}>Microfone x 2</td>
    </tr>
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 35.4622%;" style={{height: 18, width: '35.4622%'}}> </td>
    ...
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 98.6555%;" colSpan={2} style={{height: 18, width: '98.6555%'}}><strong>Alimentação</strong></td>
    </tr>
    <tr data-style="height: 18px;" style={{height: 18}}>
    ...
    <tr>
      <td data-style="width: 98.6555%;" colSpan={2} style={{width: '98.6555%'}}><strong>Outros</strong> </td>
    </tr>
    <tr data-style="height: 18px;" style={{height: 18}}>
...
<div>
  ...
  <table className="tg">
    <thead>
      <tr>
        <th className="tg-tynx">Descrição</th>
        <th className="tg-tynx">Multiplexação de pinos</th>
    ...
    <tbody>
      <tr>
        <td className="tg-3z1b">Pino 1</td>
      ...
      <tr>
        ...
        <td className="tg-73oq">Conector de áudio de 3,5 mm</td>
      </tr>
      <tr>
        <td className="tg-3z1b">Pinos de interrupção para toque na tela</td>
      ...
      <tr>
        ...
        <td className="tg-73oq">Pinos de habilitação SPI para CAN</td>
      </tr>
      <tr>
        <td className="tg-3z1b" />
        <td className="tg-3z1b" />
        ...
        <td className="tg-73oq">Pinos de habilitação SPI para LoRa®</td>
      </tr>
      <tr>
        <td className="tg-3z1b" />
        <td className="tg-3z1b" />
      ...
      <tr>
        ...
        <td className="tg-73oq">Pinos de interrupção para CAN</td>
      </tr>
      <tr>
        <td className="tg-3z1b">Pinos de controle da luz de fundo do LCD</td>
      ...
      <tr>
        <td className="tg-3z1b">Conector de áudio de 3,5 mm</td>
