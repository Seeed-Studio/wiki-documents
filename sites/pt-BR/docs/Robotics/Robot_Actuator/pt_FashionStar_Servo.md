---
description: Este wiki fornece tutoriais para servomotores FashionStar.
title: Servo Motor FashionStar
keywords:
  - atuador
  - motor
  - braço
...
url: https://wiki.seeedstudio.com/pt-br/fashionstar_servo/
---

# Central de Documentos dos Servomotores FashionStar
...
## Ficha técnica
  ...
  <a href="https://files.seeedstudio.com/products/Fashionstar/Fashion%20Star_U25(H)_Datasheet_EN_V1.1.08.pdf" className="nav-item">
    <span className="text">HA8-U25H-M 0.88N·m  </span>
  </a>
  <a href="https://files.seeedstudio.com/products/Fashionstar/Fashion%20Star_U25(H)_Datasheet_EN_V1.1.08.pdf" className="nav-item">
    <span className="text">RA8-U25H-M 0.88N·m </span>
  </a>
  <a href="https://files.seeedstudio.com/products/Fashionstar/Fashion%20Star_U100H_Datasheet_EN_V1.1.08.pdf" className="nav-item">
  ...
  <a href="https://files.seeedstudio.com/products/Fashionstar/UC01_Datasheet_EN_V1.1.07.pdf" className="nav-item">
    <span className="text">Conversor TTL-USB UC-01 </span>
  </a>
...
## Dimensão
  <a href="https://github.com/servodevelop/servo-dimension" className="nav-item">
    <span className="text">modelo</span>
  </a>
