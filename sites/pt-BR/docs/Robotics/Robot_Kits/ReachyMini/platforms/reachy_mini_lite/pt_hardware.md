---
description: Folha de dados de hardware do Reachy Mini Lite incluindo dimensões, graus de liberdade, especificações dos motores, câmera, matriz de microfones e componentes eletrônicos.
title: Folha de Dados de Hardware do Reachy Mini Lite
...
# Folha de Dados de Hardware do Reachy Mini Lite
...
Observe que ele *não* será carregado por esta porta USB.
O Reachy Mini Lite é um dispositivo conectado a um computador
...
- Placa da matriz de microfones
    ...
    - Taxa de amostragem máxima de 16 kHz / sensibilidade de -26 dB FS / 64 dBA SNR
...
- Placa controladora Lite:
    ...
    - Conexão CSI para câmera
    - Conexão para matriz de microfones
    - Entrada USB-C, usada para a porta USB da interface inferior. Observe que ela *não* irá carregar por esta porta USB. O Reachy Mini Lite é um dispositivo conectado a um computador