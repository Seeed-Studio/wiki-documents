...
Este exemplo demonstra como usar o arranjo de microfones para detectar a Direção de Chegada (DoA) da fala. O robô usa o endpoint FastAPI para obter informações de DoA, calcula a posição da fonte sonora, a transforma em coordenadas de mundo e olha automaticamente na direção do locutor.
...
3. Transforma a posição de coordenadas da cabeça para coordenadas de mundo
...
- Transformação em tempo real de coordenadas da cabeça para coordenadas de mundo


Veja o exemplo completo em: [sound_doa.py](https://github.com/pollen-robotics/reachy_mini/tree/main/examples/sound_doa.py)