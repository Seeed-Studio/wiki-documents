...
:::tip
Se você comprou um kit pré-montado, pule diretamente para o vídeo tutorial no **Passo 3** no final deste artigo e siga as instruções. Não é necessário gravar IDs dos motores nem calibrar posições zero.
:::
...
2. Como alternativa, você pode escolher nosso gabinete open source para fonte de alimentação MeanWell 24V 14,6A para montagem própria. As instruções em texto e a lista de materiais (BOM) estão em open source no [repositório GitHub](https://github.com/LAN-GER/reBot-DevArm/tree/main/hardware/reBot_B601_DM) (recomendado apenas para desenvolvedores com experiência relevante em montagem de fontes de alimentação).
...
- Compre 2 grampos de fixação (≥3 polegadas) e uma fonte de alimentação chaveada 24V 15A com saída XT30 (use marca conhecida, sem produtos de baixa qualidade).
...
- [Placa de Separação de Sinal e Potência × 1](https://www.seeedstudio.com/XT30-2-2-Power-Separation-Board-p-6707.html)
...
:::
1.Abra o software host **DM_Tools**, selecione a porta COM USB correspondente e defina a taxa de baud para `921600`. Após a conexão bem-sucedida, as informações serão impressas na interface `Serial`.
...
| Motor 1 Ativado | Motor 2 Ativado | Motor 3 Ativado | Motor 4 Ativado | Motor 5 Ativado | Motor 6 Ativado | Motor 7 Ativado |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Etapa 1: Instalar o miniforge (no Windows\Ubuntu\Mac\Jetson\Pi)
...
- Esse problema geralmente acontece quando a calibração de parâmetros é acionada acidentalmente durante a configuração do ID, o que sobrescreve parâmetros predefinidos de fábrica, como a inércia do motor. Use **DM_Tools_v.1.8.0.1.exe (somente Windows)** disponível em:
