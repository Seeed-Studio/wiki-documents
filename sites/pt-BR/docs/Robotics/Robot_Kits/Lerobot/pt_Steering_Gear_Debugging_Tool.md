...
Por exemplo, você pode conectar o servo nº 6 à placa controladora conforme mostrado abaixo. Outros servos são conectados de maneira semelhante, assim você pode evitar desmontar o braço robótico.
...
Status: O status exibirá Normal, Sobrecorrente ou Sobrecarga
