---
description: Este wiki fornece o tutorial de montagem e depuração para o Lekiwi e realiza a coleta de dados e o treinamento dentro do framework Lerobot.
