...
![Banner do CodeCraft](https://files.seeedstudio.com/SenseCraft/sensecraft-wiki/codecraft/1-quick-start-and-support/codecraft-banner.webp)
...
Recomendado para usuários que desejam começar a criar projetos.
...
- Exemplos de projetos: Temporizador Pomodoro, Temporizador Pomodoro no Terminal, LED de coração piscante com ESP32S3 e LED controlado por botão do Beginner Kit
...
- Informações do aplicativo, documentação, lista de materiais e visualização e publicação
