---
sidebar_position: 2
description: Registro no Dashboard
title: Registro no Dashboard
keywords:
  - Cloud and Chain
...
1. Acesse [**https://status.sensecapmx.cloud/**](https://status.sensecapmx.cloud?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecap_mx_dashboard)
2. Clique no botão "**Register**" abaixo.  
    1. Você terá a opção de criar uma conta OU registrar/login com sua conta do Discord.
...
![Registro no Dashboard SenseCAP](https://www.sensecapmx.com/wp-content/uploads/2022/07/register-dash-new.png)
...
![Login no Dashboard SenseCAP](https://www.sensecapmx.com/wp-content/uploads/2022/07/dash-sign-in-new.png)
