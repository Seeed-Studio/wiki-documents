...
## Passo 1. Acesse o workspace do Grove Vision AI V2 e conecte o dispositivo

Acesse o workspace do Grove Vision AI V2 via **[`SenseCraft AI`](https://sensecraft.seeed.cc/ai)** > **`Models`** > **`Workspace`** > **`Grove Vision AI V2`**, ou use o [link direto para o workspace](https://sensecraft.seeed.cc/ai/device/local/36).
...
## Passo 2. Certifique-se de que um modelo esteja carregado no Grove Vision AI V2

Antes de prosseguir, certifique-se de que seu dispositivo Grove Vision AI V2 tenha um modelo treinado implantado nele. Se você ainda não implantou um modelo, consulte a documentação do SenseCraft AI para obter instruções sobre como treinar e implantar modelos no seu dispositivo.
...
## Passo 3. Acesse as configurações de saída
...
## Passo 4. Selecione as ações de disparo desejadas
...
## Passo 5. Envie a configuração de disparo para o Grove Vision AI V2
