---
sidebar_position: 5
description: Como usar Treinamento (Classificação)
title: Treinamento - Classificação
...
Neste guia abrangente, vamos conduzi-lo pelo processo de treinamento de um modelo de classificação usando a plataforma SenseCraft AI. Embora nosso foco principal seja treinar um modelo para o XIAO ESP32S3 Sense, é importante observar que esta plataforma também é compatível com outros dispositivos da Seeed Studio, como o Grove Vision AI e o Watcher.

Não tem um dispositivo Seeed Studio? Sem problemas! Você ainda pode acompanhar e experimentar o processo de treinamento usando a câmera integrada do seu laptop. No entanto, para desempenho ideal e melhores resultados, recomendamos usar o dispositivo-alvo para treinar e implantar seu modelo.
...
Se você estiver usando a câmera do seu laptop, pode pular esta etapa. Porque, ao acessar esta página, o vídeo ao vivo da câmera é exibido automaticamente. Se isso não acontecer, verifique as permissões do seu navegador.
...
### Etapa 2. Crie e rotule categorias
...
### Etapa 3. Capture dados de treinamento
...
### Etapa 5. Implemente o modelo treinado
...
Após a conclusão do treinamento do modelo, é hora de implantá-lo no dispositivo-alvo. Se você estiver usando o XIAO ESP32S3 Sense ou outro dispositivo Seeed Studio, selecione o dispositivo apropriado no menu suspenso e clique em **'Deploy to device'**. Se você treinou o modelo usando a câmera do seu laptop, pode pular esta etapa e seguir para a demonstração dos resultados.
...
Parabéns! Você treinou e implantou com sucesso seu modelo de reconhecimento de gestos corporais. Agora é hora de colocá-lo à prova:
...
Lembre-se: embora a plataforma permita treinar modelos usando qualquer câmera, para obter os melhores resultados e desempenho ideal, recomendamos usar o dispositivo-alvo (atualmente limitado a dispositivos Seeed Studio) para treinar e implantar seu modelo.
