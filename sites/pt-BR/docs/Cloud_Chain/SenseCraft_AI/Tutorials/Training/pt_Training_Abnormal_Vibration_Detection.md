---
description: Introduz o uso de detecção de vibração anormal.
...
1. Abra o navegador e visite <a href="https://sensecraft.seeed.cc/ai/home" target="_blank">**SenseCraft AI**</a>.
...
Nossos algoritmos e firmware são de código aberto. Estamos trabalhando ativamente em recursos como relatório via WiFi + MQTT e análise FFT. Sinta-se à vontade para enviar um <a href="https://github.com/Seeed-Studio/AcousticsLab/issues" target="_blank">Issue</a> ou um <a href="https://github.com/Seeed-Studio/AcousticsLab/pulls" target="_blank">Pull Request</a>.
