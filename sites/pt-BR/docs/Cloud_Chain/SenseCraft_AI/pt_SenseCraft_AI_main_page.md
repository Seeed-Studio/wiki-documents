...
- **para Grove Vision AI V2**: Aqui, você encontra os modelos pré-treinados projetados especificamente para o dispositivo Grove Vision AI V2.
...
- **para SenseCAP Watcher**: Esta subseção fornece informações sobre os modelos pré-treinados que podem ser usados com o dispositivo SenseCAP Watcher, habilitando várias funcionalidades de monitoramento e detecção.
...
- Workspace do reComputer Jetson: Esta subseção fornece informações sobre como configurar e utilizar o Workspace do reComputer Jetson para trabalhar com saídas de modelos. Ela aborda tópicos como configuração do workspace, visualização das previsões do modelo e integração com outros softwares.
