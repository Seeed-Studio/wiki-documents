...
url: https://wiki.seeedstudio.com/pt-br/connect_wio_tracker_to_TTN/
---


[The Things Stack(TTS)](https://www.thethingsnetwork.org/) é uma pilha de servidor de rede LoRaWAN®, que é o componente crítico para qualquer solução LoRaWAN. Neste capítulo guiaremos os usuários para conectar a Wio Tracker 1110 Dev Board à The Things Network.

## Configurar a Dev Board

Antes de conectar ao TTS, você precisa configurar os parâmetros básicos da sua placa no aplicativo SenseCAP Mate. Consulte [Primeiros Passos](https://wiki.seeedstudio.com/pt-br/Get_Started_with_Wio-Trakcer_1110/#configure-the-frequency-and-connect-to-the-gateway) para mais detalhes.
...
Cole o `Device EUI`/`APP EUI`/`APP Key`, selecione o `frequency plan` de acordo com o seu dispositivo e, em seguida, clique em `Register end device`.
...
:::tip
O `JoinEUI`, anteriormente chamado de `AppEUI`, é o mesmo.
:::

### Etapa 3: Configurar o decodificador

Navegue até `Payload formatters`, selecione Formatter type como `Custom Javasript formatter` e, em seguida, copie o seguinte código:
