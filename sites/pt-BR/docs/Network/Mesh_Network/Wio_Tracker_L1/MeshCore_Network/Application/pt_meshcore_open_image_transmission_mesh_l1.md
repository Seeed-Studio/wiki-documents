...
2. Conecte seu nó MeshCore ao app. [Clique aqui](https://wiki.seeedstudio.com/pt-br/get_started_with_other_mesh_firmware/#connect-via-app) para ler o guia de conexão do L1.
