---
description: Este guia explica como enviar imagens reconstruídas por IA via MeshCore usando compressão de imagem de taxa de bits ultrabaixa baseada em Card Tracker wio tracker L1.
...
url: https://wiki.seeedstudio.com/pt-br/meshcore_ai_image_transmission_l1/
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Transmissão de Imagem com IA via MeshCore com Wio Tracker L1
...
2. Conecte seu nó MeshCore ao APP. [Clique aqui](https://wiki.seeedstudio.com/pt-br/get_started_with_other_mesh_firmware/#connect-via-app) para ler o guia de conexão L1.
