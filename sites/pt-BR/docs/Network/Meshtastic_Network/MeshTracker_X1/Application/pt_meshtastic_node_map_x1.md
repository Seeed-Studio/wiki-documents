...
Este guia explica como exibir as localizações de dispositivos [Meshtastic](https://meshtastic.org/docs/introduction/) em Meshtastic Node Maps usando o [MeshTracker X1](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html), assumindo que os dispositivos já foram gravados com o firmware Meshtastic.
