...
url: https://wiki.seeedstudio.com/pt-br/meshcore_node_map_meshtracker_x1/
---
...
O Mapa de Nós pode fornecer visibilidade em tempo real na rede [MeshCore](https://meshcore.io/#hardware) ao traçar as localizações dos nós, permitindo que os usuários entendam a topologia da rede e a distribuição dos nós. 
...
Para que um nó companheiro apareça no Mapa de Nós MeshCore, o dispositivo deve ser configurado corretamente para relatar sua localização. Configure da seguinte forma:
...
Para que um repetidor ou room server apareça no Mapa de Nós MeshCore, o dispositivo deve ser configurado corretamente para relatar sua localização. 
