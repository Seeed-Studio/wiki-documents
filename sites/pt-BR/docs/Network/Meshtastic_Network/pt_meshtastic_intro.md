...
- Longo alcance (recorde de 254 km pela kboxlabs)
- Não exige telefone para comunicação em mesh
- Comunicação descentralizada - nenhum roteador dedicado é necessário
- Comunicação criptografada
- Excelente duração de bateria
- Envie e receba mensagens de texto entre membros da malha
- Recursos opcionais de localização baseados em GPS
- E muito mais!
...
Esses rádios são projetados para retransmitir as mensagens que recebem, formando uma rede mesh. Essa configuração garante que todos os membros do grupo, incluindo aqueles a maior distância, possam receber mensagens. Dependendo das configurações empregadas, a rede mesh Meshtastic pode suportar até 100 dispositivos simultaneamente.
...
- [Wio Tracker L1](https://wiki.seeedstudio.com/pt-br/wio_tracker_node/)

- [SenseCAP Solar Node](https://wiki.seeedstudio.com/pt-br/solar_node/)
...
- [Kit de Desenvolvimento Tracker para Meshtastic® – Wio Tracker 1110](https://www.seeedstudio.com/Wio-Tracker-1110-Dev-Kit-for-Meshtastic.html)

:::note
Meshtastic® é uma marca registrada da Meshtastic LLC. Os componentes de software Meshtastic são lançados sob várias licenças; consulte o GitHub para mais detalhes. Nenhuma garantia é fornecida - use por sua conta e risco.
:::
