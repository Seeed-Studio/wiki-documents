...
title: Comece a usar a Wio Tracker L2
keywords:
  - Meshtastic
...
Ligue o dispositivo, clique em `Enter DFU Mode`, haverá uma porta serial chamada `Tracker L2`, clique nela e conecte.
...
:::tip
O pop-up de alternância para BaseUI aparece quando você `long-press` o ícone de Bluetooth.
...
:::tip
Ao usar MUI, primeiro alterne para o modo de pareamento Bluetooth antes de parear com o seu telefone. Caso contrário, o seu telefone não conseguirá reconhecer o dispositivo.
:::
...
Para começar a se comunicar pela malha, você deve definir a sua região. Essa configuração controla qual faixa de frequência o dispositivo usa e deve ser ajustada de acordo com a sua localização regional.
...
:::info
**EU_868** deve obedecer a uma limitação de duty cycle horário de 10%, calculada a cada minuto em uma janela móvel de 1 hora. O dispositivo deixará de transmitir ao atingir esse limite, até que seja permitido novamente.
:::
...
| Pressione e segure o ícone Notificação| Notificação ativada/desativada|
| Clique no ícone Notificação| Alterna entre Som/Banner/Som e Banner|
| Pressione e segure o ícone GPS| GPS ligado/desligado|
| Pressione e segure o ícone WiFi| WiFi ligado/desligado|
...
| Screen Pin | Define a senha para inicialização do dispositivo |
| Configuration Pin | Define a senha para alterações de configuração |
...
| Selecione "GPS Format" | Alterna o formato do GPS|
| Selecione "Compass Headings" | Alterna entre Heading Dinâmico, Fixo e Congelado para "N" |
...
- Ao usar BaseUI, depois de configurar e ativar o Wifi, você só poderá conectar seu dispositivo ao aplicativo do telefone via Network. 
...
- Certifique-se de que você está se conectando a um `2.4g Wifi`. O dispositivo não consegue parear com Wifi 5G. Normalmente o hotspot do telefone pode ser ajustado para 2.4g nas configurações do telefone. Portanto, você pode testar primeiro o hotspot do seu telefone.
