---
description: Meshtastic baseado em XIAO nRF52840 & Wio-SX1262 Kit
...
Este kit combina o XIAO nRF52840 e o Wio-SX1262, suportando BLE5.0, Thread, Zigbee e LoRa (862-930MHz), e opera com baixo consumo de energia. Ele pode ser aplicado em vários campos, como [Meshtastic®](https://meshtastic.org/), redes de sensores, monitoramento ambiental, rastreamento de ativos, educação e inovação.
...
- **Microcontrolador versátil**: Incorpora o chip Nordic nRF52840 com FPU, operando até 64 MHz, com múltiplas portas de desenvolvimento montadas, compatível com Arduino / CircuitPython / Micropython
- **Poderoso desempenho LoRa**: LoRa de longo alcance no Semtech SX1262, suporta bandas de 868/915 MHz.
- **Comunicação de dois núcleos**: Suporta os modos duplos Bluetooth e LoRa, permitindo a interconexão entre domínios.
...
| **Alimentação** | **Tensão de entrada:**  <br /> - Type-C: 5V  <br /> - Bateria (BAT): 4,2V  <br /> **Corrente de carga da bateria:** 50mA / 100mA  <br /> **Consumo de energia em espera:** &lt;5µA |  
...
Clique em `Enter DFU Mode`, aparecerá uma porta serial chamada `XIAO-xxx`, clique nela e conecte, e deverá ser exibida uma unidade chamada `XIAO-xxx`.
...
Para começar a se comunicar pela malha, você deve definir sua região. Essa configuração controla qual faixa de frequência seu dispositivo utiliza e deve ser ajustada de acordo com sua localização regional.
...
:::info
**EU_868** deve respeitar uma limitação de ciclo de trabalho horário de 10%, calculada a cada minuto em uma janela contínua de 1 hora. Seu dispositivo deixará de transmitir se você atingir esse limite, até que volte a ser permitido.
:::
...
Conecte um [Módulo GNSS L76K](https://www.seeedstudio.com/L76K-GNSS-Module-for-Seeed-Studio-XIAO-p-5864.html) para fazer um rastreador.
...
- **[PDF]** [Relatório de Teste de Distância de Comunicação BLE do Seeed Studio XlAO nRF52840](https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed_XIAO_BLE_nRF52840_BLE_Communication_Distance_Test_Report.pdf)
...
- **[DXF]** [Dimensão em DXF do Seeed Studio XIAO nRF52840](https://files.seeedstudio.com/wiki/XIAO-BLE/XIAO-nRF52840-DXF.zip)
...
- **[PDF]** [O diagrama esquemático do SX1262 compatível com Xiao nRF52840](https://files.seeedstudio.com/products/113010003/Wio-SX1262%20for%20XIAO%20V1.0.pdf)
