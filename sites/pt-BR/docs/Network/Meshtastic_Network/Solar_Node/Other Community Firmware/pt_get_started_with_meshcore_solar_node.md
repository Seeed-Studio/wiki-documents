...
O dispositivo precisa ser ativado conectando o cabo USB. O LED azul Mesh acenderá por cerca de 3s, o que significa que o dispositivo foi ligado com sucesso. 

O LED azul Mesh não acenderá até que ele envie o anúncio.

:::tip
Se o dispositivo não responder quando você conectar o cabo USB, carregue-o primeiro. Não use carregador de carregamento rápido.
:::
...
:::info
**EU_868** deve obedecer a uma limitação de ciclo de trabalho horário de 10%, calculada a cada minuto em uma janela móvel de 1 hora. Seu dispositivo irá parar de transmitir se você atingir esse limite, até que seja permitido novamente.
:::
...
Você pode definir manualmente o caminho de envio da mensagem. Conecte seu dispositivo companheiro Bluetooth ao aplicativo do seu telefone. Abra uma janela de mensagem privada. Então você pode escolher o repetidor descoberto para formar seu caminho.
...
Após definir o caminho, o método de transmissão será alterado para "n hop". Por exemplo, se você adicionar 1 repetidor na sua rota, ele será alterado para 1 hop.
...
Para usuários Mac, pressione a tecla "Command" e a tecla "Space", assim você pode abrir o Spotlight. Depois digite "termial" e pressione "Return". Isso abrirá a linha de comando. 
...
Quando você tiver concluído as etapas acima, poderá [gravar o firmware do aplicativo](https://wiki.seeedstudio.com/pt-br/get_started_with_meshcore_solar_node/#flash-erase).
