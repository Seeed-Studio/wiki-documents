...
title: Tutorial de Desenvolvimento MeshCore
keywords:
  - MeshCore
  - Source Code
  - PlatformIO
...
Após concluir a codificação, execute o seguinte comando para compilar o código e convertê-lo em arquivo uf2.
...
2. Obtenha um sinal positivo geral (👍) dos mantenedores
3. Faça fork do repositório a partir da branch 'dev' e crie sua branch (fix/xxx, feature/yyy, docs/whatever)
