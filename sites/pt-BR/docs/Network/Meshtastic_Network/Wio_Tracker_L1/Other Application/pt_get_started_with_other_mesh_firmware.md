...
O disco desaparecerá depois que o firmware for gravado com sucesso. Neste momento não há firmware no dispositivo, portanto o dispositivo `NÃO` será reiniciado automaticamente.
...
### Incapaz de entrar no DFU e entrando no modo DFU manualmente
