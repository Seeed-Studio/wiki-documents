...
Você pode ir ao APP `Position Settings` para ativar o GPS. Ou você pode ir à página de GPS do dispositivo e pressionar o joystick de quatro direções para ligar ou desligar o GPS.
...
- **Zero hop** significa que seu anúncio é transmitido para qualquer pessoa que possa ouvi-lo, e é isso.
...
### Dispositivo travado & Instalação do Bootloader
...
- O log da porta serial executa por um tempo e depois para.
 ...
 Isso pode ser causado por reiniciar ou desligar manualmente e à força o dispositivo quando ele está nos seguintes estados: sem terminar o processo de transmissão de mensagem, sendo configurado......
...
- **RSSI** é determinado em conjunto pelo dispositivo e seu ambiente ao redor. Um dispositivo normal geralmente opera acima de -110 dBm. Um dispositivo com RSSI menor que -115 dBm é considerado como tendo baixo desempenho.
