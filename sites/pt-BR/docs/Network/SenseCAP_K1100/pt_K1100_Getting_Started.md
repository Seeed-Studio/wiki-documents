---
description: Introdução ao Sensor Prototype Kit
title: Introdução ao Sensor Prototype Kit
...
<div className="category">
  ...
  <div className="item">
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_Azure_IoT_Central/" target="_blank">Conectar SenseCAP ao Azure IoT Central via Node-RED (SenseCAP)</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Azure-IoT-Central/" target="_blank">Conectar Wio Terminal ao Microsoft Azure IoT Central (WiFi)</a></li>
    </ul>
    <ul>
  ...
  <div className="item">
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_PowerBI/" target="_blank">Conectar SenseCAP ao Power BI via Node-RED</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_influxdb/" target="_blank">Conectar SenseCAP ao InfluxDB via Node-RED</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_twilio/" target="_blank">Conectar SenseCAP ao Twilio via Node-RED</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_datacake/" target="_blank">Conectar SenseCAP ao Datacake via Node-RED</a></li>
    </ul>
  </div>
  <h3>
  ...
  <div className="item">
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Grove-Moisture_Sensor/" target="_blank">Sensor de Umidade do Solo Grove</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Grove-VOC_and_eCO2_Gas_Sensor-SGP30/" target="_blank">Sensor de Gás Grove VOC e eCO2 (SGP30)</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Grove-SHT4x/" target="_blank">Sensor de Temperatura e Umidade Grove (SHT40)</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Grove-Vision-AI-Module/" target="_blank">Módulo Grove Vision AI</a></li>
    </ul>
  </div>
  <h3>
  ...
  <div className="item">
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100-VOC-and-eCO2-Gas-Sensor-Grove-LoRa-E5/" target="_blank">Sensor de Gás Grove VOC e eCO2 (SGP30)</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1100-Temp-Humi-Sensor-Grove-LoRa-E5/" target="_blank">Sensor de Temperatura e Umidade Grove (SHT40)</a></li>
    </ul>
    <ul>
  ...
  <h3>
    <span className="headline" id="The Things Network Section">Seção The Things Network</span>
  </h3>
  <div className="item">
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/TTN-Introduction/" target="_blank">Introdução ao TTN</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Connecting-to-TTN/" target="_blank">Conectar ao TTN</a></li>
    </ul>
  </div>
  <h3>
  ...
  <div className="item">
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Azure-IoT-Central/" target="_blank">Conectar o Wio Terminal ao Microsoft Azure IoT Central</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Azure-IOT/" target="_blank">Conectar o Wio Terminal ao Microsoft Azure IoT Hub</a></li>
    </ul>
  </div>
  <h3>
    <span className="headline" id="Cloud">Nuvem</span>
  </h3>
  <div className="item">
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Connect_AWS_via_helium/" target="_blank">Conectar ao AWS IoT Core via Helium (Helium)</a></li>
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Azure-IoT-Central/" target="_blank">Conectar o Wio Terminal ao Microsoft Azure IoT Central (WiFi)</a></li>
    </ul>
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Azure-IOT/" target="_blank">Conectar o Wio Terminal ao Microsoft Azure IoT Hub (WiFi)</a></li>
    </ul>
  ...
  <h3>
    <span className="headline" id="Project">Projeto</span>
  </h3>
  <div className="item">
    <ul>
    ...
    <ul>
      <li><a href="https://wiki.seeedstudio.com/pt-br/K1111-Quick-Start-Guide/" target="_blank">Sistema de alarme de monitoramento de umidade do solo</a></li>
    </ul>
    <ul>
      <li><a href="https://www.hackster.io/hendra/environment-data-lora-node-c91415" target="_blank">Comunicação ponto a ponto Grove Wio E5</a></li>
    </ul>
  </div>
</div>

## <span id="jump1">Introdução</span>

### Início Rápido com SenseCAP - K1100

<table style={{marginLeft: 'auto', marginRight: 'auto'}}>
  <tbody>
    <tr>
      <td align="left">Neste tutorial, queremos que você comece passando pela seção de <strong>Guia de Início Rápido</strong>. Conheça a extraordinária apresentação de dados do nosso kit e a facilidade da funcionalidade de IoT. Neste capítulo, você pode experimentar a diversão da coleta e do processamento de dados com nosso projeto de código aberto no menor tempo possível. E você pode transferir os dados coletados para diferentes plataformas por meio de WiFi ou LoRa®.<br /><br /><a href="https://wiki.seeedstudio.com/pt-br/K1100-quickstart/">Ir para o capítulo &gt;</a></td>
      <td>
...
### Aplicações em Nuvem SenseCAP

<table>
    <tbody>
        <tr>
            <td colspan="2">Para facilitar que nossos usuários conectem dados da plataforma SenseCAP a várias outras plataformas PaaS para um processamento de dados mais aprofundado, faremos uma série de tutoriais para SenseCAP &amp; Node-RED.<br /><br /><a href="https://wiki.seeedstudio.com/pt-br/K1100-quickstart/">Ir para o capítulo &gt;</a></td>
            <td>
                <div align="center"><img width="600" src="https://files.seeedstudio.com/wiki/K1100_overview/1.png" /></div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_Azure_IoT_Central/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr> <td colspan={3}>—————————————————————————————————————————————</td>  </tr>
        <tr>
            <th>Conectando SenseCAP ao Power BI via Node-RED</th>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_PowerBI/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_influxdb/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr> <td colspan={3}>—————————————————————————————————————————————</td>  </tr>
        <tr>
            <th>Conectando SenseCAP ao Twilio via Node-RED</th>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_twilio/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_datacake/">Ir para o capítulo &gt;</a></th>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        <tr>
            <td colspan="2">Microsoft Azure IoT é um conjunto de serviços em nuvem gerenciados pela Microsoft que conectam, monitoram e controlam bilhões de ativos de IoT. Ele inclui segurança e sistemas operacionais para dispositivos e equipamentos, juntamente com dados e análises que ajudam as empresas a criar, implantar e gerenciar aplicações de IoT.</td>
            <td>
        ...
        <tr>
            <th>Conectar SenseCAP ao Azure IoT Central via Node-RED</th>
            <th>Conectar Wio Terminal ao Microsoft Azure IoT Central (WiFi)</th>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_SenseCAP_to_Azure_IoT_Central/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Azure-IoT-Central/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr> <td> </td> </tr>
        <tr>
            <th>Desenvolver no Microsoft Azure IoT Central</th>
        </tr>
        <tr>
            <td align="left">Neste capítulo, descreveremos como processar dados e desenvolvê-los ainda mais no Azure IoT Central.</td>
        </tr>
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Develop-in-Microsoft-Azure-IoT-Central/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr> <td colspan="3">————————————————————————————————————————————————————</td>  </tr>
        <tr>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100_Azure_to_PowerBI/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Configuring-Web-APP-Visualization/">Ir para o capítulo &gt;</a></th>
        </tr>
  </tbody></table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100-IMU-Sensor-Grove-LoRa-E5/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100-Soil-Moisture-Sensor-Grove-LoRa-E5/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr>
        ...
        <tr>
            <th>Grove Sensor de Gás VOC e eCO2 (SGP30)</th>
            <th>Grove Sensor de Temperatura &amp; Umidade (SHT40)</th>
        ...
        <tr>
            ...
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100-Temp-Humi-Sensor-Grove-LoRa-E5/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/K1100-Vision-AI-Module-Grove-LoRa-E5/">Ir para o capítulo &gt;</a></th>
        </tr>
</tbody></table>
...
<table>
    <tbody>
        ...
        <tr>
            <th>Introdução ao TTN</th>
            <th>Conectando ao TTN</th>
            <td> </td>
        </tr>
        <tr>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/TTN-Introduction">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Connecting-to-TTN">Ir para o capítulo &gt;</a></th>
            <td> </td>
        </tr>
        <tr>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <th><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Azure-IoT-Central/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Getting_started_with_Ubidots/">Ir para o capítulo &gt;</a></th>
        </tr>
        <tr> <td> </td> </tr>
        <tr>
        ...
        <tr>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Quick-Start-to-using-Blynk/">Ir para o capítulo &gt;</a></th>
            <th><a href="https://wiki.seeedstudio.com/pt-br/Connect-Wio-Terminal-to-Google-Cloud/">Ir para o capítulo &gt;</a></th>
            <th> </th>
        </tr>
</tbody></table>
...
<table>
    ...
    <tr>
      ...
      <td><a href="https://wiki.seeedstudio.com/pt-br/Train-Deploy-AI-Model/">Ir para o capítulo &gt;</a></td>
      <td colspan="2" />
    </tr>
  </tbody></table>
...
<table>
  <tbody><tr>
      <td>Além dos tutoriais básicos acima para cada plataforma, preparamos uma variedade de exemplos ricos sobre o uso deste kit, para que você possa ver aqui que o valor do kit é ilimitado!</td>
      <td>
...
<table align="center">
  <tbody><tr>
    ...
    <tr>
      ...
      <td align="left"><strong>IoT Into the Wild Contest for Sustainable Planet 2022</strong><br /><br />Temos o prazer de compartilhar com você os projetos que nossos participantes produziram usando este ótimo kit. Você também pode consultar os projetos deles para ainda mais possibilidades!<br /><br /><a href="https://www.hackster.io/contests/iotinthewild#winners" target="_blank">Ir para o capítulo &gt;</a></td>
    </tr>
  </tbody></table>
