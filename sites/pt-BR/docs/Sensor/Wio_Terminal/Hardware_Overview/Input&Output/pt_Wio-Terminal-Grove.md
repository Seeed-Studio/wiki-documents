---
description: Porta Grove
title: Porta Grove
keywords:
  - Wio_terminal Visão_Geral_do_Hardware
  - Entrada&Saída
...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Grove/
---

# Porta Grove

Este repositório apresenta como usar o Wio Terminal com o [**Ecossistema Grove**](https://www.seeedstudio.com/grove.html).
...
Esta seção apresenta como usar o [Grove - TDS Sensor](https://wiki.seeedstudio.com/pt-br/Grove-TDS-Sensor/) com o Wio Terminal para exibir leituras de TDS em tempo real em um gráfico de linha!

### Instalação das bibliotecas

1. Instale a biblioteca [LCD](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Overview/).

2. Instale a biblioteca [Linechart](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Linecharts/).
...
Para mais informações, visite [u8g2](https://github.com/olikraus/u8g2/wiki)
...
Esta seção apresenta como usar o [Grove - Temperature Sensor](https://wiki.seeedstudio.com/pt-br/Grove-Temperature_Sensor_V1.2/) com o Wio Terminal para exibir leituras de temperatura ambiente em tempo real.

### Instalação das bibliotecas

1. Instale a biblioteca [LCD](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Overview/).

2. Instale a biblioteca [Linechart](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Histogram/).
...
1. Instale a [TinyGPSPlus Library](https://github.com/mikalhart/TinyGPSPlus).
