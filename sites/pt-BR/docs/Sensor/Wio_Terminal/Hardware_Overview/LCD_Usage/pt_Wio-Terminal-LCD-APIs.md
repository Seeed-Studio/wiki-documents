---
title: Exemplos de API de LCD
nointro: null
keywords:
  - docs
  - docusaurus
image: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-APIs/
...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-APIs/
---
# Exemplos de API de LCD TFT

Este repositório fornece alguns GIFs para os exemplos da biblioteca de LCD TFT; todos os exemplos podem ser encontrados em `File`->`Example`->`Seeed_Arduino_LCD` -> `320 x 240`. Você pode usar esses exemplos para implementar no seu projeto.

Para mais informações sobre a tela LCD TFT, visite [Noções básicas da tela LCD TFT](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Basic/).
...
Obrigado por escolher nossos produtos! Estamos aqui para fornecer diferentes tipos de suporte e garantir que sua experiência com nossos produtos seja o mais tranquila possível. Oferecemos vários canais de comunicação para atender a diferentes preferências e necessidades.
