...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-RTC/
---

# Visão geral de RTC

Este wiki apresenta como usar a funcionalidade de RTC integrada dentro do núcleo SAMD51 no Wio Terminal para que você possa acompanhar o tempo. Este recurso evita que você tenha que adicionar um módulo RTC externo ao sistema!

![](https://files.seeedstudio.com/wiki/Wio-Terminal-RTC/demo.png)

## Instalando a biblioteca Seeed_Arduino_RTC para Wio Terminal

1. Visite o repositório [Seeed_Arduino_RTC](https://github.com/Seeed-Studio/Seeed_Arduino_RTC) e baixe todo o repositório para o seu disco local.

2. Agora, a Seeed_Arduino_RTC pode ser instalada na IDE do Arduino. Abra a IDE do Arduino e clique em `sketch` -> `Include Library` -> `Add .ZIP Library`, e escolha o arquivo `Seeed_Arduino_RTC` que você acabou de baixar.

![InstallLibrary](https://files.seeedstudio.com/wiki/Wio-Terminal/img/Xnip2019-11-21_15-50-13.jpg)

## Código de exemplo

O código a seguir é o uso básico da biblioteca RTC para o SAMD51:
>Para mais referência de API, verifique [aqui](https://github.com/Seeed-Studio/Seeed_Arduino_RTC)
...
Você também pode usar NTP para obter a hora para o RTC.

- Para esta demonstração, você deve primeiro passar pelo **[Wio Terminal Network wiki](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Network-Overview/)**.

### Bibliotecas dependentes

- Bibliotecas relacionadas à rede do Wio Terminal
