---
description: Kit de Aplicações ML101 com Curso do Prof. Vijay
title: Kit de Aplicações ML101 com Curso do Prof. Vijay
keywords:
...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-TinyML-Kit-Course/
---
...
Aplicações para tiny machine learning são abundantes, e alguns exemplos interessantes incluem o seguinte:
...
- [Cabo Grove](https://www.seeedstudio.com/Grove-Universal-4-Pin-20cm-Unbuckled-Cable-5-PCs-Pack-p-749.html)
...
P. Você pode explicar as diferenças entre aprendizado de máquina na nuvem, de borda e embarcado?
P. Do que uma máquina minúscula precisa para aprender?
P. Existem limitações para o tiny machine learning?
P. Como podemos usar tiny machine learning em casa ou no escritório?
P. Como essas máquinas chegam a conclusões com base em seu conjunto de dados e quão pequeno é esse conjunto de dados, tipicamente?
P. Quando é melhor usar uma máquina grande em vez de um sistema de tiny machine learning?
...
1. Pré-processamento: Esta etapa é usada para limpar e preparar os dados para análise posterior.
2. Exploração de dados: Esta etapa é usada para explorar os dados e encontrar padrões.
3. Detecção de padrões: Esta etapa é usada para detectar padrões nos dados.
4. Pós-processamento: Esta etapa é usada para melhorar a precisão do modelo e preparar os dados para implantação.
...
2. Preparar e configurar os parâmetros
3. Treinar o modelo de aprendizado de máquina
4. Avaliar o desempenho do modelo de aprendizado de máquina
5. Implantar em um ambiente de produção / usar para treinamento adicional, dependendo das circunstâncias.
...
- Fase de Propagação Direta (Forward): A saída de cada neurônio na primeira camada oculta é calculada usando a regra de sinal, de modo que os neurônios computam f = sgn (w1*inputs+b1)+sgn (w2*hiddens+b2)+...+sgn(wm+bm) e então aplicamos uma função de ativação como a sigmoide. Isso nos dá níveis de atividade sináptica para cada conexão entre neurônios e permite que os neurônios na próxima camada sejam ativados.
...
2. aumento da eficiência computacional.
...
Hiperparâmetros como número de camadas, tipo de camadas, função de ativação etc.
...
- [O que é um sistema embarcado](http://www.edn.com/electronics-blogs/digest/4427211/What-is-an-embedded-system)

- [Um Guia Introdutório a Sistemas Embarcados](https://www.cs.utah.edu/~gk/papers/embedded_primer.pdf)

- [O Estado do Desenvolvimento de Sistemas Embarcados](https://www.eetimes.com/document.asp?doc_id=133)
