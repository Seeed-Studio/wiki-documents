---
description: Como medir níveis de ruído com o Wio Terminal
title: Como medir níveis de ruído com o Wio Terminal
keywords:
...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Sound-Meter/
---

# Como medir níveis de ruído com o Wio Terminal

## Visão geral

Este exemplo mostra como exibir perfeitamente o Medidor de Decibéis no Wio Terminal.
...
- O dB pode ser apresentado no mostrador, leitura numérica e gráfico de linha, respectivamente.
- Há um guia para apresentar o que o número de dB significa.

## Primeiros passos

Para começar a usar a biblioteca de Áudio para o Wio Terminal, siga os seguintes passos:

## Instalação da biblioteca

1. Instale a biblioteca de Áudio `Seeed_Arduino_Audio`. Visite a [**Visão geral de áudio**](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Audio-Overview/) para mais informações.

2. Instale a biblioteca da tela LCD `Seeed_Arduino_LCD`, visite [Wio Terminal LCD](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Overview/) para mais informações.

3. Agora, a biblioteca pode ser instalada no Arduino IDE. Abra o Arduino IDE e clique em `sketch` -> `Include Library` -> `Add .ZIP Library`, e escolha o arquivo `Seeed_Arduino_Audio` que você acabou de baixar.

![InstallLibrary](https://files.seeedstudio.com/wiki/Wio-Terminal/img/Xnip2019-11-21_15-50-13.jpg)

## Exibir o valor de dB no Monitor Serial do Arduino

Este exemplo exibe o valor de dB no Monitor Serial do Arduino, assim podemos testar o código de dB.

:::note
O código é bem longo, então você pode apenas clicar em 'copy to clipboard' e depois colar no Arduino IDE.
:::
