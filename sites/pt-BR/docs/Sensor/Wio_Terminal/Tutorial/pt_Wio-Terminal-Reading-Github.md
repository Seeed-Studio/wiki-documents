---
description: Acessando o GitHub usando o Wio Terminal
title: Acessando o GitHub usando o Wio Terminal
keywords:
...
url: https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Reading-Github/
---

# Lendo estatísticas de repositórios do Github a partir do Wio Terminal

<div align="center"><img src="https://files.seeedstudio.com/wiki/Wio-Terminal/img/Github.gif" /></div>

Este wiki apresenta como usar o Wio Terminal para acessar um servidor **HTTPS**, o que significa que você pode usar o Wio Terminal para capturar dados em tempo real da internet! Aqui, o Wio Terminal está conectado a um Wi‑Fi e obtém dados do Github.

Com isso, você pode aplicar a demo a outras APIs, como obter informações de clima, estatísticas do YouTube etc.
...
- Conecta a um servidor https

- Captura estatísticas de repositório do Github

- Pode ser alterado para qualquer repositório do Github

## Bibliotecas Arduino necessárias

- Instale a biblioteca da tela LCD `Seeed_Arduino_LCD`. Para mais informações, visite [Wio Terminal LCD](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Overview/).

- Visite o repositório [ArduinoJson](https://github.com/bblanchon/ArduinoJson) e baixe todo o repositório para o seu disco local.

  - Agora, a biblioteca ArduinoJson pode ser instalada na IDE Arduino. Abra a IDE Arduino e clique em `sketch` -> `Include Library` -> `Add .ZIP Library`, e escolha o arquivo `ArduinoJson` que você acabou de baixar.
...
- Baixe o arquivo de cabeçalho [`Free_Fonts.h`](https://files.seeedstudio.com/wiki/Wio-Terminal/res/Free_Fonts.h) para poder usar abreviações para as fontes gratuitas incluídas na biblioteca LCD. Certifique‑se de colocar este arquivo de cabeçalho no mesmo local do sketch Arduino.

- Baixe o código completo [aqui](https://files.seeedstudio.com/wiki/Wio-Terminal/res/GitHubStats.zip) ou copie o seguinte.

- Envie o código.

## Código completo

**Observação:** Altere o `ssid` e a `password` para a sua rede Wi‑Fi.
