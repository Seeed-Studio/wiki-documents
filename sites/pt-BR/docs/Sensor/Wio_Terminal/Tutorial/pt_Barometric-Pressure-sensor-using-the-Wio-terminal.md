---
description: Sensor de pressão usando o Wio terminal
title: Sensor de pressão usando o Wio terminal
keywords:
...
url: https://wiki.seeedstudio.com/pt-br/Barometric-Pressure-sensor-using-the-Wio-terminal/
---

# Sensor de Pressão Barométrica de Alta Precisão usando o Wio terminal
...
A demonstração mostra que o Grove - sensor de pressão de alta precisão DPS310 é totalmente compatível com o Wio terminal, e sua medição possui alta precisão.

## Recursos

- A faixa de valores normais de pressão atmosférica pode ser exibida pela cor do mostrador
- com o tempo para exibir os graus de temperatura
- Detecção de pressão barométrica e temperatura de alta precisão

## Hardware

- [**Wio terminal**](https://www.seeedstudio.com/Wio-Terminal-p-4509.html)
- [**Grove- sensor de pressão de alta precisão DPS310**](https://www.seeedstudio.com/Grove-High-Precision-Barometer-Sensor-DPS310-p-4397.html)
...
se você não tiver o Arduino IDE, consulte [**Introdução ao Wio Terminal**](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-Getting-Started/)

- Instale a biblioteca da tela LCD `Seeed_Arduino_LCD`, visite [Wio Terminal LCD](https://wiki.seeedstudio.com/pt-br/Wio-Terminal-LCD-Overview/).

- Instale a biblioteca DPS310-Pressure-Sensor `#include <Dps310.h>`, visite [DPS310-Pressure-Sensor](https://wiki.seeedstudio.com/pt-br/Grove-High-Precision-Barometric-Pressure-Sensor-DPS310/).
