...
1. **Comprar acesso ao TRMNL**
   ...
   - Compre acesso ao aplicativo web TRMNL + recursos de dispositivo em: [https://shop.usetrmnl.com/products/byod](https://shop.usetrmnl.com/products/byod)
...
Conecte o cabo de extensão FPC e monte todo o case:
...
:::tip
Se o seu kit TRMNL estiver longe do roteador, você pode passar a antena para fora do case para obter um melhor desempenho de sinal.
:::
...
1. Acesse a [página de dispositivo SenseCraft HMI](https://sensecraft.seeed.cc/hmi/device).
...
Na parte inferior você pode escolher se deseja pular automaticamente telas cujo conteúdo não foi alterado. Veja o [post do blog sobre Smart Playlists](https://usetrmnl.com/blog/smart-playlists) para mais detalhes.
...
- **[Imprimível]** [Base em L](https://www.printables.com/model/1354879)
