---
description: Guia de referência para controlar qualquer produto Seeed ePaper compatível a partir da IDE Arduino - configuração da IDE Arduino, instalação da biblioteca Seeed_GFX, geração de driver.h. As análises detalhadas específicas de hardware ficam no cookbook de cada produto.
...
- [reTerminal E Series Arduino cookbook](/pt-br/reterminal_e10xx_with_arduino) — cobre reTerminal E1001 / E1002 / E1003 / E1004 com exemplos completos de periféricos (LEDs, buzzer, botões, SHT4x, BMS, microSD, renderização de imagem BMP).
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>Use a Configuration Tool com a tela de sua escolha</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Veja o [guia dedicado Kit DIY TRMNL + Arduino](/pt-br/ogdiy_kit_works_with_arduino)</td>
    </tr>
    <tr>
      <td><strong>Placa de Expansão XIAO eInk v2 / Placa Breakout ePaper</strong></td>
      <td>Qualquer XIAO que você conectar</td>
      <td>Use a Configuration Tool com sua escolha de XIAO + tela</td>
    </tr>
  </table>
</div>
...
- **[reTerminal E Series Arduino cookbook](/pt-br/reterminal_e10xx_with_arduino)** — Hello World no E1001/E1002/E1003/E1004, além do conjunto completo de periféricos: controle de LED, buzzer (bipes PWM passivos + reprodução de melodia), entrada de 3 botões, temperatura/umidade SHT4x, gerenciamento de bateria, cartão microSD, renderização de imagem BMP a partir do SD.
- **[Painel ePaper XIAO 7,5" + Arduino](/pt-br/xiao_075inch_epaper_panel_arduino)** — passo a passo com XIAO ESP32-C3 usando `Seeed_GFX`.
- **[Kit DIY TRMNL 7,5" + Arduino](/pt-br/ogdiy_kit_works_with_arduino)** — usando o hardware do kit em sketches Arduino personalizados (em vez da plataforma em nuvem TRMNL).
