---
description: O reTerminal E1004 é um display ePaper colorido completo de 13,3 polegadas, open-source, alimentado por ESP32-S3, com tecnologia E Ink® Spectra™ 6 e suporte ao SenseCraft Seeedash.
...
O reTerminal E1004 é um display ePaper colorido completo de 13,3 polegadas, open-source, com até 6 meses de duração de bateria. Alimentado por ESP32-S3, ele oferece suporte nativo à nossa plataforma de UI sem código SenseCraft Seeedash para criação de dashboards sem esforço, além de suportar Home Assistant via [ESPHome](/pt-br/reterminal_e10xx_with_esphome), Arduino e ESP-IDF para desenvolvimento adicional. Com o display ePaper colorido completo E Ink® Spectra™ 6, é perfeito para porta-retratos digitais e visualização de dashboards coloridos. É necessário ESPHome **2026.7.0 ou posterior** para o driver de display do E1004.
...
2. **Botões de Toque:** Botões capacitivos de toque na moldura frontal para atualização de tela e navegação de páginas (anterior / próxima).
...
4. **LED Vermelho de Carga:** Indica o status de carregamento da bateria.
5. **Porta USB-C de Dados e Carga:** Para carregar o dispositivo e transmissão de dados.
...
O reTerminal E1004 vem pré-carregado com firmware que oferece suporte ao **SenseCraft Seeedash**, uma plataforma sem código que permite projetar e implantar dashboards personalizados com facilidade.
...
**Passo 3.** Siga as instruções na tela para colocar seu dispositivo em modo de transmissão Bluetooth. Certifique-se de que o Bluetooth do seu telefone esteja ativado. Toque em **Scan**, e o aplicativo irá detectar os dispositivos próximos. Selecione seu dispositivo na lista para conectar.
...
2. **Select firmware** — escolha o firmware mais recente nas opções de lançamento do menu suspenso.
...
Depois que seu dispositivo estiver pareado, você poderá começar a usá-lo para exibir o que quiser. Recomendamos o **SenseCraft Seeedash** — uma plataforma em nuvem sem código que permite projetar e implantar conteúdo no seu reTerminal E1004 em apenas alguns cliques.

O SenseCraft Seeedash possui um Wiki dedicado com tutoriais completos e documentação de recursos. Para guias detalhados (configuração de conta, gravação de firmware, uso avançado do editor, implantação etc.), consulte:
...
A maneira mais rápida de colocar algo na sua tela é começar a partir de um template pronto. Na página **Home** do SenseCraft Seeedash, você encontrará uma coleção grande e em constante crescimento de templates contribuídos pela comunidade — dashboards, relógios, painéis de clima, paredes de citações, calendários, porta-retratos e muito mais. Navegue pela galeria, escolha o design que preferir e faça o deploy para o seu reTerminal E1004 com um clique.
...
O botão de atualização está localizado como o botão mais à esquerda na parte frontal inferior do dispositivo ou na parte de trás do dispositivo na posição mostrada na imagem acima. Ele possui várias funções:
...
- **LED Vermelho**:
  - Desligado: Totalmente carregado ou não está carregando
...
O conector de expansão (J2) é um cabeçalho 2×4 (número da peça **ST-FH-254-0148-2×4P**) que fornece 8 pinos organizados em duas colunas. A notação de posição dos pinos abaixo usa `Lx` para a coluna esquerda e `Rx` para a coluna direita (numerados de cima para baixo, conforme mostrado na imagem acima):
