...
O reTerminal E1003 é um display ePaper monocromático open-source de 10,3 polegadas com suporte a toque, oferecendo 16 níveis de escala de cinza e alta resolução de 1404×1872 pixels, com até 6 meses de duração de bateria (com base em uma atualização por dia). Alimentado por um ESP32-S3, ele oferece suporte nativo à nossa plataforma de interface sem código [SenseCraft HMI](https://sensecraft.seeed.cc/hmi) para criação fácil de dashboards. Seja para visualização e controle de dashboards de casa inteligente, painéis de informações em escritórios ou projetos educacionais, este dispositivo pronto para uso com suporte a toque oferece visuais impressionantes e personalização flexível para atender a todas as suas necessidades.
...
11. **Suporte de apoio impresso em 3D:** O acessório de suporte incluso para manter o dispositivo na posição vertical sobre uma superfície plana.
...
**Passo 1. Baixe e instale o driver**
...
**Passo 2. Ative a extensão do driver (crítico)**
Abra o app **CH34xVCPDriver** a partir do Launchpad, clique em **Install** e, em seguida, vá para **System Settings → General → Login Items & Extensions → Driver Extensions**. Altere **CH34xVCPDriver Extensions** para **ON** (azul).
<div style={{ display: 'flex', justifyContent: 'center', gap: '10px' }}>
...
**Passo 3.** Siga as instruções na tela para colocar seu dispositivo no modo de transmissão Bluetooth. Certifique-se de que o Bluetooth do seu telefone esteja ativado. Toque em **Scan**, e o aplicativo irá detectar dispositivos próximos. Selecione seu dispositivo na lista para conectar.
...
**Passo 5.** O aplicativo enviará as credenciais do Wi-Fi para o dispositivo e o adicionará à sua conta SenseCraft. Uma mensagem "Device added successfully" aparecerá ao concluir. Agora você pode tocar em **Start exploring!** para continuar.
...
- **Pressionar uma vez**: Atualiza manualmente o display e verifica se há novo conteúdo na plataforma SenseCraft. O buzzer emitirá um bipe para confirmar a ação. Esse botão também é comumente usado para ativar o dispositivo quando ele entrou em modo de suspensão e uma atualização do dashboard não está imediatamente disponível.
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>GPIO47</td>
			<td>GPIO/ADC</td>
			<td>Entrada/saída de uso geral com capacidade de entrada analógica</td>
		</tr>
		<tr>
			<td>4</td>
