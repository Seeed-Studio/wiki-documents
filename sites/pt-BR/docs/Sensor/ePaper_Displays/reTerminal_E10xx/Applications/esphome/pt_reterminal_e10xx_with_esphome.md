---
description: Este artigo descreve como fazer o reTerminal E Series ePaper Display funcionar com Home Assistant e ESPHome.
title: Uso básico do ESPHome
...
# reTerminal E Series ePaper Display funcionando com ESPHome para Home Assistant
...
- **Amplo suporte a dispositivos**: Home Assistant se integra a milhares de diferentes dispositivos e serviços de casa inteligente, tornando-o altamente versátil e preparado para o futuro.
...
### Por que usar o reTerminal E Series ePaper Display com Home Assistant?

O reTerminal E Series ePaper Display é um excelente companheiro para o Home Assistant por vários motivos:

1. **Eficiência energética**: O display de papel eletrônico consome energia apenas ao atualizar o conteúdo, tornando-o perfeito para exibir informações persistentes, como previsões do tempo, eventos de calendário ou status do sistema.

2. **Visibilidade clara**: Diferente das telas LCD, os displays de papel eletrônico são facilmente legíveis em qualquer condição de iluminação, incluindo luz solar direta, o que os torna ideais para painéis de controle de parede.
...
Essas vantagens tornam o reTerminal E Series ePaper Display uma escolha ideal para criar um display de informações sempre ligado e energeticamente eficiente para sua configuração de Home Assistant.

### Integração com ESPHome

ESPHome é uma ferramenta de criação de firmware de código aberto projetada especificamente para dispositivos ESP8266/ESP32. Ela permite criar firmware personalizado usando arquivos de configuração YAML simples, que podem então ser gravados no seu dispositivo. Para o reTerminal E Series, o ESPHome atua como o middleware essencial que habilita a comunicação entre o dispositivo e o Home Assistant.
...
Passo 3. O Home Assistant deve detectar automaticamente o seu dispositivo reTerminal E Series ePaper Display via mDNS. Se ele aparecer na seção de dispositivos descobertos, clique em Configure para adicioná-lo.
...
Passo 6. Depois de conectado, o seu reTerminal E Series ePaper Display aparecerá como um dispositivo no Home Assistant com todos os seus sensores e componentes disponíveis.
...
Passo 2. Pesquise um ícone que você queira usar em seu projeto. Você pode navegar por categoria ou usar a função de busca.
...
Este exemplo demonstra como exibir imagens personalizadas no e-paper display reTerminal E Series ePaper Display. Você pode usar esse recurso para mostrar logotipos, ícones ou quaisquer gráficos que melhorem a experiência do seu painel.
...
Passo 5. Adicione o seguinte código ao seu arquivo de configuração ESPHome após a seção `captive_portal`. Esse código define o recurso de imagem e configura a tela para exibi-lo.
...
Passo 6. Salve sua configuração e envie-a para o seu reTerminal E Series. Quando a atualização for concluída, o seu e-paper display exibirá a imagem.
...
:::caution
Lembre-se de que e-paper displays têm taxas de atualização limitadas. A configuração `update_interval: 300s` significa que sua tela será atualizada apenas a cada 5 minutos. Ajuste esse valor de acordo com suas necessidades, mas esteja ciente de que atualizações frequentes podem reduzir a vida útil dos e-paper displays.
:::
...
### P3: O reTerminal E Series ePaper Display não consegue se conectar ao seu computador?
