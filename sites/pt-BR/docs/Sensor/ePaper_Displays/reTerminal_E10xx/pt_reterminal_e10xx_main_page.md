...
---
# Visão geral dos displays reTerminal E Series ePaper
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td align="center"><strong>7,3" Totalmente colorido</strong><br/>E Ink® Spectra™ 6<br/>~3 meses de bateria</td>
      <td align="center"><strong>10,3" Monocromático</strong><br/>Escala de cinza de 16 níveis + Toque<br/>~6 meses de bateria</td>
      <td align="center"><strong>13,3" Totalmente colorido</strong><br/>E Ink® Spectra™ 6<br/>~6 meses de bateria</td>
    </tr>
    <tr>
...
Todos os quatro modelos compartilham a mesma plataforma ESP32-S3, wireless Wi-Fi 4 / Bluetooth 5.0, sensor T/H e buzzer on-board, entrada USB-C 5 V / 1 A e faixa de operação de 0–40 °C — tudo em um gabinete de metal. As diferenças estão principalmente no **painel de display**, **comportamento de atualização**, **bateria**, **expansão** e **certificações**:
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td align="center">—</td>
			<td align="center">—</td>
			<td align="center">✅ Toque capacitivo<br/>(SenseCraft Seeedash v1.1.2+)</td>
			<td align="center">—</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="center">Flash de 32 MB<br/>microSD até 32 GB</td>
			<td align="center">Flash de 32 MB<br/>microSD até 32 GB</td>
			<td align="center">Flash de 32 MB<br/>microSD até 32 GB</td>
			<td align="center">Flash de 32 MB<br/>microSD até 32 GB<br/>(<strong>16 GB incluídos</strong>)</td>
		</tr>
		<tr>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>10,3" com escala de cinza de 16 níveis, toque capacitivo (Seeedash v1.1.2+) e bateria de 6 meses.</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>Todos os quatro modelos suportam Home Assistant via ESPHome. E1003 e E1004 exigem ESPHome 2026.7.0 ou posterior.</td>
		</tr>
		<tr>
			<td>Quer um dashboard TRMNL E-Ink</td>
			<td align="center"><strong>E1001 / E1002 / E1003 / E1004</strong></td>
			<td>Todos os quatro modelos são suportados. E1002 e E1004 possuem painéis coloridos, mas atualmente funcionam em modo monocromático no TRMNL.</td>
		</tr>
		<tr>
...
O reTerminal E1001 possui um display ePaper monocromático de 7,5 polegadas com capacidade de escala de cinza de 4 níveis. Com sua resolução de 800×480, oferece texto nítido e imagens claras consumindo energia mínima. O display monocromático é perfeito para aplicações em que a legibilidade do texto e a vida útil da bateria são prioridades.
...
O reTerminal E1003 é um display ePaper monocromático open-source de 10,3 polegadas com 16 níveis de escala de cinza e alta resolução de 1404×1872 pixels, com até 6 meses de duração de bateria. A interação por toque é atualmente suportada no firmware SenseCraft Seeedash v1.1.2. Alimentado por ESP32-S3, ele oferece suporte nativo ao design de UI sem código do SenseCraft Seeedash, enquanto Arduino, PlatformIO e ESPHome (Home Assistant) estão disponíveis para desenvolvimento adicional.

A biblioteca Arduino relacionada ao toque está planejada para futura liberação open-source, proporcionando maior flexibilidade para personalizar painéis. Mais atualizações serão compartilhadas em breve. O ESPHome já oferece suporte ao driver de display E1003 e ao toque capacitivo GT911 — veja os [ESPHome cookbooks](/pt-br/reterminal_e10xx_with_esphome).

### Principais recursos

- Display ePaper monocromático de 10,3 polegadas com suporte a interação por toque no firmware Seeedash v1.1.2
...
- Suporte nativo ao SenseCraft Seeedash, além de compatibilidade com Arduino, PlatformIO e ESPHome (Home Assistant)
...
O reTerminal E1004 possui um display ePaper colorido de 13,3 polegadas e até 6 meses de duração de bateria. Alimentado por ESP32-S3, ele oferece suporte ao SenseCraft Seeedash para criação de dashboards sem código e upload de imagens, além de suportar Home Assistant via ESPHome, Arduino e ESP-IDF para fluxos de trabalho de desenvolvimento avançados. ESPHome **2026.7.0 ou posterior** é necessário para o driver de display E1004 — veja os [ESPHome cookbooks](/pt-br/reterminal_e10xx_with_esphome).

### Principais recursos

- Display ePaper colorido de 13,3 polegadas
- Até 6 meses de duração de bateria para cenários sempre ligados
- Plataforma ESP32-S3 com suporte sem código SenseCraft Seeedash
- Compatível com Home Assistant / ESPHome, Arduino e ESP-IDF

## SenseCraft Seeedash — A plataforma sem código padrão
...
Todo dispositivo da reTerminal E Series é enviado com o firmware **SenseCraft Seeedash** pronto para uso, para que você possa começar sem escrever uma única linha de código. O aplicativo web cuida do login, design do dashboard e implantação over-the-air para o seu dispositivo:
...
- **Interação por toque** — totalmente suportada no E1003 a partir do firmware Seeedash v1.1.2.

Se você precisar de mais controle do que o fluxo de trabalho sem código oferece, cada dispositivo também expõe o ESP32-S3 subjacente, para que você possa passar para ESPHome / Home Assistant, Arduino e os tutoriais de aplicação abaixo a qualquer momento. Para um YAML ESPHome pronto para uso, utilize o cartão ESPHome do [Firmware Hub](https://seeed-projects.github.io/OSHW-reTerminal-Series-E-D/) e marque os recursos de que você precisa.

## Aplicações e tutoriais

Além do SenseCraft Seeedash, a reTerminal E Series se integra a várias plataformas padrão do setor e ferramentas de design de UI visual. A matriz abaixo informa, para cada tutorial, quais modelos ele cobre atualmente.
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_esphome_advanced">ESPHome — I/O, Bateria, Toque &amp; Energia</a></td>
			<td>Botões, buzzer, LED onboard, monitoramento de bateria, deep sleep, dashboards com múltiplas páginas e toque capacitivo (E1003).</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Crie telas HMI visualmente e faça o deploy por meio da Arduino IDE.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">—</td>
			<td align="center">—</td>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Gerenciamento de horário com RTC, deep sleep / light sleep, gravação com microfone I2S e desenho com toque capacitivo (E1003 apenas para microfone &amp; toque).</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
...
:::tip
Procurando as instruções de primeiros passos específicas por dispositivo (unboxing, configuração de Wi-Fi, atualização de firmware)? Vá para o Wiki do produto vinculado na matriz acima:
...
- [Documentação do SenseCraft Seeedash](https://wiki.seeedstudio.com/pt-br/sensecraft_hmi_overview/)
