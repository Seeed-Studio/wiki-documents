...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>O suporte direto ao Home Assistant está disponível nos modelos E1001, E1002 e E1004. O ESPHome para o E1003 está planejado.</td>
		</tr>
		<tr>
...
- Perfeito para exibição de galerias, dashboards coloridos e aplicações orientadas ao visual
...
O reTerminal E1003 é uma tela ePaper monocromática open-source de 10,3 polegadas com 16 níveis de escala de cinza e alta resolução de 1404×1872 pixels, com até 6 meses de duração de bateria. A interação por toque é atualmente suportada no firmware SenseCraft HMI v1.1.2. Alimentado por ESP32-S3, oferece suporte nativo ao design de UI sem código do SenseCraft HMI, enquanto Arduino e PlatformIO estão disponíveis para desenvolvimento adicional.
...
- Escala de cinza em 16 níveis com alta resolução de 1404×1872
...
O reTerminal E1004 possui uma tela ePaper colorida de 13,3 polegadas e até 6 meses de duração de bateria. Alimentado por ESP32-S3, oferece suporte ao SenseCraft HMI para criação de dashboards sem código e envio de imagens, além de suportar Home Assistant, Arduino e ESP-IDF para fluxos de trabalho de desenvolvimento avançados.
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Renderize texto, gráficos e imagens na tela de ePaper com as bibliotecas Seeed_GFX ou GxEPD2.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_arduino_peripherals_2">Arduino — RTC, baixo consumo &amp; áudio</a></td>
			<td>Gerenciamento de horário via RTC, deep sleep / light sleep e gravação de microfone I2S (apenas E1001 / E1002 / E1003 para o microfone).</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
