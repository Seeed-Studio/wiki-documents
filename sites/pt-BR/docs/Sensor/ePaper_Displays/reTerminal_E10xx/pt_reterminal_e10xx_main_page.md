...
Quatro modelos, um ecossistema. Escolha por **tamanho de tela**, **cor vs. monocromático**, **toque** e **vida útil da bateria**:
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td align="center"><a href="https://www.seeedstudio.com/catalogsearch/result/?q=e1003" target="_blank" rel="noopener noreferrer"><strong>Comprar E1003</strong></a><br/><a href="https://wiki.seeedstudio.com/pt-br/getting_started_with_reterminal_e1003" target="_blank" rel="noopener noreferrer">Wiki →</a></td>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td align="center">176 × 120 × 53 mm<br/>(17 mm sem base)</td>
			<td align="center">176 × 120 × 53 mm<br/>(17 mm sem base)</td>
		...
		<tr>
			...
			<td align="center">Cabeçalho 2 × 4<br/>UART / I²C / GPIO / ADC</td>
		</tr>
		<tr>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Painel colorido completo Spectra™ 6 de 7,3" — galeria, receitas, quadro de tarefas das crianças, sinalização de varejo. Observação: o colorido completo troca a atualização parcial por visuais mais ricos (~15–20 s para atualização completa).</td>
		</tr>
		<tr>
		...
		<tr>
			<td>Quer um dashboard E-Ink TRMNL</td>
			<td align="center"><strong>E1001 / E1002</strong></td>
			<td>Ambos são oficialmente suportados. O E1002 atualmente roda em modo monocromático sob o TRMNL.</td>
		</tr>
		<tr>
...
- Perfeito para exibições de galeria, dashboards coloridos e aplicações orientadas ao visual
...
A biblioteca relacionada ao toque está planejada para ser disponibilizada como open-source no futuro, oferecendo maior flexibilidade para personalizar os painéis. Mais atualizações serão compartilhadas em breve. O suporte ao driver ESPHome para o E1003 também está planejado para uma versão futura.

### Principais recursos

- Tela ePaper monocromática de 10,3 polegadas com suporte a interação por toque no firmware HMI v1.1.2
...
O reTerminal E1004 possui uma tela ePaper colorida de 13,3 polegadas e até 6 meses de duração de bateria. Alimentado por ESP32-S3, ele oferece suporte ao SenseCraft HMI para criação de dashboards sem código e upload de imagens, além de suportar Home Assistant, Arduino e ESP-IDF para fluxos de trabalho de desenvolvimento avançados.

### Principais recursos

- Tela ePaper colorida de 13,3 polegadas
- Até 6 meses de duração de bateria para cenários always-on
...
Todo dispositivo da série reTerminal E vem com o firmware **SenseCraft HMI** de fábrica, para que você possa começar a usar sem escrever uma única linha de código. O aplicativo web cuida do login, design do dashboard e implantação over-the-air para o seu dispositivo:
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_esphome">ESPHome — Basic Usage</a></td>
			<td>Conecte o dispositivo ao Home Assistant e desenhe gráficos simples com YAML.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_esphome_advanced">ESPHome — Advanced Usage</a></td>
			<td>Botões, buzzer, monitoramento de bateria, deep sleep, dashboards com múltiplas páginas.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">Planejado</td>
			<td align="center">via Home Assistant</td>
		...
		<tr>
			...
			<td>Implante dashboards E-Ink por meio da plataforma TRMNL.</td>
			<td align="center">✅</td>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_squareline_vision">Work with SquareLine Vision</a></td>
			<td>Arraste e solte UI LVGL no navegador e depois exporte o código pronto para compilação.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">—</td>
			<td align="center">—</td>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			<td><a href="https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_arduino_peripherals">Arduino — Onboard Peripherals</a></td>
...
:::tip
Procurando as instruções de primeiros passos por dispositivo (desembalagem, configuração de Wi‑Fi, atualização de firmware)? Vá para o Wiki do produto vinculado na matriz acima:
