...
Quatro terminais alimentados por ESP32-S3, compartilhando a mesma família de gabinetes, pilha de software e projeto de bateria. As diferenças são tamanho de tela, cor vs. monocromático, toque e duração da bateria.
...
Se você já tem (ou quer adquirir separadamente) um painel ePaper de 24 pinos, 50 pinos, 10,3" ou 13,3", a família de placas controladoras oferece a eletrônica de suporte — gerenciamento de bateria, botões, CI de carregamento e o MCU.
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>Integração nativa com Home Assistant; construa dashboards de forma declarativa em YAML.</td>
    ...
    <tr>
      ...
      <td>UI LVGL de arrastar e soltar no navegador, depois exporte o código pronto para compilação.</td>
...
- [Work with Arduino](https://wiki.seeedstudio.com/pt-br/epaper_work_with_arduino) — referência principal: configuração da IDE, biblioteca `Seeed_GFX`, geração de `driver.h`. Guias por produto: reTerminal E Series — [ePaper Display](https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_arduino) & [Onboard Peripherals](https://wiki.seeedstudio.com/pt-br/reterminal_e10xx_with_arduino_peripherals), [TRMNL DIY Kit](https://wiki.seeedstudio.com/pt-br/ogdiy_kit_works_with_arduino), [XIAO 7.5" Panel](https://wiki.seeedstudio.com/pt-br/xiao_075inch_epaper_panel_arduino).
- [Work with PlatformIO](https://wiki.seeedstudio.com/pt-br/epaper_work_with_platformio) — referência principal: configuração do VS Code, configuração de `platformio.ini`, configuração de `Seeed_GFX` e seleção do ambiente PlatformIO por produto. Guia por produto: [EE04 / EE0x PlatformIO](https://wiki.seeedstudio.com/pt-br/ee04_with_platformio).
