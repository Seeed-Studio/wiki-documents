...
:::note
Se você quiser explorar mais sobre o controle via xvf_host com scripts em Python, leia este [artigo](https://github.com/respeaker/reSpeaker_XVF3800_USB_4MIC_ARRAY/blob/master/host_control/README.md).
:::
