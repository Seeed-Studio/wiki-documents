...
title: reSpeaker XVF3800 USB Mic Array com XIAO ESP32S3 Streaming de Áudio HTTP
keywords:
  - reSpeaker
  - XIAO
  - ESP32S3
...
url: https://wiki.seeedstudio.com/pt-br/respeaker_xvf3800_xiao_http_audio_stream/
---

## Introdução 

Este guia descreve como capturar áudio de uma matriz de microfones XVF3800 usando um ESP32-S3 (XIAO ESP32S3), gravar 5 segundos de áudio PCM estéreo de 16 kHz e 32 bits e armazenar os dados em PSRAM para lidar com buffers de áudio grandes. O áudio gravado é então enviado via Wi-Fi para um servidor HTTP Flask baseado em Python, onde é recebido e salvo como um arquivo WAV padrão. Esta configuração é bem adequada para aplicações como captura de voz, registro remoto de áudio e pipelines de processamento de fala, incluindo conversão de fala em texto (STT) e análise de áudio baseada em aprendizado de máquina.
...
:::note
Você deve habilitar a PSRAM, caso contrário malloc() irá falhar.
:::
...
## Código do Servidor Python (Flask)

**Você precisa instalar o flask no seu ambiente** `pip install flask` 
