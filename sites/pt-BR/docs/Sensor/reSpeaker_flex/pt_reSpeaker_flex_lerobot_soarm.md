...
title: Adicione Interação por Voz ao Seu SO-ARM10x com reSpeaker Flex
keywords:
  - reSpeaker flex
  - xvf3800
...
|---------|---------|------|
| [Groq](https://groq.com/) | Whisper STT, LLaMA LLM, Orpheus TTS | Nível gratuito é suficiente |
...
[Configure the Motors](https://wiki.seeedstudio.com/pt-br/lerobot_so100m_new/#configure-the-motors)
