...
title: HTTP Streaming reSpeaker Flex com Xiao ESP32S3
keywords:
  - reSpeaker flex
  - xvf3800
  - ESP32S3
...
url: https://wiki.seeedstudio.com/pt-br/respeaker_flex_xiao_http_stream/
---

## Introdução 

Este guia descreve como capturar áudio de um array de microfones reSpeaker Flex XVF3800 usando um ESP32-S3 (XIAO ESP32S3), gravar 5 segundos de áudio PCM estéreo de 32 bits a 16 kHz e armazenar os dados na PSRAM para lidar com buffers de áudio grandes. O áudio gravado é então enviado via Wi-Fi para um servidor HTTP Flask baseado em Python, onde é recebido e salvo como um arquivo WAV padrão. Esta configuração é bem adequada para aplicações como captura de voz, registro remoto de áudio e pipelines de processamento de fala, incluindo reconhecimento de fala (STT) e análise de áudio baseada em aprendizado de máquina.
...
**Você precisa instalar e executar o flask no seu ambiente** `pip install flask` 
