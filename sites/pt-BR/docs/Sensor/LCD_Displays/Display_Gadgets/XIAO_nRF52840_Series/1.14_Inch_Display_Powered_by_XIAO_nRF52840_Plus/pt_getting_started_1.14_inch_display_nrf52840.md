...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>Tela</td><td>[GraphicTest](/pt-br/function_1.14_inch_display_nrf52840#tela-display--graphictest) — dez primitivas gráficas com medições de tempo</td></tr>
    ...
    <tr><td>Microfone e alto-falante</td><td>[Voice Bar + Flash Recorder](/pt-br/function_1.14_inch_display_nrf52840#microfone--alto-falante) — medidor de nível PDM em tempo real e gravação com reprodução via I2S</td></tr>
...
Não — recomendamos fortemente **não conectar ou desconectar com a placa ligada** dispositivos na interface I2C enquanto o dashboard estiver em execução. Sempre desligue a placa antes de conectar ou desconectar qualquer coisa no conector Grove I2C ou nos pads de breakout SDA/SCL. Conectar a quente pode travar o barramento I2C.
