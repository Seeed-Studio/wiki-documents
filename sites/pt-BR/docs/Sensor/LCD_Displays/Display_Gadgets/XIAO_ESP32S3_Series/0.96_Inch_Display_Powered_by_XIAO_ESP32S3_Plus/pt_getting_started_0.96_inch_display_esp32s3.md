...
O ESP32-S3 Plus adiciona conectividade Wi-Fi e Bluetooth, tornando a placa adequada para wearables compactos, dashboards portáteis de sensores, gadgets de chaveiro e protótipos IoT sem fio.
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>D15</td><td>NC</td><td>Não conectado</td><td>Sem conexão física</td></tr>
    ...
    <tr><td>D18</td><td>LCD_BL_PWM</td><td>Controle de backlight do LCD</td><td>Conectado internamente ao circuito driver do backlight</td></tr>
    <tr><td>D19</td><td>NC</td><td>Não conectado</td><td>Sem conexão física</td></tr>
  </table>
</div>
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>Tela</td><td>[GraphicTest](/pt-br/function_0.96_inch_display_esp32s3#screen-display--graphictest) — dez primitivas gráficas com medições de tempo</td></tr>
...
2. Abra **Tools > Board > Boards Manager**, procure por **esp32** e instale a versão **3.3.11**.
