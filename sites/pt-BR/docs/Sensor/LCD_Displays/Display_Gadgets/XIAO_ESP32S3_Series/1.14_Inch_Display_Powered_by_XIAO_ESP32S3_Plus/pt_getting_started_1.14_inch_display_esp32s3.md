...
A placa de display inclui vários periféricos onboard. A página [Function](/pt-br/function_1.14_inch_display_esp32s3) fornece uma demonstração independente para cada um:
