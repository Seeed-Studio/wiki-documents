---
description: Visão geral e comparação da série XIAO Display Gadgets.
title: Série XIAO Display Gadgets
keywords:
  - XIAO
  - Display
  - LCD
...
url: https://wiki.seeedstudio.com/pt-br/display_gadgets/
---

# Série XIAO Display Gadgets
...
A série XIAO Display Gadgets é uma família de placas de expansão compactas que combinam um controlador principal Seeed Studio XIAO com um pequeno LCD colorido. Seis modelos estão disponíveis em três tamanhos de tela — 0,96", 1,14" e 1,47" — e dois controladores XIAO — o XIAO ESP32-S3 Plus e o XIAO nRF52840 Plus — variando de um display de 80×160 que cabe no bolso até um display capacitivo com toque de 172×320 com armazenamento MicroSD.
...
<div class="table-center">
  <table align="center">
    <tr>
      ...
      <th colspan="3">Série XIAO ESP32-S3 Plus</th>
      <th colspan="3">Série XIAO nRF52840 Plus</th>
    </tr>
    <tr>
      <th><a href="/pt-br/getting_started_1.47_inch_touch_display_esp32s3">1,47''</a></th>
      <th><a href="/pt-br/getting_started_1.14_inch_display_esp32s3">1,14''</a></th>
      <th><a href="/pt-br/getting_started_0.96_inch_display_esp32s3">0,96''</a></th>
      <th><a href="/pt-br/getting_started_1.47_inch_touch_display_nrf52840">1,47''</a></th>
      <th><a href="/pt-br/getting_started_1.14_inch_display_nrf52840">1,14''</a></th>
      <th><a href="/pt-br/getting_started_0.96_inch_display_nrf52840">0,96''</a></th>
    </tr>
    <tr><td>Posicionamento do Produto</td><td>Toque e interação completa</td><td>Sensoriamento e expansão</td><td>Ultracompacto</td><td>Toque e interação completa</td><td>Sensoriamento e expansão</td><td>Ultracompacto</td></tr>
...
Todos os seis modelos compartilham o mesmo hardware integrado:

- LCD TFT IPS colorido (SPI) — 80×160, 135×240 ou 172×320, dependendo do tamanho da tela
- Microfone digital PDM
- IMU de 6 eixos (LSM6DS3, acelerômetro de 3 eixos + giroscópio de 3 eixos)
- Botões de usuário — 2 ou 3, dependendo do modelo
- Conector JST de 2 pinos para bateria LiPo de 3,7 V
- Detecção de tensão da bateria (os modelos nRF52840 detectam adicionalmente o status de carregamento)

Todos os modelos são programados com a Arduino IDE usando a biblioteca gráfica **Seeed_GFX2** da Seeed.
