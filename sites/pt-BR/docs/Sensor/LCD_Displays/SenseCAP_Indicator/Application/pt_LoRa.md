---
description: Uso da demonstração LoRa
title: Comunicação LoRa - SenseCAP Indicator
keywords:
  - SenseCAP Indicator
  - LoRa
  - ESP32S3
...
url: https://wiki.seeedstudio.com/pt-br/SenseCAP_Indicator_LoRa/
---
...
Esta [demonstração](https://github.com/Seeed-Solution/indicator_lora_commu) mostra como estabelecer uma comunicação LoRa básica entre o SenseCAP Indicator e a placa XIAO usando o Wio-E5 como intermediário. O SenseCAP Indicator obtém dados de sensores da XIAO, que são então transmitidos via Wio-E5. A carga útil transmitida é posteriormente recebida pelo SenseCAP Indicator, que a decodifica e gera o resultado, exibindo os dados na sua tela.

Sem código LVGL: [Code · GitHub](https://github.com/Seeed-Solution/indicator_lora_commu/tree/29624d10643a41ae5e1e24124b81e93b5e3cd3bb)

## Hardware

### SenseCAP Indicator

Na página [Dive_into_the_Hardware](/pt-br/SenseCAP_Indicator_Dive_into_the_Hardware/#Diagrama-de-hardware), podemos ver que o transceptor LoRa está conectado ao MCU ESP32-S3 por meio da interface SPI.
...
Como o SDK [SenseCAP_Indicator_ESP32](https://github.com/Seeed-Solution/sensecap_indicator_esp32) já fornece a biblioteca LoRa, podemos usá-la diretamente; você pode revisar rapidamente a página [LoRa®](/pt-br/SenseCAP_Indicator_ESP32_LoRa) para ver como usar a biblioteca LoRa.
...
Siga as [instruções](/pt-br/SenseCAP_Indicator_How_To_Flash_The_Default_Firmware) fornecidas para configurar o ambiente de desenvolvimento.

### Etapa 1: Baixar o código de demonstração

Clone ou baixe o código de demonstração a partir [deste link](https://github.com/Seeed-Solution/indicator_lora_commu). Este código servirá como ponto de partida para sua aplicação LoRa.
...
<div class="table-center">
  ...
  <tr>
    <td> <a href="https://github.com/Seeed-Solution/SenseCAP_Indicator_ESP32/blob/main/examples/indicator_lora/main/demo/beep.c"><span> Controle de Beep </span></a> </td>
    <td> Recebe a string "ON" ou "OFF" e pode executar as funções correspondentes</td>
  </tr>
  <tr>
    <td> <a href="https://github.com/Seeed-Solution/indicator_lora_commu"><span> PingPong </span></a></td>
    <td> estabelece um padrão de comunicação ping-pong entre um dispositivo mestre e um escravo.</td>
  </tr>
  <tr>
    <td> <a href="https://github.com/Seeed-Solution/indicator_lora_commu"><span> Upload de Dados de Múltiplos Sensores </span></a></td>
    <td> O XIAOS3 coleta dados e utiliza o Wio-E5 (com módulo LoRa e comandos AT) para enviar os dados dos sensores para o Indicator.</td>
  </tr>
 </table>
</div>

Para mais detalhes, consulte o arquivo [README](https://github.com/Seeed-Solution/SenseCAP_Indicator_ESP32/blob/main/examples/indicator_lora/README.md).

## Suporte Técnico

**Precisa de ajuda com o seu SenseCAP Indicator? Estamos aqui para ajudar você!**

Se você encontrar qualquer problema ou tiver dúvidas ao seguir este tutorial, sinta-se à vontade para entrar em contato com o nosso suporte técnico. Estamos sempre aqui para ajudar!

Visite nosso [Canal Oficial da Seeed no Discord](https://discord.gg/kpY74apCWj) para fazer suas perguntas ou o [GitHub discussions](https://github.com/Seeed-Solution/SenseCAP_Indicator_ESP32/discussions) para compartilhar tudo o que quiser!
