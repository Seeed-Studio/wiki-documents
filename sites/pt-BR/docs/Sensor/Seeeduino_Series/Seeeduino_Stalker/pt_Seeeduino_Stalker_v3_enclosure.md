---
description: Gabinete Seeeduino Stalker v3
title: Gabinete Seeeduino Stalker v3
keywords:
  - Seeeduino
...
url: https://wiki.seeedstudio.com/pt-br/Seeeduino_Stalker_v3_enclosure/
---
...
O gabinete Seeeduino Stalker V3 é usado para Arch GPRS V3, é à prova d'água e resistente o suficiente, podendo transportar a Arch GPRS V3 para testes ambientais e coleta de dados muito bem.
...
---
É muito fácil de usar, você só precisa usar a placa de montagem de PVC para fixá-lo.

**Primeiro——Montar a coluna do parafuso e o parafuso de nylon.**

Devemos montar a coluna do parafuso e o parafuso de nylon.
...
**Segundo——Colocar a almofada de espuma.**

![enter image description here](https://files.seeedstudio.com/wiki/Seeeduino_Stalker_v3_enclosure/img/IMG_0749.JPG)

**Terceiro——Colocar a bateria.**

Vale notar que devemos colocar a peça separadora da bateria para evitar que a bateria entre em contato com os componentes.
...
**Quarto——Fixar a PCBA e a bateria solar**

Dobrando a placa de PVC e fixando a PCBA com um encaixe.
...
Como mencionamos antes, o gabinete é usado para transportar a Arch GPRS V3 para testes ambientais e coleta de dados.

Sensores da série Grove podem ser facilmente montados na placa de PVC por rebite.

![enter image description here](https://files.seeedstudio.com/wiki/Seeeduino_Stalker_v3_enclosure/img/IMG_0764.JPG)

**O gabinete Stalker carrega a Arch GPRS em ambiente externo**.
...
**Se você montar o bloco de ferro, pode jogá-lo na água, a bateria solar ficará sempre para cima**.
...
<tr>
<th scope="row">Gabinete Stalker</th>
<td>90 de diâmetro 9,25 de altura</td>
<td>1</td>
</tr>
<tr>
<th scope="row">Peça de montagem em PVC</th>
<td>Tamanho 200*63mm</td>
<td>1</td>
</tr>
<tr>
<th scope="row">Peça separadora de bateria</th>
<td>Tamanho 71,8*60mm</td>
<td>1</td>
</tr>
<tr>
...
<tr>
<th scope="row">Esponja de amortecimento</th>
<td>Tamanho 70*55*8mm</td>
<td>1</td>
</tr>
</table>
