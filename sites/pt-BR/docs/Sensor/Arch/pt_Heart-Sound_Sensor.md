---
description: Sensor de Som Cardíaco
title: Sensor de Som Cardíaco
keywords:
  - Arch
...
url: https://wiki.seeedstudio.com/pt-br/Heart-Sound_Sensor/
---


O Arch Max é uma placa de desenvolvimento compatível com mbed para prototipagem rápida.
Ela é baseada em um microcontrolador STM32F407VET6 com núcleo ARM Cortex-M4F rodando a 168MHz. Inclui um open link para fornecer depuração SWD, programação por arrastar-e-soltar e comunicação serial USB.
...
*   STM32F407VET6 de alto desempenho
    ...
    *   MCU ARM Cortex-M4 com FPU a 168MHz

        *   512 KB de Flash, 192 KB de RAM

*   Open link on-board para depuração e programação
...
*   Fator de forma Arduino, compatível com vários shields
...
3.  Clique no ícone **Compile** da barra de ferramentas superior para compilar o programa, depois baixe o arquivo hex compilado.

4.  Arraste e solte o arquivo bin baixado no disco MBED

Você pode abrir o **main.cpp** para alterar o programa. Por exemplo, use o código a seguir para piscar o LED a cada 0,1s
...
Para habilitar a depuração SWD ou obter mensagens de depuração por meio da serial virtual USB, instale [o driver do mbed](https://developer.mbed.org/handbook/Windows-serial-configuration).

##   Atualizar ou restaurar o firmware

A versão mais recente de firmware para o Arch Max é a v0203, compilada em 8 de outubro de 2014. Para verificar a versão e a data de compilação do seu firmware, abra o arquivo MBED.HTM do seu disco MBED em um editor de texto.
...
*   Mantenha o botão do Arch Max pressionado e ligue-o
...
<td>Arch Max v1.0</td>
<td>v1.0</td>
<td>O fornecimento de energia de 5V não estava conectado à alimentação USB, o usuário deve conectar à alimentação externa</td>
</tr>
<tr>
<td>Arch Max v1.1</td>
<td>v1.1</td>
<td>O fornecimento de energia de 5V pode se conectar à alimentação USB</td>
</tr>
</tbody>
</table>
...
- **[Eagle]**  [Arquivo Eagle de esquemático para ARCH Max](https://files.seeedstudio.com/wiki/Arch_Max/res/ARCH_Max.zip)
- **[PDF]**[PCB do Arch Max](https://files.seeedstudio.com/wiki/Arch_Max/res/Arch%20Max.pdf)
