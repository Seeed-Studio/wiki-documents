---
title: Grove - LED RGB Encadeável
nointro: null
keywords:
  - docs
  - docusaurus
image: https://wiki.seeedstudio.com/pt-br/Grove-Chainable_RGB_LED/
...
url: https://wiki.seeedstudio.com/pt-br/Grove-Chainable_RGB_LED/
---
...
|----------|-----------------------------------------------------------|--------------|--------------|
| v1    | Versão pública inicial (beta)                             | 5 de maio de 2011  |[![](https://files.seeedstudio.com/wiki/Seeed-WiKi/docs/images/get_one_now_small.png)](https://www.seeedstudio.com/Grove-Chainable-RGB-LED-p-850.html)|
| v2    | Substitui P9813S16 por P9813S14 e muda o conector Grove de vertical para horizontal | 19 de abril de 2016  |[![](https://files.seeedstudio.com/wiki/Seeed-WiKi/docs/images/get_one_now_small.png)](https://www.seeedstudio.com/Grove-%E2%80%93-Chainable-RGB-Led-V2.0-p-2903.html)|
...
- Baixe a [Chainable LED Library](https://github.com/pjpmarques/ChainableLED) e instale-a na Biblioteca do Arduino. Há um tutorial sobre [como instalar a Biblioteca do Arduino](/pt-br/How_to_install_Arduino_Library) na página wiki.
...
**Aplicação estendida:**
Com base na [Chainable LED Library](https://github.com/pjpmarques/ChainableLED), nós projetamos este demo: a cor RGB varia com a temperatura medida pelo Grove - temperature. A cor RGB varia de verde para vermelho quando a temperatura vai de 25 a 32. O código de teste é mostrado abaixo. Experimente se você estiver interessado.
...
2.Você deve ter concluído a configuração do ambiente de desenvolvimento, caso contrário siga por [aqui](/pt-br/GrovePi_Plus).
...
Se esta é a sua primeira vez usando o Cloud9 IDE, siga este [**link**](/pt-br/BeagleBone_Green).

**Passo1:** Configure o soquete Grove - UART como um soquete Grove - GPIO, apenas siga este [**link**](https://www.seeedstudio.com/recipe/362-how-to-use-the-grove-uart-port-as-a-gpio-on-bbg.html).
...
- **[Library]**[Biblioteca Chainable RGB LED para o P9813](https://github.com/pjpmarques/ChainableLED)
- **[Library]**[Repositório Github para a Biblioteca Chainable RGB LED (novo)](https://github.com/Seeed-Studio/Grove_Chainable_RGB_LED)
- **[Library]** [Código CodeCraft](https://files.seeedstudio.com/wiki/Grove-Chainable_RGB_LED/res/Chainable%20RGB%20LED.zip)
- **[Eagle]**[Arquivo eagle do Chainable RGB LED V1](https://files.seeedstudio.com/wiki/Grove-Chainable_RGB_LED/res/Chainable_RGB_LED_eagle_file%20V1.zip)
- **[Eagle]**[Arquivo eagle do Chainable RGB LED V2](https://files.seeedstudio.com/wiki/Grove-Chainable_RGB_LED/res/Grove%20-%20Chainable%20RGB%20LED%20v2.0.zip)
