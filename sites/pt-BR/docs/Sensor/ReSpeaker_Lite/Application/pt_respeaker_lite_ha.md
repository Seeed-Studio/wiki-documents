...
Baixe o firmware como repositório completo a partir [daqui](https://github.com/formatBCE/Respeaker-Lite-ESPHome-integration).
...
se você estiver usando uma máquina host Linux 

```bash
sudo apt install dfu-util -y
sudo dfu-util -R -e -a 1 -D /path/to/dfu_firmware.bin
```
se você estiver usando uma máquina host Windows
...
**Como adicionar um dispositivo em ilustração GIF**
...
**Compilando arquivo YAML : Ilustração em GIF**
...
Conecte a porta USB Type-C da placa ESP32-S3 ao seu PC usando um cabo USB Type-C.
...
Gostaríamos de agradecer ao FormatBCE por criar este incrível arquivo YAML para o Seeed Studio reSpeaker Lite. Apoie-o no seu [Github](https://github.com/formatBCE/Respeaker-Lite-ESPHome-integration)
