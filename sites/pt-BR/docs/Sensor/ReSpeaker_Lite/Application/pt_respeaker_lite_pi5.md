---
description: LLM - integrado com Raspberry Pi5
...
Consulte a [documentação de primeiros passos](https://www.raspberrypi.com/documentation/computers/getting-started.html#getting-started-with-your-raspberry-pi) para configurar primeiro o seu Raspberry Pi e conectar o seu Pi à rede.


:::note
Certifique-se de que a sua versão do python é mais recente que python3.7.1.<br/>
