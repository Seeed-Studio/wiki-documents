---
description: Seeed Studio XIAO RP2350 com PlatformIO
title: XIAO RP2350 com PlatformIO
keywords:
  - xiao
...
Como a plataforma já possui opções de placa de desenvolvimento XIAO ESP32S3 e XIAO ESP32C3, podemos escolher uma delas para criar nossos arquivos. Claro, outros arquivos também servem, não há problema. O nome do projeto também pode ser escolhido livremente.
...
:::tip
Antes disso, eu já tinha instalado o pacote de instalação do XIAO RP2350, então você pode ver que a imagem na operação dois tem a opção para XIAO RP2350, mas você não a terá quando realizar a operação.
:::

### Etapa 3. Modifique o arquivo platformio.ini

Quando você criar o arquivo do PlatformIO com sucesso, muitos arquivos aparecerão na coluna à esquerda. Podemos ver um arquivo chamado platform.ini. Em seguida, precisamos substituir o conteúdo dentro dele.
...
Por fim, se você vir o mesmo resultado que na imagem acima, isso significa que você adicionou com sucesso a Placa de Desenvolvimento XIAO RP2350. Quando criar um projeto novamente, você verá a opção XIAO RP2350 disponível.
