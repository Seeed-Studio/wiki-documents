---
description: Primeiros passos com a Série Seeed Studio XIAO nRF52840
title: Primeiros passos com a Série Seeed Studio XIAO nRF52840
keywords:
  - xiao
...
- Ambas as bibliotecas oferecem um ótimo suporte quando se trata do uso básico, como **LED, Digital, Analógico, Serial, I2C, SPI**.
...
1. Se você usar o pacote onboard de Seeed nRF52 Boards, a função Serial pode não compilar. A solução é adicionar a linha `#include <Adafruit_TinyUSB.h>` no seu código. Você pode baixar esse pacote em: https://github.com/adafruit/Adafruit_TinyUSB_Arduino
...
Vá até **File > Preferences** e preencha **"Additional Boards Manager URLs"** com a URL abaixo:
...
**Se você quiser saber mais informações detalhadas sobre este exemplo, clique [Aqui](https://forum.seeedstudio.com/t/xiao-sense-accelerometer-examples-and-low-power/270801)**
...
- **Passo 4.** Arraste o arquivo bin ou [arquivo hex](https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed_XIAO_nRF52840_Sense_bootloader-0.6.1_s140_7.3.0.hex) para o software. Em seguida, pressione F4 e F5 nessa ordem. A regravação estará concluída.
...
- **📄[Schematic]** [Esquemático do XIAO nRF52840](https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed_Studio_XIAO_nRF52840_PDF.pdf )
- **🗃️[Arquivos de Projeto de PCB]** 
  - [Projeto KiCad do XIAO nRF52840](https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed-Studio-XIAO-nRF52840V1.1-KiCad-Project-260105.zip )
...
- **📄[Datasheet]** [Datasheet do Mic MSM261D3526H1CPM](https://files.seeedstudio.com/wiki/XIAO-BLE/mic-MSM261D3526H1CPM-ENG.pdf )
...
- **🗃️[Arquivos de Projeto de PCB]** 
  ...
  - [Projeto KiCad da Base XIAO Plus (com pad inferior exposto)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_Plus_Base_with_botton_pad_lead_out_V1.0.zip )
  - [Projeto KiCad da Base XIAO Plus (sem pad inferior exposto)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_Plus_Base_without_botton_pad_lead_out_V1.0.zip )
- **🗃️[Bibliotecas de Projeto de PCB]** 
  - [Footprints KiCad da Série XIAO](https://files.seeedstudio.com/wiki/XIAO-KiCad-Library/XIAO_Series_Footprints.zip )
  - [Símbolos SCH KiCad da Série XIAO](https://files.seeedstudio.com/wiki/XIAO-KiCad-Library/XIAO_Series_SCH_Symbols.zip )
