---
description: Este artigo descreve como usar a QSPI Flash no XIAO nRF52840 Sense.
title: A QSPI Flash para XIAO nRF52840 Sense
keywords:
  - QSPI Flash
...
# Uso da QSPI Flash no Seeed Studio XIAO nRF52840 Sense

:::tip
Agradecimentos especiais aos usuários da comunidade **JM_Laird** e **Haakonish** pelo apoio e ajuda com este tutorial! O programa usado neste artigo foi obtido do usuário do Github **PMCheetham** e o código‑fonte pode ser encontrado **[AQUI](https://github.com/PMCheetham/SEEED_nRF52840_QSPI/tree/main)**.
:::

Bem-vindo a este tutorial sobre o uso da QSPI Flash no XIAO nRF52840 e XIAO nRF52840 Sense! O XIAO é uma placa poderosa e compacta que possui 256 KB de RAM, 1 MB de Flash e 2 MB de Flash onboard. Neste tutorial, você aprenderá como utilizar a QSPI Flash nas placas XIAO, o que pode ampliar muito a capacidade de armazenamento e acelerar seus projetos. Vamos começar!

A seguir está um programa de exemplo fornecido por PMCheetham que funciona bem com o XIAO nRF52840 Sense. Com o programa a seguir você pode usar livremente a QSPI Flash no XIAO.
...
O programa está disponível apenas para placas **mbed**, portanto selecione a XIAO nRF52840 na aba mbed ao compilar e enviar.
