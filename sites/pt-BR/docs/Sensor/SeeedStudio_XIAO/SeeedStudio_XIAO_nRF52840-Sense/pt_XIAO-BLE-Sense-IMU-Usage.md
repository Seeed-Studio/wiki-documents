...
**Seeed Studio XIAO nRF52840 Sense** é equipado com uma **Unidade de Medição Inercial (IMU) de 6 eixos** de alta precisão, que inclui um **acelerômetro de 3 eixos** e um **giroscópio de 3 eixos**. Há também um **sensor de temperatura incorporado** neste módulo. Acreditamos que este módulo pode ajudar bastante em seus projetos de TinyML. Este wiki apresentará o básico de como usar esta IMU nesta placa.

**Nota**

- **Seeed Studio XIAO nRF52840** não é equipado com este módulo IMU.
- A função de IMU terá um desempenho melhor quando usamos a "Seeed nrf52 mbed-enabled Boards Library", portanto recomendamos fortemente isso.
...
## Ver dados do acelerômetro, giroscópio e temperatura no monitor serial
...
- **Passo 2**. Abra a Arduino IDE, navegue para `Sketch > Include Library > Add .ZIP Library...` e abra o arquivo zip baixado.

<p style={{textAlign: 'center'}}><img src="https://files.seeedstudio.com/wiki/XIAO-BLE/add-zip.png" alt="pir" width={600} height="auto" /></p>


- **Passo 3.** Navegue para `File > Examples > Accelerometer And Gyroscope LSM6DS3 > HighLevelExample` para abrir o **HighLevelExample**
...
**Nota:** Assim que você fizer o upload dos códigos, eles não serão executados automaticamente até que você clique em **Serial Monitor** no canto superior direito da janela do Arduino.
...
Se você quiser testar mais exemplos, pode navegar para `File > Examples > Accelerometer And Gyroscope LSM6DS3` e conferir todos os exemplos em **Accelerometer And Gyroscope LSM6DS3**