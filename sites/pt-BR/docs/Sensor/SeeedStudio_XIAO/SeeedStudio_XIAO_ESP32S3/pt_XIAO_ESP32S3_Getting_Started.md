...
- O conector B2B do XIAO ESP32-S3 Plus é compatível com a [placa de extensão Wio-SX1262](https://www.seeedstudio.com/Wio-SX1262-with-XIAO-ESP32S3-p-5982.html), mas não com a placa de sensor de câmera plugável.
:::
...
<!-- :::tip
Agora enviamos uma solicitação de mesclagem para o ESP32 e poderemos pesquisar e usar o XIAO ESP32-S3 na Arduino IDE quando o ESP32 lançar a próxima versão da atualização do pacote onboard.
...
- **📄[Modelo 3D]** [Modelo 3D de impressão 3D do XIAO ESP32-S3 Sense – Caixa roxa (Superior)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO-ESP32S3-Sense-housing-design(top).stp )
- **📄[Modelo 3D]** [Modelo 3D de impressão 3D do XIAO ESP32-S3 Sense – Caixa roxa (Inferior)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO-ESP32S3-Sense-housing-design(bottom).stp )
...
- **🗃️[Arquivos de projeto da PCB]** 
  ...
  - [Projeto KiCad da base XIAO Plus (com pads inferiores expostos)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_Plus_Base_with_botton_pad_lead_out_V1.0.zip )
  - [Projeto KiCad da base XIAO Plus (sem pads inferiores expostos)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_Plus_Base_without_botton_pad_lead_out_V1.0.zip )
- **🗃️[Bibliotecas de projeto da PCB]** 
  - [Footprints KiCad da Série XIAO](https://files.seeedstudio.com/wiki/XIAO-KiCad-Library/New_XIAO_Series_Footprints.zip )
  - [Símbolos SCH KiCad da Série XIAO](https://files.seeedstudio.com/wiki/XIAO-KiCad-Library/XIAO_Series_SCH_Symbols.zip )
...
- **[STP]** [XIAO ESP32-S3 Sense design da carcaça (parte superior)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO-ESP32S3-Sense-housing-design(top).stp)
- **[STP]** [XIAO ESP32-S3 Sense design da carcaça (parte inferior)](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO-ESP32S3-Sense-housing-design(bottom).stp)
