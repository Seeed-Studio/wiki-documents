...
Os sensores S210x são fabricados para suportar plano de frequência universal de 863MHz ~928MHz em um único SKU. Ou seja, cada dispositivo pode suportar 7 planos de frequência.
...
| --- | --- |
| Tempo de Aquecimento do Sensor | O tempo de aquecimento indica o tempo necessário para que o sensor atinja sua maior precisão ou nível de desempenho após a aplicação da alimentação. Inserimos **200(ms)** aqui. |
