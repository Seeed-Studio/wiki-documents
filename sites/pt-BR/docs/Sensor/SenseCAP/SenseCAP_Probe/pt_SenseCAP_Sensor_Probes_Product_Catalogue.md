...
title: Catálogo de Produtos SenseCAP Sensor Probes
keywords:
...
Entre os primeiros lançamentos da série de produtos IIoT da Seeed, o SenseCAP é focado em aplicações de detecção ambiental sem fio: agricultura inteligente, agricultura de precisão e cidades inteligentes, entre outras. Ele é composto por produtos de hardware (sensores, registradores de dados & gateways, etc.), serviços de software (SenseCAP Mate App, SenseCAP Web Portal, dashboard aberto) e API para gerenciamento de dispositivos & dados.

## Sobre as sondas de sensores

Nossa linha de sondas de sensores industriais SenseCAP é projetada para suportar ambientes hostis, como vibração e exposição a produtos químicos e gases, o que é comum em aplicações industriais, e nossa linha industrial de sensores é equipada com sérias classificações de IP de IP66 a IP68 para garantir que os produtos tenham um bom desempenho em seus respectivos ambientes severos.
As sondas de sensores SenseCAP também apresentam conexões de processo para garantir um encaixe seguro no meio sendo medido, juntamente com transmissores de dados de sensores que convertem o sinal para se adequar a sistemas de instrumentação industrial.
Alguns dos Sensores Industriais MODBUS RS485 vêm em duas versões. A principal diferença é o conector do cabo. Escolha a versão que melhor se adapta às suas necessidades:
（1） A versão com fios de ligação é recomendada para uso com o [SenseCAP LoRaWAN® Data Logger](https://www.seeedstudio.com/SenseCAP-S2100-LoRaWAN-Data-Logger-p-5361.html?queryID=82d7de6ca64b8316686bdfe2c05664d2&objectID=5361&indexName=bazaar_retailer_products) para conectar à rede LoRaWAN®, aproveitando os benefícios de comunicação de baixo consumo e longo alcance.
（2）A versão com conector de aviação já pré-configurou o [SenseCAP Sensor Hub 4G Data Logger](https://www.seeedstudio.com/SenseCAP-Sensor-Hub-4G-Data-Logger-with-builtin-battery-p-4852.html?queryID=b8ef1fa7e141765c30033fc3d8eddf10&objectID=4852&indexName=bazaar_retailer_products) com experiência plug-and-play para coletar vários dados de sensores via 3G/4G LTE.
...
# Sensor de NH3 MODBUS RS485 de Grau Industrial - com Conector de Aviação à Prova d'Água
...
[1] O tempo desde que o sensor é ligado até quando os dados são lidos. Observe este parâmetro quando o sensor for ligado.

[2] Se iniciado em um ambiente com ar limpo, requer menos tempo

[3] O intervalo de atualização dos dados de medição; após o tempo de aquecimento na energização, se a alimentação continuar, o sensor atualiza periodicamente a leitura nesse intervalo.

[4] T90＜30s

## Sensor de H2S MODBUS RS485 de Grau Industrial - com Conector de Aviação à Prova d'Água
...
## Sensor de CO2, Temperatura e Umidade SenseCAP com RS485 & SDI-12, com Conector de Aviação à Prova d'Água
...
[1] O tempo de preparação necessário para que o sensor seja ligado e esteja pronto para ler valores medidos por meio de instruções Modbus deve ser observado quando o sensor for ligado e desligado a cada leitura.

[2] O tempo de aquecimento = (valor do registrador 0x0021 + 3); ler o registrador 0x0000 antes do tempo de aquecimento resultará em 0, e a leitura será atualizada a cada segundo após o tempo de aquecimento; o sensor tem um tempo T90 de 300 segundos e um tempo T60 de 120 segundos.

[3] O intervalo de atualização dos dados de medição; após o tempo de aquecimento na energização, se continuamente alimentado, o sensor atualiza periodicamente a leitura nesse intervalo.

[4] Frequência de consulta do mestre Modbus.

[5] O tempo necessário para o sensor responder após receber a instrução de leitura, depois que o registrador de atraso de resposta 0x0020 for definido como 0.

## Sensor Industrial de Temperatura e Umidade do Ar MODBUS RS485
...
## Sensor Industrial de Umidade do Solo & Temperatura MODBUS-RTU RS485, Tensão Analógica 0-2V (S-Soil MT-02A)

Com fios de ligação [101990668](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-Sensor-S-Soil-MT-02-p-4634.html?queryID=d56c42134f064eaf1203b9292aaba7c8&objectID=4634&indexName=bazaar_retailer_products) 

Com conector de aviação [314990620](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-Sensor-S-Soil-MT-02B-p-4859.html)
...
## Sensor Industrial de Umidade do Solo & Temperatura & EC MODBUS-RTU RS485 (S-Soil MTEC-02A)

Com fios de ligação [101990667](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-EC-Sensor-S-Soil-MTEC-02-p-4633.html) 

Com conector de aviação [314990621](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-EC-Sensor-S-Soil-MTEC-02B-p-4860.html?queryID=ec8fbdf14c91f77c70bd5e0177bb9620&objectID=4860&indexName=bazaar_retailer_products)
...
## Sensor Industrial de Intensidade de Luz, MODBUS-RTU RS485 & 0-2V (S-Light-01)

Com fios de ligação [314990739](https://www.seeedstudio.com/light-intensity-sensor-p-a-4863.html?queryID=f94dd76cedb45ec9d57e70d6e82af574&objectID=4863&indexName=bazaar_retailer_products)

Com conector de aviação  [314990740](https://www.seeedstudio.com/light-intensity-sensor-p-b-4863.html)
...
## Sensor Industrial de PAR (S-PAR-02A), MODBUS-RTU RS485

Com fios de ligação [314990733](https://www.seeedstudio.com/RS485-S-PAR-02A-p-4829.html)

Com conector de aviação  [314990735](https://www.seeedstudio.com/RS485-S-PAR-02B-p-4830.html)
...
## Sensor Industrial de PAR (PAR-2.5V), com Suporte a Saída Analógica 0~2.5V
...
## Sensor Industrial de Radiação Solar Total (S-ZFS-02A), MODBUS-RTU RS485
...
## Sensor Industrial de Radiação UV (S-ZW-01A), MODBUS-RTU RS485
...
## Sensor Industrial de Umidade Foliar e Temperatura (A), MODBUS-RTU RS485

Com fios de conexão [314990737](https://www.seeedstudio.com/leaf-wetness-sensor-p-a-4861.html)

Com conector de aviação  [314990738](https://www.seeedstudio.com/leaf-wetness-sensor-p-b-4861.html)
...
## Sensor de Nível de Líquido para Monitoramento de Nível de Água, Nível de Óleo e Nível de Líquidos Levemente Corrosivos
...
## Sensor Industrial de Nível de Líquido MODBUS RS485 com Conector de Aviação
...
## Sensor Industrial de pH MODBUS-RTU RS485 e Tensão Analógica 0~2V (S-pH-01A) V2.0

Com fios de conexão  [101990666](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01A-p-4632.html)

Com conector de aviação [314990622](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01B-p-4632.html)
...
## Sensor Industrial de EC e TDS MODBUS-RTU RS485 e Tensão Analógica 0-2V

Com fios de conexão [314990634](https://www.seeedstudio.com/EC-RS485-p-4848.html)

Com conector de aviação  [314990742](https://www.seeedstudio.com/EC-&-TDS-Sensor-RS485-b-p-4865.html)
...
## Sensor de Oxigênio Dissolvido RS485 MODBUS, Medidor DO por Fluorescência
...
## Sensor de Nível Ultrassônico RS485 500cm
...
## Pluviômetro Óptico Grau Industrial RG-15 Sensor de Chuva
...
## Detector de Vazamento de Água Grau Industrial IP66 RS485
...
## Abrigo contra Radiação Solar para Proteção de Sensor Externo - A10
