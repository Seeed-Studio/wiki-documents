...
title: Conectar ao The Things Network
keywords:
...
url: https://wiki.seeedstudio.com/pt-br/sensecap_t2000_tracker_ttn/
---

# Conectar ao The Things Network
[The Things Network (TTN)](https://www.thethingsnetwork.org/) é uma plataforma global e de código aberto para IoT baseada em LoRaWAN®, que oferece conectividade sem fio de baixo consumo e longo alcance. Ela é suportada pelo [The Things Stack (TTS)](https://www.thethingsindustries.com/stack/), um servidor de rede LoRaWAN® que fornece gerenciamento seguro de dispositivos e roteamento de dados. Neste capítulo, vamos orientar os usuários a conectar o [SenseCAP T2000 Tracker](https://www.seeedstudio.com/SenseCAP-Asset-Tracker-T2000-C-p-6582.html) ao [The Things Network](https://www.thethingsnetwork.org/).


## Configuração do Dispositivo

Antes de conectar ao TTS, você precisa configurar os parâmetros básicos do seu dispositivo no aplicativo SenseCraft. Consulte o [Guia Rápido](https://wiki.seeedstudio.com/pt-br/Get_Started_with_SenseCAP_T2000_tracker/) para mais detalhes.

Defina a plataforma como The Things Network e, em seguida, copie o Device EUI / AppEUI / AppKey. Depois, adicione os dispositivos manualmente no The Things Stack.
...
O The Things Stack (TTS) é um servidor de rede LoRaWAN de nível empresarial, construído sobre um núcleo de código aberto. O The Things Stack permite que você crie e gerencie redes LoRaWAN em seu próprio hardware ou na nuvem.

Para começar, registre uma conta no [The Things Network](https://www.thethingsnetwork.org/).
...
Navegue até a página Applications e clique em `Add application`.
...
Insira um Application ID e um Application name, clique em `Create application` para salvar suas alterações.
...
Depois que a aplicação for criada, clique em `Register end device`.
...
Existem duas maneiras de registrar um end device:
- Selecionar o end device no LoRaWAN Device Repository
- Inserir manualmente as especificações do end device

#### 1. Selecionar o end device no LoRaWAN Device Repository

Escolha `Select the end device in the LoRaWAN Device Repository`. <br />
Selecione `SenseCAP` e selecione o modelo `T2000 Tracker A/B/C`. <br />
Mantenha as versões de Software e Hardware como padrão e selecione o `Profile(Region)` correspondente de acordo com a configuração de banda do dispositivo.
...
Escolha um Frequency Plan apropriado. Seu dispositivo e gateway devem usar o mesmo frequency plan para se comunicar. <br />
Cole o Device EUI / AppEUI / AppKey do aplicativo SenseCraft e, em seguida, clique em `Register end device`.

:::note
O "JoinEUI" acima é similar ao "AppEUI".
:::
...
#### 2. Inserir manualmente as especificações do end device

Como alternativa, você pode escolher `Enter end device specifics manually`. Consulte as informações abaixo para garantir que os seguintes dados sejam inseridos corretamente.
...
Escolha um Frequency Plan apropriado. Seu dispositivo e gateway devem usar o mesmo frequency plan para se comunicar.

:::info
Selecione os campos LoRaWAN Version e Regional Parameters version para o seu dispositivo específico. <br />
...
Em seguida, faça o upload do Payload Formatter.

Navegue até a página Payload Formatters e escolha `Custom Javascript Formatter`.
Preencha o código do Formatter com o decoder abaixo e salve as alterações:
...
Quando o dispositivo tentar se conectar à rede, a luz verde de respiração piscará. Se o dispositivo ingressar na rede com sucesso, a luz verde piscará rapidamente 5 vezes.

Você pode verificar a atividade do dispositivo na página de visão geral da Aplicação. 
...
Clique no dispositivo final e, em seguida, verifique os `Live data`.
Quando você vir a mensagem abaixo, seu dispositivo terá ingressado na rede com sucesso.
...
Em seguida, você pode verificar os dados no console TTS.
...
[SenseCAP T2000 Tracker Decoder for TTN](https://github.com/Seeed-Solution/SenseCAP-Decoder/tree/main/T2000/TTN)
