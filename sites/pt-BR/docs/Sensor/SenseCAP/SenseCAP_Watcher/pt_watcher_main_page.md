...
# Centro Wiki do SenseCAP Watcher
...
### [Guia de início rápido](https://wiki.seeedstudio.com/pt-br/getting_started_with_watcher/)
...
##### [Integração com Node-RED](https://wiki.seeedstudio.com/pt-br/notification_with_watcher/)

- [Watcher para Node-RED](https://wiki.seeedstudio.com/pt-br/watcher_to_node_red/)

- [Watcher e Node-RED para IFTTT](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_ifttt/)

- [Watcher e Node-RED para Kafka](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_kafka/)

- [Watcher e Node-RED para Open Interpreter](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_open_interpreter/)

- [Watcher e Node-RED para P5JS](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_p5js/)

- [Watcher e Node-RED para Telegram](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_telegram/)

- [Watcher e Node-RED para Twilio](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_twilio/)

- [Watcher e Node-RED para Discord](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_discord/)

- [Watcher e Node-RED para MongoDB](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_mongodb/)

- [Watcher e Node-RED para WhatsApp](https://wiki.seeedstudio.com/pt-br/watcher_node_red_to_whatsapp/)
