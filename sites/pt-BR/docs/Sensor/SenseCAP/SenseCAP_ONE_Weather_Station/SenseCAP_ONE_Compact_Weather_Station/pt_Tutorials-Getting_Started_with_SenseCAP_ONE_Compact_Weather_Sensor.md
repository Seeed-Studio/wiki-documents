---
description: Introdução ao SenseCAP ONE Compact Weather Sensor
title: Introdução ao SenseCAP ONE Compact Weather Sensor
keywords:
  - SenseCAP
...
Recomenda-se que o diâmetro do poste seja menor ou igual a 75cm.
...
1. Selecione o protocolo de comunicação. No exemplo aqui, escolhemos o RS-485 Modbus RTU.
...
7. Quando a atualização estiver concluída, pressione o botão Reset novamente e, em seguida, clique em `"OK"` na tela.
...
2. Slave responde 01 04 04 00 00 6E 8C D6 41
...
2. Slave responde 01 04 04 FF FF FC 18 D6 41
...
Retorno:2B 04 04 00 0C EC 98 （CO2） FD 2F （Check code）；
...
Em seguida, envie "comando de leitura do valor medido 0D0!" para obter os 6 valores medidos desta medição, que são direção mínima do vento 345,9 graus, direção máxima do vento 347,5 graus, direção média do vento 346,3 graus, velocidade mínima do vento 2,8m/s, velocidade máxima do vento 2,8m/s, velocidade média do vento 2,8m/s.
