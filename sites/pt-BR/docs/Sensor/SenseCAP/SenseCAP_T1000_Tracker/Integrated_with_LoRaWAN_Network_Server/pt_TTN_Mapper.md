...
title: Configuração do TTN Mapper
keywords:
  - Tracker
  - TTN
...
url: https://wiki.seeedstudio.com/pt-br/ttn_mapper_for_SenseCAP_T1000/
---

[TTN Mapper](https://ttnmapper.org/) é uma ferramenta conveniente usada para mapear a cobertura de rede de gateways conectados ao The Things Stack. Consulte o [site de documentação oficial do TTN Mapper](https://docs.ttnmapper.org/) para mais detalhes.

Este tutorial irá orientar os usuários a adicionar o [SenseCAP T1000 Tracker](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-A-p-5697.html) ao TTN Mapper.

Para explorar as próximas etapas, consulte [Connect to The Things Network](https://wiki.seeedstudio.com/pt-br/SenseCAP_T1000_tracker_TTN/) para registrar primeiro o seu dispositivo.

### Configurar os formatadores de Payload

Crie um `Custom JavaScript formatter` e copie o código a seguir.
...
<summary>Decodificador para TTN Mapper</summary>
...
### Adicionar modelo de Webhook

Navegue até `Integrations` -> `Webhooks`, depois selecione `TTN Mapper`.
...
Dê um nome à sua integração preenchendo o campo Webhook ID.

Preencha o campo Email address com um e-mail válido, necessário para que seus dados sejam aceitos pelo TTN Mapper. Todos os dados enviados pelo seu dispositivo final serão associados a este endereço de e-mail e isso fornecerá algumas garantias sobre a qualidade dos dados.

Para saber mais sobre experimentos, leia a seção Experiments aqui.

Conclua clicando no botão `Create TTN Mapper webhook`.
...
### Observar a Cobertura da Rede

Navegue até [TTN Mapper](https://ttnmapper.org/) e selecione `Advanced Maps` no menu superior.

Na seção `Device data`, preencha o campo `Device ID` com o ID do dispositivo do The Things Stack. <br/>
Escolha hoje como `Start Date` e `End Date`. <br/>
Clique no botão `View Map` para ver os pontos de dados vindos dos dados uplink do seu dispositivo final.
