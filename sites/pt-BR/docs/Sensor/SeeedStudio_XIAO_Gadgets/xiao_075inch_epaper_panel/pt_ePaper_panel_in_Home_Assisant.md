---
description: O Display E Ink® de 7,5 polegadas alimentado pelo XIAO ESP32C3 é uma solução compacta e eficiente em energia para exibir dados do Home Assistant.
title: Funciona com ESPHome no Home Assistant
keywords:
  - display ePaper
  - ESPHome
  - Home Assistant
...
:::tip
Se o seu Home Assistant Host (Raspberry PI/Green/Yellow etc.) estiver por perto, recomendamos usar este método, pois ele é mais simples.
:::
...
Espere um momento e você verá um retorno como na imagem a seguir. Isso significa que o código está sendo executado com sucesso.
...
:::tip
Este é o modo mais simples, mas com a condição de que, ao instalar o programa pela primeira vez, você deve primeiro enviar o programa para o Painel de ePaper usando o método à esquerda. Depois disso, você pode enviá-lo via Wi-Fi. Além disso, certifique-se de que sua configuração YAML inclua seções `ota` e `api` devidamente configuradas com chaves de criptografia válidas para que este método funcione.
:::

Dessa forma, você não precisa conectar o painel de ePaper a nada, apenas certifique-se de que ele esteja online.

Clique na opção e então o firmware será instalado automaticamente no painel de ePaper.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/xiao_075inch_epaper_panel/72.png" style={{width:500, height:'auto'}}/></div>

Espere um momento e você verá um retorno como na imagem a seguir. Se falhar, pode ser devido a um sinal fraco. Por favor, aproxime o dispositivo do seu roteador. [Encontrou um problema? Clique aqui.](#Q5)
...
E <span id="ttf">então</span>, crie uma nova pasta chamada **fonts** e faça o download deste arquivo e **coloque-o na pasta fonts**.
...
Primeiro, você precisa instalar um Add-on de screenshot, o **Puppet**, [clique aqui para instalar.](https://github.com/balloob/home-assistant-addons/tree/main/puppet)
...
:::tip
Durante o modo de sono profundo, você não pode enviar código para o dispositivo diretamente. Você precisa entrar no modo de download. [Clique aqui para pular para a Q3.](#port)
:::
...
:::tip
Antes de copiar o código, por favor coloque [wifi.jpg](#image), [arquivo ttf de ícone e arquivo ttf de fonte](#ttf) na pasta **image** e na pasta **fonts**.
:::
...
#### <span id="Q6">P6</span>: Falha ao enviar o programa por Wi-Fi?
