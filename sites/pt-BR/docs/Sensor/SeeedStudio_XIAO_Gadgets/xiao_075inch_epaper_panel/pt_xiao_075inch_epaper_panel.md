...
title: Primeiros Passos com o Painel ePaper XIAO 7,5"
...
Alimentado pelo XIAO ESP32-C3, este display ePaper de 7,5 polegadas é uma tela E Ink® inteligente versátil e energeticamente eficiente que oferece suporte a uma ampla variedade de aplicações populares da comunidade, incluindo [Home Assistant](https://www.home-assistant.io/), [TRMNL](https://trmnl.app/), Arduino e mais. Esta solução de display flexível é perfeita para exibir dados de dashboards, atualizações de clima, agendas e informações personalizadas. Com visuais nítidos, excepcional duração de bateria de 3 meses (2000mAh) em modo de sono profundo e amplas possibilidades de customização, este dispositivo compacto se adapta a diversos casos de uso. Perfeito para ambientes de vida modernos e cenários de projetos, ele combina funcionalidade com design elegante para uma experiência visual aprimorada em múltiplas plataformas.
...
- Suporte ao desenvolvimento em Arduino
...
O Painel ePaper XIAO 7,5" é composto por vários componentes principais, como mostrado na vista explodida:
...
- **Placa controladora de ePaper**: controla o display e lida com a comunicação com o microcontrolador
...
- **Gabinete**: case impresso em 3D em PLA que aloja todos os componentes

O dispositivo utiliza um design interno em camadas que posiciona o display ePaper na frente, com a placa controladora, bateria e XIAO ESP32-C3 empilhados atrás dele dentro do gabinete.
...
2. **Ligue**: Com o display voltado para você, localize a chave liga/desliga no canto inferior esquerdo. Deslize-a para a posição "ON" (o rótulo ON está escondido atrás do suporte, ao seu lado direito quando estiver de frente para o display).
...
Após concluir essas etapas, seu Painel ePaper estará pronto para configuração e uso com sua plataforma de programação preferida.

### Botões de Programação

O Painel ePaper XIAO 7,5" inclui dois botões essenciais localizados atrás do suporte que auxiliam na programação e na solução de problemas:

- **Botão Boot**: Usado quando o dispositivo não tem conexão serial ou está em modo de sono e não é possível enviar programas. Para entrar no modo Bootloader:
  ...
  4. Solte o Reset, depois solte o Boot
  5. Desconecte e reconecte o cabo de alimentação

- **Botão Reset**: Usado para reiniciar o programa. Basta pressionar uma vez para resetar.

Esses botões são fundamentais para a programação do dispositivo, atualização de firmware e recuperação quando o dispositivo se torna não responsivo.
...
- [**Funciona com ESPHome no Home Assistant**](https://wiki.seeedstudio.com/pt-br/xiao_075inch_epaper_panel_esphome) - Configure e controle seu Painel ePaper por meio da integração ESPHome, ideal para usuários do Home Assistant criarem dashboards personalizados.
