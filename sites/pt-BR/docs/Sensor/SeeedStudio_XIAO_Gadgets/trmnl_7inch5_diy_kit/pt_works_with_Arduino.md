---
description: Este artigo descreve como usar o Kit DIY TRMNL 7.5inch(OG) com Arduino.
...
:::
Imprima as partes de gabinete open-source a partir da [Resource part](#Resources-Part) e monte os componentes no interior.  
...
Vamos explorar um simples exemplo de relógio analógico que demonstra como desenhar gráficos no display ePaper. [Este exemplo](https://github.com/Seeed-Studio/Seeed_GFX/blob/master/examples/ePaper/Basic/Clock/Clock.ino) cria um mostrador de relógio clássico com ponteiros de horas, minutos e segundos.
