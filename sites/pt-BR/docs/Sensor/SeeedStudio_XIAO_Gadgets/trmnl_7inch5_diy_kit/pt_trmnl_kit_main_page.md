...
title: Primeiros Passos com o TRMNL 7.5inch(OG) DIY Kit
...
- **Design Eficiente em Energia**: Bateria de 2000mAh fornece até 3 meses de operação em modo de sono profundo (intervalo de atualização de 6 horas)
- **Suporte a Ecossistema Duplo**: Compatível com Home Assistant (via ESPHome) e Arduino IDE para desenvolvimento personalizado
...
| Parâmetro | Descrição |
| --- | --- |
| MCU | Placa de Desenvolvimento XIAO ePaper Display com XIAO ESP32-S3 Plus integrado |
| Display | Display ePaper Monocromático de 7,5 polegadas |
| Resolução | 800x480 |
| Tensão de Operação | 5V |
| Bateria | Bateria Li-ion Recarregável de 2000mAh (3 meses de duração em modo de sono profundo) |
...
Alinhe o cabo FPC com o conector na Placa XIAO ePaper Display e, em seguida, prenda a trava para garantir uma conexão firme.  
...
Encaixe a tela na caixa e deixe o FPC sair.
...
Conecte o cabo de extensão FPC e monte toda a caixa.
...
:::tip
Se o seu kit TRMNL estiver longe do seu roteador, você pode mover a antena para fora da caixa. Isso trará um desempenho melhor.
:::
...
Obrigado por escolher nossos produtos! Oferecemos múltiplos canais de suporte:
