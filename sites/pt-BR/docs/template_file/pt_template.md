...
1. Faça o upload do código do primeiro passo para um determinado produto, e o efeito aparece
2. Faça o upload do código do segundo passo para um produto, e o efeito aparece
3. ...
...
### Código da tabela
Aqui estão incluídos hyperlinks, links de imagem, título da tabela
...
:::note
Algum **conteúdo** com _Markdown_ `syntax`. Confira [esta `api`](#).
:::
