...
const sidebars = {
  ptBRSidebar: [
          ...
          items: [
            {
              ...
              label: 'Display',
              items: [
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-1.2_inch_IPS_Display',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-4-Digit_Display',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-0.54_inch_Red_Dual_Alphanumeric_Display',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-0.54_inch_Red_Quad_Alphanumeric_Display',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-16x2_LCD_Series',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-LCD_RGB_Backlight',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED-Display-0.66-SSD1306_v1.0',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED_Display_0.96inch',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED-Display-0.96-SSD1315',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED-Yellow&Blue-Display-0.96-SSD1315_V1.0',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED_Display_1.12inch',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-OLED-Display-1.12-SH1107_V3.0',
                'Sensor/Grove/Grove_Accessories/Display/pt_I2C_LCD',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-Triple_Color_E-Ink_Display_2_13',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-Triple_Color_E-Ink_Display_1_54',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-Serial_LCD_V1.0',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-BlinkM',
                'Sensor/Grove/Grove_Accessories/Display/pt_Grove-Serial_Camera_Kit',
              ],
            },
            {
              type: 'category',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              type: 'category',
              label: 'Placa breakout ePaper para XIAO',
              items: [
                'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/ePaper_Breakout_Board_For_XIAO/pt_XIAO-eInk-Expansion-Board',
                'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/ePaper_Breakout_Board_For_XIAO/pt_ePaper_Breakout_Board_with_OEPL',
              ],
            },
            {
              type: 'category',
              label: 'Display redondo para XIAO',
              items: [
                'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/Round-display-for-XIAO/pt_SeeedStudio_Round_Display_for_XIAO',
                'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/Round-display-for-XIAO/pt_SeeedStudio_RoundDisplay_Usage',
                'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/Round-display-for-XIAO/pt_Draw_dials_with_Display_and_lvgl',
                {
                  type: 'category',
                  label: 'Aplicações',
                  items: [
                    'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/Round-display-for-XIAO/Application/pt_SeeedStudio_Round_Display_Christmas_ball',
                    'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/Round-display-for-XIAO/Application/pt_SeeedStudio_Round_Display_Animation_Workshop',
                  ],
                },
              ],
            },
            ...
            'Sensor/SeeedStudio_XIAO/SeeedStudio_XIAO_Expansion_board/pt_xiao_eink_expansion_board_v2',
          ...
          items: [
            {
              ...
              items: [
                ...
                // 'Sensor/ReSpeaker_Lite/XIAO_ESP32_S3/pt_respeaker_i2s_rgb', // commented out
                {
                  type: 'doc',
                  id: 'Sensor/ReSpeaker_Lite/XIAO_ESP32_S3/pt_respeaker_streams_generator',
                  label: 'Gerador de streams',
                },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              label: 'Display',
              items: [
                'Sensor/Beyond_Grove/Accessories/Display/pt_1-69inch_LCD_SPI_display',
                'Sensor/Beyond_Grove/Accessories/Display/pt_1-47inch_LCD_SPI_display',
                'Sensor/Beyond_Grove/Accessories/Display/pt_LCD_16-2_Characters-Green_Yellow_back_light',
                'Sensor/Beyond_Grove/Accessories/Display/pt_LCD_8-2_Characters-Blue_back_light',
              ],
            },
          ],
        },
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'Edge/Raspberry_Pi_Devices/Application/AIoT/UI_design/pt_reTerminal-build-UI-using-Qt-for-Python',
          ...
          items: [
            // Computer Vision
            {
              ...
              items: [
                ...
                'Edge/NVIDIA_Jetson/Application/Computer_Vision/pt_YOLOv26_Dual_USB_Camera_Image_Processing_System on_Jetson',
              ]
            },
            // Generative AI
            {
    ...
    {
      type: 'category',
      label: 'reTerminal Série E',
      collapsed: true,
      collapsible: true,
      link: {
        type: "doc",
        id: 'Edge/reTerminal_E10xx/pt_reterminal_e10xx_main_page',
      },
      items: [
        'Edge/reTerminal_E10xx/pt_getting_started_with_reterminal_e1001',
        'Edge/reTerminal_E10xx/pt_getting_started_with_reterminal_e1002',
        'Edge/reTerminal_E10xx/pt_getting_started_with_reterminal_e1003',
        'Edge/reTerminal_E10xx/pt_getting_started_with_reterminal_e1004',
        {
          type: 'category',
          label: 'Applications',
          items: [
    ...
    {
      type: 'category',
      label: 'reTerminal Série D',
      collapsed: true,
      collapsible: true,
      link: {
        type: "doc",
        id: 'Edge/reTerminal_D10xx/pt_reterminal_D10xx_main_page',
      },
      items: [
        {
          type: 'autogenerated',
