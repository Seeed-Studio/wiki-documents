...
reComputer AI Industrial R2000 系列由 Raspberry Pi CM5 和 Hailo-8 AI 加速器驱动，这款紧凑型边缘 AI 系统可提供 26 TOPS 的实时多通道视觉处理能力。凭借四核 Cortex-A76 CPU、最高 16GB 内存、64GB eMMC 和多功能接口，它可确保无缝集成到工业 AI 应用中。
...
请参考此[链接](https://wiki.seeedstudio.com/cn/r2000_series_getting_start/#更新-eeprom)。
...
将 pcie-fix.dtbo 复制到 /overlays 文件夹中，如下所示：
