...
<div class="table-center">
  <table border="1" cellspacing="0" cellpadding="6">
    ...
    <tbody>
      ...
      <tr>
        <td colspan="3"> 1 x USB-C 2.0（用于刷写 OS 与调试） </td>
      </tr>
      <tr>
        <td> RS485 </td>
...
reComputer Industrial R21xx 内置有源蜂鸣器，可用于报警和事件通知等多种用途。在 reComputer Industrial R21xx 的终端中输入：

```bash
cat /sys/kernel/debug/gpio
```

此命令将输出与 Buzzer_EN 对应的 GPIO 为 gpio627。

### RS485

reComputer Industrial R2100 系列设备包含 2 个 RS485 接口，采用 6 针 3.5mm 间距凤凰端子。
...
reComputer Industrial R21xx 系列设备包含 1 个 RS232 接口，采用 6 针 3.5mm 间距凤凰端子。
...
reComputer Industrial R2000 系列设备包含 4 个 DI 接口，采用 3 针 3.5mm 间距凤凰端子。
 单个 DI 的丝印为 "DI/G_DI"。
...
reComputer Industrial R2000 系列设备包含 4 个 DO 接口，采用 3 针 3.5mm 间距凤凰端子。
单个 DO 的丝印为 "DO/G_DO"。
**引脚定义**
端子引脚定义如下：
<div class="table-center">
...
reComputer Industrial R2100 系列设备包含 2 个 CAN FD 接口，采用 6 针 3.5mm 间距凤凰端子。
