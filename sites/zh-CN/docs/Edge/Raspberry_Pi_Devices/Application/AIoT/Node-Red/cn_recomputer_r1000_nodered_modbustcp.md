---
description: 学习如何在 reComputer R1000 上将 Modbus TCP 与 Node-RED 集成。本指南涵盖硬件设置、Modbus 设备配置以及创建 Node-RED 流程以实现高效的工业自动化和监控。
...
url: https://wiki.seeedstudio.com/cn/recomputer_r1000_node_red_modbus_tcp/
---
## 介绍
