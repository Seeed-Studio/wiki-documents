...
:::caution 固件更新提示
我们建议你在收到产品后尽快**[完成产品固件更新](#预备工作)**，以获得最佳使用体验。
:::
...
**步骤 2.** 在 “Please select the device type” 界面上，选择你的 reTerminal 型号（例如 **reTerminal E1001** 或 **reTerminal E1002**）。
...
通过 Gallery 功能，将你的 reTerminal E1001 打造成一款数字相框。上传你最喜欢的图片，平台会为电子纸显示屏进行优化。你可以创建带有自定义切换时间的幻灯片放映。
...
按照上一节所述将设备与 SenseCraft 平台配对后，你就可以开始创建第一个仪表盘了。关于每个功能的详细使用说明，请参考对应的 Wiki 页面：
...
**步骤 4.** 固定好之后，将 reTerminal E1001 放置在平坦的表面上，此时支架会支撑其保持竖直状态。
...
支架可让设备放置在桌面、台面或搁架上，非常适合作为信息展示屏、控制面板或数码相框等在各种环境中使用。
:::
