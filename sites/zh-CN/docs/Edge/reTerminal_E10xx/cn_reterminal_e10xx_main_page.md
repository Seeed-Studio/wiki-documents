...
reTerminal E1004 配备一块 13.3 英寸全彩电子纸显示屏，电池续航最长可达 6 个月。由 ESP32-S3 提供算力，支持 SenseCraft HMI 进行零代码仪表盘创建和图片上传，同时也支持 Home Assistant、Arduino 和 ESP-IDF 等高级开发流程。
...
所有 reTerminal E 系列电子纸显示设备都被设计为可与 SenseCraft HMI 平台协同工作，通过直观的 Web 界面为设备创建和部署内容。其主要特性包括：
...
- [Advanced ESPHome Usage of reTerminal E Series ePaper Display in Home Assistant](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_esphome_advanced)
  ...
  说明如何在 Home Assistant 中使用 reTerminal 的硬件和高级特性，例如深度睡眠以及更全面的使用场景。
