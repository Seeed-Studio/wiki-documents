---
description: reTerminal E1004 是一款 13.3 英寸开源全彩电子纸显示屏，由 ESP32-S3 驱动，采用 E Ink® Spectra™ 6 技术并支持 SenseCraft HMI。
...
- **超低功耗：** 内置 5000mAh 电池，在单次充电情况下可支持最长 6 个月使用（每 6 小时刷新一次）。
...
4. 输入显示在 reTerminal E1004 屏幕上的 **设备码（Device Code）** 以完成绑定流程。
...
1. 前往 **首页（Home Page）** 选择你想要的模板，或进入 **工作区（Wrokspace）** 从零开始创建你的作品。
