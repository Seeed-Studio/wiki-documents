...
url: https://wiki.seeedstudio.com/cn/industrial_vision_monitoring_on_industrial/
---
...
本 Wiki 在 Seeed 工业 Jetson 设备上部署一个参考性的**工业安全监控演示**。USB 摄像头将画面推送到浏览器；**YOLO** 负责人员和 PPE 检测，而 **VLM** 用于分析行为风险。两类模型都可以替换——该仓库只是一个起点，而不是绑定到某个固定 checkpoint。
