...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colSpan={4}>预装 Jetpack 5.1.1（及以上）（提供带板级支持包的 Linux 操作系统）</td>
    </tr>
    <tr>
      <td colSpan={2}>认证</td>
...
- [reServer Industrial 规格书](https://files.seeedstudio.com/wiki/reServer-Industrial/reServer-Industrial-Datasheet.pdf)
