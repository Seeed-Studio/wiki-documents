...
本文介绍如何在 reCamera Pro 上使用 GPIO 引脚。你将学习如何使用引脚编号计算公式确定目标 GPIO 引脚，如何通过 sysfs 接口导出并配置引脚方向和电平，以及如何使用 Python 脚本控制 GPIO 输出或读取输入电平。
...
- [reCamera Pro 官方文档](/cn/recamera_pro_getting_started/)

## 技术支持与产品讨论

感谢你选择我们的产品！我们为你提供多种支持方式，以确保你在使用我们产品的过程中体验顺畅。我们提供多种沟通渠道，以满足不同的偏好和需求。
