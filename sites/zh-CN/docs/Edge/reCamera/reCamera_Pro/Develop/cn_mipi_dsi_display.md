---
description: 本维基将简要介绍如何将 MIPI 屏幕连接到设备。
title: 连接 MIPI-DSI 显示屏
keywords:
  - reCamera
  - reCamera Pro
  - MIPI-DSI Screen
