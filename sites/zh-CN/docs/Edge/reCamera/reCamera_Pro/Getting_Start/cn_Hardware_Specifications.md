---
description: 本指南将介绍设备上的硬件资源和接口。
title: reCamera Pro 硬件规格
keywords:
  - reCamera
  - reCamera Pro
  - Edge AI
...
url: https://wiki.seeedstudio.com/cn/recamera_pro_hardware_specifications_legacy/
---
<!-- LEGACY PAGE (reCamera Pro wiki restructure, phase 2): this page has been superseded by Reference/hardware_specifications.md (https://wiki.seeedstudio.com/cn/recamera_pro_hardware_specifications/), which now serves the original slug /recamera_pro_hardware_specifications. This file is kept for history as a draft (slug /recamera_pro_hardware_specifications_legacy) and is excluded from production builds. Do not link here. -->
