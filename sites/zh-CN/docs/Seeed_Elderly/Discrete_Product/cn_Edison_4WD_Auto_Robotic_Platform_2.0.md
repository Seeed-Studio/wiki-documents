---
description: Edison 4WD 自动机器人平台 2.0
title: Edison 4WD 自动机器人平台 2.0
keywords:
  - Seeed_Elderly
...
url: https://wiki.seeedstudio.com/cn/Edison_4WD_Auto_Robotic_Platform_2.0/
---
...
为了您的方便，请进行[零件清单](https://files.seeedstudio.com/wiki/Edison_4WD_Auto_Robotic_Platform_2.0/res/Parts_List_for_Intel_Edison.pdf)检查。
...
*   本步骤所需零件：支架*4，长铝条*2，短铝条*2，M4 平头内六角螺钉*16，六角扳手*1
...
*   本步骤所需零件：PMMA 固定板*1，十字凹头带垫螺钉*1，十字凹头平头螺钉*4，六角螺母*4，底板*4，板扳手*1
...
*   所需零件：轮子*4，M3十字盘头螺钉*4，螺帽垫圈*4，开关（连接电源线）
...
*   所需零件：PMMA上板*1，M3六角螺母*4，长距离隔柱*4，短距离隔柱*4，十字盘头垫圈螺钉*4，散热片*4。
...
*   所需零件：铝制上板*1，M4 十字凹头垫圈螺钉*8，魔术贴*1，铝制上板*1。
...
*   安装铝制上板。将铝制上板放置在长距离隔板上，并按照箭头指示用十字凹头垫圈螺钉固定。现在你已经完成了机器人平台的组装。
...
*   [下载集成工具包](http://downloadmirror.intel.com/25028/eng/iotdk_win_installer.exe)

经验法则：如果您的连接速度到 Intel 服务器不够快，我们建议您首次安装时仅选择驱动程序和刷写工具。单独下载其他工具会更快。

*   [下载最新的 Edison 微计算机固件](http://downloadmirror.intel.com/25028/eng/edison-image-ww25.5-15.zip)

#### 在 Windows 上刷写最新固件

*   [Windows 上的刷写指南](https://www.intel.com/support/edison/sb/CS-035286.htm)
...
*   获取存储容量大于 4 GB 的 micro SD 卡。

*   [下载驱动此应用所需的压缩文件](https://drive.google.com/open?id=0B44iVZMUKA7-eS1CUXpVRHBTYTg)。

*   所需工具：USB OTG 电缆 * 1，[少量扎带](https://www.seeedstudio.com/depot/Multicolor-Tie-Wraps-p-1337.html)，[Intel Edison 芯片](https://www.seeedstudio.com/depot/Intel-Edison-p-2150.html?cPath=6_7) * 1，USB 摄像头 * 1。
...
**注意**：显示的设备可能不同。找到 SD 卡描述的简单方法是插入和拔出 SD 卡以查看命令 _ls_ 的差异。
...
拿出您的手机（在本例中我们使用 iPhone），连接到名为 _EDISON-E9-BB_ 的 Wi-Fi，默认 Wi-Fi 密码是 11111111。

在手机上启动浏览器，并在地址栏中输入 _edison.local_。

**注意**：在 iPhone 的地址栏中需要输入 _edison.local_。在 Windows 手机、Android 手机和其他无线设备上，您只能输入 _192.168.42.1_。

现在，您可以通过手机上的虚拟摇杆控制机器人移动。

![](https://files.seeedstudio.com/wiki/Edison_4WD_Auto_Robotic_Platform_2.0/img/4WD_Edison_80.jpg)

[在 YouTube 上查看演示。](https://www.youtube.com/watch?v=l4wGzxzov2M)

## 更多开发资源

- [引脚映射](https://files.seeedstudio.com/wiki/Edison_4WD_Auto_Robotic_Platform_2.0/res/Pin_mappings.pdf)

- [模块接口](https://files.seeedstudio.com/wiki/Edison_4WD_Auto_Robotic_Platform_2.0/res/4WD_Driver_Platform_V1.0_3400_Modules.jpg)
