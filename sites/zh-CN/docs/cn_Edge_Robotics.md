---
description: 本主题介绍 Seeed Studio 机器人产品的文档与学习课程。
title: 机器人
keywords:
  - robotics
  - nvidia
...
<div className="robotic-tab-container">
    ...
    <div className="nav-grid">
        ...
        <div className="category-card robot-kits">
          ...
          <div className="card-container">
              ...
              <a href="/cn/simulate_soarm101_by_leisaac/" className="content-card">
                <span className="text">SO10x 机械臂搭配 LeIsaac</span>
              </a>
          ...
          <div className="card-container">
              ...
              <a href="/cn/sound_follow_robot/" className="content-card">
                <span className="text">Lekiwi 声源跟随</span>
              </a>
          </div>
          ...
          <div className="card-container">
              ...
              <a href="/cn/control_robotic_arm_via_gr00t" className="content-card">
                <span className="text">StarAI 搭配 NVIDIA GR00T</span>
              </a>
          </div>
          ...
          <div className="card-container">
              <a href="/cn/StackForce_Mini_Wheeled_Legged_Robot" className="content-card">
                <span className="text">Mini 轮足机器人</span>
                <span className="tag recommended">New</span>
              </a>
          </div>
      ...
      <div className="card-container">
          ...
          <a href="/cn/orbbec_depth_camera_on_ros/" className="content-card">
            <span className="text">Orbbec 搭配 ROS</span>
          </a>
      ...
      <a href="/cn/simulate_soarm101_by_leisaac/" className="content-card">
        <span className="text">SO100 机械臂 Isaac 仿真</span>
        <span className="tag recommended">New</span>
      </a>
      </div>
  ...
  <div className="tab-content content-learning">
    ...
    <div className="learning-intro">
        <h2>🎓 机器人学院</h2>
        <p>涵盖 ROS、仿真、强化学习和高级机器人控制的完整课程体系。</p>
    </div>
    ...
    <div className="course-grid">
      ...
      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS1_Turorial/2.English/1.%20ROS%20Basics%208%20lectures/README.md" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level beg">入门</span> <span>⏱️ 8 小时</span></div>
          <h3>ROS 1 基础：8 讲</h3>
          <p>学习节点、主题、服务以及基础知识</p>
          <span className="btn-start">学习中</span>
        </div>
      </a>
      ...
      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ROS2_Tutorial/2.English/1.%20ROS%20Basics%208%20lectures/README.MD" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level int">进阶</span> <span>⏱️ 8 小时</span></div>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level beg">机械臂入门</span> <span>⏱️ 6 小时</span></div>
          <h3>MoveIt 1/2</h3>
          <p>将自定义机械臂导入 MoveIt 1/2，并实现正运动学与逆运动学</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level int">机械臂进阶</span> <span>⏱️ 6 小时</span></div>
          <h3>Pinocchio</h3>
          <p>学习 Pinocchio 机器人框架，并为你的机械臂开发运动学与动力学任务</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level adv">高级</span> <span>⏱️ 12 小时</span></div>
          <h3>NVIDIA Isaac Sim 与 Lab</h3>
          <p>Sim2Real 工作流、USD 流水线以及环境创建。</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level adv">高级</span> <span>⏱️ 10 小时</span></div>
          <h3>MuJoCo 物理引擎</h3>
          <p>为敏捷机器人控制构建动力学建模与仿真。</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level adv">困难</span> <span>⏱️ 20 小时</span></div>
          <h3>强化学习</h3>
          <p>PPO、DRL 训练流水线，以及部署到 Jetson。</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
    ...
    <div className="course-grid">
      ...
      <!-- Humanoid -->
      <a href="" className="course-card">
        <div className="course-cover c-human">人形机器人</div>
        <div className="course-info">
          <div className="course-meta"><span className="level beg">入门</span> <span>⏱️ 5 小时</span></div>
          <h3>小型舵机人形机器人课程</h3>
          <p>小型人形机器人的硬件驱动、动作与舞蹈编排，以及二次开发。</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <!-- Lekiwi -->
      <a href="" className="course-card">
        <div className="course-cover c-lekiwi">移动机器人</div>
        <div className="course-info">
          <div className="course-meta"><span className="level beg">初级</span> <span>⏱️ 6 小时</span></div>
          <h3>移动机器人学（Lekiwi）</h3>
      ...
      <a href="" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level int">中级</span> <span>⏱️ 15 小时</span></div>
          <h3>StarAI 机械臂系统课程</h3>
          <p>StarAI 6+1 自由度机械臂：运动学、动力学、模仿学习与基于 VLA 的高级强化学习</p>
          <span className="btn-plan">规划中</span>
        </div>
      </a>
      ...
      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_Mini_Wheeled_Legged_Robot/English/README.md" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level int">中级</span> <span>⏱️ 8 小时</span></div>
          <h3>Stackforce 轮足机器人课程</h3>
          <p>混合机器人平衡控制与基于 LQR 的运动规划。</p>
          <span className="btn-start">学习中</span>
        </div>
      </a>
      ...
      <a href="https://github.com/Seeed-Projects/AI_Robotics_Academy/blob/main/Seeed_ReachyMini_Tutorial/2.English/README.md" className="course-card">
        ...
        <div className="course-info">
          <div className="course-meta"><span className="level adv">高级</span> <span>⏱️ 8 小时</span></div>
          <h3>ReachyMini 教程共 13 讲</h3>
          <p>关于 ReachyMini 的基础操作、界面教程和二次开发的系统课程</p>
          <span className="btn-start">学习中</span>
        </div>
      </a>
