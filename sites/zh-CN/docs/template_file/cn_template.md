...
这里我使用 Thonny IDE 软件（Windows）以及一些相关的库和文件。此处内容应包括：
...
1. 将第一步代码上传到某个产品上，即可看到相应效果
2. 将第二步代码上传到某个产品上，即可看到相应效果
3. ...
...
:::note
一些带有 *Markdown* `syntax` 的**内容**。查看 [this `api`](#)。
:::
