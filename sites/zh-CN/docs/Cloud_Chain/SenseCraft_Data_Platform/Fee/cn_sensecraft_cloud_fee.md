...
url: https://wiki.seeedstudio.com/cn/sensecraft-fee/sensecraft-cloud-fee/
---


SenseCaft 云服务基于使用 LoRaWAN 物联网低功耗通信协议的硬件设备。LoRaWAN 设备需要按量预付费以启用数据通信功能。用户可以根据产品使用需求选择按月或按年预付费。
...
|土壤水分与温度传感器|182 天|$0.99|$2.97|$11.88|
|CO2 温湿度传感器|182 天|$0.99|$2.97|$11.88|
|LoraWAN 数据记录仪|182 天|$0.99|$2.97|$11.88|
|土壤水分、温度与电导率传感器|182 天|$0.99|$2.97|$11.88|
...
|T2000-A/B/C 追踪器|90 天|$0.99|$2.97|$11.88|

:::note
设备绑定平台后开始计费。如果在计费周期内解绑设备或修改设备所属组织，计费不会中断，仍将按设备维度进行收费。
:::
...
进入 `Device` 页面，选择你想要购买服务的设备。
进入设备详情，然后进入 `Settings` 界面。选择 `Communication Service` 以进入服务购买模块。
...
:::tip
APP 目前仅支持单设备购买，如需批量购买服务，请参考 [SenseCAP Portal Subscription](https://wiki.seeedstudio.com/cn/sensecraft_cloud_fee/#sensecap-portal-services-subscription)。
:::
