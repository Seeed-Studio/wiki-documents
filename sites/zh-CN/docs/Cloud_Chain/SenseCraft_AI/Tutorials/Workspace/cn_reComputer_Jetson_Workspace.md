...
- **[可选] 通过卸载 libreoffice 等一些不必要的软件包来节省空间，是否更改 Swap 内存大小？(/swapfile) [y/n] (默认: n): n**<br />
...
- **（如果你的根分区小于 32 GB，推荐启用）。[y/n] (默认: n): n**<br />
...
如果你已经完成 AI 模型的部署且不再需要远程管理设备，你可以将设备从平台中移除，此时设备可以在边缘端独立进行本地推理、流管理和 AI 模型管理。
...
| **Device AI Model** | 1 选择一个已经下载到设备上的 AI 模型<br />2 如果你的设备上没有 AI 模型，请前往 AI Models 页面将模型下载到设备。 |
