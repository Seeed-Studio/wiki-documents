...
<div className="rebot-page">
  ...
  <section className="doc-hero">
    <div >
      ...
      <p>本教程面向已经完成 reBot Arm B601-DM 快速开始和基础校准的用户，带你在 LeRobot 框架中完成环境安装、机械臂校准、遥操作、相机接入、数据集制作、训练、评估和进阶部署。</p>
    ...
    <div className="hero-card image-card">
      ...
      <span>LeRobot · Teleoperation · Dataset · Training</span>
    </div>
  </section>
...
<section id="course-steps" className="section-card">
  ...
  <div className="step-card-grid">
    <div className="step-card"><span className="step-mini">Step 0</span><strong>完成 B601-DM 快速入门</strong><p>先完成电源、零点、串口、MotorBridge 和基础运动测试。</p></div>
    <div className="step-card"><span className="step-mini">Step 1</span><strong>安装 LeRobot 环境</strong><p>安装 Miniforge、Seeed LeRobot 仓库、reBot 插件和 ffmpeg。</p></div>
    <div className="step-card"><span className="step-mini">Step 2</span><strong>校准 follower 与 leader</strong><p>分别校准 B601-DM follower 和 reBot 102 leader 的零位。</p></div>
    ...
    <div className="step-card"><span className="step-mini">Step 4</span><strong>接入相机并采集数据</strong><p>验证 OpenCV / RealSense / Orbbec 画面，再录制数据集。</p></div>
    <div className="step-card"><span className="step-mini">Step 5</span><strong>训练与评估策略</strong><p>从 ACT 开始，再尝试 SmolVLA、Pi0、Pi0.5 或 GR00T。</p></div>
  </div>
</section>
<section id="quick-path" className="section-card">
    <div className="section-title">
      ...
      <h2>推荐学习路线</h2>
      <p>如果你第一次使用 LeRobot，建议按下面顺序完成；如果你已经有经验，可以直接跳到对应模块。</p>
    </div>
  ...
  <section className="section-card">
    ...
    <div className="info-card">
      <p><a href="/cn/rebot_b601_dm_getting_started/">reBot Arm B601-DM</a> 是 Seeed Studio 开源的机械臂项目，目标是降低具身智能学习门槛。项目不仅开源代码，也开源机械结构、BOM、软件接口和算法示例。</p>
    ...
    <div className="feature-grid">
      ...
      <div><b>可扩展硬件</b><span>支持 reBot B601-DM follower 与 reBot 102 leader 配合完成主从遥操作。</span></div>
    </div>

    <details className="content-details">
      <summary>查看 reBot 项目介绍视频</summary>
      <div className="video-container">
        <iframe width="900" height="600" src="//player.bilibili.com/player.html?bvid=BV1mFo7BiEwX" title="Bilibili video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </details>
  </section>
  ...
  <section id="install-lerobot" className="section-card">
    ...
    <details className="content-details" open>
      ...
      <div className="video-container">
        <iframe width="900" height="600" src="//player.bilibili.com/player.html?bvid=BV12Fo7BvE7G" title="Bilibili video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </details>
...
<section id="calibration" className="section-card">
    ...
    <details className="content-details" open>
      ...
      <div className="video-container">
        <iframe width="900" height="600" src="//player.bilibili.com/player.html?bvid=BV1KFo7BiE1h" title="Bilibili video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </details>
    ...
    <h3>1. 授予串口权限</h3>
    <pre><code>{`sudo chmod 666 /dev/ttyUSB*  # leader 臂
sudo chmod 666 /dev/ttyACM*  # follower 臂（串口桥）`}</code></pre>

    <h3>2. 校准 follower 臂</h3>
    <p>B601-DM 一般只需要在组装完成后校准一次。校准时夹爪需要完全闭合，并按照零位图保持机械臂静止。</p>
...
lerobot-calibrate \
    ...
    <div className="image-wrap">
      <img src="https://files.seeedstudio.com/wiki/robotics/projects/lerobot/b601dm_zeroposition.jpg" alt="B601-DM zero position" />
    </div>
...
lerobot-teleoperate \
    ...
    <details className="content-details">
      ...
      <div className="video-container">
        <iframe width="900" height="600" src="https://player.bilibili.com/player.html?bvid=BV1A6JM62EeK&page=1&high_quality=1&danmaku=0" scrolling="no" border="0" frameBorder="no" frameSpacing="0" allowFullScreen="true"></iframe>
      </div>
    </details>
  </section>
...
.hero-panel {
  ...
  background:
    radial-gradient(circle at 10% 15%, rgba(37,99,235,0.18), transparent 32%),
    radial-gradient(circle at 90% 85%, rgba(20,184,166,0.18), transparent 32%),
...
.notice-card.warning {
  ...
  background: linear-gradient(180deg, var(--warning-soft), var(--panel-bg));
}
.info-card {
...
html[data-theme='dark'] .lerobot-page {
  --page-bg: #111318;
  --panel-bg: #1d2028;
  --panel-bg-soft: #242833;
  --text-main: #f8fafc;
  --text-muted: #a8b2c3;
...
html[data-theme='dark'] .hero-panel {
  background:
    radial-gradient(circle at 10% 15%, rgba(96,165,250,0.16), transparent 32%),
    radial-gradient(circle at 90% 85%, rgba(45,212,191,0.12), transparent 32%),
    linear-gradient(135deg, rgba(29,32,40,0.98), rgba(17,19,24,0.96));
}
html[data-theme='dark'] .hero-image-card,
html[data-theme='dark'] .quick-nav {
  background: rgba(29,32,40,0.86);
}
html[data-theme='dark'] .hero-actions a:nth-child(2),
html[data-theme='dark'] .hero-actions a:nth-child(3) {
  color: var(--primary);
  background: var(--panel-bg-soft);
}
html[data-theme='dark'] .notice-card.warning {
  background: linear-gradient(180deg, rgba(245,158,11,0.12), var(--panel-bg));
}
...
/* ==== Patch: make all rebot-page Step/Card components effective ==== */
.rebot-page {
  --rb-bg: #ffffff;
  --rb-surface: #ffffff;
...
/* Cards that were missing effective styles */
.path-grid,
.notice-grid,
.feature-grid,
.env-grid,
...
.warning-card {
  border-color: rgba(245,158,11,0.34);
  background: linear-gradient(180deg, var(--rb-warning-soft), var(--rb-surface));
}
.callout.danger,
.danger-card {
  border-color: rgba(239,68,68,0.34);
  background: linear-gradient(180deg, var(--rb-danger-soft), var(--rb-surface));
}
...
.course-step.active {
  ...
  background: linear-gradient(135deg, rgba(239,246,255,0.94), rgba(240,253,250,0.80));
}
.course-index {
  display: inline-flex;
  align-items: center;
...
html[data-theme='dark'] .rebot-page {
  --rb-bg: #111318;
  --rb-surface: #1d2028;
  --rb-surface-soft: #242833;
  --rb-text: #f8fafc;
  --rb-muted: #a8b2c3;
  --rb-border: rgba(148,163,184,0.22);
  --rb-primary: #60a5fa;
  --rb-primary-soft: rgba(96,165,250,0.12);
  --rb-accent: #2dd4bf;
  --rb-warning-soft: rgba(245,158,11,0.12);
  --rb-danger-soft: rgba(239,68,68,0.12);
  --rb-shadow: 0 18px 40px rgba(0,0,0,0.26);
}
html[data-theme='dark'] .doc-hero {
  background:
    radial-gradient(circle at 12% 18%, rgba(96,165,250,0.18), transparent 32%),
    radial-gradient(circle at 90% 85%, rgba(45,212,191,0.14), transparent 35%),
    linear-gradient(135deg, rgba(29,32,40,0.98), rgba(17,19,24,0.96));
}
...
html[data-theme='dark'] .doc-nav a:hover {
