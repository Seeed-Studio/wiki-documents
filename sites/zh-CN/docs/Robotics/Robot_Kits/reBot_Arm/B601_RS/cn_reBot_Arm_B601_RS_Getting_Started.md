...
<section className="doc-hero">
  <div>
    ...
    <h2>从开箱到校准，让 reBot Arm B601-RS 安全动起来</h2>
    <p>本教程按照真实上手流程整理：先确认套件类型，再依次完成 48V 电源检查、机械臂组装、线束检查、PCAN-USB 配置、零点校准和 MotorBridge 初体验。</p>
    <div className="hero-actions">
      <a href="#agent">优先使用 AI Agent</a>
  ...
  <div className="hero-card">
    ...
    <span>如果你使用 Codex、Cursor、Trae 等工具，建议先让 AI Agent 按流程带你完成初始化。</span>
    <span>成品套件用户：电机 ID 已经写入，重点检查线束、电源、PCAN-USB 和零点校准。</span>
  </div>
</section>
...
<div className="quick-note">
  <strong>安全提醒：</strong>B601-RS 使用 48V 电源和 RobStride 关节电机。调试前请固定机械臂，保持至少 1 米安全距离，并在每次插拔电机线或 XT30 接口前断电。
</div>
...
<nav className="doc-nav" aria-label="reBot B601-RS quick navigation">
  ...
  <a href="#motorbridge">Step 2 校准 / AI Agent</a>
  <a href="#pcan">PCAN-USB</a>
  <a href="#gateway">零点写入</a>
...
<section id="start-path" className="section-card">
  <div className="section-title">
    ...
    <h2>先确认你的套件类型</h2>
    <p>B601-RS 成品套件和散件套件的操作路径不同。先确认自己的版本，可以避免重复写入参数或误操作。</p>
  </div>

  <div className="path-grid">
    <a className="path-card recommended" href="#motorbridge">
      <b>我购买的是已组装成品套件</b>
      <span>电机 ID 已经写入，不需要重新写入。收到后请连接关节 1-2 线束，检查 48V 电源和 PCAN-USB，然后进入零点校准和 MotorBridge 初体验。</span>
      <em>推荐从 Step 2 开始</em>
    </a>
    <a className="path-card" href="#assembly">
      <b>我购买的是散件或需要自己组装</b>
      <span>建议先打开 AI Agent 流程，让 Agent 按 AGENTS.md 带你完成环境检查和安全确认；再继续机械结构组装、线束连接、电源检查、PCAN-USB 配置和零点校准。</span>
      <em>按 Step 1 → 2</em>
    </a>
  </div>
...
<section className="section-card">
  <div className="section-title">
    <span>Overview</span>
    <h2>项目概览</h2>
    <p>reBot Arm 项目已经在 <a href="https://github.com/Seeed-Projects/reBot-DevArm" target="_blank">GitHub</a> 开源。本文将带领你完成 B601-RS 从组装到 MotorBridge 控制的基础流程。</p>
  </div>
  ...
  <div className="badge-row">
    <span>6 自由度机械臂</span>
    <span>RobStride 电机</span>
    <span>MotorBridge</span>
    <span>开源项目</span>
  </div>

  <div className="buy-box">
    <a href="https://detail.tmall.com/item.htm?abbucket=16&id=1057521963559&mi_id=0000e3EnxaNqLKSz_jjVCIW5p5-sF41U-_zw4ATX6ursnIo&ns=1&skuId=6267129098361&spm=a21n57.1.hoverItem.5&utparam=%7B%22aplus_abtest%22%3A%2222fcb92cefee991f6636dec97150f39e%22%7D&xxc=taobaoSearch" target="_blank">购买 reBot Arm B601-RS</a>
  </div>
</section>
...
<section id="power" className="section-card warning-section">
  <div className="section-title">
    ...
    <h2>关于电源：上电前必须检查</h2>
    <p>B601-RS 默认发货时不一定包含电源。请使用正规品牌 48V 电源，并根据所在地区电压设置电源侧面拨码。</p>
  </div>
  ...
  <p>你可以选购我们开源的 <a href="https://www.seeedstudio.com/Power-Adapter-Kit-for-reBot-Arm-B601-RS-p-6873.html" target="_blank">48V 12.5A MeanWell 电源适配器</a>，也可以参考 GitHub 仓库中的 BOM 自行组装电源外壳。自行组装只推荐有相关电源经验的开发者使用。</p>
  ...
  <details className="video-details">
    <summary>查看电源相关参考视频</summary>
    <div className="video-container">
      <iframe src="//player.bilibili.com/player.html?isOutside=true&aid=116793196675417&bvid=BV15i7K69EnQ&cid=39314066536&p=1" title="Power supply video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
    </div>
  </details>
</section>
...
<section id="assembly" className="section-card step-section">
  <div className="step-title-row">
    ...
    <div>
      <h2>组装机械臂</h2>
      <p>散件用户需要完成本步骤。已组装成品套件用户可以直接进入校准和基础体验。</p>
    </div>
  </div>
  ...
  <div className="checklist-grid">
    ...
    <div><strong>风险提示</strong><span>机身为金属件，组装时请防止夹手、砸伤；儿童需在家长或监护人陪同下完成。</span></div>
  </div>

  :::warning
  组装视频为六月初拍摄，后续零件可能会有微调，但不影响跟随视频完成安装。最终零件以实际出货为准。
  :::

  <details className="content-details" open>
    <summary>展开组装视频</summary>
    <div className="video-container">
      <iframe src="//player.bilibili.com/player.html?isOutside=true&aid=116854970386234&bvid=BV1xCTs6vEa6&cid=39614154823&p=1" title="reBot Arm B601-RS assembly video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
  </details>
</section>
...
<section id="motorbridge" className="section-card step-section">
  <div className="step-title-row">
    ...
    <div>
      <h2>校准机械臂及上手初体验</h2>
      <p>本步骤用于完成线束检查、零点校准、MotorBridge 安装和基础调试。</p>
    </div>
  </div>

  :::tip
  如果你购买的是组装好的版本，电机 ID 已经全部写入，不需要再单独写入。由于担心运输过程中线束磨损，关节 1-2 之间线束默认未安装。收到后请在包装内找到一侧弯头、一侧直头的线束，并连接到关节 1-2。
  :::

  <div id="agent" className="agent-inline-card">
    <div className="section-title">
      <span>Recommended First</span>
      <h2>推荐优先使用 AI Agent 辅助初始化</h2>
      <p>如果你正在使用 Codex、Cursor、Trae、Claude Code 等 AI 编程工具，建议先使用 AI Agent 流程。Agent 会根据 AGENTS.md 按步骤引导你完成环境检查、电机在线扫描、PCAN-USB 配置、MotorBridge 启动和零点校准。</p>
    </div>
  
    :::warning
    AI Agent 流程仍处于 Beta 阶段。调试过程中请保持机械臂固定、远离运动范围，并在插拔电机线或 XT30 接口前断电。如果 Agent 给出的提示与本文内容不符，请以本文为准。
    :::
  
    <div className="path-grid">
      <div className="path-card recommended">
        <b>成品套件用户推荐提示词</b>
        <span>成品套件的电机 ID 已经写入，建议让 Agent 只做在线扫描、线束检查、PCAN-USB 检查和零点校准，不要重新写入电机 ID。</span>
        <em>优先推荐</em>
      </div>
      <div className="path-card">
        <b>散件 / 新机械臂用户推荐提示词</b>
        <span>如果你需要完成完整初始化，可以让 Agent 按 AGENTS.md 从环境检查、电机扫描、ID 检查、网关启动到校准逐步执行。</span>
        <em>完整初始化</em>
      </div>
    </div>
    ...
    ```text
    请参考 AGENTS.md（https://github.com/Welt-liu/reBot-B601-Agent-Guide/blob/main/zh/AGENTS.md）中的流程，帮助用户完成 reBot Arm B601-RS 的初始化。
  
    如果我是成品套件用户，请不要重新写入电机 ID，只需要帮我扫描 1~7 号电机是否都在线，并继续完成 PCAN-USB、MotorBridge Gateway 和零点校准检查。
  
    如果我是散件或新装机械臂用户，请先确认每一步安全条件，再按流程引导我完成初始化。
    ```
  
    :::tip
    适合优先使用的工具包括 Codex、Cursor、Trae、Claude Code 等。Wiki 中的 Web UI 流程仍然保留，适合不使用 AI Agent 的用户手动参考。
    :::
  </div>

  <details className="content-details">
    <summary>一号电机线束保护件</summary>

    一号电机线束长期拉扯会磨损电机接头，造成电路接触不良。打印下方配件可降低该风险。

    | 配件名称 | 示意图 | 文件名称 | 材料 | 数量 | 打印参数说明 |
    | ---- | ---- | ---- | ---- | ---- | ---- |
    | 一号电机双侧线束卡扣 | <img src="https://files.seeedstudio.com/wiki/robotics/projects/rebot_arm/Getting_start/RS_Motor1_wiring_harness_clip.jpg" width="100" /> | [3D File](https://files.seeedstudio.com/wiki/robotics/projects/rebot_arm/Getting_start/RS_Motor1_wiring_harness_clip.stp) | 拓竹黑色 PLA | 2 件 | 0.4 mm 喷嘴，0.2 mm 层厚，填充率 30% |
  </details>

  <div className="feature-grid">
    <div><strong>MotorBridge 一站式控制</strong><span>支持 RobStride、Damiao、高擎、脉塔、Hexfellow 等多种电机，并持续兼容 reBot 系列机械臂。</span></div>
    <div><strong>面向 reBot 的功能</strong><span>包含一键零点校准、参数写入、拖拽式电机控制和内置模型可视化界面。</span></div>
    <div><strong>跨平台支持</strong><span>兼容 Windows、Ubuntu、macOS，并提供功能一致的 Python SDK。</span></div>
  </div>

  <details className="video-details" open>
    <summary>展开校准与上手视频</summary>
    <div className="video-container">
      <iframe src="//player.bilibili.com/player.html?isOutside=true&bvid=BV1MEJV6TELk&p=1" title="reBot Arm B601-RS calibration video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
  </details>

  <section className="sub-step-block">
    <h3>1. 安装 Miniforge（推荐）</h3>
    <p>安装 Miniforge 并创建独立虚拟环境，可以避免其他环境包干扰 demo 运行。支持 Windows、Ubuntu、macOS、Jetson 和树莓派。</p>

    <details className="content-details">
      <summary>查看 Miniforge 安装命令</summary>
      ...
      Windows：打开 Miniforge Release 页面，下载最新的 `Miniforge3-Windows-x86_64.exe`：
    ...
    :::tip
    Git Bash 用户如果找不到 `conda` 命令，需要先初始化 conda：
  ...
  <section className="sub-step-block">
    ...
    <p>每次打开新的终端使用 reBot 相关功能时，都需要重新执行 <code>conda activate rebot</code>。</p>
  </section>

  <section className="sub-step-block">
    <h3>3. 安装 MotorBridge</h3>

    :::tip 提示 macOS 用户注意
    如果你在 macOS 上遥操时帧率偏低，可能是沁恒（WCH）CH34x 驱动版本过旧导致。对于 macOS 10.14 及以上版本，系统已内置 AppleUSBCHC0M 驱动，可以先卸载旧版驱动，改用 macOS 内置驱动。
    :::
...
<section id="pcan" className="section-card">
  <div className="section-title">
    ...
    <h2>配置 PCAN-USB</h2>
    <p>PCAN-USB 用于让电脑以 1 Mbps 速率接入 CAN 总线，从而与 B601-RS 的 RobStride 电机通信。</p>
  </div>
  ...
  <details className="content-details">
    ...
    配置 `DYLD_LIBRARY_PATH`，确保 motorbridge-gateway 运行时能找到 PCBUSB 库：
  ...
  <details className="content-details">
    ...
    请访问 <a href="https://www.peak-system.com/products/hardware/external-pc-interfaces/pcan-usb/" target="_blank">PCAN-USB 官方页面</a> 安装驱动。
  </details>
</section>

<section id="gateway" className="section-card warning-section">
  <div className="section-title">
    <span>Reset Zero Position</span>
    <h2>启动 MotorBridge Gateway 写入零点和调试</h2>
    <p>打开 MotorBridge Studio 后，根据你的系统和驱动板复制对应命令，并确认 IP 地址和端口号。</p>
  </div>

  <div className="danger-list">
    <strong>调试前安全规范</strong>
    <ul>
      <li>自备 2 个工装夹具，尺寸建议 ≥ 3 英寸。</li>
      <li>使用正规品牌 48V、XT30 输出开关电源。</li>
  ...
  在浏览器中打开 <a href="https://motorbridge.github.io/motorbridge-studio/" target="_blank">MotorBridge Studio</a>，点击帮助选项，根据你的操作系统与所用驱动板复制对应指令。

  ```bash
  motorbridge-gateway --bind 127.0.0.1:9002
  ```

  macOS 如遇到 PCBUSB 运行时库加载问题，可以使用：
...
<section id="course-path" className="section-card course-path-section">
  <div className="section-title">
    ...
    <h2>reBot B601-RS 系列课程导链</h2>
    <p>建议按照 Robotics Page 的学习顺序阅读：快速入门 → LeRobot → Pinocchio → 视觉夹取 → ROS2。你也可以通过下面的卡片直接跳转到任意课程。</p>
  </div>
  <div className="course-path-grid">
    <a className="course-path-item active" href="/cn/rebot_b601_rs_getting_started/">
      <span className="course-index">1</span>
      <span className="course-path-copy"><strong>快速入门</strong><span>完成开箱、供电检查、PCAN-USB 配置、组装、零点校准和第一次基础运动测试。</span></span>
      <span className="course-tag">当前文章</span>
    </a>
    <a className="course-path-item" href="/cn/rebot_arm_b601_rs_lerobot/">
      <span className="course-index">2</span>
      <span className="course-path-copy"><strong>LeRobot 遥操作与数据采集</strong><span>完成主从遥操作、相机接入、数据集采集，并准备模仿学习任务。</span></span>
      <span className="course-tag">Data</span>
    </a>
    <a className="course-path-item" href="/cn/rebot_arm_b601_rs_pinocchio_meshcat/">
      <span className="course-index">3</span>
      <span className="course-path-copy"><strong>Pinocchio 运动学可视化</strong><span>理解模型、坐标系、FK / IK、轨迹规划、MeshCat 可视化和重力补偿。</span></span>
      <span className="course-tag">Control</span>
    </a>
    <a className="course-path-item" href="/cn/rebot_arm_b601_rs_grasping_demo/">
      <span className="course-index">4</span>
      <span className="course-path-copy"><strong>视觉夹取 Demo</strong><span>结合 RGB-D 感知、手眼标定、YOLO / GraspNet 与真实机械臂抓取执行。</span></span>
...
/* Course navigation and polished jump cards */
...
@media (max-width: 700px) {
  ...
  .course-tag { grid-column: 2; justify-self: start; width: fit-content; }
}
