...
<section id="motorbridge" className="section-card step-section">
  ...
  <details className="content-details">
    ...
    | ---- | ---- | ---- | ---- | ---- | ---- |
    | 一号电机双侧线束卡扣 | <img src="https://files.seeedstudio.com/wiki/robotics/projects/rebot_arm/Getting_start/RS_Motor1_wiring_harness_clip.jpg" width="100" /> | [3D File](RS_Motor1_wiring_harness_clip.stp) | 拓竹黑色 PLA | 2 件 | 0.4 mm 喷嘴，0.2 mm 层厚，填充率 30% |
  </details>
