...
url: https://wiki.seeedstudio.com/cn/SenseCAP_Sensor_Probes_Product_Catalogue/
---
...
[1] 从传感器通电到读取数据的时间。注意传感器通电时的参数。

[2] 如果在清洁空气环境中启动，所需时间更短

[3] 测量数据更新间隔，在通电预热时间后，如果电源持续供电，传感器会按此间隔定期更新读数。
...
[1] 从传感器上电到可以读取数据的时间。注意传感器上电时的参数。

[2] 如果在洁净空气环境中启动，所需时间更短

[3] 测量数据更新间隔，在上电预热时间后，如果持续供电，传感器会按此间隔周期性更新读数。
...
[5] 传感器接收到读取指令后响应所需的时间，在响应延迟寄存器 0x0020 设置为 0 后。

## 工业级 MODBUS RS485 空气温湿度传感器
...
## 工业光照强度传感器，MODBUS-RTU RS485 &0-2V (S-Light-01)

带连接线 [314990739](https://www.seeedstudio.com/light-intensity-sensor-p-a-4863.html?queryID=f94dd76cedb45ec9d57e70d6e82af574&objectID=4863&indexName=bazaar_retailer_products)

带航空连接器  [314990740](https://www.seeedstudio.com/light-intensity-sensor-p-b-4863.html)
...
## 工业PAR传感器 (S-PAR-02A)，MODBUS-RTU RS485

带连接线 [314990733](https://www.seeedstudio.com/RS485-S-PAR-02A-p-4829.html)

带航空连接器  [314990735](https://www.seeedstudio.com/RS485-S-PAR-02B-p-4830.html)
...
## 工业PAR传感器 (PAR-2.5V)，支持模拟0~2.5V输出
...
## 工业总太阳辐射传感器 (S-ZFS-02A)，MODBUS-RTU RS485
...
带连接线 [314990737](https://www.seeedstudio.com/leaf-wetness-sensor-p-a-4861.html)

带航空连接器  [314990738](https://www.seeedstudio.com/leaf-wetness-sensor-p-b-4861.html)
...
## 工业pH传感器 MODBUS-RTU RS485 & 0~2V 模拟电压 (S-pH-01A) V2.0

带连接线  [101990666](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01A-p-4632.html)

带航空连接器 [314990622](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01B-p-4632.html)
...
## 工业级 EC 和 TDS 传感器 MODBUS-RTU RS485 和 0-2V 模拟电压
