...
SenseCAP ONE 是一系列一体化紧凑型气象传感器，将多种传感器集成在这一紧凑设备中，可监测多达 10 项气象参数：空气温度、空气湿度、大气压力、光照强度、风速、风向、降水量、PM 2.5、PM 10 和 CO2。

||空气温度|空气湿度|气压|光照|风速|风向|降雨量|PM2.5|PM10|CO2|噪声|
|--|--|--|--|--|--|--|--|--|--|--|--|
