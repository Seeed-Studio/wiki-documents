...
SenseCAP 传感器集线器是一个用于远程环境监测的紧凑解决方案。它由一个强大的数据记录器组成，可以连接最多 40 个 RS-485 传感器和广泛的传感器选择，您可以将其用于气象站、空气质量监测等应用。凭借 IP66 防护等级和太阳能供电，您可以依靠它提供可靠且非易失性的数据收集服务。SenseCAP 传感器集线器数据记录器有两个版本：2G 和 4G，均可供选择。
