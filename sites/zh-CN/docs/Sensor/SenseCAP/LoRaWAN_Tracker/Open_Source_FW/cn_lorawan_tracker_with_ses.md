...
- **步骤 1：** 进入 DFU 模式
 ...
 将 USB 线缆连接到您的 PC，按住设备按钮，然后快速连接充电线缆，应该会显示一个名为 `T1000-E` 的驱动器。

:::danger note
如果在连接线缆时按住设备按钮后没有弹出驱动器窗口，请按照下面的操作快速双击充电线缆。
:::
...
首先，注册 The Things Industries 或 The Things Network 账户。
