...
| respeaker_xvf3800_usb_dfu_firmware_6chl_v2.0.x.bin | 6 | 通道 0：处理后的音频（会议） <br /> 通道 1：处理后的音频（ASR） <br /> 通道 2：麦克风 0 原始数据 <br /> 通道 3：麦克风 1 原始数据 <br /> 通道 4：麦克风 2 原始数据 <br /> 通道 5：麦克风 3 原始数据 |
