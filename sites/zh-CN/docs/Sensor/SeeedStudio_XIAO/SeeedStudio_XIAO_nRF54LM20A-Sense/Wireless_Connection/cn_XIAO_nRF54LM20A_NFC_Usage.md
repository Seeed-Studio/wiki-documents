...
本教程基于 VS Code 和 nRF Connect Extension。如果你对它们还不熟悉，可以参考 [XIAO nRF54LM20A nRFConnect SDK Usage](https://wiki.seeedstudio.com/cn/xiao_nrf54lm20a_ncs/)
...
5. 打开终端，输入命令 `west flash` 将固件烧录到 XIAO nRF54LM20A 上。
