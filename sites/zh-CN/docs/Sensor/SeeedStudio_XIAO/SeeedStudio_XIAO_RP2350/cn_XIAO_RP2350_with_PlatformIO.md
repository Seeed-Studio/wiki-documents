---
description: Seeed Studio XIAO RP2350 与 PlatformIO
title: XIAO RP2350 与 PlatformIO
keywords:
  - xiao
...
url: https://wiki.seeedstudio.com/cn/xiao_rp2350_with_platform_io/
---
...
## 在 XIAO RP2350 上使用 PlatformIO

### 步骤 1. 从官网安装 [PlatformIO](https://platformio.org/platformio-ide)
...
:::tip
在此之前，我已经安装了 XIAO RP2350 安装包，所以您可以看到操作二的图片中有 XIAO RP2350 的选项，但您在执行操作时没有这个选项。
:::
...
最后，如果您看到与上图相同的结果，说明您已经成功添加了 XIAO RP2350 开发板。当您再次创建项目时，您将看到 XIAO RP2350 选项可用。
