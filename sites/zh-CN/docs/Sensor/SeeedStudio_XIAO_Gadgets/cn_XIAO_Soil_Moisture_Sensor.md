...
url: https://wiki.seeedstudio.com/cn/xiao_soil_moisture_sensor/
---
...
这是一个可直接使用的 `ESPHome` YAML 配置文件，适用于 Home Assistant：
<details>
...
:::tip
如果您的 Home Assistant 主机（Raspberry PI/Green/Yellow 等）在附近，我们建议使用此方法，因为它更简单。
:::
