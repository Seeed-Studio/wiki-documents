...
- [搭配 TRMNL 使用](https://wiki.seeedstudio.com/cn/reterminal_e10xx_trmnl) — 通过 TRMNL 云平台部署电子墨水仪表盘。单篇文章现已覆盖 reTerminal E1001/E1002、TRMNL DIY Kit 和 XIAO 7.5" ePaper Panel——在标签页中选择你的硬件。</td>
...
- [搭配 PlatformIO 使用](https://wiki.seeedstudio.com/cn/epaper_work_with_platformio) — 主参考：VS Code 配置、`platformio.ini` 配置、`Seeed_GFX` 设置，以及按产品选择 PlatformIO 环境。按产品划分的 Cookbook：[EE04 / EE0x PlatformIO](https://wiki.seeedstudio.com/cn/ee04_with_platformio)。</td>

### 开源 ESL / OEPL

- [搭配 OpenEPaperLink / OpenDisplay 使用](https://wiki.seeedstudio.com/cn/EN04_opendisplay) — 单篇文章覆盖 EN04 BLE 套件以及 ePaper Breakout Board + XIAO nRF52840 DIY 路径。</td>
