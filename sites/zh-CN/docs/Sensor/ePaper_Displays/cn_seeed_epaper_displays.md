---
description: Seeed Studio ePaper 显示产品矩阵的完整概览，从集成的 reTerminal E 系列终端，到驱动板、DIY 套件，以及为其提供支持的应用框架。
...
这三条产品线共享**同一软件生态系统**：SenseCraft Seeedash（零代码）、Home Assistant / ESPHome、TRMNL、Arduino / ESP-IDF / PlatformIO、Zephyr，以及 SquareLine Vision、EEZ Studio、Lopaka 等可视化 UI 工具。选择任意一款硬件系列，其余工具链保持一致。
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      <td>开箱即可点亮 ePaper 仪表盘，无需焊接，无需额外布线</td>
      ...
      <td>电池、外壳、温湿度传感器、蜂鸣器、按键和 Wi-Fi 全部集成。预装 SenseCraft Seeedash 固件。</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>使用对创客友好的 DIY 套件，构建兼容 TRMNL 的仪表盘</td>
    ...
    <tr>
      ...
      <td>裸屏 + 与任意 XIAO 板对接的转接板；占板面积极小。</td>
    </tr>
  </table>
</div>
...
四款基于 ESP32-S3 的终端，共享相同的外壳家族、软件栈和电池设计。差异在于屏幕尺寸、彩色或黑白、是否触控以及电池续航。
...
:::tip
如需并排查看规格对比（分辨率、刷新时间、局部刷新支持、认证、MSRP 等）以及详细的软件支持矩阵，请前往专门的 **[reTerminal E 系列总览](https://wiki.seeedstudio.com/cn/reterminal_e10xx_main_page)**。
:::
...
### ESP32-S3 驱动板（Wi-Fi / BLE，SenseCraft Seeedash）
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>内置 T-CON 时序；板载 SHT40 用于波形补偿；XIAO ESP32-S3 Plus。</td>
    ...
    <tr>
      ...
      <td>跳线可选引脚布局；适配大多数现成小尺寸 ePaper 屏幕。</td>
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td align="center">24-pin / 50-pin 通用</td>
      <td>Bluetooth LE + NFC；XIAO nRF52840 Plus；非常适合电子价签和离线标签。</td>
...
:::tip
还提供一份汇总的 **[ePaper 驱动板总览](https://wiki.seeedstudio.com/cn/xiao_epaper_display_board_overview)**，其中列出了各块板卡的特性，并可进行并排对比。
:::
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>7.5 英寸单色电子纸 + ESP32 驱动板 + 亚克力支架。为 TRMNL 云平台预先调优；也可运行 ESPHome 和 Arduino。</td>
    ...
    <tr>
      ...
      <td>裸 7.5 英寸电子纸面板，带有可直接连接到 XIAO 模组焊盘的 FPC 连接器。</td>
      <td>适用于已经有 XIAO 并希望添加屏幕的紧凑、低成本项目。</td>
...
每一款 Seeed 电子纸产品最终都汇入同一个软件生态。选择与你技能水平匹配的工作流——你也可以自由组合使用：
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      <td><a href="https://wiki.seeedstudio.com/cn/sensecraft_hmi_overview" target="_blank" rel="noopener noreferrer"><strong>SenseCraft Seeedash</strong></a></td>
    ...
    <tr>
      <td><a href="https://wiki.seeedstudio.com/cn/epaper_work_with_zephyr" target="_blank" rel="noopener noreferrer"><strong>Zephyr RTOS</strong></a></td>
      <td align="center">RTOS</td>
      <td>上游 Zephyr 开发板工作流，包括 west、设备树、内核服务、驱动、烧录和调试。</td>
    ...
    <tr>
      ...
      <td>在浏览器中拖拽式编辑 LVGL UI，然后导出可直接编译的代码。</td>
    ...
    <tr>
      ...
      <td align="center">可视化 UI 设计</td>
      <td>基于 Web 的绘图工具，可为单色和彩色电子纸布局导出代码。</td>
      <td>reTerminal E1001 / E1002</td>
    </tr>
    <tr>
...
- [Work with ESPHome](https://wiki.seeedstudio.com/cn/epaper_work_with_esphome) — 主参考：烧录路径、通用 YAML 模板、Home Assistant 集成。按产品划分的 cookbooks：[reTerminal E（基础）](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_esphome)、[reTerminal E（进阶）](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_esphome_advanced)、[EE04](https://wiki.seeedstudio.com/cn/EE04_with_esphome_advanced)、[XIAO 7.5" Panel](https://wiki.seeedstudio.com/cn/xiao_075inch_epaper_panel_esphome)、[TRMNL DIY Kit](https://wiki.seeedstudio.com/cn/ogdiy_kit_works_with_esphome)。
- [Work with TRMNL](https://wiki.seeedstudio.com/cn/reterminal_e10xx_trmnl) — 通过 TRMNL 云平台部署电子墨水仪表盘。一篇文章同时覆盖 reTerminal E1001/E1002、TRMNL DIY Kit 和 XIAO 7.5" ePaper Panel——在标签页中选择你的硬件即可。

### 零代码 / 可视化 UI 设计工具

- [Work with SenseCraft Seeedash](https://wiki.seeedstudio.com/cn/EE04_with_hmi) — Seeed 的零代码可视化界面平台；覆盖 reTerminal E 系列和 EE0x 驱动板。
- [Work with SquareLine Vision](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_squareline_vision)
- [Work with EEZ Studio](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_eezstudio) — 组合 reTerminal E 系列 + EE04 的 LVGL 工作流。
- [Work with Lopaka](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_lopaka)

### 基于代码的开发

- [Work with Arduino](https://wiki.seeedstudio.com/cn/epaper_work_with_arduino) — 主参考：IDE 配置、`Seeed_GFX` 库、`driver.h` 生成。按产品划分的 cookbooks：reTerminal E 系列 — [ePaper Display](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_arduino) 与 [Onboard Peripherals](https://wiki.seeedstudio.com/cn/reterminal_e10xx_with_arduino_peripherals)、[TRMNL DIY Kit](https://wiki.seeedstudio.com/cn/ogdiy_kit_works_with_arduino)、[XIAO 7.5" Panel](https://wiki.seeedstudio.com/cn/xiao_075inch_epaper_panel_arduino)。
- [Work with PlatformIO](https://wiki.seeedstudio.com/cn/epaper_work_with_platformio) — 主参考：VS Code 配置、`platformio.ini` 配置、`Seeed_GFX` 设置，以及按产品选择 PlatformIO 环境。按产品划分的 cookbook：[EE04 / EE0x PlatformIO](https://wiki.seeedstudio.com/cn/ee04_with_platformio)。
- [Work with Zephyr](https://wiki.seeedstudio.com/cn/epaper_work_with_zephyr) — reTerminal E1001、E1002 和 E1003 上 Zephyr RTOS 支持的入口页面，包含官方 Zephyr 开发板文档链接和开发板目标信息。

### 开源 ESL / OEPL

- [Work with OpenEPaperLink / OpenDisplay](https://wiki.seeedstudio.com/cn/EN04_opendisplay) — 一篇文章同时覆盖 EN04 BLE 套件和 ePaper Breakout Board + XIAO nRF52840 DIY 路径。

## 资源

- [SenseCraft Seeedash Documentation](https://wiki.seeedstudio.com/cn/sensecraft_hmi_overview/)
- [ESP32-S3 Datasheet](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/esp32-s3_datasheet.pdf)
- [XIAO Series Overview](https://wiki.seeedstudio.com/cn/xiao_topic_page/)
