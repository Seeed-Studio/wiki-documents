...
这块显示板集成了多个板载外设。[Function](/cn/function_0.96_inch_display_nrf52840) 页面为每个外设都提供了独立的演示：

<div class="table-center">
  <table align="center">
    <tr><th>外设</th><th>演示</th></tr>
    <tr><td>屏幕</td><td>[GraphicTest](/cn/function_0.96_inch_display_nrf52840#screen-display--graphictest) — 十种图形基本图元及其计时基准测试</td></tr>
