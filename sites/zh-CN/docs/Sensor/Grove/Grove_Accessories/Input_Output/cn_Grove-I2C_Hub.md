...
keywords:
  - docs
  - docusaurus
image: https://wiki.seeedstudio.com/cn/Grove-I2C_Hub/
slug: /Grove-I2C_Hub
sku: 103020006
last_update:
  date: 01/06/2022
...
url: https://wiki.seeedstudio.com/cn/Grove-I2C_Hub/
---

![](https://files.seeedstudio.com/wiki/Grove-I2C_Hub/img/I2C_hub.jpg)

I2C Hub Grove 是一个扩展 Grove 模块，用于将多个 I2C 设备连接到 Grove 基础扩展板。它可以与 [Universal 4 Pin to X2 4 Pin cable](https://www.seeedstudio.com/depot/universal-4-pin-to-x2-4-pin-cable-5-pcs-pack-p-847.html?cPath=178_179) 一起使用，并最多连接 3 个 I2C 设备，满足大多数开发需求。
...
- 在 Grove 平台上使用更多的 I2C 设备，而无需担心空间不足。

使用方法
-----

同时使用相同的 I2C 插座不会产生冲突，因为每个 I2C 设备都有自己的地址。硬件安装如下图所示。
...
<!-- 此 Markdown 文件来源于 https://www.seeedstudio.com/wiki/Grove_-_I2C_Hub -->
