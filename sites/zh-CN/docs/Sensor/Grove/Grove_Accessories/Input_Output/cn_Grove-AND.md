...
keywords:
  - docs
  - docusaurus
image: https://wiki.seeedstudio.com/cn/Grove-AND/
slug: /Grove-AND
last_update:
  date: 01/09/2022
  author: gunengyu
...
该模块提供了[逻辑与门](https://en.wikipedia.org/wiki/AND_gate)的功能。它基于74HC1G08芯片，这是一种高速硅门CMOS器件，提供2输入与功能。因此，Grove - AND模块在左侧有两个输入，在右侧有一个输出。只有当所有输入信号为高电平时，输出才为高电平。
