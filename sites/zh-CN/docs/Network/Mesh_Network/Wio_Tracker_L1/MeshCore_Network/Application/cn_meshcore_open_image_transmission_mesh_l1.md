---
description: 本指南介绍如何基于 Card Tracker wio tracker L1，使用超低码率图像压缩，通过 MeshCore 发送由 AI 重建的图像。
title: 图像传输
keywords:
  - MeshCore
  - MeshCore Open
...
url: https://wiki.seeedstudio.com/cn/meshcore_ai_image_transmission_l1/
---
