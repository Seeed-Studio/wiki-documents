...
url: https://wiki.seeedstudio.com/cn/meshcore_ai_image_transmission_x1/
---
...
2. 将你的 MeshCore 节点连接到 APP。[点击这里](https://wiki.seeedstudio.com/cn/sensecap_meshtracker_x1_meshcore/#app-connection) 阅读 MeshTracker X1 连接指南。
3. 配置你的 LoRa 区域和网络设置。
