...
url: https://wiki.seeedstudio.com/cn/Network/SenseCAP_Network/SenseCAP_M2_Multi_Platform/Introduction/
---
...
- 如需技术支持，请在官方 [**SenseCAP MX 社区 Discord**](https://discord.com/invite/sensecap) 频道联系 SenseCAP MX 团队。
:::
...
- **支持以太网供电 (PoE)：** 对于需要通过以太网为网关供电而不是额外电源线的用户，该设备还添加了 PoE 功能，使您的部署更加可靠和快速。
...
- **专业的管理工具和云服务：** 用户可以通过 Web 界面轻松地在几个简单步骤中设置网关。SenseCAP Portal 和 SenseCAP Local Console 也为用户高效便捷地监控和管理网关而开发。
