...
- 拔下 USB 线，然后按住按键不放，再在按住按键的同时重新插上 USB 线并继续按住 5 秒。
...
当你完成以上步骤后，你可以按照这个[步骤](https://wiki.seeedstudio.com/cn/sensecap_t1000_e/#flash-the-application-firmware)来烧录应用固件。
...
- 按住设备按键不放，然后连接充电线。当电脑中弹出一个磁盘后，你可能会看到串口。
