...
本指南介绍如何使用 [MeshTracker X1](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) 在 Meshtastic Node Map 上显示 [Meshtastic](https://meshtastic.org/docs/introduction/) 设备的位置，前提是这些设备已经刷入 Meshtastic 固件。
...
## 开始使用 Liam Cottle 的 Meshtastic Map
...
在浏览器中打开 **Liam Cottle 的 Meshtastic Map**： [Liam Cottle 的地图链接](https://meshtastic.liamcottle.net/)。你将在地图上看到所有节点。
