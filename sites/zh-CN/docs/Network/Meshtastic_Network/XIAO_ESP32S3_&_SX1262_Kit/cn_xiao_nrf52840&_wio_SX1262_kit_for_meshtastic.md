...
- **双核通信**：支持 Bluetooth 和 LoRa 双模通信，实现跨域互联。
...
XIAO nRF52840 & Wio-SX1262 套件已预先烧录 Meshtastic 固件，可帮助你快速开始使用。
...
点击 `Enter DFU Mode`，此时会出现一个名为 `XIAO-xxx` 的串口，点击并连接它，系统中应显示一个名为 `XIAO-xxx` 的驱动器。

<p style={{textAlign: 'center'}}><img src="https://files.seeedstudio.com/wiki/SenseCAP/Meshtastic/52840-connect.png" alt="pir" width={800} height="auto" /></p>

将 UF2 文件拖入 DFU 盘中。文件拷贝完成并设备重启后，固件就会被烧录。
...
- **[Ebook]** [XIAO：Big Power, Small Board 掌握 Arduino 与 TinyML](https://mjrovai.github.io/XIAO_Big_Power_Small_Board-ebook/)
