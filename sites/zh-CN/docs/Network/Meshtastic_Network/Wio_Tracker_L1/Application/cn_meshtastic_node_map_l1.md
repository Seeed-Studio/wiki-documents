---
description: 本指南说明如何使用 Meshtastic 节点地图在 Meshtastic Node Maps 上显示 Meshtastic 设备的位置。
...
本指南说明如何在 Meshtastic 节点地图上显示 [Meshtastic](https://meshtastic.org/docs/introduction/) 设备的位置，这里使用 [Wio Tracker L1 Pro](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) 和 [T1000-E](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-E-for-Meshtastic-p-5913.html) 设备，并假设这些设备已经刷入 Meshtastic 固件。
...
Meshtastic 设备会通过 MQTT 定期向 Meshtastic 服务器上报其位置。节点地图会获取这些上报信息，并显示每个节点的位置、路径和信号范围。设备可以通过以下方式上报位置：
...
在浏览器中打开 **Liam Cottle 的 Meshtastic 地图**： [Liam Cottle 地图链接](https://meshtastic.liamcottle.net/)。你将会在地图上看到所有节点。
