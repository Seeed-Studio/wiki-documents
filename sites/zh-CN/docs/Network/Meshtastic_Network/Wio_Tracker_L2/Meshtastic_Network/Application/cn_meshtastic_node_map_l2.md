---
description: 本指南介绍如何使用 MeshTracker X1 在 Meshtastic 节点地图上显示 Meshtastic 设备的位置。
...
url: https://wiki.seeedstudio.com/cn/meshtastic_node_map_l2/
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

本指南介绍如何使用 [MeshTracker X1](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) 在 Meshtastic 节点地图上显示 [Meshtastic](https://meshtastic.org/docs/introduction/) 设备的位置，前提是这些设备已经刷入 Meshtastic 固件。
...
| 节点地图 | 功能 | 适用人群 | 备注 |
|----------|----------|-----------|-------|
| [MeshMap](https://meshmap.net/) | 实时节点跟踪、Mesh 路由显示、信号范围显示 | 普通用户、初学者 | 界面简单，使用默认 Meshtastic 服务器 |
