...
这是一款基于 [Meshtastic®](https://meshtastic.org/) 的经济型太阳能供电通信节点或中继器，集成了 XIAO nRF52840 Plus 主控制器和 Wio-SX1262 LoRa 模组。它专为无网络覆盖区域设计，支持远距离通信、精确定位和低功耗运行，适用于扩展户外区域的网络覆盖。
