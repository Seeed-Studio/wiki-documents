---
description: 本指南说明如何使用 Meshtastic 节点地图显示 Meshtastic 设备的位置。
...
url: https://wiki.seeedstudio.com/cn/meshtastic_node_map_solar_node/
---
...
本指南说明如何在 Meshtastic 节点地图上显示 [Meshtastic](https://meshtastic.org/docs/introduction/) 设备的位置，使用 [Wio Tracker L1 Pro](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) 和 [T1000-E](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-E-for-Meshtastic-p-5913.html) 设备，前提是这些设备已经刷入 Meshtastic 固件。
...
在浏览器中打开 **Liam Cottle 的 Meshtastic 地图**： [Liam Cottle 的地图链接](https://meshtastic.liamcottle.net/)。你将在地图上看到所有节点。
