...
url: https://wiki.seeedstudio.com/cn/Sound_Sensor_And_LED_Bar/
---
...
--- -->
这个演示将展示如何使用声音传感器，为了指示声音的强度，我们需要一个LED灯条。
...
声音传感器的输出是模拟信号，我们将其连接到Seeeduino的A0引脚。
...
打开Arduino IDE，点击File -> Sketchbook -> sound_sensor。
