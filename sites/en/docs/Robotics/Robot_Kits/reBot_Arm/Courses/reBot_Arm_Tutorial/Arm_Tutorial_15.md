...
<section id="why-act" className="section-card">
  <div className="section-title">
    <span>ACT</span>
    <h2>15.1 From Behavioral Cloning to ACT: Just Need a "Good Model"</h2>
  </div>
...
<section id="input-output" className="section-card">
  <div className="section-title">
    <span>Interface</span>
    <h2>15.2 ACT Input and Output: See Both Ends First</h2>
  </div>
...
<section id="architecture" className="section-card">
  <div className="section-title">
    ...
    <h2>15.3 ACT Internal Structure: Three Workshops on One Assembly Line</h2>
  </div>
...
<section id="transformer" className="section-card">
  <div className="section-title">
    ...
    <h2>15.4 What Is a Transformer: Intuition Behind Attention</h2>
  </div>
...
<section id="transformer-in-act" className="section-card">
  <div className="section-title">
    <span>Attention</span>
    <h2>15.5 How Transformer Is Used in ACT</h2>
  </div>
...
<section id="defenses" className="section-card">
  <div className="section-title">
    <span>Defenses</span>
    <h2>15.8 Action Continuity and Error Accumulation: ACT's Two Lines of Defense</h2>
  </div>
...
<section id="fit" className="section-card">
  <div className="section-title">
    <span>Fit</span>
    <h2>15.9 What Tasks Is ACT Suited For?</h2>
  </div>
...
<section id="boundaries" className="section-card">
  <div className="section-title">
    ...
    <h2>15.10 ACT's Capability Boundaries</h2>
  </div>
