...
1. We have **a bunch of assignments available(shown below)** on GitHub that our team needs help with to enhance our wiki platform, each with a detailed description of what is required.
2. Once completed, the contributor can submit their content via "Pull Request".
3. Upon approval, our team of maintainers will merge the submission, record the contributions and provide tokens of appreciation.
...
We welcome more ideas! The topics-related, the scenarios-related, your wishes...

![](http://files.seeedstudio.com/wiki/wiki-platform/contributor/submit.png)

1. Share your ideas by filing out the simple table: your name(email), your wanted projects, and the description of them.
...
:::info
They will show right away - Just refresh the page to see them.
:::
...
:::info
You can complete the assignment yourself, or let others achieve it. You will be rewarded as well!
:::

## What do we offer?

We wish to express our gratitude to our contributors by offering a range of rewards.
Depending on the estimated difficulty ***(Tier 0/1/2/3)***, the estimated time to complete ***(1/3/7/15 Days)***, as well as the actual time taken, and the quality of the submitted content, we will offer varying levels of rewards.
...
3. Any additional thoughts about “solution-based” prototypes, a deployable solution, or even an interesting project idea! (Digital automation; Decentralized digital transformation; Infrastructures deployable in the wild; Carbon neutrality; Sustainable Development Goals(SDGs); Problems solved in daily life; TinyML; etc.) We value creativity and innovation, so feel free to share your ideas with us!

## Tech Support & Product Discussion

Thank you for choosing our products! We are here to provide you with different support options to ensure that your experience with our products is as smooth as possible. We offer several communication channels to cater to different preferences and needs.
...
If you have any questions or comments, please do not hesitate to hop on our forum to discuss them with us directly or contact us! We value all feedback and opinions and believe that the way to grow and prosper is together with our users and the community!
...
<table align="center">
  <tbody>
    ...
    <tr>
      ...
      <td align="left"><strong>Seeed on LinkedIn</strong><br />Digital transformation is happening. Follow us for IoT Industry news, insights, case studies, and more on LinkedIn.<p><a href="https://www.linkedin.com/company/seeedstudio" target="_blank">Click here</a></p></td>
    </tr>
  </tbody>
</table>
