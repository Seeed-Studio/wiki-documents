...
In the left sidebar of the workspace page, click on the **Output** option. From the available output options, select **GPIO** to access the GPIO configuration settings.
