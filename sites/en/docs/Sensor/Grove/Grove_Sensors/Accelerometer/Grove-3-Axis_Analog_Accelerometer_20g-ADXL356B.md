...
url: https://wiki.seeedstudio.com/Grove-3-Axis_Analog_Accelerometer_20g-ADXL356B/
---
...
|Sensitivity at X<sub>OUT</sub>, Y<sub>OUT</sub>, Z<sub>OUT</sub> / (Ratiometric to V1P8ANA)|±10 g@80 mv/g (Typ.) / ±20 g@40 mv/g (Typ.)|
