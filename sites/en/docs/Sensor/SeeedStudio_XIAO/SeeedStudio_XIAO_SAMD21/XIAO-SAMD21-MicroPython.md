...
- [Seeed Studio XIAO SAMD21](https://www.seeedstudio.com/Seeeduino-XIAO-Arduino-Microcontroller-SAMD21-Cortex-M0+-p-4426.html) or [Seeed Studio XIAO SAMD21 Plus](https://www.seeedstudio.com/Seeed-Studio-XIAO-SAMD21-Plus-p-6933.html) x1
- Type-C cable x1
- PC x1
...
| MicroPython Pin Name | XIAO SAMD21 GPIO (ID) | XIAO SAMD21 Plus GPIO (ID) | IRQ SAMD21 / Plus | ADC | Function |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
| USER_LED / D13 / SCL1 | PA17 (17) | PA17 (17) | 1 / 1 | — | Original user LED; Plus D13 & I2C1 SCL |
| RX_LED / D27 | PA18 (18) | PA18 (18) | 2 / 2 | — | Original RX LED; Plus D27 |
| TX_LED / D19 / I2S_SD | PA19 (19) | PA19 (19) | 3 / 3 | — | Original TX LED; Plus D19 & I2S data |
| D12 | — | PA28 (28) | — / 8 | — | Plus expansion GPIO |
...
| D20 / I2S_SCK | — | PA20 (20) | — / 4 | — | Plus GPIO & I2S clock |
| D21 / I2S_WS | — | PA21 (21) | — / 5 | — | Plus GPIO & I2S word select |
...
| RGB_LED | — | PA27 (27) | — / 15 | — | Plus addressable RGB LED (WS2812) |
| BUTTON | — | PB22 (54) | — / 6 | — | Plus user button (active low) |
| USB_DM | PA24 (24) | PA24 (24) | 12 / 12 | — | USB D− (native USB, not GPIO) |
| USB_DP | PA25 (25) | PA25 (25) | 13 / 13 | — | USB D+ (native USB, not GPIO) |
...
1. For XIAO SAMD21 , The RX_LED is PA18
...
2. For XIAO SAMD21 Plus, the RX_LED and TX_LED have been removed. A WS2812 LED is used instead, with its data pin assigned to PA27.
<br/>
```py
from machine import Pin, Timer
import machine
