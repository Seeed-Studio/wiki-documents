...
:::tip
Before this, I had already installed the XIAO RA4M1 installation package, so you can see that the image in operation two has the option for XIAO RA4M1, but you don't have it when you perform the operation.
:::
...
In the end, if you see the same result as in the picture above, it means you have successfully added the XIAO RA4M1 Development Board. When you create a project again, you will see the XIAO RA4M1 option available.
