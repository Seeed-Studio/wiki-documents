...
title: reSpeaker Flex control with Python
keywords:
  - reSpeaker flex
  - xvf3800
  - python
...
url: https://wiki.seeedstudio.com/respeaker_flex_python_control/
---
...
We have a comprehensive Python guide on how to communicate with the Flex using the USB firmware. This Python script can be run in your favorite IDE without requiring the Flex **XVF_Host**. You can find more commands from this [link](https://github.com/respeaker/reSpeaker_Flex/tree/main/python_control).
