...
- [reTerminal E Series — ePaper Display cookbook](/reterminal_e10xx_with_arduino) — covers reTerminal E1001 / E1002 / E1003 / E1004 with Hello World examples using both `Seeed_GFX` and `GxEPD2`.
- [reTerminal E Series — Onboard Peripherals cookbook](/reterminal_e10xx_with_arduino_peripherals) — full peripheral examples for the same models: LED, buzzer, three user buttons, SHT4x sensor, battery monitor, microSD card, and BMP image rendering from SD.
...
- **[reTerminal E Series — ePaper Display cookbook](/reterminal_e10xx_with_arduino)** — Hello World on E1001/E1002/E1003/E1004 with both `Seeed_GFX` and `GxEPD2`.
- **[reTerminal E Series — Onboard Peripherals cookbook](/reterminal_e10xx_with_arduino_peripherals)** — the full peripheral suite for the same models: LED control, buzzer (passive PWM beeps + melody playback), 3-button input, SHT4x temperature/humidity, battery management, microSD card, BMP image rendering from SD.
