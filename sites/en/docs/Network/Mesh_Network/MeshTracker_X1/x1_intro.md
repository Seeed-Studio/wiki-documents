---
description: SenseCAP MeshTracker X1 for Meshtastic Introduction. This wiki will introduce the features, specification, hardware overview, button, LED and pin list.
title: SenseCAP MeshTracker X1 Introduction
keywords:
  - Tracker
  - Meshtastic
...
|Four clicks|Temporarily mute/unmute|-|
