---
description: A practical tutorial for setting up the Meshtastic firmware source code environment, compiling the MeshTracker X1, and flashing the firmware.
title: Meshtastic Development Tutorial
keywords:
  - Meshtastic
  - Source Code
  - PlatformIO
...
url: https://wiki.seeedstudio.com/meshtastic_source_code_practical_tutorial_meshtracker_x1/
...
This shows that, in Meshtastic, **the build target for MeshTracker X1** `seeed_mesh_tracker_X1`.
