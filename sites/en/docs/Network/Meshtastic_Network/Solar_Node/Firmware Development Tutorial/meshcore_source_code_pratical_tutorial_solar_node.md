---
description: A practical tutorial for setting up the MeshCore firmware source code environment, compiling the solar node, and flashing the firmware.
...
url: https://wiki.seeedstudio.com/meshcore_source_code_pratical_tutorial_solar_node/
