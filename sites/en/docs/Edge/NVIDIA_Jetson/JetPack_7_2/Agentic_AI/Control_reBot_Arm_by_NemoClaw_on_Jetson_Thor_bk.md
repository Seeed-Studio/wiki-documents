...
url: https://wiki.seeedstudio.com/control_rebot_arm_with_nemoclaw_on_nvidia_jetson_thor_bk/
...
This Jetson Thor example is included as an agentic-AI workflow in the JetPack 7.2 ecosystem. Confirm the installed JetPack/L4T version and revalidate the NemoClaw, Ollama, container, and service versions before deployment.
:::
