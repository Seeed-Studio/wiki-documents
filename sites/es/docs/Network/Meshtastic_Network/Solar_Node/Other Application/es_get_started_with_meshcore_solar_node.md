...
Cuando la barra de progreso se llene por completo, indica que el flasheo ha finalizado. Entonces el dispositivo se reiniciará automáticamente.
...
:::tip
Si el dispositivo no responde cuando conectas el cable USB, por favor cárgalo primero. No uses un cargador de carga rápida.
:::
...
Cambia la región LoRa y guarda la configuración. Luego `Reboot` el dispositivo, de lo contrario la configuración no tendrá efecto.
...
Además, puedes ajustar el intervalo de transmisión del anuncio. El rango de intervalo de `auto zero hop advert` es de 60-240 min. El rango de intervalo de `auto flood advert` es de 3-168 horas. 
