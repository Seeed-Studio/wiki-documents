...
:::tip
Cuando necesites instalar o reemplazar la batería, utiliza una batería `Button-top` 18650(3.6V).
...
- Puedes instalar tu sensor mediante este video.
...
Cuando hayas completado los pasos anteriores, puedes seguir este [paso](https://wiki.seeedstudio.com/es/get_started_with_meshtastic_solar_node/#flash-firmware) para grabar el firmware de la aplicación.
