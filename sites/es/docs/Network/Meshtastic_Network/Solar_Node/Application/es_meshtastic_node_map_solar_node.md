...
url: https://wiki.seeedstudio.com/es/meshtastic_node_map_solar_node/
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

Esta guía explica cómo mostrar las ubicaciones de dispositivos [Meshtastic](https://meshtastic.org/docs/introduction/) en los Mapas de Nodos Meshtastic usando los dispositivos [Wio Tracker L1 Pro](https://www.seeedstudio.com/Wio-Tracker-L1-Pro-p-6454.html) y [T1000-E](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-E-for-Meshtastic-p-5913.html), suponiendo que los dispositivos ya se han flasheado con el firmware de Meshtastic.
...
Los dispositivos Meshtastic informan periódicamente de su ubicación a un servidor Meshtastic a través de MQTT. El Mapa de Nodos recupera estos informes y muestra la posición, la ruta y el alcance de la señal de cada nodo. Los dispositivos pueden informar de su ubicación:

- **Directamente mediante MapReport:** El dispositivo envía los datos de ubicación directamente al servidor.
- **Indirectamente a través de otros nodos:** La ubicación se retransmite mediante nodos vecinos.
...
| Mapa de nodos | Características | Ideal para | Notas |
|----------|----------|-----------|-------|
...
| [Mapa Meshtastic de Liam Cottle](https://meshtastic.liamcottle.net/) | Seguimiento en tiempo real, vista de rutas históricas, visualización del alcance de la señal | Usuarios avanzados, análisis de datos | Usa un servidor MQTT personalizado |

## Primeros pasos con MeshMap
...
**Ajustes de MQTT**
   ...
   - Usa el servidor, nombre de usuario y contraseña predeterminados de Meshtastic.
...
## Primeros pasos con el Mapa Meshtastic de Liam Cottle
