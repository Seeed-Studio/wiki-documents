---
description: Un tutorial práctico para configurar el entorno del código fuente del firmware de Meshtastic, compilar el objetivo Wio Tracker L1, hacer un cambio sencillo en la interfaz de usuario y grabar el firmware.
...
Si ya estás familiarizado con Git, Python o PlatformIO, puedes saltarte las secciones correspondientes e ir directamente a la parte práctica.
...
Antes de empezar, prepara las siguientes herramientas:
...
El instalador normalmente empieza a descargarse automáticamente cuando abres la página. Cuando termine la descarga, haz doble clic en el instalador y sigue el asistente de instalación.
...
Se recomienda empezar con tres tareas:
