---
description: Un tutorial práctico para configurar el entorno del código fuente del firmware MeshCore, compilar el Tracker L1 y grabar el firmware.
...
Abre una carpeta en la que quieras tu proyecto. Abre la carpeta en la terminal. [Haz clic aquí](https://github.com/meshcore-dev/MeshCore) para clonar el proyecto con git.
