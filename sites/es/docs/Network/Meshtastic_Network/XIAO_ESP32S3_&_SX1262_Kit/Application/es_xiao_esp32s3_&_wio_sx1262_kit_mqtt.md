...
title: Configuración de una pasarela MQTT con XIAO ESP32S3 y Wio-SX1262 Kit
...
Comprueba tu ID de dispositivo en el registro del puerto serie. Por ejemplo, el registro que se muestra a continuación indica que el ID del dispositivo es 24c0.
...
Abre la aplicación Meshtastic para Android y conéctate a tu dispositivo mediante Bluetooth. El código PIN predeterminado es 123456
