...
url: https://wiki.seeedstudio.com/es/meshcore_node_map_meshtracker_x1/
---
...
[Nodo MeshCore normal] → [Nodos Mesh configurados con MQTT] → [Backend API / Base de datos] → [Interfaz de usuario del mapa frontend]
