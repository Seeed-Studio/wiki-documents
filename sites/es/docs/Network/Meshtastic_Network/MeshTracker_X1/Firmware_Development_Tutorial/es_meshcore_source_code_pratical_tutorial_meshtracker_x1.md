---
description: Un tutorial práctico para configurar el entorno del código fuente del firmware MeshCore, compilar el MeshTracker X1 y flashear el firmware.
...
url: https://wiki.seeedstudio.com/es/meshcore_source_code_pratical_tutorial_meshtracker_x1/
...
Encuentra el entorno para tu placa objetivo. Toma T1000-E Bluetooth Copanion como ejemplo:
...
Mantén presionado el botón del dispositivo y luego conecta rápidamente el cable de carga dos veces; el LED verde quedará encendido de forma fija. Arrastra el archivo uf2 al disco que aparece. El archivo uf2 se puede encontrar en `.pio\build\t1000e_companion_radio_ble`
...
2. Obtén una aprobación general 👍 de los mantenedores
