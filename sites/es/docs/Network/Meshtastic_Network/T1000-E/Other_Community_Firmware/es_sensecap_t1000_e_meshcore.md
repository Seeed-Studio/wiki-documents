...
MeshCore te permite emitir manualmente tu nombre, posición y clave pública de cifrado, que también se firma para evitar suplantaciones. Cuando haces clic en el botón de anuncio, emite esos datos por LoRa. MeshCore lo llama un Anuncio. Hay dos formas de anunciar, "salto cero" y "inundación".

- **Salto cero** significa que tu anuncio se emite a cualquiera que pueda oírlo, y eso es todo.
- **Inundado** significa que se emite y luego se repite por todos los repetidores que lo oyen.
...
```
Por favor cambia COMXX por tu número de puerto COM. Por ejemplo, si tu dispositivo está en el com6, cambia el comando a:
...
- **No se reciben datos en el puerto serie**
 ...
 Comprueba si el dispositivo está en modo DFU, la luz verde se quedará fija cuando el dispositivo esté en modo DFU.
...
- Realiza un [flash erase](https://wiki.seeedstudio.com/es/sensecap_t1000_e_meshcore/#flash-erase) en el dispositivo. Luego vuelve a flashear el firmware más reciente.
...
- [T1000-E para prueba de consumo de Meshtastic y cálculo de la vida útil de la batería](https://files.seeedstudio.com/wiki/SenseCAP/Meshtastic/T1000-E%20for%20Meshtastic%20Consumption%20Test%20and%20Battery%20Life%20Calculation.xlsx)
