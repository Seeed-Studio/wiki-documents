...
- Cambia el cable de carga
 ...
 - Si aún no hay suerte, mantén pulsado el botón del dispositivo y luego conecta el cable de carga, y comprueba si aparece o no un disco en tu PC. Si es así, [haz clic aquí](https://wiki.seeedstudio.com/es/sensecap_t1000_e_meshcore/#flash-the-bootloader) para volver a instalar el bootloader.
...
- Realiza un [Flash erase](https://wiki.seeedstudio.com/es/sensecap_t1000_e_meshcore/#flash-erase) en el dispositivo. Luego vuelve a grabar el firmware más reciente.
