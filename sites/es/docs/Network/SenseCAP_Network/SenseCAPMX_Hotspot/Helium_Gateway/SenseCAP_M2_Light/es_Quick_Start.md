...
url: https://wiki.seeedstudio.com/es/Network/SenseCAP_Network/SenseCAPMX_Hotspot/Helium_Gateway/SenseCAP_M2_Light/Quick_Start/
---
...
- Instala la [Aplicación Helium Wallet](https://docs.helium.com/wallets/helium-wallet-app) y la Aplicación SenseCAP Hotspot

Crea una cuenta para tu Aplicación SenseCAP Hotspot.

![](https://files.seeedstudio.com/wiki/wiki-platform/sensor_network/M2_Light_Hotspot/image3.png)

- Elige "Helium" y vincula tu Helium Wallet a la Aplicación SenseCAP Hotspot.
