...
Configura el gateway a través de la Web UI, por favor revisa el [Quick Start](https://files.seeedstudio.com/products/SenseCAP/M2_Multi-Platform_Gateway/Quick_Start_for_SenseCAP_Gateway_&_Sensors.pdf) para iniciar sesión primero en la Consola Local.
...
Los demás ajustes se pueden dejar por defecto o se pueden cambiar para adaptarse a tus requisitos.
