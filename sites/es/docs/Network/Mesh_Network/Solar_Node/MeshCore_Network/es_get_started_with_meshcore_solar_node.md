...
Las diferentes versiones del firmware MeshCore difieren en el indicador LoRa TX y en el comportamiento del botón de encendido. Antes de juzgar el estado del dispositivo, confirma la versión de firmware que estás utilizando.
...
Las diferentes versiones de firmware MeshCore encienden distintos LED físicos para LoRa TX:
...
Para el modo Repeater, se espera el siguiente comportamiento:
