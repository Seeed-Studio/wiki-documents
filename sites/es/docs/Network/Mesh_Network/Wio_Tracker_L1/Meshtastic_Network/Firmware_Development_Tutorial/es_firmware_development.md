...
Después de que las dependencias estén instaladas, ejecuta:
...
Una vez que la instalación de dependencias haya finalizado, ejecuta de nuevo la compilación normal:
