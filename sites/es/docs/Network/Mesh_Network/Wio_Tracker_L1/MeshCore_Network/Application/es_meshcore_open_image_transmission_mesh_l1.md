---
description: Esta guía explica cómo enviar imágenes reconstruidas por IA a través de MeshCore utilizando compresión de imágenes de tasa de bits ultra baja basada en Card Tracker wio tracker L1.
...
url: https://wiki.seeedstudio.com/es/meshcore_ai_image_transmission_l1/
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Transmisión de Imágenes con IA sobre MeshCore con Wio Tracker L1
...
- **Equipos de respuesta a emergencias y desastres**: El equipo puede compartir las condiciones de campo, proporcionar actualizaciones visuales rápidas y mejorar la conciencia del equipo mediante imágenes.
...
2. Conecta tu nodo MeshCore a la APP. [Haz clic aquí](https://wiki.seeedstudio.com/es/get_started_with_other_mesh_firmware/#connect-via-app) para leer la guía de conexión L1.
3. Configura tu región LoRa y los ajustes de red.
4. Asegúrate de que otro nodo MeshCore esté disponible como receptor.

Para obtener instrucciones generales de configuración de MeshCore, consulta la [Guía de inicio de MeshCore Open](https://meshcoreopen.org/docs/getting-started/):

### Instalar el modelo

Habilita la transmisión de imágenes y descarga los archivos del modelo ml en la configuración de la APP.
