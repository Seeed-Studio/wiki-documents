...
- **PASO 3:** Escribe **lwMQTT** y **Google Cloud IoT** en el cuadro de búsqueda e instala las librerías
...
Conecta el Grove - Sensor de Temperatura y Humedad (DHT11) al Grove - Puerto Digital/Analógico (D0) del Wio Terminal.

#### Configuración de Software para Arduino

- **PASO 1:** Visita el [repositorio del Grove - Sensor de Temperatura y Humedad](https://github.com/Seeed-Studio/Grove_Temperature_And_Humidity_Sensor) y descárgalo como archivo zip
