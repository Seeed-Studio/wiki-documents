---
description: Hoja de datos completa de hardware de Reachy Mini que incluye dimensiones, grados de libertad, especificaciones de los motores, cámara, matriz de micrófonos y componentes electrónicos.
