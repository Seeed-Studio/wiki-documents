---
description: Hoja de datos de hardware de Reachy Mini Lite que incluye dimensiones, grados de libertad, especificaciones del motor, cámara, matriz de micrófonos y componentes electrónicos.
