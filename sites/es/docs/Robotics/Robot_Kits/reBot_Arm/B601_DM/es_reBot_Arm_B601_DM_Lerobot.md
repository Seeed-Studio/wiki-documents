...
# Introducción al reBot Arm B601-DM basado en LeRobot y al reBot 102 Leader
...
Si tienes más cámaras, puedes cambiar el parámetro `--robot.cameras` para añadirlas. Debes tener en cuenta el formato de `index_or_path`, que viene determinado por el último dígito del ID de la cámara que se muestra con `python -m lerobot.find_cameras opencv`.
...
- Entrenar ACT en 50 conjuntos de datos toma aproximadamente 6 horas en un portátil con una RTX 3060 (8GB), y alrededor de 2-3 horas en equipos con GPU RTX 4090 o A100.
