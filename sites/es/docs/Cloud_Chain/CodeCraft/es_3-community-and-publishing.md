...
En la [Application Gallery](https://sensecraft.seeed.cc/ai/application?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecraft_ai_app_square) de SenseCraft AI, puedes completar todo el flujo de trabajo, desde descubrir inspiración hasta publicar proyectos, en un solo lugar.
...
|------|----------|
| 🔍 Encontrar inspiración | Explorar una gran cantidad de proyectos para obtener ideas |
| 📖 Aprender con ejemplos oficiales | Estudiar implementaciones estandarizadas proporcionadas por el equipo oficial |
| ♻️ Reutilizar proyectos de la comunidad | Hacer fork o adaptar directamente trabajos existentes |
| 🚀 Publicar tu propio trabajo | Mostrar tus creaciones a la comunidad |
| 🎮 Probar rápidamente el hardware | Desde minijuegos hasta proyectos maker complejos, permitiendo la creación rápida de prototipos |

**Ventajas principales**

- **CodeCraft acelera el desarrollo** — Te ayuda a crear prototipos más rápido y reduce las barreras de programación.
- **Publicación con un solo clic** — Los proyectos terminados pueden publicarse directamente en la galería para su reutilización global.
...
| :--- | :--- | :--- |
| **Explorar y reutilizar** | **Clone** (copiar proyecto → modificar a partir del original) | • Probar rápidamente placas de desarrollo o sensores<br/>• Modificar ejemplos existentes<br/>• Adaptar proyectos oficiales para enseñanza o demostraciones |
...
### 3.2.2 Preguntas frecuentes sobre la publicación
...
| **¿Se admiten GIF en las portadas y documentos?** | - Sí, se admiten GIF tanto en la portada como en la documentación<br/>- Recomendados para demostraciones dinámicas<br/>- Mantén el tamaño del archivo pequeño para evitar cargas lentas |
...
Abre la [SenseCraft AI Application Gallery](https://sensecraft.seeed.cc/ai/application?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecraft_ai_app_square). Puedes crear una nueva aplicación desde cero o clonar una existente para modificarla y volver a publicarla.
...
| **Subir archivo de firmware** | • Sube archivos `.bin` o `.hex`<br/>• `.hex` normalmente para Grove Beginner Kit<br/>• Asegúrate de que el firmware esté probado | ![Subir firmware](https://files.seeedstudio.com/SenseCraft/sensecraft-wiki/codecraft/3-community-and-publishing/add-firmware-burning-function-block-ZH.png) |
