...
Sigue las instrucciones para autorizar a Home Assistant a acceder a tu cuenta de GitHub. Normalmente esto implicará introducir un código de verificación proporcionado por GitHub para confirmar tu identidad.
...
Después de hacer clic en la esquina superior izquierda para conectarte a Grove Vision AI V2, activa el botón MQTT e introduce la siguiente información que necesitas rellenar en la página.
