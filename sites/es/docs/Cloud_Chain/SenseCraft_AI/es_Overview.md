---
description: Explora modelos preentrenados, entrenamiento personalizado, implementación, vista previa en vivo y flujos de trabajo de salida de modelos en SenseCraft AI para dispositivos edge AI compatibles.
title: 'SenseCraft AI: Entrena e Implementa Modelos de Edge AI'
...
url: https://wiki.seeedstudio.com/es/sensecraft-ai/overview/
---


# SenseCraft AI: Entrena e Implementa Modelos de Edge AI

SenseCraft AI es una plataforma todo en uno diseñada para potenciar a desarrolladores y creadores en la construcción e implementación de proyectos de IA con facilidad. El sitio web ofrece una amplia gama de herramientas y funciones para optimizar el proceso de desarrollo de IA, haciéndolo accesible para usuarios con distintos niveles de experiencia. En este wiki, exploraremos las secciones principales del sitio web de SenseCraft AI, proporcionando una visión general de sus características y funcionalidades clave.
...
La página de inicio de SenseCraft AI sirve como el centro principal, proporcionando a los usuarios una visión general de las funcionalidades principales de la plataforma. La barra de navegación en la parte superior de la página incluye cuatro secciones principales: **Home**, **Applications**, **Models** y **Community**.

- **Home** – Página de aterrizaje de la plataforma.
- **Applications** – Explora el **Application Square** para aplicaciones listas para usar, o gestiona las tuyas en **My Applications** (incluyendo **Create New Applications** y **Create New Workspace for reCamera**).
- **Models** – Contiene la **Model Library** (modelos preentrenados), el **Workspace** por dispositivo, **Training** (Image Classification Detection, Audio Classification Detection, Image Object Detection) y **My Models** (con **Add Model**).
- **Community** – Conéctate con otros usuarios y colaboradores de SenseCraft AI.

El enfoque principal de la página de inicio es la sección **Start your journey: Deploy a pretrained Model**, que guía a los usuarios a través de un proceso paso a paso para implementar un modelo preentrenado utilizando hardware de Seeed Studio. El proceso se divide en tres pasos principales:
...
<div style={{textAlign:'center'}}>
  <img
    ...
    alt="Página de inicio de SenseCraft AI que muestra el flujo de trabajo de Gesture Detection desde el descubrimiento del modelo hasta la implementación y la salida del sensor antes de conectar un dispositivo"
    style={{width:950, maxWidth:'100%', height:'auto'}}
  />
</div>

1. Selecciona un modelo preentrenado del repositorio de modelos.
1. Implementa y previsualiza los resultados del modelo en tiempo real usando la función "Deploy and Preview Vision".
1. Aplica el modelo al hardware de Seeed Studio conectado y visualiza la salida del sensor.
...
Más abajo en la página, los usuarios encontrarán una introducción a la función "Training Models". Esta sección clasifica el contenido relacionado con el entrenamiento de modelos, facilitando que los usuarios encuentren la información que necesitan para entrenar sus propios modelos de IA utilizando los recursos de la plataforma.
...
[SenseCraft AI](https://sensecraft.seeed.cc/ai/model?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecraft_ai_model_library) es una plataforma abierta que permite a los usuarios explorar todos los modelos de IA públicos y las páginas de Inicio sin iniciar sesión. Solo necesitas registrarte e iniciar sesión cuando necesites implementar un modelo o compartir tu propio modelo.

[SenseCraft AI](https://sensecraft.seeed.cc/ai/model?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecraft_ai_model_library) y [SenseCraft Data Platform](https://sensecap.seeed.cc/portal/?utm_source=seeedstudio_wiki&utm_medium=referral&utm_campaign=wiki_to_sensecraft&utm_content=sensecraft_data_portal#/login) (la plataforma original SenseCAP Cloud) son ambos servicios de software proporcionados por Seeed Studio para los usuarios; los usuarios solo necesitan registrarse para obtener una cuenta en cualquiera de las plataformas y luego pueden usar la misma cuenta para iniciar sesión en ambas.

### Registrarse

1. Introduce tu nombre y un correo electrónico válido, y luego haz clic en **get captcha**
...
2. Obtén el código de verificación de tu correo electrónico e introdúcelo en la página de registro
...
3. Introduce tu contraseña y otra información de usuario para completar tu registro.
...
2. Introduce la contraseña antigua y la nueva contraseña para cambiarla.
...
La sección de Modelos Preentrenados del sitio web de SenseCraft AI es un repositorio completo de modelos de IA a los que los usuarios pueden acceder e implementar fácilmente en sus dispositivos. El repositorio de modelos actualmente alberga una impresionante colección de más de 400 modelos, y se añaden más de forma continua.

### Categorías de Modelos

Para ayudar a los usuarios a encontrar el modelo más adecuado para sus necesidades, el lado izquierdo de la página muestra una lista categorizada de modelos. Los usuarios pueden filtrar los modelos según varios criterios, tales como:

- **Supported Devices**: Los usuarios pueden seleccionar modelos que sean compatibles con el hardware específico que están utilizando, garantizando una integración fluida y un rendimiento óptimo.

- **Task**: Los modelos se categorizan según las tareas para las que están diseñados, como Detección, Clasificación o Segmentación. Esto permite a los usuarios identificar rápidamente los modelos que se ajustan a los requisitos de su proyecto.

- **Publisher**: Los usuarios también pueden filtrar los modelos según el publicador, lo que facilita encontrar modelos de fuentes confiables o de desarrolladores específicos.
...
El área central de la página de Modelos Preentrenados muestra información esencial sobre cada modelo, incluyendo su nombre, una breve descripción y una representación visual. Esta vista rápida ayuda a los usuarios a hacerse una idea de lo que ofrece cada modelo y de cómo podría encajar en sus proyectos.
...
- **Entrenamiento rápido**: Esta opción permite a los usuarios generar un modelo de reconocimiento de una sola clase simplemente introduciendo el nombre del objeto. Como se explica en el sitio web: "Based on YOLO - World object detection model, you can quickly generate a single-class recognition model by inputting text."
...
La opción de Entrenamiento rápido dentro del entrenamiento de Detección de objetos está impulsada por el modelo de detección de objetos YOLO-World, que es un sistema de detección de objetos en tiempo real de última generación. Cuando un usuario introduce el nombre de un objeto, el sistema aprovecha el conocimiento preentrenado del modelo YOLO-World para generar un modelo de reconocimiento de una sola clase específicamente adaptado para detectar ese objeto.
...
Sin embargo, es importante reconocer que la opción de Entrenamiento rápido puede tener limitaciones en términos de adaptabilidad y precisión. Dado que el modelo generado se basa en el conocimiento preexistente del modelo YOLO-World, es posible que no siempre capture las características únicas o variaciones del objeto especificado por el usuario. Esto puede conducir a una menor precisión o a detecciones erróneas en ciertos escenarios.
...
|     | Contenido|
| --- | --- |
| Formato del modelo | 1 El formato correcto para el modelo<br />2 Opciones: ONNX, Tensor RT, Pytorch<br />3 La plataforma admitirá más formatos de modelo |
| Tarea | 1 El tipo de tarea del modelo<br />2 Opciones: Detection, Classification, Segment, Pose |
| Framework de IA | 1 El framework de IA del modelo<br />2 Opciones: YOLOV5, YOLOV8, FOMO, MobileNetV2, PFLD<br />3 La plataforma admitirá más frameworks de IA |
| Clases | 1 Clases o etiquetas con las que el modelo categoriza para una tarea o problema específico<br />2 Asegúrate de que el id de clase y el nombre de clase coincidan correctamente. |
| Archivo del modelo | Sube un archivo de modelo en el formato de tu elección. |
| Precisión del modelo | 1 Precisión del modelo<br />2 Opciones: Int8, Float16, Float32 |
...
:::note
Para garantizar el desarrollo saludable de nuestra plataforma, revisaremos los modelos y el contenido publicados por los usuarios. Si se encuentra algún contenido ilegal, no conforme o infractor, no se permitirá su publicación y podrá ser eliminado en consecuencia.
Gracias por tu comprensión y apoyo para mantener un entorno de plataforma saludable.
:::
...
**Publicar modelo**: publicar un modelo privado que estará disponible para todos los usuarios.
...
**Privatizar modelo**: privatizar un modelo público; el modelo solo será visible para ti.
...
**Eliminar modelo**: eliminar un modelo privado; no se permite eliminar modelos públicos.
...
Una vez que un usuario ha subido correctamente un modelo entrenado, puede navegar a la página específica del dispositivo dentro del Espacio de trabajo. En la sección "Process", los usuarios pueden observar la transmisión de detección en tiempo real desde el dispositivo conectado, lo que les permite previsualizar el rendimiento del modelo en acción.

Esta función de vista previa en tiempo real es especialmente valiosa, ya que permite a los usuarios evaluar la precisión y eficacia del modelo en la detección de objetos dentro del flujo de vídeo del dispositivo. Los usuarios pueden inspeccionar visualmente las cajas delimitadoras, etiquetas y puntuaciones de confianza generadas por el modelo, lo que proporciona una retroalimentación inmediata sobre su rendimiento.
...
El Workspace va más allá del despliegue y la vista previa del modelo al proporcionar a los usuarios las herramientas para crear prototipos rápidamente y desarrollar aplicaciones utilizando los modelos entrenados. La sección "Output" ofrece una variedad de opciones para que los usuarios interactúen con los resultados del modelo e integren dichos resultados en las aplicaciones que deseen.

Tomando como ejemplo el XIAO ESP32S3 Sense, el Workspace admite varios protocolos e interfaces de comunicación, como MQTT, GPIO y puerto serie. Estas opciones permiten a los usuarios transmitir sin problemas la salida del modelo a otros sistemas, desencadenar acciones basadas en la detección de objetos o realizar un procesamiento adicional sobre los resultados detectados.
...
Por ejemplo, un usuario podría utilizar la salida MQTT para enviar datos de detección de objetos en tiempo real a un servidor remoto con fines de supervisión o análisis. Alternativamente, podría utilizar la salida GPIO para activar acciones físicas, como encender una luz o activar una alarma en función de la presencia de objetos específicos.
...
- [Centro de documentación de SenseCraft AI](/es/sensecraft-ai/sensecraft-ai-main/)
- [Entrenar un modelo de clasificación de imágenes](/es/sensecraft-ai/tutorials/sensecraft-ai-training-classification/)
- [Entrenar un modelo de detección de objetos](/es/sensecraft-ai/tutorials/sensecraft-ai-training-object-detection/)
- [Primeros pasos con SenseCraft Data Platform](/es/cloud/sensecraft-data/sensecraft-data-platform/overview/)
