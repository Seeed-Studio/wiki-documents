...
- **Integración con sensores del dispositivo**: Muestra automáticamente datos de temperatura, humedad y batería de tu dispositivo
...
3. **Conecta tu dispositivo**: Sigue las instrucciones en pantalla para vincular tu dispositivo compatible

4. **Elige una función**: Selecciona entre las funciones Gallery, Canvas, RSS o Web según tus necesidades
...
Guía completa para actualizar y flashear el firmware en tus dispositivos de pantalla de papel electrónico.

### [Guía de la interfaz del espacio de trabajo](https://sensecraft-hmi-docs.seeed.cc/en/guides/workspace-interface/)

Guía completa para comprender y usar las barras de herramientas principales, la barra de estado del dispositivo y las funciones de gestión de páginas.
...
Diseña interfaces y paneles personalizados combinando elementos estáticos con datos dinámicos de varias fuentes.

### [Función RSS](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-rss/)

Muestra contenido que se actualiza automáticamente de medios de noticias, blogs y otras fuentes de información usando fuentes RSS.

### [Función Web](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-web/)

Muestra contenido web directamente en tu dispositivo, ideal para paneles, documentación o sistemas de monitorización.

## Recursos adicionales

### [Hardware compatible](https://sensecraft-hmi-docs.seeed.cc/en/supported-hardware/)
