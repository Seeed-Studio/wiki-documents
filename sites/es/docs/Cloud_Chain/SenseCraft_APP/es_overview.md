...
:::tip note
¡La aplicación SenseCAP Mate ahora se llama oficialmente aplicación `SenseCraft`!
:::
...
La aplicación SenseCraft está disponible en versiones para iOS y Android.
...
:::tip Note
Selecciona `Global` en Server Location. También puedes crear una cuenta a través de <a href="http://sensecap.seeed.cc">SenseCAP Portal</a>
:::
...
- En la página de dispositivos, puedes añadir nuevos dispositivos haciendo clic en `+` en la esquina superior derecha.
...
4. En la página del dispositivo, haz clic en Message Center para ver los mensajes de alarma, donde se muestran Device warning device triggered alarm push messages y System notification system messages.
...
Selecciona el producto correspondiente para una vinculación rápida.
