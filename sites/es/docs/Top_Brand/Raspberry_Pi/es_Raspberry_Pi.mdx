---
description: Dispositivos de la Plataforma Raspberry Pi
title: Guía de Dispositivos de la Plataforma Raspberry Pi
keywords:
  - Raspberry pi
...
url: https://wiki.seeedstudio.com/es/Raspberry_Pi/
---
...
<FamilyValueSection lang="es" />

## Placas Oficiales de Raspberry Pi
...
## Comparar Modelos de Raspberry Pi
|               | 3B+           |   Zero      |   Zero 2 W/WH     |   4B          |   CM4     | Pico | Pico WH |   5          |
|   :---:       | :---:         |   :---:     |   :---:         |   :---:       |   :---:   | :---: | :---: |:---: |
|   RAM         |1GB          |512MB          |512MB          |2/4/8 GB       |2/4/8 GB   | 264 KB |264 KB |4/8 GB |
|   Almacenamiento     |Micro SD          |Micro SD          |Micro SD          |Micro SD      |Hasta 32GB eMMC   | 2 MB |2 MB |Micro SD |
|   Tipo de Procesador     |ARMv8 x86       |ARMv6         |ARMv6        |ARMv8 x64     |ARMv8 x64 |ARM M0+ |ARM M0+ |ARMv8 x64  |
| Velocidad del Procesador | Quad Core @1.4GHz  |1GHz |Quad Core @1GHz |Quad Core @1.5GHz|Quad Core @1.5GHz|Dual Core @133MHz|Dual Core @133MHz|Quad Core @2.4Hz|
| Factor de Forma   | Estándar [a]    |pHat |pHat |Estándar [a] | Ultra-compacto [c] |SOM de Orificio Pasante |SOM de Orificio Pasante |Estándar [a]|
|Ethernet   |✅|❌|❌|✅|✅|❌|❌|✅|
|Wifi       |❌|❌|✅|✅|❌|❌|✅|✅|
|Bluetooth  |❌|❌|✅|✅|❌|❌|✅|✅|
|Puertos USB|x4(A)|x1(Micro)|x1(Micro)|x4(A),x1(C)|❌|x1(Micro)|x1(Micro)|x4(A),x1(C)|
|Puertos I2C|x1|x1|x1|x1|x1|x1|x2|x1|
|Puertos SPI|x1|x1|x1|x1|x1|x1|x2|x1|

## Comenzando

- [Comenzando con Raspberry Pi 3 Model B](https://wiki.seeedstudio.com/es/Getting_Started_with_Arduino/)
- [Conectarse remotamente a Raspberry Pi](https://wiki.seeedstudio.com/es/remote_connect/)
- [Actualizar EEPROM para Compute Module 4](https://wiki.seeedstudio.com/es/Raspberry_pi_CM4_update_eeprom/)

## Hats (placas de extensión)
<HatSection lang="es" />
...
- Gracias a [los esfuerzos de Corey](https://github.com/orgs/Seeed-Studio/projects/6/views/1?pane=issue&itemId=33963820) y tu trabajo será [exhibido](https://wiki.seeedstudio.com/es/Honorary-Contributors/).

Las actualizaciones a esta página están <a href="https://github.com/orgs/Seeed-Studio/projects/6?pane=issue&itemId=30495963">en progreso</a>. ¡Mantente atento!