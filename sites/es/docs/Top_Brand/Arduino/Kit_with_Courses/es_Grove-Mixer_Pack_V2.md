...
url: https://wiki.seeedstudio.com/es/Grove-Mixer_Pack_V2/
---
![](https://files.seeedstudio.com/wiki/Grove-Mixer_Pack_V2/img/U8GUZNb9TVZ14lLRW6ialXEV.jpg)

<!-- El [Grove - Mixer Pack V2](https://www.seeedstudio.com/depot/Mixer-Pack-V2Electronic-blockswithout-Arduinoplug-and-play-system-p-1867.html?cPath=14) es un kit de electrónica independiente, similar a Lego, que consiste en 13 módulos Grove seleccionados del [ Grove System](/Grove_System "GROVE System") desarrollado por [Seeed Studio](https://www.seeedstudio.com/depot/). Estos mini-módulos pueden usarse como bloques de construcción para crear circuitos electrónicos y prototipos bastante rápidamente sin necesariamente usar una placa de microcontrolador como un [Seeeduino](/Seeeduino "Seeeduino") o un [ Arduino](/Arduino "Main Page"). -->
...
<!-- 1.  1x Motor DC para trabajar con el módulo [Grove - Mini Fan](/Grove-Mini_Fan "Grove - Mini Fan")

2.  1x Ventilador Colorido que se ajusta al Motor DC

3.  1x Altavoz de Audio Pequeño para trabajar con el módulo [Grove - Recorder](/Grove_Recorder "Grove - Recorder")

4.  1x Luz de Cadena LED para trabajar con el módulo [Grove - LED String Light](/Grove-LED_String_Light "Grove - LED String Light")

5.  7x [Cables Grove](/Grove_System/#grove-cables "GROVE System") (3x 200mm, 3x 50mm, 1x Cable Ramificado) -->
...
PASO 3 - Conecta el Módulo de Salida al Módulo de Alimentación
...
8. **Ventilador personal con velocidad variable**
