---
description: Grove - Pantalla E-Ink de Triple Color 2.13"
title: Grove - Pantalla E-Ink de Triple Color 2.13"
keywords:
  - Grove
...
url: https://wiki.seeedstudio.com/es/Grove-Triple_Color_E-Ink_Display_2_13/
---
...
El Grove - Pantalla E-Ink de Triple Color 2.13'' es una pantalla que aún puede mostrar contenido después de apagarse, la llamamos E-Paper (papel electrónico) o E-Ink. La pantalla es una pantalla electroforética de matriz activa TFT, con interfaz y un
diseño de sistema de referencia. El área activa de 2.13 pulgadas contiene 212x104 píxeles, y tiene capacidades de visualización completa de 1-bit blanco/negro y 1-bit rojo.
...
|Resolución de pantalla|212(H) x 104(V) píxel|
|DPI|111|
|Interfaz|UART|
...
| Seeeduino V4.2 | Base Shield | Grove - Pantalla E-Ink de Triple Color 2.13''|
|--------------|-------------|-----------------|
...
|[Obtener UNO Ahora](https://www.seeedstudio.com/Seeeduino-V4.2-p-2517.html)|[Obtener UNO Ahora](https://www.seeedstudio.com/Base-Shield-V2-p-1378.html)|[Obtener UNO Ahora](https://www.seeedstudio.com/Grove-Triple-Color-E-Ink-Display-2-13-p-2889.html)|
...
- **Paso 1.** Conecta Grove - Base Shield al Seeeduino.
...
- **Paso 4.** Conecta el Grove - Pantalla E-Ink de Triple Color 2.13'' al puerto **UART** del Grove-Base Shield.

<div align="center">
  <figure>
    <img src="https://files.seeedstudio.com/wiki/Grove-Triple_Color_E-Ink_Display_2.13/img/connect.jpg" alt="Grove - Pantalla E-Ink de Triple Color 2.13'' conectar" title="connect" />
    <figcaption><b>Figura 2</b>. <i>conectar</i></figcaption>
  </figure>
</div>
...
- **Paso 1.** Descarga el [código de demostración](https://github.com/Seeed-Studio/Grove_Triple_Color_E-lnk_2.13/tree/master/examples/Eink_factory_code_213) desde Github.

- **Paso 2.** Abre el archivo **Eink_factory_code_213.ino** con tu IDE de Arduino.
...
<div align="center">
  <figure>
    <img src="https://files.seeedstudio.com/wiki/Grove-Triple_Color_E-Ink_Display_2.13/img/demo.jpg" alt="Grove - Pantalla E-Ink de Triple Color 2.13'' DIY" title="DIY demo" />
...
Antes de empezar, por favor revisa el **Eink_factory_code_213.ino** nuevamente. Puedes encontrar los dos arrays fácilmente.
...
- **Paso 1.** Prepara una imagen de 104*212 píxeles.
...
>4. Ancho y Alto Máximo -> 104 x 212  
...
:::note
        a.**00** significa que todos los elementos del array son 0x00, en realidad necesitas 2756 0x00   
        b.**FF** significa que todos los elementos del array son 0xFF, en realidad necesitas 2756 0xFF  
...
:::
:::tip
        *¿Crear un array de 2756 0x00 o 0xFF?*  
...
Consideramos que el estado original es pantalla completa en blanco. Al actualizar la imagen, primero se actualiza el array negro, luego se actualiza el array rojo, y la imagen del array rojo sobrescribe la imagen negra.

Esta pantalla es de 104 x 212, por lo que hay 104x212=22048 píxeles, cada píxel está controlado por un bit. El elemento en el array es un número hexadecimal de dos dígitos, como **0xF0**. Convirtiendo **0xF0** a un número binario obtendremos
**1111 0000**. Un píxel con un valor de 1 mostrará blanco, y un píxel con un valor de 0 mostrará el color del array correspondiente (rojo o negro). Lo que significa que cada elemento en el array de imagen controla 8 píxeles. Por lo tanto, necesitas un array de 22048/8=2756 elementos.
...
- **[Zip]** [Grove - Triple Color E-Ink Display 2.13'' Archivos Eagle](https://files.seeedstudio.com/wiki/Grove-Triple_Color_E-Ink_Display_2.13/res/Triple_Color_E-Ink_Display_2_13.zip)

- **[PDF]** [Hoja de Datos E-paper 2.13 pulgadas](https://files.seeedstudio.com/wiki/Grove-Triple_Color_E-Ink_Display_2.13/res/E-paper_2.13_inch.pdf)
