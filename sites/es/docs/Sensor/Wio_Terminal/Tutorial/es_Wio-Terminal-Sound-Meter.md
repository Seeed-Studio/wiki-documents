---
description: Cómo medir niveles de ruido con Wio Terminal
title: Cómo medir niveles de ruido con Wio Terminal
keywords:
...
url: https://wiki.seeedstudio.com/es/Wio-Terminal-Sound-Meter/
---

# Cómo medir niveles de ruido con Wio Terminal

## Descripción general

Este ejemplo muestra cómo mostrar perfectamente el Medidor de Decibelios en el Wio Terminal.
...
- Los dB pueden presentarse en el dial, lectura y gráfico de líneas respectivamente.
- Tiene una guía para introducir qué significa el número de dB.

## Comenzando

Para comenzar con la biblioteca de Audio para Wio Terminal, por favor sigue lo siguiente:

## Instalación de la biblioteca

1. Instala la biblioteca de Audio `Seeed_Arduino_Audio`, Por favor visita la [**Descripción general de Audio**](https://wiki.seeedstudio.com/es/Wio-Terminal-Audio-Overview/) para más información.

2. Instala la biblioteca de pantalla LCD `Seeed_Arduino_LCD`, por favor visita [Wio Terminal LCD](https://wiki.seeedstudio.com/es/Wio-Terminal-LCD-Overview/) para más información.

3. Ahora, la biblioteca puede ser instalada en el Arduino IDE. Abre el Arduino IDE, y haz clic en `sketch` -> `Include Library` -> `Add .ZIP Library`, y elige el archivo `Seeed_Arduino_Audio` que acabas de descargar.

![InstallLibrary](https://files.seeedstudio.com/wiki/Wio-Terminal/img/Xnip2019-11-21_15-50-13.jpg)

## Mostrar el valor de dB en el Monitor de Arduino

Este ejemplo muestra el valor de dB en el Monitor de Arduino, así que podemos tener un código de prueba de dB.

:::note
El código es bastante largo, así que puedes simplemente hacer clic en 'copiar al portapapeles' y luego ponerlo en el Arduino IDE.
:::
...
El valor de dB se presenta.
<div align="center"><img src="https://files.seeedstudio.com/wiki/Wio-Terminal-Sound-Meter/sound-Meter-value_gGIF.gif" /></div>

## La Demostración del Medidor de Decibelios

Este ejemplo detecta dB usando el micrófono en ReSpeaker 2-Mic Hat, Se detecta el entorno circundante, luego se muestra en la pantalla.
