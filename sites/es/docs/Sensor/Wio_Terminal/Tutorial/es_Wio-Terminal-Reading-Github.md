---
description: Accediendo a GitHub usando Wio Terminal
title: Accediendo a GitHub usando Wio Terminal
keywords:
...
url: https://wiki.seeedstudio.com/es/Wio-Terminal-Reading-Github/
---

# Leyendo Estadísticas de Repositorio de Github desde Wio Terminal

<div align="center"><img src="https://files.seeedstudio.com/wiki/Wio-Terminal/img/Github.gif" /></div>

Esta wiki introduce cómo usar Wio Terminal para acceder a un servidor **HTTPS**, lo que significa que podrías usar Wio Terminal para obtener datos en vivo desde internet! Aquí, Wio Terminal se conecta a Wi-Fi y obtiene datos de Github.

Con esto, puedes implementar la Demo para otras apis como obtener información del Clima, Estadísticas de Youtube y etc.
...
- Obtiene estadísticas de repositorio desde Github

- Puede cambiar a cualquier Repositorio de Github
...
- Visita el repositorio de [ArduinoJson](https://github.com/bblanchon/ArduinoJson) y descarga todo el repositorio a tu unidad local.

  - Ahora, la librería ArduinoJson puede ser instalada en el Arduino IDE. Abre el Arduino IDE, y haz clic en `sketch` -> `Include Library` -> `Add .ZIP Library`, y elige el archivo `ArduinoJson` que acabas de descargar.
...
- Descarga el archivo de cabecera [`Free_Fonts.h`](https://files.seeedstudio.com/wiki/Wio-Terminal/res/Free_Fonts.h) para que puedas usar abreviaciones para las fuentes gratuitas incluidas en la librería LCD. Por favor asegúrate de poner este archivo de cabecera en la misma ubicación que el Sketch de Arduino.

- Descarga el código Completo [aquí](https://files.seeedstudio.com/wiki/Wio-Terminal/res/GitHubStats.zip) o copia lo siguiente.

- Sube el código.

## Código Completo

**Nota:** Cambia el `ssid` y `password` a tu Wi-Fi de Red.
