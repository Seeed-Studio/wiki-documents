...
Con [Grove - Infrared Temperature Sensor Array (AMG8833)](https://www.seeedstudio.com/Grove-Infrared-Temperature-Sensor-Array-AMG8833.html) y [Wio Terminal](https://www.seeedstudio.com/Wio-Terminal-p-4509.html), podemos construir una cámara de imagen térmica de bajo costo similar a [FLIR™](https://www.flir.com/) con facilidad! Para ponerlo en perspectiva, la resolución del Grove - Infrared Temperature Sensor Array (AMG8833) es solo de 8 x 8 (64 Píxeles), lo cual en algunos casos es suficiente. Por lo tanto, se utiliza Interpolación Lineal en el código para expandir a 70 x 70 (4900 Píxeles) para indicaciones mucho mejores.

Esta demostración está inspirada en el [video de Kris Kasprzak](https://www.youtube.com/watch?v=A9F1ezGgaC4&t=365s). Se realizaron varias modificaciones para hacerla compatible con Wio Terminal y Grove - Infrared Temperature Sensor Array (AMG8833). La mayoría de los gráficos ahora se dibujan primero en TFT LCD Sprites para mejorar el rendimiento general y una velocidad de fotogramas más rápida. También se agregó una cruz en el centro de la pantalla y se muestra la temperatura en la cruz.
...
- Indica la temperatura exacta en la cruz

- Cámara térmica IR que detecta objetos térmicos

- Botón derecho para habilitar la funcionalidad de cuadrícula ON/OFF
...
- Visita los repositorios de [Seeed_AMG8833](https://github.com/Seeed-Studio/Seeed_AMG8833) y descarga todo el repositorio a tu unidad local.

  - Ahora, la librería Seeed_AMG8833 puede ser instalada en el Arduino IDE. Abre el Arduino IDE, y haz clic en `sketch` -> `Include Library` -> `Add .ZIP Library`, y elige el archivo `Seeed_AMG8833` que acabas de descargar.

## Instrucciones de Arduino

- Conecta el Grove - Infrared Temperature Sensor Array (AMG8833) a la interfaz Grove I2C del Wio Terminal.

- Descarga el código completo [aquí](https://files.seeedstudio.com/wiki/Wio-Terminal/res/ThermalCamera.ino) o copia lo siguiente.

- Sube el código.

## Código Completo

**Nota:** Para aumentar el rendimiento y la velocidad de fotogramas de esta Cámara de Imagen Térmica IR, puedes aumentar la velocidad de CPU del Wio Terminal a 200MHz. Selecciona `Tools` -> `CPU Speed` -> `200MHz(Overclock)`
