...
---
Tanto Seeedduino como Arduino son plataformas utilizadas para crear prototipos rápidos. Sin embargo, todavía existen diferencias entre ellas. Podemos obtener más información sobre ellas comparando desde la siguiente tabla.
...
<td>Principalmente MCU AVR de 8 bits, utilizando la nueva familia de MCU Cortex-M3 Due.</td>
</tr>
<tr>
...
<td>Soporta importación de librerías, exportar proyectos, control de versiones, depuración y otras funciones.</td>
<td>Las librerías y el código de aplicación están separados, adecuado para escribir código simple, sin función de depuración.</td>
</tr>
</table>
...
Aquí te mostramos una demostración fácil: **luces de agua** usando Seeeduino Arch para que comiences.
...
- Ahora puedes compilar el código. Si el código tiene errores, te lo indicará y te dará ayuda. Y puede que encuentres que las ayudas son justo lo que necesitas.
...
- Ve a CRP DISABLD. Ahora necesitas eliminar el archivo de firmware y agregar el archivo bin waterLights_LPC11U24 a CRP DISABLD. Recuerda reiniciar el Microcontrolador para que comience a ejecutarse después de descargar un nuevo programa, ahora el seeeduino arch ejecutará el programa waterLight. Puedes probarlo.
...
- [Archivos Eagle de Seeeduino Arch](https://files.seeedstudio.com/wiki/Seeeduino_Arch_V1.0/res/Seeeduino_Arch_Eagle_files.zip)

- [Hoja de datos LPC11U2x](https://files.seeedstudio.com/wiki/Seeeduino_Arch_V1.0/res/LPC11U2x_datasheet.pdf)
