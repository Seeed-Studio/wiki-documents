---
description: Carcasa Seeeduino Stalker v3
title: Carcasa Seeeduino Stalker v3
keywords:
  - Seeeduino
...
url: https://wiki.seeedstudio.com/es/Seeeduino_Stalker_v3_enclosure/
---
...
La carcasa Seeeduino Stalker V3 se utiliza para Arch GPRS V3. Es resistente al agua y tiene suficiente resistencia, puede llevar Arch GPRS V3 para pruebas ambientales y recolección de datos muy bien.
...
- Alta transparencia
- Resistente al agua
- Estructura simple y fácil de usar

## Cómo usarla

---
Es muy fácil de usar, solo necesitas usar la placa de montaje PVC para fijarla.

**Primero——Montar la columna de tornillo y el tornillo de nylon.**

Debemos montar la columna de tornillo y el tornillo de nylon.
...
**Segundo——Colocar el cojín de esponja.**

![enter image description here](https://files.seeedstudio.com/wiki/Seeeduino_Stalker_v3_enclosure/img/IMG_0749.JPG)

**Tercero——Colocar la batería.**

Vale la pena señalar que debemos colocar la pieza separadora de batería para evitar que la batería haga contacto con los componentes.
...
**Cuarto——Fijar la PCBA y la batería solar**

Doblar la placa pvc y fijar la PCBA con un broche.
...
Como mencionamos antes, la carcasa se utiliza para llevar Arch GPRS V3 para pruebas ambientales y recolección de datos.

Los sensores de la serie Grove se pueden montar fácilmente a la placa PVC con remaches.

![enter image description here](https://files.seeedstudio.com/wiki/Seeeduino_Stalker_v3_enclosure/img/IMG_0764.JPG)

**La carcasa stalker lleva el Arch GPRS en la naturaleza**.
...
**Si montas el bloque de hierro, puedes tirarlo al agua, la batería solar siempre queda arriba**.
...
<tr>
<th scope="row">Carcasa Stalker</th>
<td>90 diámetro 9.25 Altura</td>
<td>1</td>
</tr>
<tr>
<th scope="row">Pieza de montaje PVC</th>
<td>Tamaño 200*63mm</td>
<td>1</td>
</tr>
<tr>
<th scope="row">Pieza separadora de batería</th>
<td>Tamaño 71.8*60mm</td>
<td>1</td>
</tr>
<tr>
...
<tr>
<th scope="row">Esponja Amortiguadora</th>
<td>Tamaño 70*55*8mm</td>
<td>1</td>
</tr>
</table>
