---
description: RS485 Sensor de Nivel Ultrasónico de 750cm
title: RS485 Sensor de Nivel Ultrasónico de 750cm
keywords:
  - SenseCAP
...
url: https://wiki.seeedstudio.com/es/RS485_750cm_Ultrasonic_Sensor-1/
---

# RS485 Sensor de Nivel Ultrasónico de 750cm

<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/750cm%20ultrasonic%20sensor/image1.jpeg"/></div>

El RS485 Sensor de Nivel Ultrasónico de 750cm utiliza tecnología de detección ultrasónica para medir distancias con un rango de medición de 28-750cm. Equipado con una boca de campana, puede detectar objetos hasta 750cm con una resolución de 1mm. Con su transductor ultrasónico resistente al agua IP67, puede ser utilizado en varias aplicaciones como monitoreo de alcantarillado y nivel de agua, sistemas de gestión de contenedores de basura inteligentes, evitación de robots y control automático.
...
# Jugar con el Registrador de Datos LoRaWAN S2100

En esta página, te guiaremos a través del proceso de conectar el Registrador de Datos LoRaWAN S2100 con un Sensor de Nivel Ultrasónico de 750cm, permitiéndote crear un sensor inalámbrico LoRaWAN robusto de grado industrial que puede ser utilizado comercialmente en solo cinco minutos.
## Comenzar
...
<table align="center">
	<tr>
      ...
      <th>Sensor de Nivel Ultrasónico de 750cm</th>
...
## 1. Prepara el registrador de datos, sensor ultrasónico de nivel RS485 de 750cm, gateway y herramientas.
...
2. **Sensor ultrasónico de nivel RS485 de 750cm**: Utiliza tecnología de detección ultrasónica para medición de distancia. Rango de medición de 28cm a 750cm, y la resolución puede alcanzar 1mm. Con un transductor ultrasónico impermeable IP67, tiene una fuerte adaptabilidad al entorno de trabajo.
...
### 3. Conectar el sensor ultrasónico de nivel RS485 de 750cm al registrador de datos SenseCAP
...
Secuencia de cables del sensor ultrasónico de nivel RS485 de 750cm:
...
### 4. Configurar ajustes para la comunicación entre el registrador de datos y el sensor ultrasónico de nivel RS485 de 750cm
...
Antes de subir datos, asegúrate de que el gateway esté funcionando correctamente o tenga cobertura de la red helium.

<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/SenseCAP-S2110/100.gif"/></div>

Ahora necesitamos agregar este sensor a la plataforma SenseCAP para ver los datos en la nube
...
- **[PDF]** [Sensor de Nivel Ultrasónico RS485 750cm](https://files.seeedstudio.com/wiki/RS485-Ultrasonic-Level-Sensor/RS485-750cm-Ultrasonic-Level-Sensor.pdf)
