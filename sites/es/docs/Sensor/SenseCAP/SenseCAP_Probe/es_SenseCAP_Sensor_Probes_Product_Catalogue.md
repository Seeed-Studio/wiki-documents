...
title: Catálogo de Productos de Sondas de Sensores SenseCAP
keywords:
...
url: https://wiki.seeedstudio.com/es/SenseCAP_Sensor_Probes_Product_Catalogue/
---

## Acerca de SenseCAP

Entre el primer lanzamiento de la serie de productos IIoT de Seeed, SenseCAP se enfoca en aplicaciones de detección ambiental inalámbrica: agricultura inteligente, agricultura de precisión y ciudad inteligente, por nombrar algunas. Consiste en productos de hardware (sensores, registradores de datos y gateways, etc.), servicios de software (SenseCAP Mate App, SenseCAP Web Portal, panel de control abierto) y API para gestión de dispositivos y datos.

## Acerca de las Sondas de Sensores

Nuestra gama de sondas de sensores industriales SenseCAP están diseñadas para resistir entornos hostiles como vibraciones y exposición a químicos y gases, lo cual es común en aplicaciones industriales, y nuestra gama industrial de sensores está equipada con clasificaciones IP serias desde IP66 hasta IP68 para asegurar que los productos funcionen correctamente en sus respectivos entornos hostiles.
Las Sondas de Sensores SenseCAP también cuentan con conexiones de proceso para asegurar un ajuste seguro en el medio que se está midiendo, junto con transmisores de datos de sensores que convierten la señal para adaptarse a sistemas de instrumentación industrial.
Algunos de los Sensores Industriales MODBUS RS485 vienen en dos versiones. La principal diferencia es el conector del cable. Por favor, elija la versión que mejor se adapte a sus necesidades:
（1） El que tiene cables de conexión se sugiere usar con [SenseCAP LoRaWAN® Data Logger](https://www.seeedstudio.com/SenseCAP-S2100-LoRaWAN-Data-Logger-p-5361.html?queryID=82d7de6ca64b8316686bdfe2c05664d2&objectID=5361&indexName=bazaar_retailer_products) para conectar con la red LoRaWAN®, disfrutando los beneficios de comunicación de bajo consumo y largo alcance.
（2）El que tiene conector de aviación ya preconfigurado [SenseCAP Sensor Hub 4G Data Logger](https://www.seeedstudio.com/SenseCAP-Sensor-Hub-4G-Data-Logger-with-builtin-battery-p-4852.html?queryID=b8ef1fa7e141765c30033fc3d8eddf10&objectID=4852&indexName=bazaar_retailer_products) con experiencia plug-and-play para recopilar varios datos de sensores vía 3G/4G LTE.
...
# Sensor NH3 MODBUS RS485 de Grado Industrial - con Conector de Aviación Impermeable
...
[1] El tiempo desde que el sensor se enciende hasta que se leen los datos. Note el parámetro cuando el sensor se enciende.

[2] Si se inicia en un ambiente con aire limpio requiere menos tiempo

[3] El intervalo de actualización de datos de medición, después del tiempo de calentamiento al encenderse, si la alimentación continúa, el sensor actualiza periódicamente la lectura en este intervalo.

[4] T90＜30s

## Sensor H2S MODBUS RS485 de Grado Industrial - con Conector de Aviación Impermeable
...
[1] El tiempo desde que el sensor se enciende hasta que se pueden leer los datos. Tenga en cuenta el parámetro cuando el sensor se enciende.

[2] Si se inicia en un ambiente con aire limpio requiere menos tiempo

[3] El intervalo de actualización de datos de medición, después del tiempo de calentamiento al encender, si la alimentación continúa, el sensor actualiza periódicamente la lectura en este intervalo.

[4] T90＜30s

## Sensor SenseCAP de CO2, Temperatura y Humedad con RS485 & SDI-12, con Conector de Aviación Impermeable
...
[1] El tiempo de preparación requerido para que el sensor se encienda y esté listo para leer valores medidos a través de instrucciones Modbus debe tenerse en cuenta cuando el sensor se enciende y apaga para cada lectura.

[2] El tiempo de calentamiento = (valor del registro 0x0021 + 3); leer el registro 0x0000 antes del tiempo de calentamiento resultará en 0, y la lectura se actualizará cada segundo después del tiempo de calentamiento; el sensor tiene un tiempo T90 de 300 segundos y un tiempo T60 de 120 segundos.

[3] El intervalo de actualización de datos de medición, después del tiempo de calentamiento al encender, si se alimenta continuamente, el sensor actualiza la lectura periódicamente en este intervalo.

[4] Frecuencia de consulta del maestro Modbus.

[5] El tiempo requerido para que el sensor responda después de recibir la instrucción de lectura, después de que el registro de retardo de respuesta 0x0020 se establece en 0.

## Sensor Industrial MODBUS RS485 de Temperatura y Humedad del Aire
...
## Sensor Industrial de Humedad y Temperatura del Suelo MODBUS-RTU RS485, Voltaje Analógico 0-2V (S-Soil MT-02A)

Con Cables de Conexión [101990668](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-Sensor-S-Soil-MT-02-p-4634.html?queryID=d56c42134f064eaf1203b9292aaba7c8&objectID=4634&indexName=bazaar_retailer_products) 

Con Conector de Aviación [314990620](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-Sensor-S-Soil-MT-02B-p-4859.html)
...
## Sensor Industrial de Humedad del Suelo, Temperatura y CE MODBUS-RTU RS485 (S-Soil MTEC-02A)

Con Cables de Conexión [101990667](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-EC-Sensor-S-Soil-MTEC-02-p-4633.html) 

Con Conector de Aviación [314990621](https://www.seeedstudio.com/RS485-Soil-Moisture-Temperature-EC-Sensor-S-Soil-MTEC-02B-p-4860.html?queryID=ec8fbdf14c91f77c70bd5e0177bb9620&objectID=4860&indexName=bazaar_retailer_products)
...
## Sensor Industrial de Intensidad de Luz, MODBUS-RTU RS485 &0-2V (S-Light-01)

Con Cables de Conexión [314990739](https://www.seeedstudio.com/light-intensity-sensor-p-a-4863.html?queryID=f94dd76cedb45ec9d57e70d6e82af574&objectID=4863&indexName=bazaar_retailer_products)

Con Conector de Aviación  [314990740](https://www.seeedstudio.com/light-intensity-sensor-p-b-4863.html)
...
## Sensor Industrial PAR (S-PAR-02A), MODBUS-RTU RS485

Con Cables de Conexión [314990733](https://www.seeedstudio.com/RS485-S-PAR-02A-p-4829.html)

Con Conector de Aviación  [314990735](https://www.seeedstudio.com/RS485-S-PAR-02B-p-4830.html)
...
## Sensor Industrial PAR (PAR-2.5V), Compatible con Salida Analógica 0~2.5V
...
## Sensor Industrial de Radiación Solar Total (S-ZFS-02A),MODBUS-RTU RS485
...
## Sensor Industrial de Radiación UV (S-ZW-01A), MODBUS-RTU RS485
...
## Sensor Industrial de Humedad Foliar y Temperatura (A), MODBUS-RTU RS485

Con Cables de Conexión [314990737](https://www.seeedstudio.com/leaf-wetness-sensor-p-a-4861.html)

Con Conector de Aviación  [314990738](https://www.seeedstudio.com/leaf-wetness-sensor-p-b-4861.html)
...
## Sensor de Nivel de Líquido para Monitoreo de Nivel de Agua, Nivel de Aceite y Nivel de Líquido Ligeramente Corrosivo
...
## Sensor Industrial de Nivel de Líquido MODBUS RS485 Conector de Aviación
...
## Sensor Industrial de pH MODBUS-RTU RS485 y Voltaje Analógico 0~2V (S-pH-01A) V2.0

Con Cables de Conexión  [101990666](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01A-p-4632.html)

Con Conector de Aviación [314990622](https://www.seeedstudio.com/RS485-pH-Sensor-S-pH-01B-p-4632.html)
...
## Sensor Industrial de EC y TDS MODBUS-RTU RS485 y Voltaje Analógico 0-2V

Con Cables de Conexión [314990634](https://www.seeedstudio.com/EC-RS485-p-4848.html)

Con Conector de Aviación  [314990742](https://www.seeedstudio.com/EC-&-TDS-Sensor-RS485-b-p-4865.html)
...
## Sensor de Oxígeno Disuelto MODBUS RS485, Medidor de OD por Fluorescencia
...
## Sensor de Turbidez MODBUS RS485（S-DTS210-01B)
...
## Sensor de Nivel Ultrasónico RS485 750cm
...
## Sensor de Nivel Ultrasónico RS485 500cm
...
## Pluviómetro Óptico de Grado Industrial RG-15 Sensor de Lluvia
...
## Detector de Fugas de Agua de Grado Industrial IP66 RS485
...
## Protector de Radiación Solar para Protección de Sensores Exteriores - A10
