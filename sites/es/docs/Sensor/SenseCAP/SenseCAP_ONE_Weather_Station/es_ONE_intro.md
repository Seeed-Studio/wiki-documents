...
SenseCAP ONE es una serie de sensores meteorológicos compactos todo en uno, que integran múltiples sensores en este dispositivo compacto, monitorizando hasta 10 parámetros meteorológicos: temperatura del aire, humedad del aire, presión atmosférica, intensidad de la luz, velocidad del viento, dirección del viento, precipitación, PM 2.5, PM 10 y CO2.
