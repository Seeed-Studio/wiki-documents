---
description: Introducción a SenseCAP Vision AI V2
title: Introducción a SenseCAP Vision AI V2
keywords:
...
- 2 opciones de alimentación y duración de la batería: Equipado con una batería SOCl2 tipo D de 19Ah y también compatible con fuente de alimentación DC externa mediante una caja de conexiones opcional.
...
- Integración con SenseCraft Cloud: Incluye la aplicación móvil SenseCraft Mate y un portal web para una fácil configuración del dispositivo, gestión del dispositivo y visualización rápida de datos. Cuenta con soporte de API abierta y acceso de prueba GRATUITO de 3 meses, y es compatible con plataformas IoT de terceros.
...
<table align="center">
 ...
 <tr>
    ...
    <tr>
        ...
        <strong>Distancia de comunicación:</strong> 2 a 10 km (dependiendo del entorno)<br />
    ...
    <tr>
        ...
        <td align="center">
        Batería integrada o DC 12V/1A (con cableado mediante caja de conexiones externa)
        </td>
    </tr>
 <tr>
...
**¿Es posible sustituir la cámara o disponer de una versión personalizada del sensor SenseCAP Vision AI?**
