...
---
Una baliza de localización BLE (Bluetooth Low Energy) es un pequeño dispositivo inalámbrico que transmite señales Bluetooth a intervalos regulares. Estos señales pueden ser detectadas por dispositivos con Bluetooth, como el [**SenseCAP T1000 Tracker**](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-A-p-5697.html), [**SenseCAP T2000 
...
El GPS ha demostrado su capacidad para localizar en exteriores. Ahora, también tendemos a pasar al posicionamiento en interiores, y las balizas Bluetooth hacen posible el posicionamiento preciso en interiores. Combínalo con el SenseCAP T1000 Tracker para construir una solución de posicionamiento en interiores.
...
:::tip
Consulta [Indoor Positioning System](https://wiki.seeedstudio.com/es/IPS_For_SenseCAP_T1000_Traker) para más detalles.
:::

### Características

- **Bluetooth® LE 5.0**
- **Larga duración de la batería**: Batería reemplazable Li/SOCl2, más de 5 años (0dBm/500ms en la configuración predeterminada).
...
|Encendido|Apagado|
| :-: | :-: |
|Abre la tapa trasera del producto, mantén pulsado el botón durante 3 segundos y el LED azul se encenderá durante 5 segundos; entonces el arranque se ha realizado correctamente.|En el estado de encendido, abre la tapa trasera del producto, mantén pulsado el botón durante 3 segundos y el LED azul parpadeará 5 veces para indicar un apagado correcto.|

## Directrices de despliegue

- Las balizas Bluetooth se suelen colocar a 2,5-3 m sobre el nivel del suelo, con un espaciado horizontal de 5-10 m. Estas balizas pueden desplegarse en formaciones en columna o distribuidas uniformemente en patrones triangulares, según el entorno.
...
- Las estrategias de despliegue varían según los escenarios. Por ejemplo, en interiores se puede optar por una colocación central (densa) o una distribución en cuadrícula triangular (dispersa). En pasillos interiores, las opciones incluyen despliegue sobre la línea central (para pasillos de unos 3 m de ancho) u organización en doble columna (pasillos más anchos). Evita la instalación en el techo en edificios de gran altura (altura de planta > 4 m). Opta en su lugar por la instalación en pared o a baja altura, a unos 5 m de separación. En exteriores, utiliza un patrón de cuadrícula triangular para espacios abiertos.
...
### Instrucciones de instalación mediante adsorción magnética
...
La superficie de contacto magnético del producto puede adsorberse directamente a la superficie del soporte o del equipo donde se va a instalar.

:::tip
Debido a que el volumen de los productos magnéticos es más pesado que el de los productos generales (sin absorción magnética), se recomienda no instalar este tipo de productos en superficies como techos para evitar el riesgo de caída.
:::
...
- Al pegar, fija la cinta de doble cara al dispositivo con las manos o herramientas y presiónala durante 1-2 segundos. Repite la presión varias veces para que la cinta de doble cara o el pegamento sin clavos del producto y la superficie de aplicación queden mejor adheridos.
...
|Color|Blanco|
|Grado IP|Ninguno|
|Dimensiones(L\*A\*Al)|Φ50\*20.5mm|
|Peso|39g (incluye batería)|
|Batería|Batería Li/SOCl2, 2400mAh|
|Chip|Serie nRF52|
|Versión Bluetooth|BLE 5.0|
|Protocolo Bluetooth|iBeacon|
|Sensores|Compatible con acelerómetro|
|LED|Incluido|
|APP|BeaconSET|
|Temperatura de trabajo|-30~60°C|
|Duración de la batería|<p>Más de 5 años</p><p>(0dBm/500ms en la configuración predeterminada).</p><p></p>|
...
|Potencia de transmisión|-30 - +4dBm, predeterminado 0dBm|
...
|Servicio de batería|<p>Icono de batería mostrado, detección en tiempo real</p><p>la cuadrícula completa es 100%</p>|
...
- **Paso 2**: Conecta la baliza, puedes diferenciarlas por la dirección MAC que también está adherida a la etiqueta de la baliza.
