---
description: Introducción a XIAO 1.47'' IPS Display (ESP32-S3).
title: Introducción a XIAO 1.47'' IPS Display (ESP32-S3)
keywords:
  - XIAO
  - ESP32-S3
  - IPS Display
...
# Introducción a XIAO 1.47'' IPS Display (ESP32-S3)
...
:::note
El ESP32-S3 Plus utiliza D16 para la medición de voltaje. La demostración de voltaje no muestra el porcentaje de batería y ninguna señal de estado de carga está conectada a un GPIO del ESP32-S3.
:::
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>D14</td><td>IMU_INT</td><td>Interrupción de movimiento del IMU</td><td>Reasignación de función: se usa para activación por movimiento y detección de doble toque</td></tr>
    ...
    <tr><td>D16</td><td>BAT_ADC</td><td>Detección de voltaje de batería</td><td>Conectado internamente al circuito divisor de voltaje (316K / 160K). <strong>No usar externamente</strong></td></tr>
...
La placa de pantalla integra varios periféricos a bordo. La página de [Function](/es/function_1.47_inch_touch_display_esp32s3) proporciona una demo independiente para cada uno:
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>IMU</td><td>[Electronic Quicksand + Raise to Wake](/es/function_1.47_inch_touch_display_esp32s3#imu) — efectos de movimiento de 6 ejes y activación por movimiento</td></tr>
    <tr><td>Botones</td><td>[User Button](/es/function_1.47_inch_touch_display_esp32s3#user-button) — lectura de pulsaciones y eliminación de rebotes con interrupciones</td></tr>
    <tr><td>Batería</td><td>[Battery Voltage Detection](/es/function_1.47_inch_touch_display_esp32s3#battery-voltage-detection) — mide el voltaje del divisor</td></tr>
  </table>
</div>
...
Asegúrate de haber añadido el paquete de placas ESP32 al IDE de Arduino:
...
Si la placa sigue sin aparecer, reinicia el IDE de Arduino e inténtalo de nuevo.
