---
description: Este artículo describe cómo hacer que la pantalla ePaper reTerminal E Series funcione con Home Assistant y ESPHome.
title: Uso básico de ESPHome
...
# Pantalla ePaper reTerminal E Series funcionando con ESPHome para Home Assistant
...
Home Assistant es una potente plataforma de automatización del hogar de código abierto que te permite controlar y supervisar tus dispositivos domésticos inteligentes desde una única interfaz unificada. Actúa como el concentrador central de tu hogar inteligente, lo que te permite automatizar rutinas, supervisar sensores y crear un entorno de vida más inteligente.
...
- **Potente automatización**: Crea reglas de automatización sofisticadas que puedan responder a diversos desencadenantes como la hora, estados de dispositivos, lecturas de sensores y más.
...
### ¿Por qué la pantalla ePaper reTerminal E Series con Home Assistant?

La pantalla ePaper reTerminal E Series es un excelente complemento para Home Assistant por varias razones:
...
Estas ventajas hacen que la pantalla ePaper reTerminal E Series sea una opción ideal para crear una pantalla de información siempre encendida y de bajo consumo para tu configuración de Home Assistant.

### Integración con ESPHome

ESPHome es una herramienta de creación de firmware de código abierto diseñada específicamente para dispositivos ESP8266/ESP32. Te permite crear firmware personalizado utilizando sencillos archivos de configuración YAML, que luego pueden flashearse en tu dispositivo. Para reTerminal E Series, ESPHome sirve como el middleware esencial que habilita la comunicación entre el dispositivo y Home Assistant.
...
#### Acceder a los datos meteorológicos en Developer Tools
...
- `wind_bearing`: Rumbo del viento
- `wind_speed`: Velocidad del viento

#### Uso de datos meteorológicos en ESPHome

Para usar estos datos meteorológicos en tu configuración de ESPHome para reTerminal E Serie, tendrás que configurar una conexión de Home Assistant API en tu configuración YAML de ESPHome:
...
Esta configuración crea entidades de sensor en tu dispositivo ESPHome que obtienen datos de la integración meteorológica de Home Assistant. Luego puedes usar estos sensores para actualizar la pantalla ePaper de reTerminal E Serie con la información meteorológica actual.
...
Por último, añade el código para la sección de pantalla para usar los valores anteriores. El código completo es el siguiente:
...
Después de compilar el código anterior y subirlo a tu dispositivo, es posible que primero veas **NaN** mostrado en la pantalla, por favor no te preocupes, esto es normal. Esto se debe a que el dispositivo aún no se ha añadido al entorno de Home Assistant, por lo que reTerminal todavía no ha podido adquirir los datos de Home Assistant. Solo necesitamos seguir los pasos siguientes para añadir el dispositivo.
...
Paso 5. Introduce la dirección IP de tu dispositivo reTerminal E Serie ePaper Display y la clave de cifrado de la API si has configurado una.
...
Este ejemplo demuestra cómo mostrar imágenes personalizadas en tu pantalla de tinta electrónica reTerminal E Serie ePaper Display. Puedes usar esta función para mostrar logotipos, iconos o cualquier gráfico que mejore la experiencia de tu panel.
...
### P3: ¿reTerminal E Series ePaper Display no puede conectarse a tu ordenador?
