---
description: Este artículo describe cómo utilizar las capacidades de hardware de la pantalla de tinta electrónica reTerminal E Serie en ESPHome.
title: Uso avanzado de ESPHome
...
# Uso avanzado de ESPHome de la pantalla de tinta electrónica reTerminal E Serie en Home Assistant
...
Este artículo explora configuraciones avanzadas de ESPHome para tu dispositivo de pantalla de tinta electrónica reTerminal E Serie, basándose en los conceptos fundamentales tratados en nuestra [guía de uso básico de ESPHome](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome). Si eres nuevo en ESPHome o en la reTerminal E Serie, te recomendamos comenzar con la guía básica antes de profundizar en estas aplicaciones avanzadas.

## Capacidades de hardware

La pantalla de tinta electrónica reTerminal E Serie incluye varios componentes de hardware que se pueden aprovechar en Home Assistant a través de ESPHome:
...
Veamos cómo utilizar cada uno de estos componentes en aplicaciones prácticas.

## Control de los componentes de hardware de la pantalla de tinta electrónica reTerminal E Serie

Veamos cómo utilizar cada uno de los componentes de hardware de la pantalla de tinta electrónica reTerminal E Serie en Home Assistant.

### Botones y LED

Este ejemplo muestra cómo utilizar los tres botones de tu pantalla de tinta electrónica reTerminal E Serie para controlar funciones y proporcionar retroalimentación visual con el LED integrado.
...
- Configura el Botón 3 para conmutar el LED entre encendido y apagado
...
La pantalla de tinta electrónica reTerminal E Serie incluye un zumbador en el GPIO45 que se puede utilizar para proporcionar retroalimentación audible. Así es como se configura:
...
La pantalla de tinta electrónica reTerminal E Serie puede monitorizar su nivel de batería a través de la entrada analógica en GPIO1. Así es como se configura:
...
- Convierte el voltaje en un porcentaje de batería utilizando una curva de calibración
...
:::tip
Si empiezas a usar el programa de suspensión profunda, te recomendamos encarecidamente que lo utilices preferiblemente con el botón blanco del lado derecho y que configures el botón blanco del lado derecho como botón de activación de suspensión. De este modo, cuando quieras actualizar el programa, no te encontrarás con la situación incómoda de que el dispositivo esté en suspensión y no puedas subir el programa a través del puerto serie.
:::
...
Puedes usar este ejemplo copiando el código siguiente y pegándolo después de la línea de código `captive_portal` en tu archivo Yaml.
...
- Actualiza la pantalla con el recuento actual de activaciones
...
5. **Visualización de temperatura y humedad**: Usando el sensor integrado SHT4x vía I²C
