---
description: reTerminal E1003 es una pantalla de tinta electrónica monocromática de código abierto de 10,3 pulgadas que incorpora 16 niveles de escala de grises y una alta resolución de 1404×1872 píxeles, con compatibilidad con interacción táctil en el firmware HMI v1.1.2.
sku: 100090602
...
- Actualización completa en 3 segundos para paneles de control de tinta electrónica más rápidos y con mejor respuesta
- Crea interfaces interactivas fácilmente con SenseCraft HMI y compatibilidad táctil
- Imágenes nítidas con pantalla de tinta electrónica de 16 niveles de escala de grises y alta resolución
- Autonomía de batería de 6 meses para una colocación realmente sin cables
...
1. **Pantalla de tinta electrónica:** Pantalla de tinta electrónica de 10,3" y 16 niveles de escala de grises con soporte táctil capacitivo.
2. **Botones**: Situados en la parte superior del dispositivo para uso manual de la pantalla
3. **Micrófono:** Reservado para aplicaciones de interacción por voz.
...
6. **LED rojo de carga:** Indica el estado de carga de la batería.
7. **LED verde de estado:** Indica el estado operativo o del sistema actual.
8. **Puerto USB-C de datos y carga:** Para cargar el dispositivo y transmisión de datos.
9. **Puerto de expansión:** Cabecera de pines que proporciona conexiones VDD, GND, UART, I2C y GPIO para sensores, módulos o periféricos externos.
10. **Zumbador:** Orificios de salida de audio para alertas sonoras.
11. **Inserciones para montaje del soporte:** Tuercas incrustadas (orificios para tornillos) en la parte posterior del dispositivo para fijar el soporte impreso en 3D.
...
**Paso 3.** (Opcional) Inserta una tarjeta microSD si planeas utilizar el dispositivo como marco de fotos digital o necesitas almacenamiento adicional.
...
:::note
La pantalla de tinta electrónica reTerminal E Serie solo admite redes WiFi de 2,4GHz, no de 5GHz ni otras bandas.
:::
...
1. **Select your device** — conecta el reTerminal E1003 a tu ordenador mediante el cable USB‑C, asegúrate de que el interruptor de encendido esté en **ON**, luego haz clic en **Select** y elige tu dispositivo de la lista.
...
1. Actualizar el firmware garantiza un rendimiento óptimo y acceso a las funciones más recientes. La interacción táctil para reTerminal E1003 requiere firmware **v1.1.2 o posterior**.

2. No es posible grabar el firmware correctamente cuando el dispositivo está apagado o en estado de suspensión. Si seleccionas el puerto correcto para tu dispositivo pero nunca ves el progreso de la grabación del firmware, puede que necesites activar el dispositivo pulsando el botón **Refresh** en la parte superior de la unidad e intentarlo de nuevo.
...
Una vez que tu dispositivo esté emparejado, puedes empezar a usarlo para mostrar lo que quieras. Recomendamos **SenseCraft HMI**, una plataforma en la nube sin código que te permite diseñar y desplegar contenido en tu reTerminal E1003 con solo unos pocos clics.
...
Una vez que tu diseño esté guardado, haz clic en **Deploy to Device**, selecciona tu reTerminal E1003 emparejado y el contenido se transmitirá de forma inalámbrica al dispositivo. La pantalla de tinta electrónica se actualizará para mostrar tu diseño. Con firmware **v1.1.2 o posterior**, también puedes tocar directamente la pantalla de tinta electrónica para interactuar con las páginas habilitadas para toque.
