...
Cuatro modelos, un ecosistema. Elige según **tamaño de pantalla**, **color vs. monocromo**, **táctil** y **autonomía de la batería**:
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Hasta 6 meses de duración de la batería con la configuración de refresco predeterminada.</td>
		</tr>
	</table>
</div>
