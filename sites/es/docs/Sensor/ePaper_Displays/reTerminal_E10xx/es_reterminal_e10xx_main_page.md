...
A diferencia de las pantallas tradicionales que consumen energía de forma continua, la reTerminal E Serie solo consume corriente al volver a dibujar el contenido, lo que la hace ideal para marcos de fotos digitales, paneles de control para el hogar inteligente, señalización comercial, paneles para salas de reuniones, pantallas para aulas y otros casos de uso siempre encendidos.
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      <td align="center"><strong>7.5" Monochrome</strong><br/>escala de grises de 4 niveles<br/>batería de ~3 meses</td>
      <td align="center"><strong>7.3" Full Color</strong><br/>E Ink® Spectra™ 6<br/>batería de ~3 meses</td>
      <td align="center"><strong>10.3" Monochrome</strong><br/>escala de grises de 16 niveles + táctil<br/>batería de ~6 meses</td>
      <td align="center"><strong>13.3" Full Color</strong><br/>E Ink® Spectra™ 6<br/>batería de ~6 meses</td>
    </tr>
    <tr>
      <td align="center"><a href="https://www.seeedstudio.com/reTerminal-E1001-p-6534.html" target="_blank" rel="noopener noreferrer"><strong>Buy E1001</strong></a><br/><a href="https://wiki.seeedstudio.com/es/getting_started_with_reterminal_e1001" target="_blank" rel="noopener noreferrer">Wiki →</a></td>
      <td align="center"><a href="https://www.seeedstudio.com/reTerminal-E1002-p-6533.html" target="_blank" rel="noopener noreferrer"><strong>Buy E1002</strong></a><br/><a href="https://wiki.seeedstudio.com/es/getting_started_with_reterminal_e1002" target="_blank" rel="noopener noreferrer">Wiki →</a></td>
      <td align="center"><a href="https://www.seeedstudio.com/catalogsearch/result/?q=e1003" target="_blank" rel="noopener noreferrer"><strong>Buy E1003</strong></a><br/><a href="https://wiki.seeedstudio.com/es/getting_started_with_reterminal_e1003" target="_blank" rel="noopener noreferrer">Wiki →</a></td>
      <td align="center"><a href="https://www.seeedstudio.com/reTerminal-E1004-p-6692.html" target="_blank" rel="noopener noreferrer"><strong>Buy E1004</strong></a><br/><a href="https://wiki.seeedstudio.com/es/getting_started_with_reterminal_e1004" target="_blank" rel="noopener noreferrer">Wiki →</a></td>
    </tr>
  </table>
</div>
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>7.5" monocromo con escala de grises de 4 niveles, refresco parcial, frecuencia de refresco de 2–5 s.</td>
		</tr>
		<tr>
			...
			<td>Panel a todo color Spectra™ 6 de 7.3" — galería, recetas, tablas de tareas para niños, señalización comercial. Nota: el color completo sacrifica el refresco parcial a cambio de imágenes más ricas (~15–20 s por refresco completo).</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>Ambos cuentan con soporte oficial. Actualmente, el E1002 funciona en modo monocromo bajo TRMNL.</td>
		</tr>
		<tr>
			<td>La duración de la batería es el factor más importante</td>
			<td align="center"><strong>E1003 / E1004</strong></td>
			<td>Hasta 6 meses de duración de batería con la configuración de refresco predeterminada.</td>
		</tr>
	</table>
</div>
...
reTerminal E1003 es una pantalla ePaper monocroma de 10,3 pulgadas y código abierto que incorpora 16 niveles de escala de grises y una alta resolución de 1404×1872 píxeles, con hasta 6 meses de duración de batería. La interacción táctil es compatible actualmente con el firmware SenseCraft HMI v1.1.2. Impulsado por ESP32-S3, admite de forma nativa el diseño de interfaces sin código con SenseCraft HMI, mientras que Arduino y PlatformIO están disponibles para un desarrollo adicional.

Se planea la publicación futura como código abierto de la biblioteca relacionada con el tacto, lo que proporcionará una mayor flexibilidad para personalizar los paneles. Próximamente se compartirán más actualizaciones. También está previsto el soporte del controlador ESPHome para el E1003 en una versión futura.
...
- Compatibilidad nativa con SenseCraft HMI más compatibilidad con Arduino y PlatformIO, con soporte de controlador ESPHome planificado
...
- **Gallery** — envía imágenes y presentaciones directamente al panel para casos de uso como marco digital.
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td>Botones, zumbador, monitorización de batería, deep sleep, paneles multipágina.</td>
			<td align="center">✅</td>
			<td align="center">✅</td>
			<td align="center">Planificado</td>
			<td align="center">a través de Home Assistant</td>
