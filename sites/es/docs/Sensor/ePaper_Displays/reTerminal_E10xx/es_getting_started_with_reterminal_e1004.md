---
description: reTerminal E1004 es una pantalla de tinta electrónica a color completa de 13,3 pulgadas y de código abierto, impulsada por ESP32-S3, que incorpora la tecnología E Ink® Spectra™ 6 y compatibilidad con SenseCraft Seeedash.
...
reTerminal E1004 es una pantalla ePaper a color completa de 13,3 pulgadas y código abierto, con una duración de batería de hasta 6 meses. Impulsada por ESP32-S3, es compatible de forma nativa con nuestra plataforma de interfaz gráfica sin código SenseCraft Seeedash para crear paneles de control sin esfuerzo, y al mismo tiempo es compatible con Home Assistant mediante [ESPHome](/es/reterminal_e10xx_with_esphome), Arduino y ESP-IDF para desarrollos adicionales. Con la pantalla ePaper a todo color E Ink® Spectra™ 6, es perfecta como marco digital y para visualización de paneles de control a color. Se requiere ESPHome **2026.7.0 o posterior** para el controlador de pantalla E1004.

### Características

- Pantalla ePaper a color E Ink® Spectra™ 6 de alta resolución, hermosa y lista para usar
- Diseño e implementación de interfaz sin código con SenseCraft Seeedash
...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td align="center">13,3" Spectra™ 6 ePaper a todo color</td>
		</tr>
		<tr>
...
- **Marco de fotos electrónico de bajo consumo:** Muestra fotos familiares o arte en alta resolución con calidad similar al papel sin preocuparte por cargarlo a diario.
...
1. **Pantalla ePaper:** Área de pantalla ePaper E Ink® Spectra™ 6 a todo color de 13,3".
...
3. **Botones de página arriba / abajo / refrescar:** Botones físicos en la parte trasera para pasar páginas y refrescar manualmente la pantalla ePaper.
...
6. **Interruptor de encendido:** Para encender o apagar la alimentación del dispositivo.
7. **LED verde de estado:** Indica el estado operativo o del sistema actual.
8. **Botón de reinicio:** Para reiniciar el dispositivo.
9. **Botón de arranque (Boot):** Se utiliza para entrar en modo de arranque / descarga de firmware.
...
11. **Inserciones de montaje para soporte:** Inserciones roscadas en la parte trasera para fijar el dispositivo a su soporte.

## Primeros pasos

El reTerminal E1004 viene preinstalado con firmware que es compatible con **SenseCraft Seeedash**, una plataforma sin código que te permite diseñar e implementar paneles personalizados sin esfuerzo.
...
:::note
La pantalla ePaper reTerminal E Serie solo es compatible con tarjetas MicroSD de hasta 32GB en formato Fat32.  
...
La mayoría de las distribuciones Linux modernas incluyen los controladores necesarios por defecto
...
**Paso 2.** Una vez conectado, tu teléfono debería redirigirte automáticamente a la página de configuración Wi‑Fi. Si no es así, abre un navegador y ve a `192.168.4.1`.
...
:::note
La pantalla de tinta electrónica reTerminal E Serie solo es compatible con redes WiFi de 2.4GHz, no con 5GHz u otras bandas.
:::

**Paso 4.** Cuando la conexión sea correcta, el dispositivo emitirá un pitido de confirmación y mostrará una pantalla con el código de emparejamiento.
...
**Paso 4.** Una vez conectado por Bluetooth, la aplicación te pedirá que configures la conexión Wi‑Fi. Selecciona tu red Wi‑Fi local de 2.4GHz de la lista desplegable, introduce la contraseña y toca **Next**.
...
**Paso 5.** La aplicación enviará las credenciales Wi‑Fi al dispositivo y lo añadirá a tu cuenta SenseCraft. Aparecerá un mensaje de "Device added successfully" cuando se complete. Ahora puedes tocar **Start exploring!** para continuar.
...
**Paso 7.** Puedes tocar el dispositivo en la lista para ver su página de **Device Detail**. Desde aquí puedes gestionar el dispositivo y subir fotos. Para un diseño más complejo de paneles y lienzos, se te pedirá que uses la versión de navegador web de SenseCraft.
...
Después de que el dispositivo se haya añadido correctamente a tu cuenta SenseCraft, la plataforma comprobará automáticamente la versión del firmware. Si hay un firmware más reciente disponible, se te pedirá que lo actualices.
...
1. **Selecciona tu dispositivo** — conecta el reTerminal E1004 a tu ordenador mediante el cable USB‑C, asegúrate de que el interruptor de encendido esté en **ON**, luego haz clic en **Select** y elige tu dispositivo de la lista.

2. **Selecciona el firmware** — elige el firmware más reciente en el menú desplegable de versiones publicadas.

3. **Flashear** — haz clic en **Flash** y espera a que la actualización se complete. Activa **Full Flash** solo si quieres restablecer el dispositivo al estado de fábrica (se borrarán todos los datos, ajustes y diseños).
...
## Mostrar contenido en tu reTerminal E1004

Una vez que tu dispositivo esté emparejado, puedes empezar a usarlo para mostrar lo que quieras. Recomendamos **SenseCraft Seeedash**, una plataforma en la nube sin código que te permite diseñar y desplegar contenido en tu reTerminal E1004 con solo unos pocos clics.
...
La forma más rápida de mostrar algo en tu pantalla es partir de una plantilla ya preparada. En la página **Home** de SenseCraft Seeedash encontrarás una amplia y creciente colección de plantillas aportadas por la comunidad: paneles de control, relojes, paneles meteorológicos, muros de citas, calendarios, marcos de fotos y más. Explora la galería, elige el diseño que más te guste y despliega en tu reTerminal E1004 con un solo clic.
...
Una vez que tu diseño esté guardado, haz clic en **Deploy to Device**, selecciona tu reTerminal E1004 emparejado y el contenido se transmitirá de forma inalámbrica al dispositivo. La pantalla de tinta electrónica se actualizará para mostrar tu diseño.
...
El botón de actualización se encuentra como el botón más a la izquierda en la parte frontal inferior del dispositivo, o en la parte posterior del dispositivo en la posición que se muestra en la imagen anterior. Cumple varias funciones:
...
- La duración de la batería depende de la frecuencia de actualización (hasta 6 meses en modo de bajo consumo con un intervalo de actualización de 6 horas)
...
El conector de expansión (J2) es un cabezal 2×4 (número de parte **ST-FH-254-0148-2×4P**) que proporciona 8 pines dispuestos en dos columnas. La notación de posición de pines que aparece a continuación usa `Lx` para la columna izquierda y `Rx` para la columna derecha (numeradas de arriba abajo, como se muestra en la imagen anterior):
