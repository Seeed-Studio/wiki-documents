...
<div class="table-center">
	<table align="center">
		...
		<tr>
			...
			<td align="center">Soporta tarjetas SD de hasta 32GB, formato FAT32</td>
		</tr>
		<tr>
...
:::tip
Por lo tanto, necesitamos completar los siguientes pasos de configuración de red durante este tiempo. Cuando el dispositivo entra en suspensión, no podrás encontrar el punto de acceso del dispositivo. Si esto ocurre, puedes despertar el dispositivo pulsando una vez el botón verde de Wake del dispositivo.
:::
...
**Paso 1.** Conéctate al punto de acceso Wi-Fi del dispositivo desde tu smartphone u ordenador. El nombre del AP aparecerá en la pantalla (no se requiere contraseña). Las credenciales de la red son `reTerminal E1002-{MAC Adress}`.
...
:::note
La pantalla de tinta electrónica reTerminal E Serie solo es compatible con redes WiFi de 2,4 GHz, no con 5 GHz ni otras bandas.
:::
...
**Paso 3.** Ponle un nombre a tu dispositivo e introduce el código de emparejamiento que aparece en la pantalla de tu dispositivo y haz clic en **Create**.
...
**Paso 5.** La aplicación enviará las credenciales Wi‑Fi al dispositivo y lo añadirá a tu cuenta de SenseCraft. Aparecerá un mensaje de "Device added successfully" cuando se complete. Ahora puedes tocar **Start exploring!** para continuar.
...
**Paso 7.** Puedes tocar el dispositivo en la lista para ver su página de **Device Detail**. Desde aquí puedes gestionar el dispositivo y subir fotos. Para diseños de paneles y lienzos más complejos, se te pedirá que uses la versión de SenseCraft para navegador web.
...
3. **Flash** — haz clic en **Flash** y espera a que se complete la actualización. Activa **Full Flash** solo si quieres restablecer el dispositivo al estado de fábrica (se borrarán todos los datos, ajustes y diseños).
...
Una vez emparejado tu dispositivo, puedes empezar a usarlo para mostrar lo que quieras. Recomendamos **SenseCraft HMI**, una plataforma en la nube sin código que te permite diseñar y desplegar contenido en tu reTerminal E1002 con solo unos pocos clics.
...
La forma más rápida de mostrar algo en tu pantalla es empezar desde una plantilla ya preparada. En la página **Home** de SenseCraft HMI encontrarás una amplia y creciente colección de plantillas aportadas por la comunidad: paneles de control, relojes, paneles meteorológicos, muros de citas, calendarios, marcos de fotos y más. Explora la galería, elige el diseño que más te guste y desplíegalo en tu reTerminal E1002 con un solo clic.
...
- **Pulsación única**: Actualiza manualmente la pantalla y comprueba si hay contenido nuevo desde la plataforma SenseCraft. El zumbador emitirá un pitido para confirmar la acción. Este botón también se utiliza comúnmente para activar el dispositivo. Puedes usar este botón para activar un dispositivo cuando se ha puesto en reposo y un comando de actualización del panel de control normalmente no está disponible de inmediato para el dispositivo.
