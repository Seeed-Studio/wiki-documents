...
Las tres líneas comparten el **mismo ecosistema de software**: SenseCraft Seeedash (no-code), Home Assistant / ESPHome, TRMNL, Arduino / ESP-IDF / PlatformIO, Zephyr, además de herramientas visuales de UI como SquareLine Vision, EEZ Studio y Lopaka. Elige una familia de hardware y el resto de la cadena de herramientas permanece igual.
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>Batería, carcasa, sensor T/H, zumbador, botones y Wi-Fi totalmente integrados. Se envía con firmware SenseCraft Seeedash.</td>
    </tr>
    <tr>
...
### Placas controladoras ESP32-S3 (Wi-Fi / BLE, SenseCraft Seeedash)
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td align="center">Universal de 24 pines / 50 pines</td>
    ...
    <tr>
      ...
      <td align="center">Universal de 24 pines (más reciente)</td>
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      <td><a href="https://wiki.seeedstudio.com/es/sensecraft_hmi_overview" target="_blank" rel="noopener noreferrer"><strong>SenseCraft Seeedash</strong></a></td>
      <td align="center">Sin código (nube)</td>
      <td>Generador de IA, Galería, Lienzo, Contenido RSS / Web, despliegue OTA. El firmware predeterminado en la reTerminal E Serie.</td>
    ...
    <tr>
      ...
      <td>Paneles de control impulsados por complementos (calendario, noticias, clima, finanzas, datos personalizados).</td>
    ...
    <tr>
      ...
      <td>Firmware ePaper de código abierto impulsado por BLE. OpenDisplay se dirige a EN04 listo para usar; OEPL Config Builder se dirige a la Breakout Board + ruta DIY con XIAO nRF52840.</td>
...
Cada tutorial a continuación recorre una plataforma de extremo a extremo:

### Frameworks de hogar inteligente y paneles de control

- [Work with ESPHome](https://wiki.seeedstudio.com/es/epaper_work_with_esphome) — referencia principal: rutas de flasheo, esqueleto YAML genérico, integración con Home Assistant. Cookbooks por producto: [reTerminal E (Básico)](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome), [reTerminal E (Avanzado)](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome_advanced), [EE04](https://wiki.seeedstudio.com/es/EE04_with_esphome_advanced), [XIAO 7.5" Panel](https://wiki.seeedstudio.com/es/xiao_075inch_epaper_panel_esphome), [TRMNL DIY Kit](https://wiki.seeedstudio.com/es/ogdiy_kit_works_with_esphome).
- [Work with TRMNL](https://wiki.seeedstudio.com/es/reterminal_e10xx_trmnl) — despliega paneles E-Ink a través de la plataforma en la nube TRMNL. Un solo artículo ahora cubre reTerminal E1001/E1002, el TRMNL DIY Kit y el XIAO 7.5" ePaper Panel — elige tu hardware en las pestañas.

### Herramientas sin código / de diseño visual de UI

- [Work with SenseCraft Seeedash](https://wiki.seeedstudio.com/es/EE04_with_hmi) — la plataforma de interfaz visual sin código de Seeed; cubre la reTerminal E Serie y las placas controladoras EE0x.
- [Work with SquareLine Vision](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_squareline_vision)
- [Work with EEZ Studio](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_eezstudio) — flujo de trabajo combinado reTerminal E Serie + EE04 con LVGL.
- [Work with Lopaka](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_lopaka)

### Desarrollo basado en código

- [Work with Arduino](https://wiki.seeedstudio.com/es/epaper_work_with_arduino) — referencia principal: configuración del IDE, biblioteca `Seeed_GFX`, generación de `driver.h`. Cookbooks por producto: reTerminal E Serie — [ePaper Display](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_arduino) y [Onboard Peripherals](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_arduino_peripherals), [TRMNL DIY Kit](https://wiki.seeedstudio.com/es/ogdiy_kit_works_with_arduino), [XIAO 7.5" Panel](https://wiki.seeedstudio.com/es/xiao_075inch_epaper_panel_arduino).
- [Work with PlatformIO](https://wiki.seeedstudio.com/es/epaper_work_with_platformio) — referencia principal: configuración de VS Code, configuración de `platformio.ini`, configuración de `Seeed_GFX` y selección del entorno PlatformIO por producto. Cookbook por producto: [EE04 / EE0x PlatformIO](https://wiki.seeedstudio.com/es/ee04_with_platformio).
- [Work with Zephyr](https://wiki.seeedstudio.com/es/epaper_work_with_zephyr) — página de entrada para el soporte de Zephyr RTOS en reTerminal E1001, E1002 y E1003, con enlaces a la documentación oficial de placas Zephyr y objetivos de placa.

### ESL / OEPL de código abierto

- [Work with OpenEPaperLink / OpenDisplay](https://wiki.seeedstudio.com/es/EN04_opendisplay) — un solo artículo cubre el kit EN04 BLE y la ruta DIY con ePaper Breakout Board + XIAO nRF52840.

## Recursos

- [SenseCraft Seeedash Documentation](https://wiki.seeedstudio.com/es/sensecraft_hmi_overview/)
