...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      <td>Encender un panel de control ePaper listo para usar, sin soldar y sin cableado adicional</td>
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>Controlador dedicado para color de gran formato; Wi‑Fi + BLE; ideal para señalización digital.</td>
    ...
    <tr>
      ...
      <td align="center">Universal de 24 pines / 50 pines (más reciente)</td>
...
<div class="table-center">
  <table align="center">
    ...
    <tr>
      ...
      <td>Firmware ePaper de código abierto controlado por BLE. OpenDisplay se dirige a EN04 listo para usar; OEPL Config Builder se dirige a la ruta DIY con Breakout Board + XIAO nRF52840.</td>
...
- [Work with SenseCraft HMI](https://wiki.seeedstudio.com/es/EE04_with_hmi) — plataforma de interfaz visual sin código de Seeed; cubre reTerminal E Serie y las placas controladoras EE0x.
...
- [Work with Arduino](https://wiki.seeedstudio.com/es/epaper_work_with_arduino) — referencia principal: configuración del IDE, biblioteca `Seeed_GFX`, generación de `driver.h`. Recetarios por producto: [reTerminal E Serie](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_arduino), [TRMNL DIY Kit](https://wiki.seeedstudio.com/es/ogdiy_kit_works_with_arduino), [XIAO 7.5" Panel](https://wiki.seeedstudio.com/es/xiao_075inch_epaper_panel_arduino).
- [Work with PlatformIO — EE04](https://wiki.seeedstudio.com/es/ee04_with_platformio)
