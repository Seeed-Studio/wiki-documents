---
description: Este artículo describe cómo usar el TRMNL 7.5inch(OG) DIY Kit para trabajar con Arduino.
...
Para programar el TRMNL DIY Kit con Arduino, tendrás que configurar el Arduino IDE con soporte para ESP32.
...
3. En la función `loop()`, leemos el estado de cada botón. Como usamos resistencias pull-up, los pines leen LOW cuando los botones se presionan.
...
- Determinamos y mostramos el estado de la batería en función de los umbrales de voltaje
...
## Pantalla de tinta electrónica (ePaper)

El TRMNL 7.5" (OG) DIY Kit incorpora una hermosa pantalla de tinta electrónica en blanco y negro de 7,5 pulgadas que ofrece una visibilidad clara en diversas condiciones de iluminación y un consumo de energía ultrabajo. En esta sección, exploraremos cómo configurar y controlar la pantalla de tinta electrónica usando Arduino.

### Configuración de hardware

Antes de comenzar a programar, asegurémonos de que la pantalla de tinta electrónica esté correctamente conectada a la placa TRMNL:

**Paso 1.** Conecta la pantalla de tinta electrónica al conector de 24 pines en la placa controladora. El conector admite inserción a ciegas, por lo que no puedes insertarla de forma incorrecta.
...
Paso 8. ¡Ahora puedes subir el ejemplo a tu TRMNL DIY Kit y ver la pantalla de tinta electrónica en acción!
...
### Ejemplo básico de pantalla de tinta electrónica

Exploremos un sencillo ejemplo de reloj analógico que demuestra cómo dibujar gráficos en la pantalla de tinta electrónica. [Este ejemplo](https://github.com/Seeed-Studio/Seeed_GFX/blob/master/examples/ePaper/Basic/Clock/Clock.ino) crea una clásica esfera de reloj con agujas de horas, minutos y segundos.
...
2. **Función `setup`:**
   ...
   - La pantalla se rellena de blanco como fondo usando `epaper.fillScreen(TFT_WHITE)`.
   ...
   - Las marcas de los minutos se dibujan como 60 puntos con énfasis especial en las posiciones de los cuartos de hora.
...
3. **Función `loop`:**
   ...
   - Las posiciones de las manecillas se calculan usando funciones trigonométricas:
     - Manecilla de horas: 30 grados por hora (más un ajuste por los minutos)
     - Manecilla de minutos: 6 grados por minuto (más un ajuste por los segundos)
...
4. **Función auxiliar:**
   - La función `conv2d` convierte una representación en cadena de un número a un valor entero, usada para analizar los valores de hora, minuto y segundo de la hora de compilación.
...
3. **Compilación condicional:** Las directivas `#ifdef EPAPER_ENABLE` aseguran que el código solo se compile y ejecute si la pantalla de e-paper está correctamente configurada en el sistema.
