---
description: La pantalla E-Ink de 7,5 pulgadas con XIAO ESP32C3 es una solución compacta y de bajo consumo para mostrar datos mediante Arduino.
...
# Primeros pasos con el panel ePaper XIAO de 7,5" en Arduino
...
El panel ePaper XIAO de 7,5" se puede programar usando el Arduino IDE, lo que lo hace accesible para makers y desarrolladores familiarizados con el ecosistema Arduino. Esta guía te llevará a través de la configuración del entorno de desarrollo de Arduino y te ayudará a comenzar con ejemplos básicos.
...
Primero, si aún no tienes Arduino IDE, ve a [Arduino IDE](https://www.arduino.cc/en/software) y descarga la última versión.
...
Después de eso, ve a **Tools** -> **Board** -> **XIAO ESP32C3** y **Tools** -> **Port** -> **Select the port your board is connected to**. Luego haz clic en **Upload** para cargar el código.
