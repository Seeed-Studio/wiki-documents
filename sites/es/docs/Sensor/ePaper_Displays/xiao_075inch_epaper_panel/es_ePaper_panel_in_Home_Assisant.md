---
description: La pantalla E Ink® de 7,5 pulgadas con XIAO ESP32C3 es una solución compacta y de bajo consumo para mostrar datos de Home Assistant.
...
# Panel ePaper XIAO 7,5" que funciona con ESPHome
...
ESPHome es una herramienta de creación de firmware de código abierto diseñada específicamente para dispositivos ESP8266/ESP32. Te permite crear firmware personalizado utilizando sencillos archivos de configuración YAML, que luego se pueden grabar en tu dispositivo. Para el panel ePaper XIAO de 7,5", ESPHome sirve como el middleware esencial que habilita la comunicación entre el dispositivo y Home Assistant.
...
Y entonces, ESPHome Builder aparecerá en la barra lateral.
...
Espera un momento y verás la respuesta como en la siguiente imagen. Significa que el código se está ejecutando correctamente.
...
Espera un momento y verás la respuesta como en la siguiente imagen. Si falla, puede deberse a una señal débil. Por favor, acerca el dispositivo a tu router. [¿Has encontrado un problema? Haz clic aquí.](#Q5)
...
Al iniciar el complemento se lanzará un nuevo servidor en el puerto 10000. Cualquier ruta que solicites devolverá una captura de pantalla de esa página. Tendrás que especificar el tamaño de la ventana gráfica que quieras.
...
:::tip
Durante el modo de suspensión profunda, no puedes cargar código al dispositivo directamente. Necesitas entrar en el modo de descarga.[Click here jump to Q3.](#port)
:::
...
:::tip
Antes de copiar el código, por favor coloca [wifi.jpg](#image), [icon ttf file and font ttf file](#ttf) en la carpeta **image** y en la carpeta **fonts**.
:::
...
Según nuestras pruebas, si se actualiza la pantalla cada 6 horas, la batería durará alrededor de 3 meses en modo de suspensión profunda.

#### <span id="Q5">P5</span>: ¿El ePaper Penel no puede conectarse a tu ordenador?
...
- **[STP]**: [Modelo 3D de carcasa](https://files.seeedstudio.com/wiki/xiao_075inch_epaper_panel/3D_model.zip)
