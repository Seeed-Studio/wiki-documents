...
Impulsada por el **XIAO ESP32-S3 Plus**, la placa de pantalla EE05 es compatible con una amplia gama de pantallas ePaper de 24 pines y permite el diseño e implementación de interfaces de usuario sin código con SenseCraft Seeedash. Con IO de extensión y un interruptor de alimentación para el conector de batería, es ideal para aplicaciones de pantalla inteligente de bajo consumo.
...
| **Fuente de alimentación** | Batería de litio de 3.7V / USB Type-C |
...
- **Conexión de la batería**: Comprueba la polaridad del conector JST 2.0mm para asegurarte de que coincida con el diseño de la placa.
