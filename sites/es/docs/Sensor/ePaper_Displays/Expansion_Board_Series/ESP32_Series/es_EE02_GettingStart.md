...
| **Conector ePaper** | FPC de 60 pines, paso de 0,5 mm |
...
- **Panel en tiempo real**: Pantallas de información en vivo para datos meteorológicos, bursátiles, de tráfico o de automatización del hogar.
...
*   Asegúrate de que PSRAM está habilitada en el menú Tools del Arduino IDE.
