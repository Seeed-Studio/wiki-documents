...
- Interruptor de encendido integrado e indicador de estado de carga

## Especificaciones

|Elemento|Valor|
|---|---|
|Tensión de funcionamiento|3.3V / Batería de litio de 3.7V|
...
- **Paso 1.** Descarga el [Demo code](https://github.com/Seeed-Studio/Seeed_Arduino_DopplerRadar).
