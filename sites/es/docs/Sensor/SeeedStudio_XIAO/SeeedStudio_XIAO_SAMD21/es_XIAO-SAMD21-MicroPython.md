...
- [Seeed Studio XIAO SAMD21](https://www.seeedstudio.com/Seeeduino-XIAO-Arduino-Microcontroller-SAMD21-Cortex-M0+-p-4426.html) o [Seeed Studio XIAO SAMD21 Plus](https://www.seeedstudio.com/Seeed-Studio-XIAO-SAMD21-Plus-p-6933.html) x1
- Cable Type-C x1
- PC x1
...
- [**Modo Bootloader para la Serie XIAO SAMD21**](https://wiki.seeedstudio.com/es/Seeeduino-XIAO/#enter-bootloader-mode)
...
Simplemente ve a la página oficial de MicroPython y descarga el firmware más reciente
    ...
    - [Firmware MicroPython para la Serie XIAO SAMD21](https://micropython.org/download/SEEED_XIAO_SAMD21/)


También es posible [compilar tu propio firmware](https://wiki.seeedstudio.com/es/Compiling_MicroPython_for_embedded_devices/) para garantizar la seguridad y el soporte de las funciones más recientes, pero no es necesario.
<br/>
...
1. Para XIAO SAMD21, el RX_LED es PA18
...
2. Para XIAO SAMD21 Plus, los RX_LED y TX_LED se han eliminado. En su lugar se utiliza un LED WS2812, con su pin de datos asignado a PA27.
<br/>
```py
from machine import Pin, Timer
import machine
