---
description: Seeed Studio XIAO SAMD21 con PlatformIO
title: XIAO SAMD21 con PlatformIO
keywords:
  - xiao
...
url: https://wiki.seeedstudio.com/es/xiao_samd21_with_platform_io/
---
...
:::tip
Antes de esto, ya había instalado el paquete de instalación de XIAO SAMD21, por lo que puedes ver que la imagen en la operación dos tiene la opción para XIAO SAMD21, pero tú no la tienes cuando realizas la operación.
:::
...
Al final, si ves el mismo resultado que en la imagen de arriba, significa que has añadido exitosamente la Placa de Desarrollo XIAO SAMD21. Cuando crees un proyecto nuevamente, verás la opción XIAO SAMD21 disponible.
