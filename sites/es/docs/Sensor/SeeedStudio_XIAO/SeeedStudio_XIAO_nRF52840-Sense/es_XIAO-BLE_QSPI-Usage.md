...
:::tip
¡Agradecimientos especiales a los usuarios de la comunidad **JM_Laird** y **Haakonish** por su apoyo y ayuda con este tutorial! El programa utilizado en este artículo fue obtenido del usuario de Github **PMCheetham** y la fuente se puede encontrar **[AQUÍ](https://github.com/PMCheetham/SEEED_nRF52840_QSPI/tree/main)**.
:::


¡Bienvenido a este tutorial sobre el uso de Flash QSPI en XIAO nRF52840 y XIAO nRF52840 Sense! XIAO es una placa potente y compacta que cuenta con 256 KB de RAM, 1 MB de Flash y 2 MB de Flash integrada. En este tutorial, aprenderás cómo utilizar la Flash QSPI en las placas XIAO, lo que puede expandir enormemente la capacidad de almacenamiento y acelerar tus proyectos. ¡Comencemos!

El siguiente es un programa de ejemplo proporcionado por PMCheetham que funciona bien con el XIAO nRF52840 Sense. Con el siguiente programa puedes usar libremente la Flash QSPI en el XIAO.
...
El programa solo está disponible para placas **mbed**, así que por favor selecciona el XIAO nRF52840 bajo la pestaña mbed al compilar y cargar.
