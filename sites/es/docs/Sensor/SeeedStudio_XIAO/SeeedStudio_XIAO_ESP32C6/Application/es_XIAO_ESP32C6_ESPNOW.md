...
url: https://wiki.seeedstudio.com/es/xiao_esp32c6_espnow/
---
...
#### Código de la Parte 2 de la Resolución
...
- `#define ESPNOW_WIFI_CHANNE` 
  - Función : el canal en el que se encuentra el emisor y receptor
- `#define MAX_ESP_NOW_MAC_LEN` 
  - Función : longitud de la dirección MAC
- `#define MAX_CHARACTERS_NUMBER` 
