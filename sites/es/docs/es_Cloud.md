---
description: Descubre los servicios en la nube SenseCraft de Seeed:una potente plataforma de grado industrial diseñada para una gestión eficiente de datos, operaciones en tiempo real y aplicaciones IoT escalables. Más información sobre cómo SenseCraft admite tu implementación de nube IoT industrial.
title: Cloud
keywords:
  - SenseCraft Matrix
  - SenseCraft
...
<strong><font color={'8DC215'} size={"4"}>Esta sección destaca diferentes servicios en la nube ofrecidos por Seeed Studio, adaptados a varias aplicaciones de IoT industrial. Puedes explorar más en las siguientes áreas:</font></strong>
...
- APIs para diversos propósitos de conexión
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>La SenseCraft Data Platform proporciona monitorización de datos para nodos sensores y gateways SenseCAP.</font></p>
    </div>
</div>
...
<div class="independent_container">
    <div class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/es/sensecraft-data-platform/tutorials/device-management#sensor-node-management" target="_blank"><span><font color={'FFFFFF'} size={"2"}><strong>Nodos Sensor SenseCAP</strong> - Ver EUI, nombre, estado, tipo de datos y más.</font></span></a>
            <br/>
            ...
            <br/>
            <a href="/es/sensecraft-data-platform/tutorials/device-management#settings" target="_blank"><span><font color={'FFFFFF'} size={"2"}><strong>Settings</strong> - Ajusta la frecuencia de recopilación de datos y otros parámetros.</font></span></a>
            <br/>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p>La SenseCraft App se utiliza en teléfonos móviles para configurar, crear y gestionar sensores, y mostrar datos desde la SenseCraft Data Platform.</p>
            <br/>
            > <a href="/es/sensecraft-app/overview#download" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Download</font></span></a> / <a href="/es/sensecraft-app/overview#config" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Vincular Dispositivos</font></span></a> / <a href="/es/sensecraft-app/overview#account" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Cuenta</font></span></a> / <a href="/es/sensecraft-app/overview#user" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Usuario</font></span></a>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p>SenseCraft AI se puede acceder desde la SenseCraft Data Platform y la SenseCraft App.</p>
            <br/>
            ...
            > <a href="/es/sensecraft-data-platform/applications/planting-advice" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Conectando XIAO ESP32-C3</font></span></a>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p>La API de SenseCraft Data Platform admite la gestión de dispositivos y datos.</p>
            <br/>
