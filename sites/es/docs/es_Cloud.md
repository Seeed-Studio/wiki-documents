...
Los servicios en la nube son un componente vital que permite la gestión de datos procesados desde placas de computación y proporciona a los usuarios operaciones en tiempo real. Esta página presenta los servicios en la nube SenseCraft de nivel industrial de Seeed, junto con otras aplicaciones de servicios en la nube adaptadas a diversas necesidades de IoT industrial. A través de una sólida infraestructura en la nube, Seeed permite a los usuarios almacenar, analizar y aprovechar de forma segura los datos procesados, facilitando la toma de decisiones basada en datos y mejorando la eficiencia operativa en diversos ámbitos.

## Servicio en la nube SenseCraft

<strong><font color={'8DC215'} size={"4"}>Esta sección destaca los diferentes servicios en la nube ofrecidos por Seeed Studio, adaptados a varias aplicaciones de IoT industrial. Puedes explorar más en las siguientes áreas:</font></strong>
...
- API para diversos propósitos de conexión
- Introducción a los servicios en la nube

### Plataforma de datos SenseCraft / Panel de control Blockchain
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>La plataforma de datos SenseCraft proporciona monitorización de datos para nodos sensores y gateways SenseCAP.</font></p>
    </div>
</div>

<div class="intro_container">
    <div class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Panel SenseCraft MX</font></div>
            ...
            <br/>
            <a href="/es/sensecraft-blockchain/blockchain-dashboard/dashboard-registration" target="_blank"><span><font color={'FFFFFF'} size={"2"}>Registro en el panel</font></span></a>
            <br/>
...
<div class="independent_container">
    <div class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/es/sensecraft-data-platform/tutorials/device-management#node-group-management" target="_blank"><span><font color={'FFFFFF'} size={"2"}><strong>Grupos de nodos SenseCAP</strong> - Gestiona dispositivos cómodamente por grupos.</font></span></a>
            <br/>
            ...
            <br/>
            <a href="/es/sensecraft-data-platform/tutorials/device-management#settings" target="_blank"><span><font color={'FFFFFF'} size={"2"}><strong>Ajustes</strong> - Ajusta la frecuencia de recopilación de datos y otros parámetros.</font></span></a>
            <br/>
            ...
            /
            <a href="/es/sensecraft-data-platform/tutorials/device-management#bind-device" target="_blank"><span><font color={'FFFFFF'} size={"2"}><strong>Vinculación del dispositivo</strong></font></span></a>
            /
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>App SenseCAP MX Blockchain</font></div>
            <p>La app SenseCAP HotSpot se utiliza en teléfonos móviles para gestionar hotspots LoRaWAN.</p>
            <br/>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <p>La app SenseCraft se utiliza en teléfonos móviles para configurar y gestionar sensores y mostrar datos de la plataforma de datos SenseCraft.</p>
            <br/>
            > <a href="/es/sensecraft-app/overview#download" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Descargar</font></span></a> / <a href="/es/sensecraft-app/overview#device" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Vincular dispositivos</font></span></a> / <a href="/es/sensecraft-app/overview#account" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Cuenta</font></span></a> / <a href="/es/sensecraft-app/overview#user" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Usuario</font></span></a>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Asesor de IA</font></div>
            <p>El Asesor de IA utiliza datos de sensores de la plataforma de datos SenseCraft para proporcionar recomendaciones para escenarios compatibles.</p>
            <br/>
            > <a href="/es/sensecraft-data-platform/applications/ai-advisor" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Asesor de IA</font></span></a>
            > <a href="/es/sensecraft-data-platform/applications/planting-advice" target="_blank"><span><font color={'FFFFFF'} size={"3"}>Ejemplo de recomendaciones de plantación</font></span></a>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Plataforma de datos SenseCAP - API</font></div>
            <p>La API de la plataforma de datos SenseCraft admite la gestión de dispositivos y datos.</p>
            <br/>
