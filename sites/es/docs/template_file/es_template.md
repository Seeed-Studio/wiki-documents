...
Estoy utilizando (productos de Seeed) como hardware aquí. El contenido aquí debe incluir:
...
Estoy utilizando el software Thonny IDE(Windows) y algunas bibliotecas y archivos relacionados. El contenido aquí debe incluir:
...
Algunos problemas pueden encontrarse en el proceso de conexión de hardware, depuración de software o carga.
...
## ✨ Otro código de funciones de la wiki
...
### Botón de descarga de biblioteca de Github
...
:::note
Algo de **contenido** con _Markdown_ `syntax`. Check [this `api`](#).
:::
