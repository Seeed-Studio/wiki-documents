...
Esta página te guía desde cero hasta completar un inicio de sesión y realizar tu primera llamada a la API.
...
El token es válido durante 24 horas de forma predeterminada (`Max-Age=86400`). Después de que caduque, inicia sesión de nuevo para obtener un token nuevo.
