...
## Información básica
En esta interfaz, puedes ver la información básica de hardware y software del dispositivo, así como el uso de los recursos del sistema.
<img width={800} src="https://files.seeedstudio.com/wiki/reCamera-Pro/web_ui_wiki/msedge_aWZqM1cZvA.png" />

## Configuración de hora
Esta interfaz te permite configurar la hora del sistema en recamera pro.
...
En esta interfaz, puedes configurar cómo conectarte a recamera pro, y puedes ajustar si habilitar la conexión remota SSH, la configuración HTTP y la velocidad en baudios del puerto serie.
...
Para importar la configuración, debes seleccionar un archivo tar para importar, que tiene la misma extensión de archivo que el archivo de configuración exportado. Después de la importación, se cargará automáticamente. Espera al reinicio y, a continuación, se actualizará la información de configuración importada.
