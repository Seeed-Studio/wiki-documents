...
| GET | `/network/wifi-status` | Consultar el estado de energía de Wi‑Fi |
| POST | `/network/wifi-status?power=on/off` | Conmutar la energía de Wi‑Fi |
...
| `dLink.iPower` | Estado de energía de la interfaz |
...
### Consultar el estado de energía de Wi‑Fi
...
| Campo | Descripción |
|---|---|
| `iPower` | Estado de energía de Wi‑Fi, `1` encendido, `0` apagado |
| `id` | ID de la interfaz |
| `sType` | Tipo de interfaz |

### Conmutar la energía de Wi‑Fi
