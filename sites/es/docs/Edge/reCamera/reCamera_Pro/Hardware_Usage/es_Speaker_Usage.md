...
title: Uso del altavoz de reCamera Pro
keywords:
  - reCamera
  - reCamera Pro
  - Speaker
...
# Uso del altavoz
- El altavoz es un modelo de 8Ω / 1W impulsado por el amplificador de potencia de audio Clase D NS4150B integrado en la placa.
