...
title: Imagen experimental de Debian 13
keywords:
  - reCamera
  - reCamera Pro
  - RV1126B
...
[Descarga la imagen de Debian 13](https://github.com/yyling0101-a11y/reCamere_pro_debian_img/releases/download/v1.0.0/recamera_pro_debian13_v1.0.0.tar.gz).
...
Utiliza V4L2 para capturar un fotograma bruto NV12 y luego usa FFmpeg para convertirlo a JPEG:
...
Crea el archivo de configuración del daemon de Docker para establecer el directorio de datos y desactivar la red predeterminada:
...
## Instalar herramientas GStreamer y capturar datos de la cámara
