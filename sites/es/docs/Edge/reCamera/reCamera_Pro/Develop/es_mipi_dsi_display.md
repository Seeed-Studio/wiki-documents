...
title: Conectar una pantalla MIPI-DSI
keywords:
  - reCamera
  - reCamera Pro
  - MIPI-DSI Screen
...
Después de conectar la pantalla MIPI, encienda el dispositivo y la imagen de la cámara en tiempo real se mostrará en la pantalla MIPI.
