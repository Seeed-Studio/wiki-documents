...
El modelo de IMU incorporado en el dispositivo es ICM-42670-P, un sensor de 6 ejes que integra un acelerómetro de 3 ejes y un giroscopio de 3 ejes. El giroscopio del ICM-42670-P admite rangos de medición de ±250 / ±500 / ±1000 / ±2000 dps, mientras que el acelerómetro admite rangos de ±2 / ±4 / ±8 / ±16 g. Sus datos internos se emiten en formato de complemento a dos de 16 bits.
...
Ejecuta el siguiente comando para leer los datos en bruto correspondientes. El siguiente ejemplo muestra la lectura de los datos de aceleración del eje X:
