...
- **Fallo en la reproducción de audio**: Confirma que el archivo de audio esté en formato WAV y que el comando `aplay` esté disponible. Si el altavoz está en silencio, revisa la configuración de volumen de ALSA.
