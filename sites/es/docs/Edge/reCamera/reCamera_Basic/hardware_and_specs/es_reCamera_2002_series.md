...
url: https://wiki.seeedstudio.com/es/reCamera/reCamera_Basic/hardware_and_specs/recamera_2002_series_hardware_and_specs
---

# Descripción general de reCamera

reCamera es una cámara de IA diminuta y de código abierto, programable y personalizable, impulsada por un SoC RISC-V, que ofrece un rendimiento de IA en el dispositivo de 1 TOPS con codificación de video de 5MP a 30 FPS. El diseño de hardware modular y las interfaces ampliables ofrecen la plataforma más versátil para desarrolladores que construyen sistemas de visión con IA.
    ...
    <tbody>
        ...
        <tr>
            <td style={{width: '35.3932%'}} colspan="2" rowspan="1" width="208">
                <p><strong><span data-font-family='"Source Sans Pro", sans-serif'>reCamera 2002 Serie</span></strong></p>
            </td>
        ...
        <tr>
            ...
            <td style={{width: '18.8653%'}} colspan="1" rowspan="1" width="111">
                <p><span data-font-family="Montserrat">Rendimiento de IA</span></p>
            </td>
        ...
        <tr>
            ...
            <td style={{width: '64.4424%'}} colspan="2" rowspan="1" width="379">
                <p><span data-font-family="Montserrat">1 indicador de encendido, 2 E/S programables</span></p>
            </td>
        </tr>
        <tr>
            <td style={{width: '16.528%'}} colspan="1" rowspan="2" width="97">
...
<tr >
    <td >IMAGEN</td>
    <td  colspan="3">Resolución de imagen fija de 2592 x 1944</td>
</tr>
<tr >
    <td >VÍDEO</td>
...
- 1 x lector de tarjetas SD para almacenamiento e intercambio de datos.
...
Hay 3 indicadores en la reCamera, las luces **roja y azul** son indicadores programables, y el indicador **verde** es el indicador de alimentación que no es programable. La **roja** es el indicador de estado de la CPU y la **azul** es el indicador de estado de lectura de la eMMC del sistema.
...
La versión 2002w de reCamera tiene el módulo Wi-Fi en el hardware. El Wi-Fi es de doble modo AP+STA, que se puede usar para configurar la red del dispositivo o configurar el dispositivo en modo AP.

El **SSID** del Wi-Fi en modo AP es: `reCamera_+ the last six bits of MAC`.

La **contraseña** del Wi-Fi en modo AP es: `12345678`.

El ssid y la contraseña del WiFi_AP se pueden configurar en el archivo `/etc/hostapd_2g4.conf` del sistema de la reCamera.

<div align="center"><img width={600} src="https://files.seeedstudio.com/wiki/reCamera/image-2.png" /></div>

El archivo de configuración STA de la reCamera está en **/etc/wpa_supplicant.conf**, donde configuras la cuenta y la contraseña de Wi-Fi a la que conectarte.
...
La ranura para tarjeta SD puede ampliar el espacio de almacenamiento de la reCamera. Después de insertar la tarjeta SD, puedes encontrar la existencia de tu SD usando el comando `lsblk`.
...
Ten en cuenta que la reCamera solo reconoce sistemas de archivos **ext4**.
...
Comprueba el resultado del montaje con `lsblk`
...
El dispositivo tiene una velocidad en baudios del puerto serie de 115200 y puede iniciar sesión en el sistema de la reCamera.
