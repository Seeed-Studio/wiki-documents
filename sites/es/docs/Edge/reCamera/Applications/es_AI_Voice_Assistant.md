...
url: https://wiki.seeedstudio.com/es/ai_voice_interaction_with_recamera/
---
...
Antes de ejecutar el servicio, debes configurar las claves de API de **iFlytek**. Ve a la [Plataforma Abierta de iFlytek](https://www.xfyun.cn/) para registrar una cuenta y activar los siguientes tres servicios:
