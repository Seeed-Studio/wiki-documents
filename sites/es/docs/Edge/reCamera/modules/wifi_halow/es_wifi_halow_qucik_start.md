---
title: Guía de inicio de Wifi Halow
...
* **reCamera**: Un dispositivo reCamera con la placa inferior retirada.
---
...
- ***IPEX Antenna***: Cambiar antenas (hay dos antenas en el módulo Wifi Halow: una antena SMA externa y una antena IPEX interna). Al activarlo se habilita la antena interna, consulta la figura siguiente para más detalles:
  ...
  ![Ubicación de la antena](https://files.seeedstudio.com/wiki/reCamera/reCamera_Wifi_Halow/wifi_halow_antenna.jpg)
...
3. Después de una conexión exitosa, haz clic en la red bajo ***My Networks*** para ver información detallada como la IP, como se muestra en la figura siguiente:
![Ubicación de la antena](https://files.seeedstudio.com/wiki/reCamera/reCamera_Wifi_Halow/wifi_halow_detial.png)
...
Hay una interfaz PH en el módulo Wifi Halow para conectar una batería, y junto a ella hay dos indicadores LED. La luz roja se enciende cuando la batería se está cargando y la luz verde se enciende cuando está completamente cargada, como se muestra en la figura siguiente:
