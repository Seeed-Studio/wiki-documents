---
description: Guía de ensamblaje de reComputer Industrial R20xx
title: Guía de ensamblaje de reComputer Industrial R20xx
keywords:
  - Raspberry pi
...
url: https://wiki.seeedstudio.com/es/recomputer_industrial_r20xx_assembly_guide/
---
...
El reComputer Industrial R20xx admite una variedad de comunicaciones inalámbricas IoT, incluidas 4G, 5G, LoRa®, Wi-Fi/BLE y Zigbee. Admite expansión mediante una ranura M.2 para almacenamiento SSD o capacidades de IA mediante un acelerador NPU. Si decides incluir el acelerador de IA directamente en tu compra, obtendrás 26 TOPS adicionales de potencia de cómputo. Además, nuestros servicios de ingeniería de hardware incluyen personalización de logotipo, marca del embalaje, etiquetado, grabación de firmware y servicios de creación de imágenes, proporcionando un soporte integral adaptado a tus necesidades específicas.
...
El método de montaje vertical también es adecuado para reComputer Industrial R20xx; sin embargo, los soportes de montaje no están incluidos en la caja y deben adquirirse por separado.
