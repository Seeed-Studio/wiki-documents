---
description: Aprende cómo integrar Modbus TCP con Node-RED en el reTerminal DM. Esta guía cubre la configuración del hardware, la configuración de dispositivos Modbus, y la creación de flujos de Node-RED para automatización industrial y monitoreo eficientes.
title: reTerminal DM con Node Red y Modbus TCP
keywords:
  - HMI
  - reTerminal DM
  - Node-Red
...
url: https://wiki.seeedstudio.com/es/reterminal_dm_node_red_modbus_tcp/
---
## Introducción
...
El reTerminal DM es compatible con la comunicación Modbus con varios dispositivos, incluyendo **PLCs, VFDs, HMIs, medidores de energía y sistemas BMS**. Para este caso, se utilizará el PLC Siemens LOGO, que es compatible con **protocolos Modbus TCP/IP**. Conecte el reTerminal DM con un puerto Ethernet y un dispositivo habilitado para Modbus TCP.

### Preparación del Software

Hemos preparado una [Guía de introducción sobre Node-RED](https://wiki.seeedstudio.com/es/reTerminal-DM-Getting-Started-with-Node-Red/). Se recomienda que revise esta guía antes de proceder con el wiki.

### Configurar ajustes de Ethernet para Modbus TCP/IP

Dado que el dominio IP de su PLC/Dispositivo es diferente de su configuración inalámbrica, es posible que tenga que cambiar la configuración IP manualmente. Para eso,

- **Paso 01**: Ejecute el siguiente comando:
