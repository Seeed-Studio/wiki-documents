...
url: https://wiki.seeedstudio.com/es/reterminal_dm_200_node_red_influxdb/
---
## Introducción

Desplegar [InfluxDB](https://www.influxdata.com/) en un reTerminal DM, un HMI alimentado por Raspberry Pi, permite la recopilación y análisis robustos de datos de series temporales en el borde de tu red. Esta configuración es ideal para aplicaciones IoT, proporcionando información en tiempo real y capacidades de monitoreo. Al aprovechar la base de datos InfluxDB ligera pero poderosa, puedes gestionar y analizar eficientemente los datos de sensores directamente en el reTerminal DM. La siguiente guía describe los pasos para instalar, configurar y usar InfluxDB en tu reTerminal DM, asegurando una integración perfecta en tu infraestructura de datos.
...
Esta guía cubre los pasos para instalar y configurar InfluxDB en un HMI reTerminal DM.

**Paso 1**: Actualizar el Sistema

Primero, asegúrate de que tu sistema esté actualizado ejecutando el siguiente comando: SSH a reTerminal DM y
...
## Añadiendo Autenticación a InfluxDB
...
**Paso 1**. Abre tu Node-RED en tu navegador (típicamente `http://<your-reTerminal-DM-ip>:1880`).
