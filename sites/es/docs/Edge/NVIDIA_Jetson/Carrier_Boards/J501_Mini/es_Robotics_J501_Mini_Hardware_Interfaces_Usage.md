...
2.Coloque un disipador térmico en el módulo para obtener un mejor rendimiento.
3.Durante el funcionamiento con entrada de alto voltaje y alta carga, no toque el disipador térmico para evitar quemaduras.
