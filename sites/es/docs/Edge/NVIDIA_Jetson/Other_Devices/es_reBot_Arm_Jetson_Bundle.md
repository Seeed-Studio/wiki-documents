...
Para ayudar a desarrolladores, investigadores y educadores a acelerar su camino hacia la IA incorporada, Seeed Studio combina el reBot Arm B601 totalmente de código abierto con el avanzado kit de desarrollo NVIDIA Jetson para crear un potente kit de desarrollo robótico de próxima generación.
...
2. Utiliza un adaptador USB-a-CAN para conectar el brazo robótico al NVIDIA Jetson mediante la interfaz Type-C.
