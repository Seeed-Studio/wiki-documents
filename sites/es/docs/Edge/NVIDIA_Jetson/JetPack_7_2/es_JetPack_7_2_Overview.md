...
- **Compatibilidad de Jetson Orin en JetPack 7**: JetPack 7.2 lleva la pila de software JetPack 7 a la familia Jetson Orin manteniendo la compatibilidad con Jetson Thor.
...
| IA agentiva y habilidades reutilizables para Jetson | [Creación rápida de prototipos con NVIDIA Skills](/es/rapid_prototyping_on_jetson_with_nvidia_skills_bk/) y [NemoClaw en Jetson Thor](/es/control_rebot_arm_with_nemoclaw_on_nvidia_jetson_thor_bk/) |
...
JetPack 7.2 amplía el flujo de trabajo del desarrollador de Jetson más allá de la configuración manual al convertir las habilidades de agente reutilizables y las aplicaciones agentivas locales en partes de primera clase del ecosistema.
...
- [Guía del desarrollador de Jetson Linux 39.2](https://docs.nvidia.com/jetson/archives/r39.2/DeveloperGuide/index.html)
