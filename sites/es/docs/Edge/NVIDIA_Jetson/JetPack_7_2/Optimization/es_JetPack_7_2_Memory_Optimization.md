...
El [JetPack 7.2 Deep Dive](/es/jetpack72_deep_dive_bk/) registró que la memoria después de cargar un modelo de 27B cayó de aproximadamente **24.6 GB** en JetPack 6.2 a **14.7 GB** en JetPack 7.2 en la comparación de Seeed. Toma ese resultado como una referencia específica de la carga de trabajo, no como una reducción garantizada para cada modelo.
