const docList = [
  ...
  [
    ...
    },
    {
      ...
      "title_ja": "Python SDK を使用してメモリレイヤーを追加した reSpeaker Clip 用独自アプリを構築する",
      "title_es": "Crea tu propia app para reSpeaker Clip añadiendo una capa de memoria usando el SDK de Python",
      "title_pt": "Crie seu próprio app para reSpeaker Clip adicionando camada de memória usando o Python SDK"
    }
  ],
  [
    {
    ...
    {
      "path": "/rebot_arm_b601_dm_web_simulator_developer_guide",
      ...
      "date": "2026-07-30",
      "title_cn": "reBot Arm B601-DM Web 仿真器与 ROS2/MuJoCo 开发者教程",
      "title_ja": "reBot Arm B601-DM Web シミュレータおよび ROS2/MuJoCo 開発者ガイド",
      "title_es": "Guía para Desarrolladores del Simulador Web reBot Arm B601-DM y ROS2/MuJoCo",
      "title_pt": "Guia do Desenvolvedor do Simulador Web reBot Arm B601-DM e ROS2/MuJoCo"
    }
  ],
  [
    {
