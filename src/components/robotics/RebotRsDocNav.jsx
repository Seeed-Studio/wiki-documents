...
const ITEMS = [
  ...
  {slug: '/rebot_arm_b601_rs_lerobot/', en: 'LeRobot', zh: 'LeRobot'},
  {
  ...
  {slug: '/rebot_arm_b601_rs_ros2_integration/', en: 'ROS2', zh: 'ROS2'},
  {
  ...
  {slug: '/rebot_arm_b601_rs_isaacsim/', en: 'Isaac Sim', zh: 'Isaac Sim'},
  {slug: '/rebot_arm_b601_rs_mit_control/', en: 'MIT Control', zh: 'MIT 控制'},
];
...
export default function RebotRsDocNav() {
  ...
  return (
    <nav
      ...
      aria-label={isZh ? 'reBot Arm B601-RS 文档导航' : 'reBot Arm B601-RS docs navigation'}
    >
      {ITEMS.map((item) => {
