...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Sensor/Grove/Grove_Sensors/Proximity/Grove-80cm_Infrared_Proximity_Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Infrared</font></span></a>
            <br/>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Sensor/Grove/Grove_Sensors/Touch/Grove-Touch_Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Touch </font></span></a>
            <br/>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'left'}}>
            ...
            <a href="/Sensor/Wio_Series/Wio RP2040/Wio RP2040 mini Dev Board/Application/Use_MQTT_to_remotely_light_up_LED_lights" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Use MQTT to remotely light up LED lights</font></span></a>
            <br/>
            <a href="/Sensor/Wio_Series/Wio RP2040/Wio RP2040 mini Dev Board/Application/Use_Socket_to_connect_to_the_forum" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Use Socket to connect to the forum</font></span></a>
            <br/>
            <a href="/Sensor/Wio_Series/Wio RP2040/Wio RP2040 mini Dev Board/Application/Wireless-Fall-Detection-Device" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Wireless Fall Detection Device</font></span></a>
            <br/>
    </a>
</div>
...
<div class="independent_container">
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/Top_Brand/Arduino/Tutorials/Arduino_Enhanced_Usage/ODYSSEY-X86J4105-Firmata" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Firmata Tutorial - How to Use Firmata on Arduino Compatible</font></span></a>
            <br/>
            <a href="/Top_Brand/Arduino/Tutorials/Arduino_Enhanced_Usage/Software-FreeRTOS" target="_blank"><span><font color={'FFFFFF'} size={"2"}> FreeRTOS Tutorial - How to use FreeRTOS apply Multi-tasking</font></span></a>
            <br/>
            <a href="/Top_Brand/Arduino/Tutorials/Arduino_Enhanced_Usage/Software-SWD" target="_blank"><span><font color={'FFFFFF'} size={"2"}> How to Debug Arduino Boards using SWD Interface</font></span></a>
            <br/>
            <a href="/Top_Brand/Arduino/Tutorials/Arduino_Enhanced_Usage/Flashing-Arduino-Bootloader-DAPLink" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Flashing the Arduino Bootloader using DAP Link</font></span></a>
            <br/>
    </a>
</div>
