---
description: 選択した製品にJetpackをフラッシュします。このページには現在、製品の一部が含まれています。
title: 選択した製品にJetpackをフラッシュ
keywords:
  - jetson
  - flash
  - jetapck
...
製品と、フラッシュしたい Jetson Linux を選択してください。このページには現在、製品の一部が含まれています。
...
お使いのデバイスの Jetson Linux サポートを確認するには[こちら](https://seeedstudio88-my.sharepoint.com/:x:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EX8k1puq5J1IgMZKYYdmuqgB_EtGjxSB7_-hRjUGjTa0dQ?e=1QSozj)をクリックしてください
:::
...
{/* <table>
  <tr>
   <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/ja/Traffic-Management-DeepStream-SDK/">DeepStream Example</a></div>
    </td>
   <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/A608/Real-Time-Whisper.gif" width="300" />
      <div><a href="https://wiki.seeedstudio.com/ja/Edge/NVIDIA_Jetson/Application/Generative_AI/Whisper_on_Jetson_for_Real_Time_Speech_to_Text/">Whisper on Jetson</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/Jetson-Nano-MaskCam/tu3.png" width="300" />
      <div><a href="https://wiki.seeedstudio.com/ja/Jetson-Nano-MaskCam/">MaskCam Project</a></div>
    </td>
  </tr>
  <tr>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/sound_follow/robot.jpg" width="300" />
      <div><a href="https://wiki.seeedstudio.com/ja/sound_follow_robot/">Sound-Following Robot</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
    ...
    <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/ja/deploy_deepseek_on_jetson_with_mlc/">DeepSeek Demo</a></div>
    </td>
  </tr>
</table> */}
