...
{/* <table>
  <tr>
   <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/Traffic-Management-DeepStream-SDK/">DeepStream 例</a></div>
    </td>
   <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/A608/Real-Time-Whisper.gif" width="300" />
      <div><a href="https://wiki.seeedstudio.com/Edge/NVIDIA_Jetson/Application/Generative_AI/Whisper_on_Jetson_for_Real_Time_Speech_to_Text/">Jetson 上の Whisper</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/Jetson-Nano-MaskCam/tu3.png" width="300" />
      <div><a href="https://wiki.seeedstudio.com/Jetson-Nano-MaskCam/">MaskCam プロジェクト</a></div>
    </td>
  </tr>
  <tr>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/sound_follow/robot.jpg" width="300" />
      <div><a href="https://wiki.seeedstudio.com/sound_follow_robot/">サウンド追従ロボット</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
    ...
    <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/deploy_deepseek_on_jetson_with_mlc/">DeepSeek デモ</a></div>
    </td>
  </tr>
</table> */}
