...
**Xiaomi Smart Light統合**を追加して、スマートライトのオン/オフを切り替えられるようにしましょう。進む前に、Xiaomi Smart Lightにアクセスできることを確認してください。もし別のスマートライト（例: **Philips Hue**）をお持ちの場合は、**Philips Hue統合**を追加することができ、手順はほぼ同じです。
