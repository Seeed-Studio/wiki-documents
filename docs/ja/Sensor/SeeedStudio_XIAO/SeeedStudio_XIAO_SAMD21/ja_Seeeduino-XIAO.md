...
コードを提出してくれた[Aleksei Tertychnyi](https://github.com/WeSpeakEnglish)に感謝します。すべての関連機能は彼によって開発・貢献されました。
...
- ステップ2. Seeed Studio XIAO SAMD21をコンピューターに接続します。黄色の電源LEDが点灯するはずです。
...
- **[DXF]** [Seeed Studio XIAO SAMD21寸法（DXF形式）](https://files.seeedstudio.com/wiki/Seeeduino-XIAO/res/102010328_Seeeduino_XIAO_Dimension.rar)
