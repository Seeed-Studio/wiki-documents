...
XIAO nRF52840 & Wio-SX1262 キットには Meshtastic ファームウェアがプリインストールされており、すぐに使い始めることができます。

### ファームウェアの書き込み

:::caution note
ファームウェアの更新には `NRF-OTA を使用しないでください`。デバイスが完全に動作しなくなる可能性があります。
:::
...
UF2 ファイルを DFU ドライブにドラッグします。ファイルがダウンロードされ、デバイスが再起動した後、ファームウェアが書き込まれます。
...
:::info
**EU_868** は、1時間のローリングベースで毎分計算される時間あたり 10% のデューティサイクル制限を遵守する必要があります。制限に達すると、再び許可されるまでデバイスは送信を停止します。
:::
...
## リソース
- [Xiao nRF52840 と互換性のある SX1262 の回路図](https://files.seeedstudio.com/products/113010003/Wio-SX1262%20for%20XIAO%20V1.0.pdf)
- [Xiao モジュールデータシート](https://files.seeedstudio.com/products/SenseCAP/Wio_SX1262/Wio-SX1262_Module_Datasheet.pdf
)
- [Xiao リファレンス設計](https://files.seeedstudio.com/wiki/XIAO/XIAO-Reference-Design.pdf)
- [Seeed Studio XlAO nRF52840 BLE 通信距離テストレポート](https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed_XIAO_BLE_nRF52840_BLE_Communication_Distance_Test_Report.pdf)
- [Seeed Studio XlAO nRF52840 CE |FCC|MIC](https://files.seeedstudio.com/wiki/XIAO-BLE/XIAO-nRF52840-CE-FCC-MIC.zip)
- [XIAO nRF52840 キット Kicad ライブラリ](https://github.com/Seeed-Studio/OPL_Kicad_Library/tree/master/Seeed%20Studio%20Wio%20SX1262%20for%20XIAO%20nRF52840%20v1.3)
