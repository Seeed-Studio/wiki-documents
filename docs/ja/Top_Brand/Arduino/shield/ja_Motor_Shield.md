...
モーターシールドは、モーターの動作速度と方向をArduinoで制御するためのドライバモジュールです。
...
以下は、各バージョンのモーターシールドの比較を示しています：

 |パラメータ|Motor Shield V1.0|Motor Shield V2.0|
 |---|---|---|
|**動作電圧**|+5V|+5V|
 |**電源**|外部電源供給|外部電源またはArduino/Seeeduinoの+5ピン|
