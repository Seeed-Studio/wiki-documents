...
センシングは、物理世界からデジタル化されたデータを取得するための最初であり、おそらく最も重要なステップです。動的なセンシングフレームワーク内でセンサーと情報インフラを活用することで、社会活動の監視や物理的および自然環境の理解の基盤を築きます。このセンシングプロセスにより、周囲の世界からデータを収集し理解することが可能になります。

このページでは、以下の2つの主要な製品カテゴリを紹介します。

 - **産業用センサーおよびネットワーキングデバイス**

 - **エントリーレベルのセンサーおよびネットワーキングモジュール**

## 産業用センサーおよびネットワークデバイス

<strong><font color={'8DC215'} size={"4"}>Seeedは、物理世界からデジタル化されたデータを<em>計測レベルの精度</em>で生成する能力を備えた、長距離接続対応の高度な産業用センサーを発売しました。このセクションでは以下を見つけることができます：</font></strong>

- 各種産業用環境データセンシング用センサー＆プローブ
- 即時展開可能なインテリジェントシナリオ向けAIベースのセンサー
- リモート環境データ監視用データロガー
- 長距離、高セキュリティ、屋内外データ伝送用ゲートウェイ
- ルーターなどのデータ伝送用その他のネットワークインフラ

### 産業用センサーおよびプローブ

<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>SenseCAP センサー＆プローブ</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP センサーとプローブは、産業用ハードウェア設計で複数の環境データセンシングを提供します。</font></div>
    </div>
</div>

<div class="independent_container">
    <div class="independent_item" style={{textAlign: 'left'}}>
            <div class="independent_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>SenseCAP S210Xシリーズセンサー</font></div>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S210XシリーズユーザーガイドのPDFダウンロード</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2101 - 温度と湿度</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2102 - ワイヤレス光強度</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2103 - 温度、湿度、CO2</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2104 - 土壌水分と温度</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/S210X/SenseCAP%20S210X%20LoRaWAN%20Sensor%20User%20Guide.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP S2105 - 土壌水分、温度、EC</font></span></a>
            <br/>
    </div>
    <div class="independent_item" style={{textAlign: 'left'}}>
...
<div class="intro_container">
    <div class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="https://files.seeedstudio.com/products/101990784/SenseCAP%20ONE%20Compact%20Weather%20Sensor%20User%20Guide-v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S500 - 温度、湿度、気圧、風速、風向</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/101990784/SenseCAP%20ONE%20Compact%20Weather%20Sensor%20User%20Guide-v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S700 - 温度、湿度、風速/風向、気圧、光強度、降水強度</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/101990784/SenseCAP%20ONE%20Compact%20Weather%20Sensor%20User%20Guide-v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S900 - PM2.5およびPM10を検知可能な9-in-1センサー</font></span></a>
            <br/>
            <a href="https://files.seeedstudio.com/products/101990784/SenseCAP%20ONE%20Compact%20Weather%20Sensor%20User%20Guide-v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}> SenseCAP ONE S1000 - CO2、PM2.5およびPM10を検知可能な10-in-1センサー</font></span></a>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP データロガーは MODBUS-RTU RS485/アナログ/GPIO センサーに接続し、センサーから LoRaWAN® / 4G ネットワークにデータを送信できます。</font></div>
    </div>
</div>
...
<div class="independent_container">
    ...
    <div class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="https://files.seeedstudio.com/products/SenseCAP/114992170/Developer%20Guide%20for%20Private%20MQTT%20Messaging%20of%20SenseCAP%20SensorHub%20v2.0.pdf" target="_blank"><span><font color={'FFFFFF'} size={"2"}>プライベート MQTT メッセージング用 SenseCAP センサーハブ開発者ガイドの PDF ダウンロード</font></span></a>
            <br/>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>SenseCAP ゲートウェイは、ロングレンジ / LoRaWAN® デバイス向けに広範囲の無線ネットワークカバレッジとデータ伝送能力を提供します</font></div>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>ルーターは、ローカルネットワークをインターネットに接続することでデバイス間の通信を可能にします。</font></div>
    </div>
</div>
...
<strong><font color={'8DC215'} size={"4"}>複雑な機器を必要とせず、マイクロコントローラーとシンプルな機能を持つ電子機器を利用することで、物理的な世界を感知し監視することが可能です。この分野では以下のものを見つけることができます：</font></strong>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Groveセンサー</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>Groveセンサーのさまざまな種類の紹介。</font></div>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>Groveセンサーネットワーク</font></div>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>Groveセンサーネットワークとセンサーで利用可能な通信方法の紹介。</font></div>
    </div>
</div>
...
<div class="title_container">
    <div class="title_item" style={{textAlign: 'center'}}>
            ...
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}> Groveエコシステム外のセンサーおよびセンシングノードの紹介。</font></div>
    </div>
</div>
...
数分で産業用グレードのIoTセンサーやアプリケーションを構築し、低コストでカスタムオープンソースのLoRaWANデバイスを開発するスピードを想像してください。

### SenseCAP S2110センサービルダー
...
## シンプルから高度なソリューションへの移行

- エントリーレベルのセンサーハードウェアを使用した産業ソリューションの開発。
