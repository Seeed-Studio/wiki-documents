...
<div className="text--center margin-bottom--lg">
  <p className="text--lg">We're here to help! Choose your preferred support channel below.</p>
</div>

<div className="row">
  <div className="col col--3">
    <div className="card text--center padding--lg height--full">
      <div style={{fontSize: '3rem', marginBottom: '1rem'}}>💬</div>
      <h3>Community Forum</h3>
      <p>Join our active community for discussions, troubleshooting, and sharing projects.</p>
      <a href="https://forum.seeedstudio.com/" 
         className="button button--outline button--primary"
         style={{
           borderColor: '#8dc21f', 
           color: '#8dc21f',
           '--ifm-button-color': '#8dc21f'
         }}>
        Visit Forum
      </a>
    </div>
  ...
  <div className="col col--3">
    <div className="card text--center padding--lg height--full">
      ...
      <a href="https://www.seeedstudio.com/contacts" 
         className="button button--outline button--primary"
         style={{
           borderColor: '#8dc21f', 
           color: '#8dc21f',
  ...
  <div className="col col--3">
    <div className="card text--center padding--lg height--full">
      ...
      <a href="https://discord.gg/eWkprNDMU7" 
         className="button button--outline button--primary"
         style={{
           borderColor: '#8dc21f', 
           color: '#8dc21f',
  ...
  <div className="col col--3">
    <div className="card text--center padding--lg height--full">
      ...
      <a href="https://github.com/Seeed-Studio/wiki-documents/discussions/69" 
         className="button button--outline button--primary"
         style={{
           borderColor: '#8dc21f', 
           color: '#8dc21f',
