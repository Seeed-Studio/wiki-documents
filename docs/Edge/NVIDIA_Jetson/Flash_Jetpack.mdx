...
<div className="hero hero--primary" style={{background: 'linear-gradient(135deg, #003a4a 0%, #8dc21f 100%)'}}>
...
<div className="container margin-bottom--xl">
  ...
  <div className="alert alert--info margin-top--lg" style={{background: 'linear-gradient(135deg, #e0f2fe 0%, #f0f9ff 100%)', border: '1px solid #8dc21f'}}>
    ...
    <div className="text--center margin-top--md">
      <a href="https://seeedstudio88-my.sharepoint.com/:x:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EX8k1puq5J1IgMZKYYdmuqgB_EtGjxSB7_-hRjUGjTa0dQ?e=1QSozj" 
         ...
         style={{background: 'linear-gradient(135deg, #8dc21f 0%, #74b281 100%)', border: 'none'}}>
...
<div className="card margin-bottom--lg" style={{borderLeft: '4px solid #8dc21f', background: 'linear-gradient(135deg, var(--ifm-card-background-color) 0%, rgba(141, 194, 31, 0.05) 100%)'}}>
  <div className="card__body">
    <ExtractAndFlash />
  </div>
</div> 
    ...
    <div className="card height--full">
      ...
      <div className="card__footer">
        <a href="https://github.com/Seeed-Projects/reComputer-Jetson-for-Beginners" 
           ...
           style={{background: '#8dc21f', borderColor: '#8dc21f'}}>
  ...
  <div className="col col--3">
    <div className="card text--center padding--lg height--full">
      ...
      <a href="https://forum.seeedstudio.com/" 
         ...
         style={{borderColor: '#8dc21f', color: '#8dc21f'}}>
        Visit Forum
      </a>
    </div>
  </div>
