...
bzprodimageurl: https://statics3.seeedstudio.com/images/product/Grove-Q Touch Sensor.jpg
surveyurl: https://www.research.net/r/Grove-Q_Touch_Sensor
sku: 101020069
tags: grove_i2c, io_3v3, io_5v, plat_duino
---

![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Grove-Q_Touch_Sensor.jpg)
...
[![](https://files.seeedstudio.com/wiki/common/Get_One_Now_Banner.png)](https://www.seeedstudio.com/Grove-Q-Touch-Sensor-p-1854.html)
...
![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Grove-Q_Touch.png)
...
![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Grove-Q_Touch_Demo1.JPG)
...
![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Grove-Q_Touch_Demo2.JPG)
...
![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Screenshot--QTouch.png)
...
![](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/img/Screenshot--getTouchNumber.png)
...
<div class="altium-ecad-viewer" data-project-src="https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/res/Grove_Q－Touch_Sensor_v1.0_sch_pcb.zip" style="border-radius: 0px 0px 4px 4px; height: 500px; border-style: solid; border-width: 1px; border-color: rgb(241, 241, 241); overflow: hidden; max-width: 1280px; max-height: 700px; box-sizing: border-box;" />
</div>
...
-   [Schematic pdf](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/res/Grove-Q_Touch_Sensor_v1.0.pdf)
-   [Eagle file](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/res/Grove_Q－Touch_Sensor_v1.0_sch_pcb.zip)
-   [AT42QT107 datasheet](https://files.seeedstudio.com/wiki/Grove-Q_Touch_Sensor/res/AT42QT1070-MMH.pdf)
-   [How to detect finger touch?](/How_to_detect_finger_touch?)

<!-- This Markdown file was created from https://www.seeedstudio.com/wiki/Grove_-_Q_Touch_Sensor -->
