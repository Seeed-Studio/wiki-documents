---
description: Guide for installing GStreamer to receive video and audio streams from wireless Reachy Mini via WebRTC. Supports Linux, macOS, and Windows.
title: GStreamer Installation for Wireless
keywords:
- Reachy Mini
- Wireless
- GStreamer
...
- Audio
- Streaming
slug: /reachymini/sdk/gstreamer-installation
last_update:
  date: 02/11/2026
  author: Tienjui Wong
translation:
...
To build and install the WebRTC plugin, run following commands:
...
Download the GStreamer installer from official website:
...
When installing Reachy Mini Python package, you will also need to add `gstreamer` extra :
...
If you encounter issues with the stream, you can test components individually.
