---
description: Setup guide for Reachy Mini (Wireless) - the autonomous version powered by Raspberry Pi 4 with battery and Wi-Fi. Includes assembly, Wi-Fi configuration, and system update instructions.
...
- Assembly
- Wi-Fi
image: https://github.com/pollen-robotics/reachy_mini/raw/develop/docs/assets/digital_assembly_guide_preview_mini.jpg
slug: /reachymini/wireless/get_started
last_update:
  date: 02/11/2026
  author: Tienjui Wong
translation:
...
👉 **[Go to the Usage Guide](usage)** to learn how to:
...
**[Reflash the ISO](reflash_the_rpi_ISO)**

**[Install Daemon from a Specific Branch](install_daemon_from_branch)**

**[Development Workflow](development_workflow)** - Best practices for developing and testing code on the Wireless Reachy Mini
