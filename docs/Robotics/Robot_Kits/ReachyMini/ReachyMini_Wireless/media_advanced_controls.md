---
description: Advanced camera and sound system controls for Reachy Mini Wireless. Learn to control camera with rpicam commands and microphone/speaker settings via XMOS XVF3800.
title: Advanced Media Controls - Wireless
keywords:
- Reachy Mini
- Wireless
- Camera
...
- GStreamer
- XMOS
slug: /reachymini/wireless/media_advanced_controls
last_update:
  date: 02/11/2026
  author: Tienjui Wong
translation:
...
```
This feature is also directly available from [the SDK](../../SDK/python-sdk).
