---
description: Comprehensive motors diagnosis and troubleshooting guide for Reachy Mini. Learn to use the Testbench app, identify motor issues, and fix common problems like blinking LEDs, overload errors, and missing motors.
title: Motors Diagnosis & Troubleshooting
keywords:
- Reachy Mini
- Motors
- Diagnosis
...
- Overload
- Reflashing
slug: /reachymini/wireless/motors_diagnosis
last_update:
  date: 02/11/2026
  author: Tienjui Wong
translation:
