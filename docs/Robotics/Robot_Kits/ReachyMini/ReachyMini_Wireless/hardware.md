---
description: Complete hardware datasheet for Reachy Mini Wireless including dimensions, motor specifications, camera, microphone array, power requirements, and component details.
title: Reachy Mini Wireless - Hardware Datasheet
keywords:
- Reachy Mini
- Wireless
- Hardware
...
- Microphone
- Raspberry Pi
image: https://github.com/pollen-robotics/reachy_mini/raw/develop/docs/assets/reachy_mini_dimensions.png
slug: /reachymini/wireless/hardware
last_update:
  date: 02/11/2026
  author: Tienjui Wong
translation:
