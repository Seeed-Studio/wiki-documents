---
description: Guide to reading motor parameters using Dynamixel Wizard software for Reachy Mini Lite. Learn to connect and read motor configuration values.
title: How to Read Motor Parameters - Dynamixel Wizard
keywords:
- Reachy Mini
- Lite
- Dynamixel
