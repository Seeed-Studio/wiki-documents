---
description: Complete hardware datasheet for Reachy Mini Lite including dimensions, motor specifications, camera, microphone array, and USB-C connection details.
