...
**Note** you need to input *edison.local* in address bar on iPhone. On windows phone, Android phone and other wireless devices you can only input *192.168.42.1*.
