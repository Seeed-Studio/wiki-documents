...
**Bluetooth Bee** is an easy to use <font size={4} face="黑体">Bluetooth Serial Port Profile(SPP)</font> module compatible with existing **Xbee** sockets, designed for transparent wireless serial connection setup.
