...
The XIAO nRF52840 & Wio-SX1262 Kit comes pre-flashed with the Meshtastic firmware, allowing you to get started quickly. But it's recommended to update to the latest firmware first and configure it properly.


### Flash Firmware

* **Step 1**: Visit [Meshtastic Flasher](https://flasher.meshtastic.org/), select target device to `Seeed XIAO nRF52840`.
