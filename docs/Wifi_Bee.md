...
<div class="altium-ecad-viewer" data-project-src="https://github.com/SeeedDocument/Wifi_Bee/raw/master/res/WifiBee_v1.0_Eagle_Files.zip" style="border-radius: 0px 0px 4px 4px; height: 500px; border-style: solid; border-width: 1px; border-color: rgb(241, 241, 241); overflow: hidden; max-width: 1280px; max-height: 700px; box-sizing: border-box;" />
</div>
