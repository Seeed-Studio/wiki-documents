...
[SenseCraft HMI](https://sensecraft.seeed.cc/hmi) 是 Seeed Studio 强大的基于云的界面设计平台，让您无需编程即可为基于屏幕的设备创建专业的可视化界面。凭借直观的拖拽编辑器、预构建模板和 AI 驱动的设计功能，SenseCraft HMI 让您轻松将硬件转换为美观的信息显示屏、仪表板、数字标牌和控制面板。
...
在您的网络浏览器中访问 [SenseCraft HMI](https://sensecraft.seeed.cc/hmi) 并创建账户或 `登录`。
...
- Full Flash：启用 Full Flash 会清除所有设备存储的信息，包括 WiFi 网络和用户面板数据。
:::
</TabItem>
...
了解更多关于 AI 生成器功能。[更多](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-ai-generator/)
...
<div style={{textAlign:'center'}}>
    <img src="https://files.seeedstudio.com/wiki/Epaper/EE04/HMI/hmi42.png" alt="7.3 英寸电子纸显示屏" style={{width:700, height:'auto', border:'1px solid #ccc', borderRadius:5, boxShadow:'2px 2px 8px rgba(0,0,0,0.2)'}}/>
...
了解更多关于图库功能。[更多](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-gallery/)
...
<div style={{textAlign:'center'}}>
    <img src="https://files.seeedstudio.com/wiki/Epaper/EE04/HMI/hmi50.png" alt="7.3 英寸电子纸显示屏" style={{width:700, height:'auto', border:'1px solid #ccc', borderRadius:5, boxShadow:'2px 2px 8px rgba(0,0,0,0.2)'}}/>
    <p style={{fontSize:'0.9em', color:'#555', marginTop:10}}><em>7.3 英寸电子纸显示屏</em></p>
</div>
...
了解更多关于画布功能。[更多](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-canvas/)
...
<div style={{textAlign:'center'}}>
    <img src="https://files.seeedstudio.com/wiki/Epaper/EE04/HMI/hmi46.png" alt="7.3 英寸电子纸显示屏" style={{width:700, height:'auto', border:'1px solid #ccc', borderRadius:5, boxShadow:'2px 2px 8px rgba(0,0,0,0.2)'}}/>
    <p style={{fontSize:'0.9em', color:'#555', marginTop:10}}><em>7.3 英寸电子纸显示屏</em></p>
</div>
...
了解更多关于 RSS 订阅集成。[更多](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-rss/)
...
<div style={{textAlign:'center'}}>
    <img src="https://files.seeedstudio.com/wiki/Epaper/EE04/HMI/hmi51.png" alt="7.3 英寸电子纸显示屏" style={{width:700, height:'auto', border:'1px solid #ccc', borderRadius:5, boxShadow:'2px 2px 8px rgba(0,0,0,0.2)'}}/>
    <p style={{fontSize:'0.9em', color:'#555', marginTop:10}}><em>7.3 英寸电子纸显示屏</em></p>
</div>
...
了解更多关于网页内容显示。[更多](https://sensecraft-hmi-docs.seeed.cc/en/guides/sensecraft-hmi-web/)
...
<div style={{textAlign:'center'}}>
    <img src="https://files.seeedstudio.com/wiki/Epaper/EE04/HMI/hmi53.png" alt="7.3 英寸电子纸显示屏" style={{width:700, height:'auto', border:'1px solid #ccc', borderRadius:5, boxShadow:'2px 2px 8px rgba(0,0,0,0.2)'}}/>
    <p style={{fontSize:'0.9em', color:'#555', marginTop:10}}><em>7.3 英寸电子纸显示屏</em></p>
</div>
