...
title: 使用 OpenEPaperLink BLE DIY 套件设置和配置 OpenEPaperLink
keywords:
  - epaper
  - oepl
  - en04
...
# 使用 OpenEPaperLink BLE DIY 套件设置和配置 OpenEPaperLink
...
## 什么是 [OpenEPaperLink](https://openepaperlink.de/)？
...
- **专用硬件**：为 EN04 等板子设计，不限于商业 ESL 标签
...
:::caution
请仔细检查极性，不同的电池可能有混合接线。如果红线和黑线不对齐，可以使用针轻松地从 JST 连接器中取出，然后正确定位。
:::
...
**步骤 6. 配置板子**  
打开 [OEPL Configuration Page](https://openepaperlink.org/ble/config/?config=nrf52840-en04-s6) 并连接到您的板子。
...
**步骤 3. 选择图像**  
点击 **"Select Image"** 并从您的计算机中选择一个图像文件。
...
有关详细的安装说明，请参阅 [OpenEPaperLink Home Assistant Integration Repository](https://github.com/OpenEPaperLink/Home_Assistant_Integration?tab=readme-ov-file#getting-help)。
...
您将看到显示器上显示了一个新图像，表明设备已连接到 Home Assistant。
...
- **[GitHub]** [OEPL_BLE 固件仓库](https://github.com/OpenEPaperLink/OEPL_BLE)
- **[Web Tool]** [固件网页安装器](https://openepaperlink.org/ble/install/)
- **[Web Tool]** [配置构建器](https://openepaperlink.org/ble/config/)
- **[Web Tool]** [显示测试器](https://openepaperlink.org/ble/display/)
- **[Discord]** [OpenEPaperLink 社区](https://discord.gg/fekcBc5RN5)
