...
<div class="all_container">
    ...
    <div class="xiao_topic_page_font1">
        <font size={"2.1"}>Seeed Studio XIAO系列由7个版本组成，可以满足创造者、产品设计师和教育工作者的多样化需求。如果你是一名创造者，你可以从丰富的资源中获取项目灵感和需要的知识点。XIAO系列为教育工作者提供了全面的入门课程和详细的wiki，可以帮助教育工作者快速学习怎样在项目中高效使用XIAO系列。如果你是一名产品设计师，XIAO SoM用户手册包含了从模块选择到批量生产的所有内容。<br /> <br /> XIAO是排版紧凑、功能和用户友好设计的结合体。整个XIAO系列具有紧凑的设计，所有SMD组件都放置在板的同一侧，因此设计师可以轻松地将XIAO集成到自己的板中，以实现快速批量生产。</font>
    </div>
</div>
...
<html>
    ...
    <tr class="form_without_frame">
        <th class="form_without_frame"><font size={"5"}>Seeed Studio XIAO 阔展板</font></th>
        <th class="form_without_frame"><font size={"5"}>Seeed Studio XIAO的Grove Shield</font></th>
    </tr>
    <tr class="form_without_frame">
...
<html>
    <table> 
    <tr class="form_without_frame">
        <th class="form_without_frame"><font size={"5"}>Seeed Studio XIAO圆形显示器</font></th>
        <th class="form_without_frame"><font size={"5"}>Grove 适用于Seeed Studio XIAO的Grove入门套件</font></th>
    </tr>
    <tr class="form_without_frame">
...
- **[ZIP]** [Seeed Studio XIAO RP2040 认证文件](https://files.seeedstudio.com/wiki/XIAO-RP2040/res/XIAO-RP2040-Certification.zip)
...
- **[DXF]** [Seeed Studio XIAO ESP32C3 尺寸 (DXF)](https://files.seeedstudio.com/wiki/XIAO_WiFi/Resources/XIAO-ESP32C3-DXF.zip)
...
- **[XLSX]** [Seeed Studio XIAO ESP32S3 Sense 引脚输出板](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_ESP32S3_Sense_Pinout.xlsx)
