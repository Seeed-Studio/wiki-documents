...
XIAO MG24 内置电源管理芯片，允许 XIAO MG24 使用电池独立供电或通过 XIAO MG24 的 USB 端口为电池充电。
...
1. 当 XIAO MG24 未连接电池时，连接 Type-C 数据线时红灯亮起，30 秒后熄灭。
2. 连接电池并连接 Type-C 数据线充电时，红灯闪烁。
