...
在本页面中，我们将指导如何使用简单易用的 micropython 语法来使用 XIAO ESP32C6 的功能。
...
<strong><font color={'8DC215'} size={"3"}>本 wiki 中使用的 XIAO ESP32C6 开发板固件由我们的朋友宋志硕制作，我们对此深表感谢。</font></strong>


## 入门指南

该固件专为 XIAO ESP32C6 MicroPython 编程而设计。我们将首先刷写固件，然后使用示例程序。
...
运行程序时，你可以在shell窗口中看到XIAO连接到指定的wifi并获取NTP网络时间。
...
如果程序无法烧录，请尝试使用BOOT按钮和RST按钮将开发板设置为启动下载模式
