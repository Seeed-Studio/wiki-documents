...
由 XIAO ESP32-C3 驱动，这款 7.5 英寸电子纸显示屏是一个多功能、节能的智能 E Ink® 屏幕，支持广泛的流行社区应用，包括 [Home Assistant](https://www.home-assistant.io/)、[TRMNL](https://trmnl.app/)、Arduino 等。这个灵活的显示解决方案非常适合展示仪表板数据、天气更新、日程安排和自定义信息。凭借清晰的视觉效果、在深度睡眠模式下卓越的 3 个月电池续航（2000mAh）以及广泛的自定义可能性，这个紧凑的设备适应各种使用场景。非常适合现代生活空间和项目环境，它将功能性与优雅设计相结合，为多个平台提供增强的视觉体验。
...
- **2000 mAh 电池**：为延长运行时间提供电源，特别是在睡眠模式下
...
完成这些步骤后，您的电子纸面板将准备好进行配置，并与您首选的编程平台一起使用。

### 编程按钮

XIAO 7.5" 电子纸面板包含两个位于支架后面的重要按钮，有助于编程和故障排除：
...
以下 Wiki 页面提供了关于编程和使用 XIAO 7.5" 电子纸面板不同方式的详细信息：

* [**与 Home Assistant 中的 ESPHome 配合使用**](https://wiki.seeedstudio.com/cn/xiao_075inch_epaper_panel_esphome) - 通过 ESPHome 集成配置和控制您的电子纸面板，非常适合 Home Assistant 用户创建自定义仪表板。

* [**与 Arduino 配合使用**](https://wiki.seeedstudio.com/cn/xiao_075inch_epaper_panel_arduino/) - 使用 Arduino IDE 和我们的库及示例为自定义应用程序编程您的设备。

* [**与 TRMNL 配合使用**](https://wiki.seeedstudio.com/cn/xiao_7_5_inch_epaper_panel_with_trmnl) - 使用 trmnl 控制您的显示屏，这是一个用于智能视觉仪表板管理的开源平台。
