...
大多数微控制器（MCU）使用TTL电平，而计算机串口通常使用232电平。如果我们希望计算机与MCU通信，就需要这个 **Grove - 232**。通过集成的Grove接口，您的Arduino与计算机之间的通信将变得异常方便。

该模块基于Max3232，支持多种波特率通信，理论上支持高达230400bps的波特率通信。
...
这是一个简单的模块，只需将对应的接口连接到对应的设备即可使用串口工具传输数据。需要注意的是，当连接TTL设备时，模块的RX引脚需要连接到设备的TX引脚，反之亦然，模块的TX引脚需要连接到设备的RX引脚。
...
- **[Zip]** [Grove-RS232 Eagle文件](https://files.seeedstudio.com/wiki/Grove-RS232/res/Grove-RS232.zip)

- **[PDF]** [MAX3232数据手册](https://files.seeedstudio.com/wiki/Grove-RS232/res/Max3232.pdf)

- **[PDF]** [PDF格式Wiki](https://github.com/SeeedDocument/Grove-RS232/tree/master/res/Grove-RS232.pdf)
