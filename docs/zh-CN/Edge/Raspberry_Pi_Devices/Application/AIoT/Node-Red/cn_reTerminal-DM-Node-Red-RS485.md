...
在本节中，我们将安装 `node-red-contrib-modbus` 节点，因此请复习如何[安装节点](/reTerminal-DM-Getting-Started-with-Node-Red#install-nodes)。

### 选项 1：命令行

首先，请复习通过 SSH 访问 reTerminal DM 的知识，请查看[这里](/reterminal-dm-flash-OS#install-drivers)的步骤
