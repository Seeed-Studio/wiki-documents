...
这个亚克力外壳是为 BeagleBone® 设计的，就像 Raspberry PI B+ 外壳一样。它由亚克力板制成，通过激光切割、CNC 铣削和热弯工艺制造，几乎完全是手工制作的。外壳看起来非常紧凑和美观，总共只有 4 块板，非常容易组装。它非常坚固，不像其他由 6 块亚克力板组成的外壳那样容易破裂。外壳的圆角和斜边设计让您在握持时感到非常舒适。
...
它与其他外壳不同，例如由 6 块亚克力板激光切割的外壳和注塑模型。虽然这些方式便宜且制作速度快，但可能有人觉得它们缺乏个性。现在，有一种为 BeagleBone® 设计的外壳与众不同，它由 Seeedstudio 工程师设计。它不是通过注塑模型和简单激光切割的大规模方式制作的。制作这个外壳需要三种生产工艺——激光切割、CNC 铣削和热弯。这些工艺都适合小规模项目。

**<big>第一步工艺——激光切割</big>**

我们需要使用激光切割机进行切割，这种方式便宜且快速。

<div align="center"><img width={1000} src="https://files.seeedstudio.com/wiki/Beaglebone_Case/img/20141016191356.jpg" /></div>

**<big>第二步工艺——CNC 铣削</big>**

激光切割后，我们需要进行一些结构切割，使其易于组装和弯曲。
...
<table cellSpacing={0} width="80%">
  <tbody>
    ...
    <tr>
      <th scope="row"> 顶部外壳 </th>
      <td> 4mm 厚度 </td>
      <td> 1 </td>
    </tr>
    <tr>
      <th scope="row"> 底部外壳 </th>
      <td> 4mm 厚度 </td>
      <td> 1 </td>
    </tr>
    <tr>
      <th scope="row"> 侧板 1 </th>
      <td> 2.5mm 厚度 </td>
      <td> 1 </td>
    </tr>
    <tr>
      <th scope="row"> 侧板 2 </th>
      <td> 2.5mm 厚度 </td>
      <td> 1 </td>
    </tr>
    <tr>
      <th scope="row"> 金属螺丝 </th>
      <td> M3*4 </td>
      <td> 4 </td>
    </tr>
    <tr>
