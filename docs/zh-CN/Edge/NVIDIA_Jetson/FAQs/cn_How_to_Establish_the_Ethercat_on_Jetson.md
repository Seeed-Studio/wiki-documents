---
description: 如何建立 Jetson 与 EtherCAT 设备之间的通信
title: 如何建立 Jetson 与 EtherCAT 设备之间的通信
keywords:
- jetson
- jetpack
- L4T
...
**EtherCAT（用于控制自动化技术的以太网）**是一种基于 **IEEE 802.3 以太网标准**的开源、高性能实时工业以太网现场总线协议。它采用**主从架构**，以其在工业自动化环境中的卓越速度、精度和灵活性而闻名

本文档使用 [**recomputer robotics J401**](https://www.seeedstudio.com/reComputer-Robotics-Carrier-board-p-6442.html) 作为 **EtherCAT 主站**，使用 [**MyActuator X4**](https://www.seeedstudio.com/Myactuator-X4-P12-5-10-Planetarty-Actuator-p-6470.html) 作为**从站**，演示如何建立 Jetson 与 EtherCAT 设备之间的通信。
