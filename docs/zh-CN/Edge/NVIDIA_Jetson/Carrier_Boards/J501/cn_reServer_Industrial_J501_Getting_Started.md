...
J501 载板是一款强大的扩展板，支持 NVIDIA Jetson AGX Orin 模块。它具有丰富的数据端口和扩展接口，完全释放了 AGX Orin 模块的全部性能。同时它支持添加 GMSL 扩展以连接多达 8 个 GMSL 摄像头。
...
1x RS232/RS422/RS485 </td>
    ...
    <tr>
      <td rowSpan={9}>扩展</td>
      <td> Mini PCIE </td>
      <td> 1x Mini PCIe 用于 LoRaWAN®/4G/系列无线模块（模块不包含） </td>
    </tr>
    <tr>
      <td> M.2 Key B </td>
