---
description: 将 Jetpack 刷写到选定产品。此页面目前包含产品的一个子集。
...
选择您的产品和您希望刷写的 Jetson Linux。此页面目前包含产品的一个子集。
...
JetPack 支持 🚀 [MAXN super](https://developer.nvidia.com/blog/nvidia-jetpack-6-2-brings-super-mode-to-nvidia-jetson-orin-nano-and-jetson-orin-nx-modules/) 配置
...
另外，对于 Ubuntu 18.04 及以下版本，安装 `lz4c`

```bash
sudo apt-get install -y liblz4-tool
```

对于 Ubuntu 20.04 / 22.04 及以上版本：
...
{/* <table>
  <tr>
   ...
   <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/cn/Edge/NVIDIA_Jetson/Application/Generative_AI/Whisper_on_Jetson_for_Real_Time_Speech_to_Text/">Jetson 上的 Whisper</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
