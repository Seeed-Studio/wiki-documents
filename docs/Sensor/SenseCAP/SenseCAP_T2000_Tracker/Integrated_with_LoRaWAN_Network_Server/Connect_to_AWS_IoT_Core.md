...
`DevEUI / AppEUI / AppKey`: can be found in the SenseCAP Mate APP, check [Get_Started](https://wiki.seeedstudio.com/Get_Started_with_SenseCAP_T2000_tracker/) for more details.
