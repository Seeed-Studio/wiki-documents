...
- [**Devices** for Home Assistant](#jump2)
  ...
  - [**Link Star - Router with four network interfaces**](#jump6)
  - [**reRouter - Router with Raspberry Pi CM4**](#jump6) -->
- [**Peripherals** for Enhancing Home Assistant Devices](#jump3)
  <!-- - [**Home Assistant SkyConnect USB Stick - Home Assistant Official**](#jump6)
  - [**mmWave Human Detection Sensor Kit**](#jump6) -->
...
<!-- ## Platforms to expand Home Assistant capabilities

### Home Assistant Cloud

<div class="all_container">
    <div class="xiao_topic_page_pic">
        <img src="https://www.home-assistant.io/images/blog/2018-09-thinking-big/logo-text.svg" style={{width:400, height:'auto'}}/>
    </div>
    <div class="xiao_topic_page_vertical">
        <br /><font size={"3"}><strong>Cloud service focused on Home Assistant</strong></font>
        <font size={"2"}>Launched by the founder of Home Assistant, NABU CASA </font>
        <br /><font size={"3"}><strong>Access from anywhere</strong></font><font size={"2"}>Quickly access your Home Assistant instance from your phone, your favorite coffeeshop or at work.</font>
        <br /><font size={"3"}><strong>Easily connect to voice assistants</strong></font><font size={"2"}>Control your Home with your voice using Assist, the unique one made by NABU CASA. <br /> You can still connect to both Google Assistant and Amazon Alexa to use the Amazon Echo or Google Home. </font>
        <br /><font size={"3"}><strong>Keep Home Assistant secure</strong></font><font size={"2"}>All data is fully encrypted between your device and your Home Assistant instance. No snooping. </font>
    </div>
</div>
...
<div class="get_one_now_container" style={{textAlign: 'center'}}>
    <a class="get_one_now_item" href="https://www.nabucasa.com/"><strong><span><font color={'FFFFFF'} size={"4"}> 🖱️ Know More </font></span></strong></a>
    <a class="get_one_now_item" href="https://www.nabucasa.com/config/remote/"><strong><span><font color={'FFFFFF'} size={"4"}> 📚 Remote UI </font></span></strong></a>
    <a class="get_one_now_item" href="https://www.nabucasa.com/config/"><strong><span><font color={'FFFFFF'} size={"4"}>📚 Getting Started</font></span></strong></a>
</div>
...
<div class="table-center">
    ...
    <tr class="table-trnobg"></tr>
      ...
      <td class="table-trnobg"><div class="get_one_now_container" style={{textAlign: 'center'}}><a class="get_one_now_item" href="https://wiki.seeedstudio.com/SenseCAP_Indicator_Application_Home_Assistant/"><strong><span><font color={'FFFFFF'} size={"4"}>📚 Learn More</font></span></strong></a></div></td>
		</tr>
	</table>
</div>
