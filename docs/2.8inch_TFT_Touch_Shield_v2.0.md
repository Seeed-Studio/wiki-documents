...
Q:how to drive 2.8 TFT Touch Shield V2 by using the core of  SAMD21 or kendryte k210 ?

A:If you want to drive 2.8 TFT Touch Shield V2 by using the core of  SAMD21 or kendryte k210 .
you need to download the [Seeed_Arduino_LCD](https://github.com/Seeed-Studio/Seeed_Arduino_LCD).
and below details with how to use
