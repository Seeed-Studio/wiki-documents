...
You can discover this page with three large portions.

- Devices with their usages
- Single Board Computers with their usages
- Microcontrollers with their usages
...
<strong><font color={'8DC215'} size={"4"}>This portion here includes the embedded computing modules. Here you can find:</font></strong>

- Microcontrollers with embedded computing
- Application with IoT and ML
