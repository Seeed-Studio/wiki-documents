...
Está equipado con una interfaz I2C digital completamente calibrada, por lo que hay definiciones de pines ligeramente diferentes. Debes descargar e instalar la biblioteca [aquí](https://github.com/Seeed-Studio/Grove_Temperature_And_Humidity_Sensor) para usar el DHT20.
...
- **[ZIP]** [Grove - Sensor de Temperatura y Humedad V2.0(DHT20)](https://files.seeedstudio.com/wiki/Grove-Temperature-Humidity-Sensor/Pico-micropython-master.zip)
