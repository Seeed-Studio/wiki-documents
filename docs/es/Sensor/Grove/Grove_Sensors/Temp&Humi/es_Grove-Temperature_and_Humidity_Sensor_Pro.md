...
:::note
Este Grove - Temperature&Humidity Sensor Pro y nuestro otro producto [Grove-Temperature and Humidity Sensor](https://wiki.seeedstudio.com/es/Grove-Temperature_Humidity_Pressure_Gas_Sensor_BME680/) comparten esta biblioteca. Sin importar qué producto estés usando, asegúrate de haber puesto en efecto la línea de definición del sensor de tu placa y comentado las líneas de definición de otras especificaciones. Por ejemplo, el sensor que usamos en Grove - Temperature and Humidity Sensor Pro es DHT 22. Así que la parte de definición de la especificación del sensor debería ser:
:::
...
|[Consigue UNO Ahora](https://www.seeedstudio.com/Raspberry-Pi-3-Model-B-p-2625.html)|[Consigue UNO Ahora](https://www.seeedstudio.com/Grove-Base-Hat-for-Raspberry-Pi-p-3186.html)|[Consigue UNO Ahora](https://www.seeedstudio.com/Grove-Temperature-Humidity-Sensor-Pro-AM230-p-838.html)|
...
:::tip
Si todo va bien, podrás ver el siguiente resultado ejecutando python dht_simpleread.py
:::
...
- **[PDF]** [Esquemático del Sensor de Temperatura y Humedad Pro en formato PDF](https://files.seeedstudio.com/wiki/Grove-Temperature_and_Humidity_Sensor_Pro/res/TemperatureHumidiy%20Pro%20Schematic.pdf)
- **[Library]** [Librería del Sensor de Temperatura y Humedad Pro](https://files.seeedstudio.com/wiki/Grove-Temperature_and_Humidity_Sensor_Pro/res/Humidity_Temperature_Sensor_pro.zip)
