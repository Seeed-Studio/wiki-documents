---
description: Grove - Sensor de Gas(MQ5)
title: Grove - Sensor de Gas(MQ5)
keywords:
- Grove
image: https://files.seeedstudio.com/wiki/wiki-platform/S-tempor.png
slug: /es/Grove-Gas_Sensor-MQ5
last_update:
  date: 1/3/2023
  author: shuxu hu
---
...
| PH       | Consumo de Calentamiento| 0.5 | -          | 800   | mW     |
| RL       | Resistencia de Carga    |     | ajustable  |       |        |
| RH       | Resistencia del Calentador| -   | 31±10%     | -     | Ω      |
| Rs       | Resistencia de Sensado  | 10  | -          | 60    | kΩ     |
| Alcance  | Concentración de Detección| 200 | -          | 10000 | ppm    |
...
| Seeeduino V4.2 | Base Shield | Grove - Sensor de Gas(MQ5) |
|--------------|-------------|-----------------|
...
|<a href="https://www.seeedstudio.com/Seeeduino-V4.2-p-2517.html" target="_blank">Obtener Uno Ahora</a>|<a href="https://www.seeedstudio.com/Base-Shield-V2-p-1378.html" target="_blank">Obtener Uno Ahora</a>|<a href="https://www.seeedstudio.com/Grove-Gas-Sensor-MQ-p-938.html" target="_blank">Obtener Uno Ahora</a>|
...
<p class="admonition-title">Nota</p>
Necesitas una herramienta adicional para encontrar un umbral determinado para varias condiciones del aire. Y luego establecer el umbral en el código.
</div>
...
Este ejemplo demuestra una forma de conocer la concentración aproximada de Gas. Según la hoja de datos de los sensores MQ5, estas ecuaciones están probadas para condiciones estándar y no están calibradas. Puede variar según los cambios de temperatura o humedad.
...
| Raspberry pi | Grove Base Hat para RasPi| Grove - Sensor de Gas(MQ5)|
|--------------|-------------|-----------------|
|<p><img src="https://files.seeedstudio.com/wiki/wiki_english/docs/images/rasp.jpg" alt="pir" width={600} height="auto" /></p>|<p><img src="https://files.seeedstudio.com/wiki/Grove_Base_Hat_for_Raspberry_Pi/img/thumbnail.jpg" alt="pir" width={600} height="auto" /></p>|<p><img src="https://files.seeedstudio.com/wiki/Grove-Gas_Sensor-MQ5/img/45d_small.jpg" alt="pir" width={600} height="auto" /></p>|
|[Obtener UNO Ahora](https://www.seeedstudio.com/Raspberry-Pi-3-Model-B-p-2625.html)|[Obtener UNO Ahora](https://www.seeedstudio.com/Grove-Base-Hat-for-Raspberry-Pi-p-3186.html)|[Obtener UNO Ahora](https://www.seeedstudio.com/Grove-Gas-Sensor-MQ-p-938.html)|
