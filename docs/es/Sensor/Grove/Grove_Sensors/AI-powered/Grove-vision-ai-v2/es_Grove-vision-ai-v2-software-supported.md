...
Podemos ver que en la Configuración de Vista Previa en el lado izquierdo, hay dos opciones de configuración que se pueden cambiar para optimizar la precisión de reconocimiento del modelo.
...
- **IoU (Intersection over Union):** Esto mide cuánta superposición hay entre dos cajas. Imagina que dibujaste una caja alrededor de un objeto en una imagen, y el modelo también dibujó una caja. IoU te dice qué tan bien coinciden tus cajas. Mayor IoU significa que las cajas están más cerca.
:::
