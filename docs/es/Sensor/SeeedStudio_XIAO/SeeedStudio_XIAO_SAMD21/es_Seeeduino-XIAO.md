...
El circuito convertidor DC-DC incorporado capaz de cambiar el voltaje de 5V a 3.3V permite alimentar el dispositivo con un suministro de 5V a través del PIN-VIN y PIN-5V.
