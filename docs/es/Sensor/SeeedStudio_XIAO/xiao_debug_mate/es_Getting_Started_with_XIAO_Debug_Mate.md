...
title: Introducción a XIAO Debug Mate
...
Dentro del paquete, encontrarás cuatro pegatinas de distribución de pines. Estas están diseñadas para aplicarse junto a los conectores de expansión en el Debug Mate, proporcionándote una referencia rápida y conveniente para la función de cada pin.

Para aplicarlas correctamente, observa el pequeño **triángulo blanco** en una esquina de cada pegatina. Este triángulo es un marcador de alineación. Debe orientarse para coincidir con la esquina correspondiente del PCB del Debug Mate. Las pegatinas frontal y trasera también tienen diferentes orientaciones de texto para asegurar que sean legibles desde el lado correcto. Por favor, consulta la imagen a continuación para la colocación correcta.
...
Las marcas en los lados frontal y trasero también son diferentes. Por ejemplo, en el lado frontal, los pines XIAO están etiquetados con sus números de pin: D6, D7, D8, y así sucesivamente. En el lado trasero, estos pines están marcados con sus protocolos o funciones: TX, RX, SCK, y así sucesivamente.
