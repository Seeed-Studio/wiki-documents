...
- [Lista de Comandos AT del Rastreador LoRaWAN](https://files.seeedstudio.com/wiki/SenseCAP/LoraWAN_Tracker/LoRaWAN%20Tracker%20AT%20Command.pdf)
...
- Opcionalmente, filtrar el dispositivo por su nombre anunciado:
 ...
 En `react-native-ble-plx`, el nombre local se puede acceder a través de `(Device).localName`.
