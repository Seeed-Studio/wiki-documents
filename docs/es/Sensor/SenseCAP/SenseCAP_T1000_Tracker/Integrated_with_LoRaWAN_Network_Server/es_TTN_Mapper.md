...
slug: /es/ttn_mapper_for_SenseCAP_T1000
last_update:
  date: 10/13/2023
  author: Jessie
---
...
Este tutorial guiará a los usuarios para agregar el [SenseCAP T1000 Tracker](https://www.seeedstudio.com/SenseCAP-Card-Tracker-T1000-A-p-5697.html) a TTN Mapper.

Para explorar los siguientes pasos, por favor consulta [Conectar a The Things Network](https://wiki.seeedstudio.com/es/SenseCAP_T1000_tracker_TTN/) para registrar tu dispositivo primero.
...
Asigna un nombre a tu integración completando el campo Webhook ID.
...
Navega a [TTN Mapper](https://ttnmapper.org/) y selecciona `Advanced Maps` en el menú superior.

En la sección `Device data`, completa el campo `Device ID` con el ID del dispositivo de The Things Stack. <br/>
Elige hoy como `Start Date` y `End Date`. <br/>
