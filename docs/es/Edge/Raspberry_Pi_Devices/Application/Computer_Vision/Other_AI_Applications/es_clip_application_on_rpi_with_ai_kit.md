...
Y si quieres usar tu cámara, debes ingresar el comando a continuación después de asegurarte de que raspberry conecte tu propia cámara:
...
En el video mostrado a continuación, puedes ver que cuando ingreso "banana," el modelo CLIP reconoce un plátano, y cuando ingreso "apple," el modelo reconoce una manzana. Solo necesitas ingresar diferentes palabras, y el modelo CLIP reconocerá diferentes objetos.
