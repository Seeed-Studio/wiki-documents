...
La serie reComputer Industrial R20xx está alimentada por Raspberry Pi CM5 y el acelerador de IA Hailo-8, este sistema compacto de IA de borde ofrece 26 TOPS para procesamiento de visión multicanal en tiempo real. Con una CPU Cortex-A76 de cuatro núcleos, hasta 16GB de RAM, 64GB de eMMC y una interfaz versátil, garantiza una integración perfecta en aplicaciones industriales de IA.
...
**NOTA:** Puedes seleccionar otro OS como **Ubuntu de 64 bits** navegando a **Otros OS de propósito general**
