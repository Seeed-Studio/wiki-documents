---
description: Guía de Ensamblaje del reComputer Industrial R21xx
title: Guía de Ensamblaje del reComputer Industrial R21xx
keywords:
- Raspberry pi
- Edge Controller
...
El método de montaje vertical también es adecuado para el reComputer Industrial R2000, sin embargo los soportes de montaje no están incluidos en la caja, necesitan compra adicional.
...
<table >
  <tbody>
    ...
    <tr data-style="height: 18px;" style={{height: 18}}>
      <td data-style="height: 18px; width: 20%;" colSpan={1} style={{height: 18, width: '20%'}}>Antena Wi-Fi/BLE</td>      <td data-style="height: 18px; width: 30%;" colSpan={1} style={{height: 18, width: '30%'}}><img width={700} src="https://files.seeedstudio.com/wiki/reComputer-R1000/recomputer_r_images/49.png" /></td>
