...
El reComputer Industrial R21xx, alimentado por Raspberry Pi CM5, es una computadora de IA en el borde adaptable con capacidades de IA. Cuenta con interfaces industriales integrales **(2x Ethernet, 4xUSB, 2x RS485, 2x RS232, 2x CAN FD, 4x DI y 4x DO)** y opciones de conectividad inalámbrica flexibles (4G/5G, LoRa®, Wi-Fi/BLE), lo que lo hace ideal para diversas aplicaciones industriales.
...
- Vida útil de producción: el reComputer Industrial R21xx permanecerá en producción hasta al menos diciembre de 2030
...
- Wi-Fi integrado en chip
- BLE integrado en chip
- Mini-PCIe: LTE, USB LoRa®, USB Zigbee
- M.2 KEY-B: 4G/5G

**Interfaces Ricas**

- 2x RS485 (aislado), 2x RS232 (aislado), 4x puertos DI aislados, 4x puertos DO aislados
...
| **Procesador de IA**      | Pre-instalado 1x Hailo-8 M.2 Aceleración de IA 26TOPS                           |
...
| **Interfaz**              |                                                                                 |
| **Ethernet**              | 1 x 10/100/1000 Mbps (soporta PoE PD)                                           |
| **USB**                   | 3 x USB-A 3.0 Host; 1 x USB-A 2.0 Host                                          |
| **Ranura M.2**            | 1x 2280 para SSD M.2 NVMe; 1x 2280 para Acelerador de IA                       |
| **Mini-PCIe**             | 1x Mini-PCIe para módulo LoRa                                                   |
| **Tarjeta SIM**           | soporta tarjeta Nano SIM                                                        |
| **LED**                   | 4 x indicadores LED                                                             |
| **Botón / Interruptor**   | 1x Botón de Reset; 1x Interruptor de Arranque                                   |
| **Comunicación Inalámbrica** |                                                                              |
| **Wi-Fi 2.4/5.0 GHz**     | Wi-Fi integrado en chip                                                         |
| **BLE 5.0**               | BLE integrado en chip                                                           |
| **Celular 4G/5G**         | 4G LTE/5G*                                                                      |
...
| **Mecánico**              |                                                                                 |
| **Dimensión (A x Al x P)** | 197.5 mm x 155 mm x 67.5 mm                                                    |
...
[Hailo](https://hailo.ai/) ofrece procesadores de IA de vanguardia especialmente diseñados para aplicaciones de aprendizaje profundo de alto rendimiento en dispositivos de borde. Las soluciones de la empresa se enfocan en habilitar la próxima era de IA generativa en el borde, junto con percepción y mejora de video, impulsadas por aceleradores de IA avanzados y procesadores de visión. Y el reComputer_R21xx, equipado con el acelerador NPU Hailo-8 que proporciona 26 TOPs de rendimiento de IA, es capaz de lograr más de 200 FPS con YOLOv8s.
...
El reComputer Industrial R21xx soporta dos opciones de fuente de alimentación: terminal DC y puerto PoE. Esto proporciona flexibilidad en la selección de fuente de alimentación y permite una fácil integración con varias fuentes de energía.
...
El puerto ETH0(PoE PD) del reComputer Industrial R21xx puede soportar alimentación PoE, proporcionando una forma conveniente y eficiente de alimentar el dispositivo a través de Ethernet. Esta opción simplifica el proceso de instalación y reduce la cantidad de cableado requerido, convirtiéndolo en una solución ideal para aplicaciones con fuentes de alimentación limitadas o donde las tomas de corriente no están fácilmente disponibles.

- PoE PD: IEEE 802.3at, 25.5W Máx

> Nota:
> Vale la pena señalar que el módulo PoE proporcionado con el reComputer Industrial R21xx cumple con el estándar IEEE 802.3at y puede proporcionar una fuente de alimentación máxima de 25W. Por lo tanto, si hay necesidad de conectar periféricos de alta potencia como módulos 5G o 4G, la alimentación PoE puede no ser suficiente. En este caso, se recomienda usar el terminal DC para la alimentación en su lugar para asegurar una operación estable y confiable del dispositivo.

**Consumo de Energía**

El reComputer Industrial R21xx no viene con un botón de encendido por defecto, y el sistema se iniciará automáticamente una vez que se conecte la alimentación. Al apagar, por favor seleccione la opción de apagado en el sistema operativo y espere a que el sistema se apague completamente antes de cortar la alimentación. Para reiniciar el sistema, simplemente reconecte la alimentación.
...
| **USB**         | 3 x USB-A 3.0 Host ; 1 x USB-C 2.0 (para flashear OS y Debug)                        |
| **RS485**       | 2x RS485 (aislado)                                                                   |
| **RS232**       | 2x RS232 (aislado)                                                                   |
| **CAN**         | 2x Puertos CAN FD Aislados                                                              |
| **DI**          | 4 x Puertos DI Aislados  (Voltaje de Entrada: 5-24V DC)                                      |
| **DO**          | 4 x Puertos DO Aislados  (Voltaje de Salida: < 60V DC)                                     |
| **HDMI**        | 2 x HDMI 2.0                                                                          |
| **LED**         | 4 x indicadores LED                                                                    |
| **Ranura para Tarjeta SIM**   | soporta Tarjeta Nano SIM                                                            |
| **Ranura M.2 M-KEY**  | 1x 2280 para M.2 NVMe SSD ; 1x 2280 para Acelerador AI                             |
...
El reComputer Industrial R21xx cuenta con 4 indicadores LED que sirven para señalar el estado operacional de la máquina. Por favor consulte la tabla a continuación para las funciones específicas y el estado de cada LED:
  ...
  <table border="1" cellspacing="0" cellpadding="6">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Naranja</td>
        <td>Encendido</td>
        <td>Bajo Linux este pin parpadeará para indicar acceso a eMMC. Si ocurre algún error durante el arranque, entonces este LED parpadeará un patrón de error que puede ser decodificado usando la tabla de búsqueda( [Raspberry Pi Documentation - Configuration](https://www.raspberrypi.com/documentation/computers/configuration.html)) en el sitio web de Raspberry Pi.</td>
      </tr>
      <tr>
        <td> **USER** </td>
...
Si el LED ACT no parpadea, entonces el código EEPROM podría estar corrupto, intente de nuevo sin nada conectado para asegurarse. Para más detalles por favor revise el foro de Raspberry Pi:
STICKY: Is your Pi not booting? (The Boot Problems Sticky) - Raspberry Pi Forums.
Para más detalles por favor revise el [foro de Raspberry Pi](https://forums.raspberrypi.com//viewtopic.php?f=28&t=58151)

#### Indicador USER

El reComputer Industrial R21xx contiene un indicador USER, y los usuarios pueden personalizar el estado según las necesidades reales.
...
El reComputer Industrial R21xx contiene un buzzer activo, que puede ser usado para varios propósitos como alarmas y notificaciones de eventos. Ingrese en la terminal del reComputer Industrial R21xx:
...
Nota : El empaque del producto contiene algunas resistencias terminales de 120 Ohm. Puede usarlas según sea necesario al comunicarse vía RS485.
...
El equipo de la serie reComputer Industrial R2000 incluye 8 puertos DI, terminales phoenix de 3 pines con espaciado de 3.5mm.
...
> Nota
> Para detalles sobre las pruebas de DI, consulte la sección [enlace](https://wiki.seeedstudio.com/es/recomputer_industrial_R21xx_configure_system/di-(digital-input)-testing).

### DO (Salida Digital)

El equipo de la serie reComputer Industrial R2000 incluye 8 puertos DO, terminales phoenix de 3 pines con espaciado de 3.5mm.
...
El equipo de la serie reComputer Industrial R2100 incluye 2 puertos CAN FD, terminales phoenix de 6 pines con espaciado de 3.5mm.
...
El Interruptor de Arranque del reComputer Industrial R2000 está conectado al pin nRPI_BOOT del CM5. Este interruptor proporciona a los usuarios la opción de seleccionar la fuente de arranque entre eMMC y USB. En modo normal, el interruptor debe estar alejado del lado con la etiqueta "BOOT", permitiendo que el sistema arranque desde eMMC. Por el contrario, cuando los usuarios necesiten flashear la imagen del sistema, deben colocar el interruptor hacia la etiqueta "BOOT", permitiendo que el sistema arranque desde la interfaz USB Type-C.

| Posición del Interruptor | Modo         | Descripción      | nRPI-BOOT |
|----------------|--------------|-----------------|-----------|
|      <img src="https://files.seeedstudio.com/wiki/reComputer-AI-Industrial/R2000/LOW.png" alt="image" width="80"/>            | Modo normal  | Arranque desde eMMC   | Bajo       |
|     <img src="https://files.seeedstudio.com/wiki/reComputer-AI-Industrial/R2000/HIGH.png" alt="image" width="80"/>             | Modo flash   | Arranque desde USB    | Alto      |
...
El reComputer Industrial R21xx está equipado con 1 puerto USB Type-C y 4 puertos USB Type-A. Consulte la tabla a continuación para sus funciones y descripciones.
...
| Type-A   | *1       | USB 2.0    | USB-Host     | Conectar diferentes dispositivos USB como unidades flash, teclados USB o ratones. |
| Type-A   | *3       | USB 3.0    | USB-Host     | Conectar diferentes dispositivos USB como unidades flash, teclados USB o ratones. |
...
> **Nota**  
> Tenga en cuenta que la versión estándar del reComputer Industrial R2000 no viene con un módulo 5G/4G.
> Si requiere funcionalidad 5G/4G, debe comprar por separado un módulo 5G/4G adicional.
...
Hay un interruptor de botón pulsador mini ubicado en el orificio de reinicio del reComputer AI Industrial R2135. Al presionar este botón con un objeto delgado, el CM4 puede ser reiniciado. Este pin cuando está alto señala que el CM4 ha iniciado. Llevar este pin a bajo reinicia el módulo.
...
El reComputer Industrial R2000 viene con dos puertos Ethernet RJ45. ETH0 es una interfaz Gigabit Ethernet nativa CM5 que soporta tres velocidades diferentes: 10/100/1000 Mbit/s. Puede habilitar la entrega de alimentación por Ethernet (PoE) a través de esta interfaz, proporcionando energía al reComputer Industrial R2000. El otro ETH1 soporta 10/100 Mbit/s que es convertido desde USB.
...
El reComputer Industrial R2000 cuenta con 2x interfaz HDMI nativa desde CM5, soportando hasta salida de video 4K @ 60 fps. Es ideal para aplicaciones que requieren múltiples pantallas, permitiendo a los usuarios mostrar su contenido en pantallas externas grandes.
...
El reComputer Industrial R2000 soporta una rica selección de módulos de expansión y accesorios, haciéndolo adecuado para una amplia gama de escenarios y requisitos. Si está interesado en personalizar el reComputer Industrial R2000, por favor contacte odm@seeed.cc para más información.
...
<div class="table-center">
  <table border="1" cellspacing="0" cellpadding="6">
    ...
    <tbody>
      ...
      <tr>
        <td>Este módulo necesita ser soldado en la placa portadora del reComputer Industrial R21xx</td>
        <td>PoE</td>
...
La placa base del reComputer Industrial R21xx cuenta con dos ranuras Mini-PCIe. La ranura Mini-PCIe 1 soporta módulo 4G, módulo LoRa® usando el protocolo USB y módulo Zigbee usando protocolo USB; mientras que la ranura Mini-PCIe 2 soporta módulo LoRa® usando el protocolo USB y SPI y módulo Zigbee usando protocolo USB. Adicionalmente, el módulo 4G y el módulo LoRa® no deben usarse al mismo tiempo, no se pueden conectar dos módulos LoRa® en la placa.
...
El reComputer Industrial R21xx está alimentado por el CM5 con una versión Wi-Fi/BLE integrada, proporcionando los mismos parámetros Wi-Fi/BLE que el CM5. Para información detallada de parámetros, por favor consulte el sitio web oficial de Raspberry Pi.  

### Módulo 4G

La placa base del reComputer Industrial R21xx cuenta con una ranura M.2 B-KEY y una ranura Mini-PCIe, ambas ranuras M.2 B-KEY y Mini-PCIe soportan un módulo 4G. El módulo 4G EC25 de Quectel ha sido completamente probado para ser compatible con el reComputer Industrial R21xx.

### Módulo 5G

La placa base del reComputer Industrial R21xx cuenta con una ranura M.2 B-KEY, soportando un módulo 4G/5G usando el protocolo USB. El módulo 4G EC25 de Quectel ha sido completamente probado para ser compatible con el reComputer Industrial R21xx.

> Nota
> Por favor tenga en cuenta que si requiere funcionalidad 4G/5G, es necesario comprar el módulo 4G correspondiente y la antena externa, y seguir las instrucciones en la sección 4.5 "Ensamblar Módulo y Antena 4G/LoRa®/Zigbee".

### Módulo LoRa®  

La ranura Mini-PCIe soporta módulo LoRa® usando el protocolo USB y SPI. El módulo WM1302 de Seeed Studio ha sido completamente probado para ser compatible con el reComputer Industrial R2000.

> Nota
> Por favor tenga en cuenta que si requiere funcionalidad LoRa®, es necesario comprar el módulo LoRa® correspondiente y la antena externa, y seguir las instrucciones en la sección 4.5 "Ensamblar Módulo y Antena 4G/LoRa®/Zigbee".
...
> Nota
> Tenga en cuenta que:
> Los resultados de las pruebas de velocidad pueden variar dependiendo del modelo de SSD, método de prueba y entorno de prueba. Los valores proporcionados aquí son solo para fines de referencia y se obtuvieron en el laboratorio de Seeed.
...
El TPM cuenta con el OPTIGA™ TPM SLB9670 de Infineon que cumple con la especificación TPM 2.0 del Trusted Computing Group (TCG) y se recomienda como chip de cifrado para el reComputer Industrial R2000. El chip cuenta con una interfaz SPI aplicada para el puerto J26 en la placa, para habilitar una raíz de confianza para la integridad de la plataforma, atestación remota y servicios criptográficos.

### Módulo UPS (Sistema de Alimentación Ininterrumpida)
...
El UPS es 7F, que opera en serie. El módulo UPS está posicionado entre los componentes DC5V y CM5, con una señal GPIO utilizada para alertar a la CPU en caso de una pérdida de energía del suministro de 5V. Al recibir esta señal, la CPU ejecuta un script urgente antes de que se agote la energía del supercondensador, iniciando un comando "$ shutdown".
La duración de respaldo proporcionada por el UPS depende en gran medida de la carga del sistema. A continuación se muestran algunos escenarios típicos probados con un módulo CM5 que cuenta con 4GB de RAM, almacenamiento eMMC de 32GB y un módulo Wi-Fi.
...
- [Folleto reComputer Industrial R21xx](https://files.seeedstudio.com/wiki/raspberry-pi/Seeed_Raspberry_Pi_Flyer.pdf)
