...
### 2.2 conectar la red e instalar el nodo faltante
...
Luego completa el Token, que son los API Tokens en la página web de InfluxDB de los que hablamos al principio.

<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/reCamera/Applications/Heatmap/heatmap_20.png" /></div>

Hacemos clic en Copy to Cilpboard y completamos el Token copiado en la configuración.
...
Luego hacemos clic en el despliegue en la esquina superior derecha para hacer que el cambio que acabamos de hacer tome efecto. Hay una ventana emergente de advertencia y podemos cerrarla.

<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/reCamera/Applications/Heatmap/heatmap_23.png" /></div>

### 2.4 Ver datos de InfluxDB
...
Regresa a la interfaz de configuración de hace un momento y abre la conexión ssh.
...
La IP de reCamera se puede encontrar en la configuración de red
...
La ruta de la carpeta del archivo 'Heatmap area calibration' que descargaste de GitHub después de la descompresión, primero ingresamos a Heatmap area calibration, hacemos clic en la caja de ruta arriba de la carpeta, y copiamos la ruta.
...
Elegimos la imagen más reciente, usualmente la última imagen, y la renombramos R1
...
Si es una acumulación de 1 hora (miles de puntos), max debe establecerse en 150 o más alto, de lo contrario el mapa se volverá instantáneamente rojo (sobreexpuesto).
...
En este punto, deberías poder ver la siguiente visualización en el panel de Grafana. Si encuentras algún problema, por favor consulta la sección "Preguntas Frecuentes" al final del artículo.
