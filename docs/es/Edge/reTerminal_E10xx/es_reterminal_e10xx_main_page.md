---
description: Este artículo es una página de colección para la serie reTerminal E.
...
El reTerminal E1001 cuenta con una pantalla ePaper monocromática de 7.5 pulgadas con capacidad de escala de grises de 4 niveles. Con su resolución de 800×480, ofrece texto nítido e imágenes claras mientras consume energía mínima. La pantalla monocromática es perfecta para aplicaciones donde la legibilidad del texto y la vida útil de la batería son prioridades.

### Características principales

- Pantalla ePaper monocromática de 7.5 pulgadas con escala de grises de 4 niveles
- Resolución de 800×480
- Consumo de energía ultra bajo para vida útil extendida de la batería
...
- Resolución de 800×480
- Representación rica de colores manteniendo bajo consumo de energía
...
<div class="get_one_now_container" style={{textAlign: 'center'}}>
    ...
    <a class="get_one_now_item" href="https://wiki.seeedstudio.com/es/sensecraft_hmi_overview" target="_blank" rel="noopener noreferrer">
            <strong><span><font color={'FFFFFF'} size={"4"}> Wiki SenseCraft HMI</font></span></strong>
  </a>
</div><br />

Todos los dispositivos de pantalla ePaper de la serie reTerminal E están diseñados para funcionar con la plataforma SenseCraft HMI, proporcionando una interfaz web intuitiva para crear e implementar contenido en sus dispositivos. Las características principales incluyen:

- **Generador AI**: Crear tableros usando indicaciones de texto
...
- **Integración RSS**: Mostrar noticias y actualizaciones de feeds web
- **Visualización de contenido web**: Mostrar contenido de páginas web

## Aplicaciones

La pantalla ePaper de la serie reTerminal E soporta múltiples plataformas de desarrollo y marcos de trabajo:

- [Pantalla ePaper de la serie reTerminal E funciona con ESPHome para Home Assistant](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome)

  Explica cómo conectar la pantalla ePaper de la serie reTerminal E a Home Assistant y escribir programas simples para dibujar gráficos simples en ESPHome a través de YAML.

- [Uso avanzado de ESPHome de la pantalla ePaper de la serie reTerminal E en Home Assistant](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome_advanced)

  Explica cómo usar el hardware de reTerminal y características avanzadas como el sueño profundo y casos de uso integrales en Home Assistant.

- [La pantalla ePaper de la serie reTerminal E funciona con TRMNL](https://wiki.seeedstudio.com/es/reterminal_e10xx_trmnl)

  Utilizar el marco de trabajo TRMNL dedicado para desarrollo simplificado e implementación rápida.
...
Cualquier cambio o modificación no aprobada expresamente por la parte responsable del cumplimiento podría anular la autoridad del usuario para operar el equipo. Este dispositivo cumple con la Parte 15 de las Reglas FCC. La operación está sujeta a las siguientes dos condiciones:
