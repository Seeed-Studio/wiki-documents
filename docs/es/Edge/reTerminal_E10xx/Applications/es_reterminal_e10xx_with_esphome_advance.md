---
description: Este artículo describe cómo utilizar las capacidades de hardware de la serie reTerminal E10xx en ESPHome.
title: Uso Avanzado de ESPHome del reTerminal E10xx en Home Assistant
...
# Uso Avanzado de ESPHome del reTerminal E10xx en Home Assistant
...
Este artículo explora configuraciones avanzadas de ESPHome para tu dispositivo reTerminal E10xx, basándose en los conceptos fundamentales cubiertos en nuestra [guía de Uso Básico de ESPHome](https://wiki.seeedstudio.com/es/reterminal_e10xx_with_esphome). Si eres nuevo en ESPHome o el reTerminal E10xx, recomendamos comenzar con la guía básica antes de sumergirte en estas aplicaciones avanzadas.

## Capacidades de Hardware

El reTerminal E10xx incluye varios componentes de hardware que pueden ser aprovechados en Home Assistant a través de ESPHome:
...
## Control de Componentes de Hardware del reTerminal E10xx

Exploremos cómo usar cada uno de los componentes de hardware en el reTerminal E10xx en Home Assistant.

### Botones y LED

Este ejemplo demuestra cómo usar los tres botones en tu reTerminal E10xx para controlar funciones y proporcionar retroalimentación visual con el LED integrado.
...
El reTerminal E10xx incluye un zumbador en GPIO45 que se puede usar para proporcionar retroalimentación audible. Aquí se explica cómo configurarlo:
...
El reTerminal E10xx puede monitorear su nivel de batería a través de la entrada analógica en GPIO1. Aquí te mostramos cómo configurarlo:
...
- Hace que tanto el voltaje en bruto como el porcentaje estén disponibles en Home Assistant

:::caution
Para medir el nivel de la batería, necesitas habilitar el pin **GPIO21**. De lo contrario, no es posible leer el valor de voltaje de la batería desde GPIO1.
:::
...
Este ejemplo demuestra cómo capturar capturas de pantalla de tu panel de Home Assistant y mostrarlas en tu reTerminal E10xx.
...
El complemento Puppet lanza un servidor en el puerto 10000 que genera capturas de pantalla de cualquier página de Home Assistant. Aquí te mostramos cómo usarlo:
...
Esta URL capturará una captura de pantalla de tu panel de control predeterminado a una resolución de 800x480 (perfecta para reTerminal E10xx).
...
Paso 10. Prueba tu URL de captura de pantalla ingresándola en un navegador web. Deberías ver la captura de pantalla de tu página de Home Assistant seleccionada.
...
Cuando tu configuración se haya subido exitosamente y esté ejecutándose, tu reTerminal E10xx mostrará una captura de pantalla del panel de control de tu Home Assistant:
...
Este ejemplo demuestra cómo usar el modo de suspensión profunda para reducir significativamente el consumo de energía, haciendo que tu reTerminal E10xx sea adecuado para aplicaciones alimentadas por batería.
...
Al ejecutarse, verás un contador incrementar cada vez que el dispositivo despierte del sueño:
...
Este ejemplo avanzado combina múltiples características en una solución de panel de control completa para el reTerminal E10xx. Demuestra:
...
Cuando tu configuración se haya subido exitosamente y esté ejecutándose, tu reTerminal E10xx mostrará un panel completo con datos ambientales, hora y estado de la batería:
...
1. **Múltiples Páginas**: La pantalla alterna entre dos páginas - un panel climático y una visualización de hora/fecha
...
En este caso, deberías ir a Configuración -> Dispositivos y Servicios -> Integraciones para **RECONFIGURAR** el dispositivo. ¿No encuentras tu Panel ePaper? Intenta reiniciar Home Assistant.

<div style={{flex:1}}><img src="https://files.seeedstudio.com/wiki/xiao_075inch_epaper_panel/101.png" style={{width:'100%', height:'auto'}}/></div>

### P2: ¿Por qué no puedo obtener esos datos en Home Assistant? {#port}

En este caso, deberías ir a Configuración -> Dispositivos y Servicios -> Integraciones para **AÑADIR** tu dispositivo a Home Assistant.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/xiao_075inch_epaper_panel/11.png" style={{width:800, height:'auto'}}/></div>

<!-- ### P3: ¿Cómo puedo subir un nuevo programa cuando el dispositivo está en modo de sueño profundo?
...
Cuando el dispositivo está en modo de sueño profundo, no puedes subir un nuevo programa directamente. Sigue estos pasos para entrar en modo de descarga:
...
Paso 2. Mientras mantienes el botón **Boot**, presiona el botón **Reset** una vez, luego suelta el botón **Boot**.

Paso 3. Apaga el interruptor de la batería y desconecta el cable de alimentación.

Paso 4. Finalmente, vuelve a conectar el cable y sube un nuevo programa. -->

### P3: ¿Falló la subida del programa por Wi-Fi?

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/xiao_075inch_epaper_panel/74.png" style={{width:800, height:'auto'}}/></div>

En este caso, tu dispositivo está desconectado o en modo de sueño profundo. Por favor asegúrate de que esté conectado a tu red o despiértalo del modo de sueño antes de intentar subir.
