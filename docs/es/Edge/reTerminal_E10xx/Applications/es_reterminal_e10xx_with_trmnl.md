...
- **Selecciona tu red Wi-Fi de 2.4GHz** (la pantalla ePaper de la serie reTerminal E no soporta redes de 5GHz).
...
Después de que tu reTerminal E Series ePaper Display esté conectado a tu Wi-Fi y hayas registrado su dirección MAC (ID del dispositivo), puedes agregarlo a tu cuenta de TRMNL:
...
2. **Ir a la Página de Dispositivos**  
   - En la interfaz de TRMNL, navega a la sección **Dispositivos**.

3. **Agregar un Nuevo Dispositivo**  
   - Haz clic en el botón **Agregar nuevo dispositivo**, que generalmente se encuentra en la esquina superior derecha o en el centro de la página de Dispositivos.
...
5. **Registrar la Dirección MAC del reTerminal E Series ePaper Display**

   Para establecer una conexión entre el reTerminal E Series ePaper Display y TRMNL, necesitamos vincular la dirección MAC correcta del dispositivo dentro de la página de configuración de TRMNL.
...
¡Tu reTerminal E Series ePaper Display ahora está vinculado a tu cuenta de TRMNL! Ahora puedes enviar listas de reproducción, imágenes u otro contenido a tu pantalla directamente desde la interfaz de TRMNL.

> 💡 **Consejo:** Si tienes múltiples reTerminal E Series, repite los pasos anteriores para cada dispositivo usando sus IDs de dispositivo únicos.
...
Este sistema flexible de listas de reproducción te permite personalizar completamente qué muestra tu reTerminal E Series, con qué frecuencia se actualiza y en qué orden. Puedes mezclar y combinar diferentes plugins para crear un panel personalizado que se adapte a tus necesidades.
...
En la parte superior de la página de Plugins, verás todos los plugins que ya has conectado a tu cuenta de TRMNL. Estos están listos para ser agregados a tu lista de reproducción y mostrados en tu reTerminal E Series. Los ejemplos incluyen:
