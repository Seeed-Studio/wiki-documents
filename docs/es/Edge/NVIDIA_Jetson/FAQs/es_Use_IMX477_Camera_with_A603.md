...
:::caution
Por favor ten en cuenta que necesitas usar el BSP para [ **JP5.1.2** ](https://developer.nvidia.com/embedded/jetson-linux-r3541).
:::
...
:::caution
Por favor ten en cuenta que necesitas usar el BSP para [ **JP6.0** ](https://developer.nvidia.com/embedded/jetson-linux-r363).
:::
