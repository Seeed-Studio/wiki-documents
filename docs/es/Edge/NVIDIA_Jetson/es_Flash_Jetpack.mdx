---
description: Flashear Jetpack al producto seleccionado. Esta página actualmente incluye un subconjunto de los productos.
title: Flashear Jetpack al Producto Seleccionado
keywords:
  - jetson
  - flash
  - jetapck
...
Selecciona tu producto y el Jetson Linux que deseas flashear. Esta página actualmente incluye un subconjunto de los productos.
...
JetPack con soporte 🚀 para configuraciones [MAXN super](https://developer.nvidia.com/blog/nvidia-jetpack-6-2-brings-super-mode-to-nvidia-jetson-orin-nano-and-jetson-orin-nx-modules/)
...
Instalando las dependencias de flash en la PC Host:
```bash
sudo apt-get update && \
...
Adicionalmente, para Ubuntu 18.04 e inferiores, instala `lz4c`
...
{/* <table>
  <tr>
   <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/es/Traffic-Management-DeepStream-SDK/">Ejemplo DeepStream</a></div>
    </td>
   <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/A608/Real-Time-Whisper.gif" width="300" />
      <div><a href="https://wiki.seeedstudio.com/es/Edge/NVIDIA_Jetson/Application/Generative_AI/Whisper_on_Jetson_for_Real_Time_Speech_to_Text/">Whisper en Jetson</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/Jetson-Nano-MaskCam/tu3.png" width="300" />
      <div><a href="https://wiki.seeedstudio.com/es/Jetson-Nano-MaskCam/">Proyecto MaskCam</a></div>
    </td>
  </tr>
  <tr>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/sound_follow/robot.jpg" width="300" />
      <div><a href="https://wiki.seeedstudio.com/es/sound_follow_robot/">Robot Seguidor de Sonido</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
    ...
    <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/es/deploy_deepseek_on_jetson_with_mlc/">Demo DeepSeek</a></div>
    </td>
  </tr>
</table> */}
