...
slug: /es/reServer_J2032_Getting_Started
sku: 110061403
last_update:
  date: 01/03/2023
  author: w0x7ce
...
# Primeros Pasos con reServer J2032
...
reServer J2032 es el nuevo y potente dispositivo de computación Edge AI que orgullosamente introducimos a nuestra familia reThings, adopta el elegante diseño de carcasa con factor de forma reServer que empaqueta la unidad potente en una forma extremadamente compacta. Este pequeño servidor inteligente no solo es capaz de trabajar fácil y eficientemente desde el borde hasta la nube, sino que también añade poder de procesamiento de IA a la fórmula.

reServer J2032 está equipado con el módulo Nvidia Jetson™ Xavier NX 16GB de vanguardia (Módulo Jetson™ Xavier NX 8GB opcional) que puede entregar hasta 21 TOPS para procesar tareas comunes de IA, la cantidad extensa de RAM GPU permite el procesamiento paralelo de múltiples redes neuronales. Tiene puertos Ethernet duales que consisten en un puerto Ethernet de alta velocidad de 2.5 Gigabit y uno de 1 Gigabit y también soporta conectividad híbrida incluyendo 5G, LoRa® y BLE. reServer 2032 también teniendo conectores de datos SATA III 6.0Gbps duales, es capaz de equipar hasta dos discos duros internos SATA de 3.5"/2.5" para adquirir más almacenamiento.

Mientras tanto, reServer es de diseño compacto para trabajar eficientemente en casi cualquier escenario de servidor. La estructura ordenada de reServer también hace que sea simple acceder a los discos duros, y las ranuras extensas de extensión de módulos de comunicación que permiten instalación, actualizaciones y mantenimiento fáciles.

Teniendo conectores de datos SATA III 6.0Gbps duales, reServer es capaz de equipar hasta dos discos duros internos SATA de 3.5"/2.5" para adquirir más almacenamiento.
...
- Diseño compacto para un servidor de escritorio con una dimensión general de 132mm x124mm x233mm
- Alimentado por el Módulo Nvidia Jetson™ Xavier NX 16Gb.
- Periféricos ricos incluyendo puerto LAN dual(1 x puerto de 2.5Gigabit y 1 x puerto de 1 Gigabit), 2 x USB 3.2 gen 2 Tipo-A, puerto HDMI y puerto DP, 1 x M.2 Key B, 1 x puerto Mini-PCIe.
- Soporta conectividad híbrida incluyendo 5G, LoRa® y BLE (5G y LoRa® necesitan módulos adicionales)
...
- M.2 B-Key para expandibilidad como módulos 4G/5G.
- Puerto Mini-PCIe para expandibilidad como módulos 4G/5G y módulo LoRaWAN® (**WM1302-USB-XXXX**)
...
- Pre-instalado con NVIDIA Jetpack 4.6.1 (Jetson™ Linux R32.7.1)

> LoRaWAN® es una marca usada bajo licencia de LoRa Alliance®.
La Marca LoRa® es una marca comercial de Semtech Corporation o sus subsidiarias.## Especificaciones
    ...
    <table><colgroup><col width="115px" /><col width="188px" /><col width="392px" /></colgroup>
      <tbody>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">2x Motores NVDLA</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
        ...
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Codificador de Video</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Soporta 2 x 2.5''/3.5" SATA (HDD/SSD), hasta SATA3 (SSD de 2.5 pulgadas 256GB x1, hasta SATA3 ya instalado)</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Coprocesador</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
        ...
        <tr>
          ...
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Puerto Ethernet 2.5G</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Convertido desde PCIe</p>
        ...
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Puerto Ethernet 1000M</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Interfaz Ethernet nativa del Jetson Xavier NX</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Soporta hasta HDMI2.0</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Soporta hasta DP1.4</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Soporta hasta 10Gbit</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Interfaz de Alimentación DC Jack</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">DC 12V @5A, pin central de 2.5mm</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={2} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Ranura para Tarjeta SIM</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={2} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Soporta HDD/SSD de 2.5 pulgadas o 3.5 pulgadas, hasta SATA3</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Para ventilador de carcasa, solo soporta ventiladores de 12V, el ventilador inferior ya está instalado</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Conector de Ventilador Jetson Xavier NX</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Solo soporta ventiladores de 5V, ventilador de refrigeración con disipador de aluminio ya instalado</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Para programación de NX</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Conector USB TYPE-C para Coprocesador</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Para actualización de firmware del coprocesador</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Conector de Encendido Automático</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Cortocircuitar para entrar en modo de encendido por tecla, dejar flotante para entrar en modo de encendido automático</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Conector de Depuración 2x5 Pines</p>
          </td>
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
        ...
        <tr>
          <td data-style="width: 594px;" colSpan={2} rowSpan={1} align valign="middle" style={{width: 594}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Zumbador Activo</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={2} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Modo de suspensión o sin SSD/HDD insertado-----LED APAGADO</p>
            ...
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Estado de transferencia de datos ----- LED parpadea</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
        ...
        <tr>
          ...
          <td data-style="width: 395px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 395}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Encender</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 193px;" colSpan={1} rowSpan={1} align valign="middle" style={{width: 193}}>
        ...
        <tr>
          ...
          <td data-style="width: 594px;" colSpan={2} rowSpan={1} align valign="middle" style={{width: 594}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">SSD de 2.5 pulgadas 256GB x1, hasta SATA3</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 594px;" colSpan={2} rowSpan={1} align valign="middle" style={{width: 594}}>
            <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">&nbsp;</p>
            <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">Ventilador de Refrigeración con Disipador de Aluminio</p>
          </td>
        </tr>
        <tr>
          <td data-style="width: 594px;" colSpan={2} rowSpan={1} align valign="middle" style={{width: 594}}>
...
reServer J2032 ya viene pre-flasheado con JetPack de fábrica. Pero si deseas volver a flashear el dispositivo, por favor sigue [este wiki](https://wiki.seeedstudio.com/es/reServer_J2032_Flash_Jetpack).

## Inicio Rápido con Ensamblaje de Periféricos y Módulos de reServer

!!! Note:
    reServer J2032 vendrá con **Jetpack 4.6.1 preinstalado** en la EMMC del módulo Jetson Xavier NX, lo que significa que podrías comenzar directamente a desarrollar tu propia aplicación con él.
...
### Ensamblaje de Periféricos y Módulos

Para esta parte, introduciremos cómo instalar o reemplazar algunos hardware/módulos compatibles dentro de reServer. por favor omite esto si los siguientes pasos no se aplican a tu caso de uso.
...
#### Instalación del Módulo LoRaWAN® en Puerto Mini-PCIe

!!! Note:
    La siguiente guía de configuración para instalar el Módulo LoRaWAN® en el puerto Mini-PCIe solo ha sido probada con los siguientes módulos [WM1302-USB-US915](https://www.seeedstudio.com/WM1302-LoRaWAN-Gateway-Module-USB-US915-p-4891.html?queryID=6e7ba3140d26416085ce7ea85c0be886&objectID=4891&indexName=bazaar_retailer_products) o [WM1302-USB-868](https://www.seeedstudio.com/WM1302-LoRaWAN-Gateway-Module-USB-EU868-p-4892.html?queryID=6e7ba3140d26416085ce7ea85c0be886&objectID=4892&indexName=bazaar_retailer_products). el Módulo LoRaWAN® no está incluido.

- **Paso 1.** Localiza la ranura Mini-PCIe en la parte posterior de la placa portadora e instala el Módulo LoRaWAN®.
...
- **Paso 2.** Conecta el cable de antena y localiza la ranura de montaje de antena en la parte posterior de la carcasa del reServer J2032 que debería tener un inserto de goma bloqueando el agujero.

!!! Note:
     reServer J2032 no se envía con Adaptadores de Antena y Antena.
...
- **Paso 3.** modifica reServer J2032 para ser usado con el módulo LoRaWAN® escribiendo el siguiente comando en la `Terminal`:
...
- **Paso 4.** verifica si el módulo LoRaWAN® está conectado correctamente, abre `Terminal` y escribe el siguiente comando:
  
!!! Note:
    Los siguientes pasos para habilitar el módulo LoRaWAN® solo han sido probados y aplicados en el Jetpack 4.6.1 predeterminado de fábrica

```
ls /dev/ttyACM*
```

Deberías ver la siguiente salida como se muestra a continuación:
...
- **Paso 5.** Para usar el Módulo LoRaWAN® por favor descarga el código fuente:
...
Muévete a la carpeta sx1302_hal y construye el programa:
...
Comienza a ejecutar la aplicación de gateway LoRaWAN®, aquí tienes un ejemplo usando el módulo [WM1302-USB-868](https://www.seeedstudio.com/WM1302-LoRaWAN-Gateway-Module-USB-EU868-p-4892.html?queryID=6e7ba3140d26416085ce7ea85c0be886&objectID=4892&indexName=bazaar_retailer_products), donde se ha elegido el archivo de configuración `global_conf.json.sx1250.EU868.USB`:
...
#### Instalación del Módulo 4G/5G Mini-PCIe

!!! Nota:
     **El módulo 4G QC25-EUX** se utiliza con la siguiente guía de configuración y el módulo no está incluido.

- **Paso 1.** Localiza la ranura Mini-PCIe en la parte posterior de la placa portadora e instala el Módulo LoRaWAN®.

!!! Nota:
     Necesitas insertar una tarjeta SIM estándar en la ranura de tarjeta SIM del reServer J2032 para habilitar la red 4G/5G.
     Si observas detenidamente, la **Bandeja de tarjeta SIM** tiene dos capas, el puerto **Mini-PCIe** está utilizando la **Ranura SIM 2** como se indica en la imagen a continuación.
...
- **Paso 2.** Conecta el cable de la antena y localiza la ranura de montaje de la antena en la parte posterior de la carcasa del reServer J2032 que debería tener un inserto de goma bloqueando el orificio.

!!! Nota:
     El reServer J2032 no se envía con Adaptadores de Antena y Antena.

<p style={{textAlign: 'center'}}><img src="https://files.seeedstudio.com/wiki/reServerJ2032/antenna.jpg" alt="pir" width={650} height="auto" /></p>

- **Paso 3.** modifica el reServer J2032 para ser usado con el **módulo 4G QC25-EUX** escribiendo el siguiente comando en la `Terminal`:
...
- **Paso 4.** verifica si el **módulo 4G QC25-EUX** está conectado correctamente encendiendo y arrancando el sistema, luego abre `Terminal` y escribe el siguiente comando:
  
!!! Note:
    Los siguientes pasos para habilitar el **módulo 4G QC25-EUX** solo han sido probados y aplicados en la **Versión de Jetpack OS por Defecto de Fábrica 4.6.1**
...
- **Paso 5.** Habilita el **módulo 4G QC25-EUX** para conectarse a la red 4G, por favor abre ```Terminal``` y escribe:

Abre el monitor serie minicom con el módulo 4G conectado
...
Ahora si escribes `ifconfig` en `Terminal` deberías ver una salida similar a la imagen mostrada abajo donde tienes asignada una dirección IP de tu operador móvil de tarjeta SIM:
...
#### Instalación del Puerto M.2 B-key del Módulo 4G/5G

!!! Note:
    El M.2 B-Key en reServer J2032 soporta formato 3042/3052(USB3.2 GEN2) compatible con Módulo Inalámbrico 4G/5G **(El Módulo 4G/5G no está incluido en reServer)**. El módulo 5G SIM8202G-M2 se usa en los siguientes pasos.

- **Paso 1.** Instalar el Módulo SIM8202G-M2 al M.2 B-Key.
...
- **Paso 2.** Conectar el cable de antena al Módulo.

!!! Note:
     reServer J2032 no se envía con Adaptadores de Antena y Antena, Para usar el Módulo 5G **SIM8202G-M2** para conectar a la red necesitas tener Antenas conectadas al módulo.

<p style={{textAlign: 'center'}}><img src="https://files.seeedstudio.com/wiki/reServerJ2032/antenna.jpg" alt="pir" width={650} height="auto" /></p>

- **Paso 3.** Modificar reServer J2032 para ser usado con el **módulo 5G SIM8202G-M2** en el puerto M.2 B-Key escribiendo el siguiente comando en la `Terminal`:
...
- **Paso 4.** verifica si el **módulo 5G SIM8202G-M2** está conectado correctamente encendiendo y arrancando el sistema, luego abre `Terminal` y escribe el siguiente comando:
  
!!! Note:
    Los siguientes pasos para habilitar el **módulo 5G SIM8202G-M2** solo han sido probados y aplicados en la **Versión de Jetpack OS por Defecto de Fábrica 4.6.1**

```
lsusb -t
```

Deberías ver salidas similares a las que se muestran a continuación:
...
**Paso 5.** Habilitar el módulo 5G **SIM8202G-M2** para conectarse a la red 5G

!!! Note:
     Necesitas insertar una tarjeta SIM estándar en la ranura para tarjeta SIM del reServer J2032 para habilitar la red 4G/5G.
     Si observas detenidamente, la **Bandeja de tarjeta SIM** tiene dos ranuras superior e inferior, el puerto **M.2 B-key** está utilizando la **Ranura Inferior**.
...
Abre el monitor serie minicom con el módulo 5G SIM8202G-M2 conectado
...
Una vez que se abra la conexión serie, escriba `AT` y presione 'Enter', debería ver `OK` en la siguiente línea.

Ahora, para poder conectarse a la red 4G/5G, siga el comando para instalar el controlador requerido para el módulo 5G SIM8202G-M2 para habilitar la conexión de red:
...
Ahora si escribes `ifconfig` en `Terminal` deberías ver una salida similar a la imagen mostrada a continuación, donde tienes asignada una dirección IP de tu operador móvil de la tarjeta SIM:
...
reServer soporta la instalación de dos discos duros internos de 3.5"/2.5" para adquirir más almacenamiento.
Por favor sigue los pasos para instalar los HDDs.

- **Paso 1.** Retira los tornillos y extrae los soportes

- **Paso 2.** Fija los HDDs a los soportes con tornillos
...
Para esta parte, introduciremos la conexión de interfaz de reServer.

#### Conexión de Alimentación

Simplemente conecta el adaptador de alimentación AC-DC (incluido en la caja del producto) con el cable de alimentación AC (fuera de la caja del producto pero aún en el paquete), luego conéctalo al conector DC de 12V de reServer.
...
Puedes conectar dispositivos USB como teclado y ratón a través del puerto USB 3.1 dual.
...
Hay dos métodos para que reServer se conecte a una pantalla.
...
reServer J2032 viene con dos puertos ethernet cuyas velocidades de conexión son 1000BASE-T y 2.5GBASE-T respectivamente,
...
- **[PDF]** [Guía de Ensamblaje de reServer](https://files.seeedstudio.com/wiki/reComputer/reServer_Jetson_Assembly_Guide.pdf)
