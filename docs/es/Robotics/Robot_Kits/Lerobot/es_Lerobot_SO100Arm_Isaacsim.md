...
title: Cómo Importar y Controlar SO100Arm Kit en Isaac Sim
keywords:
- Lerobot
- Huggingface
- Arm
...
:::caution
Las partes impresas en 3D y las abrazaderas de mesa no están incluidas en el producto. Sin embargo, el SO-100ARM proporciona [archivos STL detallados para impresión 3D](https://github.com/TheRobotStudio/SO-ARM100/tree/main/stl_files_for_3dprinting) y parámetros de impresión. Además, también ofrecemos las [partes impresas en 3D de la Abrazadera de Mesa](https://makerworld.com/zh/models/908660).
:::
...
## Importar el URDF a Isaac Sim
  ...
  **Asegúrate de que Isaac Sim haya sido instalado según el [tutorial oficial](https://docs.omniverse.nvidia.com/isaacsim/latest/installation/install_workstation.html) de NVIDIA, [ROS2 haya sido instalado, y la configuración básica del entorno haya sido completada](https://docs.omniverse.nvidia.com/isaacsim/latest/installation/install_ros.html). Abre la interfaz de Isaac Sim con parámetros como se muestra en la figura a continuación.**
  <div align="center">
      <img width={600}
