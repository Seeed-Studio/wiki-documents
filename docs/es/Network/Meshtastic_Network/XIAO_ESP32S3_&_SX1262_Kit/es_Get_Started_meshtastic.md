...
| [Device](https://meshtastic.org/docs/configuration/radio/device/) | Las opciones de configuración de Dispositivo son: Rol del Dispositivo, Salida Serie, Registro de Depuración y Restablecimiento de Fábrica. |
