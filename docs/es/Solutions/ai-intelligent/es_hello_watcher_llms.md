  ...
  <div class="section-header">
	...
	<ul class="info-list">
		...
		<li class="info-item">
			...
			<div class="info-content">
				<h3>Construye Apps de IA Sin Código, Tan Simple Como Lego</h3>
...
Los desarrolladores o usuarios avanzados pueden instalar diferentes modelos o firmware para empoderar a Watcher con capacidades más poderosas y exclusivas.
