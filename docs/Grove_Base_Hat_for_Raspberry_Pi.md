...
The Grove Base Hat for Raspberry Pi provide Digital/Analog/I2C/PWM/UART port to meet all your needs. With the help of build-in MCU, a 12-bit ADC is also available for Raspberry Pi.

Frankly speaking, only 34 Grove modules support the Grove Base Hat for Raspberry Pi now. However, we will continue to add new compatible modules, the more you use, the more grove added.
...
It seems nothing happened, however you can find the most famous sentence in cyber world if you check your oled.😄
